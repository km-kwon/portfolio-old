...
`,Dv=`# 브라우저 안에서 JS와 렌더링은 어떻게 돌아가는가 (2편)\r
\r
...
`,Ov=`# 커링?? 컬링도 아니고 이게 뭐누 (근데 실무에서 은근 자주 만남)\r
\r
개발하다 보면 이런 순간이 있다.\r
\r
- 함수 하나 만들었는데\r
...
`,Lv=`# 프론트엔드에서 DDD와 FSD, 그리고 ‘도메인 슬라이스’ 아키텍처\r
\r
...
`});const h={type:"element",tagName:"li",properties:c,children:f};return t.patch(a,h),t.applyData(a,h)}function $w(t){let a=!1;if(t.type==="list"){a=t.spread||!1;const l=t.children;let u=-1;for(;!a&&++u<l.length;)a=Sx(l[u])}return a}function Sx(t){const a=t.spread;return a??t.children.length>1}function eC(t,a){const l={},u=t.all(a);let s=-1;for(typeof a.start=="number"&&a.start!==1&&(l.start=a.start);++s<u.length;){const f=u[s];if(f.type==="element"&&f.tagName==="li"&&f.properties&&Array.isArray(f.properties.className)&&f.properties.className.includes("task-list-item")){l.className=["contains-task-list"];break}}const c={type:"element",tagName:a.ordered?"ol":"ul",properties:l,children:t.wrap(u,!0)};return t.patch(a,c),t.applyData(a,c)}function nC(t,a){const l={type:"element",tagName:"p",properties:{},children:t.all(a)};return t.patch(a,l),t.applyData(a,l)}function tC(t,a){const l={type:"root",children:t.wrap(t.all(a))};return t.patch(a,l),t.applyData(a,l)}function rC(t,a){const l={type:"element",tagName:"strong",properties:{},children:t.all(a)};return t.patch(a,l),t.applyData(a,l)}function lC(t,a){const l=t.all(a),u=l.shift(),s=[];if(u){const f={type:"element",tagName:"thead",properties:{},children:t.wrap([u],!0)};t.patch(a.children[0],f),s.push(f)}if(l.length>0){const f={type:"element",tagName:"tbody",properties:{},children:t.wrap(l,!0)},m=ef(a.children[1]),p=ex(a.children[a.children.length-1]);m&&p&&(f.position={start:m,end:p}),s.push(f)}const c={type:"element",tagName:"table",properties:{},children:t.wrap(s,!0)};return t.patch(a,c),t.applyData(a,c)}function aC(t,a,l){const u=l?l.children:void 0,c=(u?u.indexOf(a):1)===0?"th":"td",f=l&&l.type==="table"?l.align:void 0,m=f?f.length:a.children.length;let p=-1;const h=[];for(;++p<m;){const x=a.children[p],S={},v=f?f[p]:void 0;v&&(S.align=v);let C={type:"element",tagName:c,properties:S,children:[]};x&&(C.children=t.all(x),t.patch(x,C),C=t.applyData(x,C)),h.push(C)}const b={type:"element",tagName:"tr",properties:{},children:t.wrap(h,!0)};return t.patch(a,b),t.applyData(a,b)}function iC(t,a){const l={type:"element",tagName:"td",properties:{},children:t.all(a)};return t.patch(a,l),t.applyData(a,l)}const tg=9,rg=32;function uC(t){const a=String(t),l=/\r?\n|\r/g;let u=l.exec(a),s=0;const c=[];for(;u;)c.push(lg(a.slice(s,u.index),s>0,!0),u[0]),s=u.index+u[0].length,u=l.exec(a);return c.push(lg(a.slice(s),s>0,!1)),c.join("")}function lg(t,a,l){let u=0,s=t.length;if(a){let c=t.codePointAt(u);for(;c===tg||c===rg;)u++,c=t.codePointAt(u)}if(l){let c=t.codePointAt(s-1);for(;c===tg||c===rg;)s--,c=t.codePointAt(s-1)}return s>u?t.slice(u,s):""}function sC(t,a){const l={type:"text",value:uC(String(a.value))};return t.patch(a,l),t.applyData(a,l)}function oC(t,a){const l={type:"element",tagName:"hr",properties:{},children:[]};return t.patch(a,l),t.applyData(a,l)}const cC={blockquote:Hw,break:qw,code:Iw,delete:Vw,emphasis:Fw,footnoteReference:Gw,heading:Yw,html:Pw,imageReference:Xw,image:Jw,inlineCode:Qw,linkReference:Zw,link:Kw,listItem:Ww,list:eC,paragraph:nC,root:tC,strong:rC,table:lC,tableCell:iC,tableRow:aC,text:sC,thematicBreak:oC,toml:vu,yaml:vu,definition:vu,footnoteDefinition:vu};function vu(){}const kx=-1,Bu=0,Ia=1,_u=2,sf=3,of=4,cf=5,ff=6,wx=7,Cx=8,ag=typeof self=="object"?self:globalThis,fC=(t,a)=>{const l=(s,c)=>(t.set(c,s),s),u=s=>{if(t.has(s))return t.get(s);const[c,f]=a[s];switch(c){case Bu:case kx:return l(f,s);case Ia:{const m=l([],s);for(const p of f)m.push(u(p));return m}case _u:{const m=l({},s);for(const[p,h]of f)m[u(p)]=u(h);return m}case sf:return l(new Date(f),s);case of:{const{source:m,flags:p}=f;return l(new RegExp(m,p),s)}case cf:{const m=l(new Map,s);for(const[p,h]of f)m.set(u(p),u(h));return m}case ff:{const m=l(new Set,s);for(const p of f)m.add(u(p));return m}case wx:{const{name:m,message:p}=f;return l(new ag[m](p),s)}case Cx:return l(BigInt(f),s);case"BigInt":return l(Object(BigInt(f)),s);case"ArrayBuffer":return l(new Uint8Array(f).buffer,f);case"DataView":{const{buffer:m}=new Uint8Array(f);return l(new DataView(m),f)}}return l(new ag[c](f),s)};return u},ig=t=>fC(new Map,t)(0),El="",{toString:dC}={},{keys:hC}=Object,za=t=>{const a=typeof t;if(a!=="object"||!t)return[Bu,a];const l=dC.call(t).slice(8,-1);switch(l){case"Array":return[Ia,El];case"Object":return[_u,El];case"Date":return[sf,El];case"RegExp":return[of,El];case"Map":return[cf,El];case"Set":return[ff,El];case"DataView":return[Ia,l]}return l.includes("Array")?[Ia,l]:l.includes("Error")?[wx,l]:[_u,l]},Su=([t,a])=>t===Bu&&(a==="function"||a==="symbol"),mC=(t,a,l,u)=>{const s=(f,m)=>{const p=u.push(f)-1;return l.set(m,p),p},c=f=>{if(l.has(f))return l.get(f);let[m,p]=za(f);switch(m){case Bu:{let b=f;switch(p){case"bigint":m=Cx,b=f.toString();break;case"function":case"symbol":if(t)throw new TypeError("unable to serialize "+p);b=null;break;case"undefined":return s([kx],f)}return s([m,b],f)}case Ia:{if(p){let S=f;return p==="DataView"?S=new Uint8Array(f.buffer):p==="ArrayBuffer"&&(S=new Uint8Array(f)),s([p,[...S]],f)}const b=[],x=s([m,b],f);for(const S of f)b.push(c(S));return x}case _u:{if(p)switch(p){case"BigInt":return s([p,f.toString()],f);case"Boolean":case"Number":case"String":return s([p,f.valueOf()],f)}if(a&&"toJSON"in f)return c(f.toJSON());const b=[],x=s([m,b],f);for(const S of hC(f))(t||!Su(za(f[S])))&&b.push([c(S),c(f[S])]);return x}case sf:return s([m,f.toISOString()],f);case of:{const{source:b,flags:x}=f;return s([m,{source:b,flags:x}],f)}case cf:{const b=[],x=s([m,b],f);for(const[S,v]of f)(t||!(Su(za(S))||Su(za(v))))&&b.push([c(S),c(v)]);return x}case ff:{const b=[],x=s([m,b],f);for(const S of f)(t||!Su(za(S)))&&b.push(c(S));return x}}const{message:h}=f;return s([m,{name:p,message:h}],f)};return c},ug=(t,{json:a,lossy:l}={})=>{const u=[];return mC(!(a||l),!!a,new Map,u)(t),u},Du=typeof structuredClone=="function"?(t,a)=>a&&("json"in a||"lossy"in a)?ig(ug(t,a)):structuredClone(t):(t,a)=>ig(ug(t,a));function pC(t,a){const l=[{type:"text",value:"↩"}];return a>1&&l.push({type:"element",tagName:"sup",properties:{},children:[{type:"text",value:String(a)}]}),l}function gC(t,a){return"Back to reference "+(t+1)+(a>1?"-"+a:"")}function xC(t){const a=typeof t.options.clobberPrefix=="string"?t.options.clobberPrefix:"user-content-",l=t.options.footnoteBackContent||pC,u=t.options.footnoteBackLabel||gC,s=t.options.footnoteLabel||"Footnotes",c=t.options.footnoteLabelTagName||"h2",f=t.options.footnoteLabelProperties||{className:["sr-only"]},m=[];let p=-1;for(;++p<t.footnoteOrder.length;){const h=t.footnoteById.get(t.footnoteOrder[p]);if(!h)continue;const b=t.all(h),x=String(h.identifier).toUpperCase(),S=Rl(x.toLowerCase());let v=0;const C=[],O=t.footnoteCounts.get(x);for(;O!==void 0&&++v<=O;){C.length>0&&C.push({type:"text",value:" "});let H=typeof l=="string"?l:l(p,v);typeof H=="string"&&(H={type:"text",value:H}),C.push({type:"element",tagName:"a",properties:{href:"#"+a+"fnref-"+S+(v>1?"-"+v:""),dataFootnoteBackref:"",ariaLabel:typeof u=="string"?u:u(p,v),className:["data-footnote-backref"]},children:Array.isArray(H)?H:[H]})}const z=b[b.length-1];if(z&&z.type==="element"&&z.tagName==="p"){const H=z.children[z.children.length-1];H&&H.type==="text"?H.value+=" ":z.children.push({type:"text",value:" "}),z.children.push(...C)}else b.push(...C);const j={type:"element",tagName:"li",properties:{id:a+"fn-"+S},children:t.wrap(b,!0)};t.patch(h,j),m.push(j)}if(m.length!==0)return{type:"element",tagName:"section",properties:{dataFootnotes:!0,className:["footnotes"]},children:[{type:"element",tagName:c,properties:{...Du(f),id:"footnote-label"},children:[{type:"text",value:s}]},{type:"text",value:`
`},{type:"element",tagName:"ol",properties:{},children:t.wrap(m,!0)},{type:"text",value:`
`}]}}const Hu=(function(t){if(t==null)return SC;if(typeof t=="function")return qu(t);if(typeof t=="object")return Array.isArray(t)?bC(t):yC(t);if(typeof t=="string")return vC(t);throw new Error("Expected function, string, or object as test")});function bC(t){const a=[];let l=-1;for(;++l<t.length;)a[l]=Hu(t[l]);return qu(u);function u(...s){let c=-1;for(;++c<a.length;)if(a[c].apply(this,s))return!0;return!1}}function yC(t){const a=t;return qu(l);function l(u){const s=u;let c;for(c in t)if(s[c]!==a[c])return!1;return!0}}function vC(t){return qu(a);function a(l){return l&&l.type===t}}function qu(t){return a;function a(l,u,s){return!!(kC(l)&&t.call(this,l,typeof u=="number"?u:void 0,s||void 0))}}function SC(){return!0}function kC(t){return t!==null&&typeof t=="object"&&"type"in t}const Tx=[],wC=!0,Hc=!1,CC="skip";function Ex(t,a,l,u){let s;typeof a=="function"&&typeof l!="function"?(u=l,l=a):s=a;const c=Hu(s),f=u?-1:1;m(t,void 0,[])();function m(p,h,b){const x=p&&typeof p=="object"?p:{};if(typeof x.type=="string"){const v=typeof x.tagName=="string"?x.tagName:typeof x.name=="string"?x.name:void 0;Object.defineProperty(S,"name",{value:"node ("+(p.type+(v?"<"+v+">":""))+")"})}return S;function S(){let v=Tx,C,O,z;if((!a||c(p,h,b[b.length-1]||void 0))&&(v=TC(l(p,b)),v[0]===Hc))return v;if("children"in p&&p.children){const j=p;if(j.children&&v[0]!==CC)for(O=(u?j.children.length:-1)+f,z=b.concat(j);O>-1&&O<j.children.length;){const H=j.children[O];if(C=m(H,O,z)(),C[0]===Hc)return C;O=typeof C[1]=="number"?C[1]:O+f}}return v}}}function TC(t){return Array.isArray(t)?t:typeof t=="number"?[wC,t]:t==null?Tx:[t]}function df(t,a,l,u){let s,c,f;typeof a=="function"&&typeof l!="function"?(c=void 0,f=a,s=l):(c=a,f=l,s=u),Ex(t,c,m,s);function m(p,h){const b=h[h.length-1],x=b?b.children.indexOf(p):void 0;return f(p,x,b)}}const qc={}.hasOwnProperty,EC={};function AC(t,a){const l=a||EC,u=new Map,s=new Map,c=new Map,f={...cC,...l.handlers},m={all:h,applyData:NC,definitionById:u,footnoteById:s,footnoteCounts:c,footnoteOrder:[],handlers:f,one:p,options:l,patch:jC,wrap:_C};return df(t,function(b){if(b.type==="definition"||b.type==="footnoteDefinition"){const x=b.type==="definition"?u:s,S=String(b.identifier).toUpperCase();x.has(S)||x.set(S,b)}}),m;function p(b,x){const S=b.type,v=m.handlers[S];if(qc.call(m.handlers,S)&&v)return v(m,b,x);if(m.options.passThrough&&m.options.passThrough.includes(S)){if("children"in b){const{children:O,...z}=b,j=Du(z);return j.children=m.all(b),j}return Du(b)}return(m.options.unknownHandler||MC)(m,b,x)}function h(b){const x=[];if("children"in b){const S=b.children;let v=-1;for(;++v<S.length;){const C=m.one(S[v],b);if(C){if(v&&S[v-1].type==="break"&&(!Array.isArray(C)&&C.type==="text"&&(C.value=sg(C.value)),!Array.isArray(C)&&C.type==="element")){const O=C.children[0];O&&O.type==="text"&&(O.value=sg(O.value))}Array.isArray(C)?x.push(...C):x.push(C)}}}return x}}function jC(t,a){t.position&&(a.position=g2(t))}function NC(t,a){let l=a;if(t&&t.data){const u=t.data.hName,s=t.data.hChildren,c=t.data.hProperties;if(typeof u=="string")if(l.type==="element")l.tagName=u;else{const f="children"in l?l.children:[l];l={type:"element",tagName:u,properties:{},children:f}}l.type==="element"&&c&&Object.assign(l.properties,Du(c)),"children"in l&&l.children&&s!==null&&s!==void 0&&(l.children=s)}return l}function MC(t,a){const l=a.data||{},u="value"in a&&!(qc.call(l,"hProperties")||qc.call(l,"hChildren"))?{type:"text",value:a.value}:{type:"element",tagName:"div",properties:{},children:t.all(a)};return t.patch(a,u),t.applyData(a,u)}function _C(t,a){const l=[];let u=-1;for(a&&l.push({type:"text",value:`
`});++u<t.length;)u&&l.push({type:"text",value:`
`}),l.push(t[u]);return a&&t.length>0&&l.push({type:"text",value:`
`}),l}function sg(t){let a=0,l=t.charCodeAt(a);for(;l===9||l===32;)a++,l=t.charCodeAt(a);return t.slice(a)}function og(t,a){const l=AC(t,a),u=l.one(t,void 0),s=xC(l),c=Array.isArray(u)?{type:"root",children:u}:u||{type:"root",children:[]};return s&&c.children.push({type:"text",value:`
`},s),c}function DC(t,a){return t&&"run"in t?async function(l,u){const s=og(l,{file:u,...a});await t.run(s,u)}:function(l,u){return og(l,{file:u,...t||a})}}function cg(t){if(t)throw t}var yc,fg;function RC(){if(fg)return yc;fg=1;var t=Object.prototype.hasOwnProperty,a=Object.prototype.toString,l=Object.defineProperty,u=Object.getOwnPropertyDescriptor,s=function(h){return typeof Array.isArray=="function"?Array.isArray(h):a.call(h)==="[object Array]"},c=function(h){if(!h||a.call(h)!=="[object Object]")return!1;var b=t.call(h,"constructor"),x=h.constructor&&h.constructor.prototype&&t.call(h.constructor.prototype,"isPrototypeOf");if(h.constructor&&!b&&!x)return!1;var S;for(S in h);return typeof S>"u"||t.call(h,S)},f=function(h,b){l&&b.name==="__proto__"?l(h,b.name,{enumerable:!0,configurable:!0,value:b.newValue,writable:!0}):h[b.name]=b.newValue},m=function(h,b){if(b==="__proto__")if(t.call(h,b)){if(u)return u(h,b).value}else return;return h[b]};return yc=function p(){var h,b,x,S,v,C,O=arguments[0],z=1,j=arguments.length,H=!1;for(typeof O=="boolean"&&(H=O,O=arguments[1]||{},z=2),(O==null||typeof O!="object"&&typeof O!="function")&&(O={});z<j;++z)if(h=arguments[z],h!=null)for(b in h)x=m(O,b),S=m(h,b),O!==S&&(H&&S&&(c(S)||(v=s(S)))?(v?(v=!1,C=x&&s(x)?x:[]):C=x&&c(x)?x:{},f(O,{name:b,newValue:p(H,C,S)})):typeof S<"u"&&f(O,{name:b,newValue:S}));return O},yc}var OC=RC();const vc=Yc(OC);function Ic(t){if(typeof t!="object"||t===null)return!1;const a=Object.getPrototypeOf(t);return(a===null||a===Object.prototype||Object.getPrototypeOf(a)===null)&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)}function zC(){const t=[],a={run:l,use:u};return a;function l(...s){let c=-1;const f=s.pop();if(typeof f!="function")throw new TypeError("Expected function as last argument, not "+f);m(null,...s);function m(p,...h){const b=t[++c];let x=-1;if(p){f(p);return}for(;++x<s.length;)(h[x]===null||h[x]===void 0)&&(h[x]=s[x]);s=h,b?LC(b,m)(...h):f(null,...h)}}function u(s){if(typeof s!="function")throw new TypeError("Expected `middelware` to be a function, not "+s);return t.push(s),a}}function LC(t,a){let l;return u;function u(...f){const m=t.length>f.length;let p;m&&f.push(s);try{p=t.apply(this,f)}catch(h){const b=h;if(m&&l)throw b;return s(b)}m||(p&&p.then&&typeof p.then=="function"?p.then(c,s):p instanceof Error?s(p):c(p))}function s(f,...m){l||(l=!0,a(f,...m))}function c(f){s(null,f)}}const mt={basename:UC,dirname:BC,extname:HC,join:qC,sep:"/"};function UC(t,a){if(a!==void 0&&typeof a!="string")throw new TypeError('"ext" argument must be a string');Wa(t);let l=0,u=-1,s=t.length,c;if(a===void 0||a.length===0||a.length>t.length){for(;s--;)if(t.codePointAt(s)===47){if(c){l=s+1;break}}else u<0&&(c=!0,u=s+1);return u<0?"":t.slice(l,u)}if(a===t)return"";let f=-1,m=a.length-1;for(;s--;)if(t.codePointAt(s)===47){if(c){l=s+1;break}}else f<0&&(c=!0,f=s+1),m>-1&&(t.codePointAt(s)===a.codePointAt(m--)?m<0&&(u=s):(m=-1,u=f));return l===u?u=f:u<0&&(u=t.length),t.slice(l,u)}function BC(t){if(Wa(t),t.length===0)return".";let a=-1,l=t.length,u;for(;--l;)if(t.codePointAt(l)===47){if(u){a=l;break}}else u||(u=!0);return a<0?t.codePointAt(0)===47?"/":".":a===1&&t.codePointAt(0)===47?"//":t.slice(0,a)}function HC(t){Wa(t);let a=t.length,l=-1,u=0,s=-1,c=0,f;for(;a--;){const m=t.codePointAt(a);if(m===47){if(f){u=a+1;break}continue}l<0&&(f=!0,l=a+1),m===46?s<0?s=a:c!==1&&(c=1):s>-1&&(c=-1)}return s<0||l<0||c===0||c===1&&s===l-1&&s===u+1?"":t.slice(s,l)}function qC(...t){let a=-1,l;for(;++a<t.length;)Wa(t[a]),t[a]&&(l=l===void 0?t[a]:l+"/"+t[a]);return l===void 0?".":IC(l)}function IC(t){Wa(t);const a=t.codePointAt(0)===47;let l=VC(t,!a);return l.length===0&&!a&&(l="."),l.length>0&&t.codePointAt(t.length-1)===47&&(l+="/"),a?"/"+l:l}function VC(t,a){let l="",u=0,s=-1,c=0,f=-1,m,p;for(;++f<=t.length;){if(f<t.length)m=t.codePointAt(f);else{if(m===47)break;m=47}if(m===47){if(!(s===f-1||c===1))if(s!==f-1&&c===2){if(l.length<2||u!==2||l.codePointAt(l.length-1)!==46||l.codePointAt(l.length-2)!==46){if(l.length>2){if(p=l.lastIndexOf("/"),p!==l.length-1){p<0?(l="",u=0):(l=l.slice(0,p),u=l.length-1-l.lastIndexOf("/")),s=f,c=0;continue}}else if(l.length>0){l="",u=0,s=f,c=0;continue}}a&&(l=l.length>0?l+"/..":"..",u=2)}else l.length>0?l+="/"+t.slice(s+1,f):l=t.slice(s+1,f),u=f-s-1;s=f,c=0}else m===46&&c>-1?c++:c=-1}return l}function Wa(t){if(typeof t!="string")throw new TypeError("Path must be a string. Received "+JSON.stringify(t))}const FC={cwd:GC};function GC(){return"/"}function Vc(t){return!!(t!==null&&typeof t=="object"&&"href"in t&&t.href&&"protocol"in t&&t.protocol&&t.auth===void 0)}function YC(t){if(typeof t=="string")t=new URL(t);else if(!Vc(t)){const a=new TypeError('The "path" argument must be of type string or an instance of URL. Received `'+t+"`");throw a.code="ERR_INVALID_ARG_TYPE",a}if(t.protocol!=="file:"){const a=new TypeError("The URL must be of scheme file");throw a.code="ERR_INVALID_URL_SCHEME",a}return PC(t)}function PC(t){if(t.hostname!==""){const u=new TypeError('File URL host must be "localhost" or empty on darwin');throw u.code="ERR_INVALID_FILE_URL_HOST",u}const a=t.pathname;let l=-1;for(;++l<a.length;)if(a.codePointAt(l)===37&&a.codePointAt(l+1)===50){const u=a.codePointAt(l+2);if(u===70||u===102){const s=new TypeError("File URL path must not include encoded / characters");throw s.code="ERR_INVALID_FILE_URL_PATH",s}}return decodeURIComponent(a)}const Sc=["history","path","basename","stem","extname","dirname"];class Ax{constructor(a){let l;a?Vc(a)?l={path:a}:typeof a=="string"||XC(a)?l={value:a}:l=a:l={},this.cwd="cwd"in l?"":FC.cwd(),this.data={},this.history=[],this.messages=[],this.value,this.map,this.result,this.stored;let u=-1;for(;++u<Sc.length;){const c=Sc[u];c in l&&l[c]!==void 0&&l[c]!==null&&(this[c]=c==="history"?[...l[c]]:l[c])}let s;for(s in l)Sc.includes(s)||(this[s]=l[s])}get basename(){return typeof this.path=="string"?mt.basename(this.path):void 0}set basename(a){wc(a,"basename"),kc(a,"basename"),this.path=mt.join(this.dirname||"",a)}get dirname(){return typeof this.path=="string"?mt.dirname(this.path):void 0}set dirname(a){dg(this.basename,"dirname"),this.path=mt.join(a||"",this.basename)}get extname(){return typeof this.path=="string"?mt.extname(this.path):void 0}set extname(a){if(kc(a,"extname"),dg(this.dirname,"extname"),a){if(a.codePointAt(0)!==46)throw new Error("`extname` must start with `.`");if(a.includes(".",1))throw new Error("`extname` cannot contain multiple dots")}this.path=mt.join(this.dirname,this.stem+(a||""))}get path(){return this.history[this.history.length-1]}set path(a){Vc(a)&&(a=YC(a)),wc(a,"path"),this.path!==a&&this.history.push(a)}get stem(){return typeof this.path=="string"?mt.basename(this.path,this.extname):void 0}set stem(a){wc(a,"stem"),kc(a,"stem"),this.path=mt.join(this.dirname||"",a+(this.extname||""))}fail(a,l,u){const s=this.message(a,l,u);throw s.fatal=!0,s}info(a,l,u){const s=this.message(a,l,u);return s.fatal=void 0,s}message(a,l,u){const s=new xn(a,l,u);return this.path&&(s.name=this.path+":"+s.name,s.file=this.path),s.fatal=!1,this.messages.push(s),s}toString(a){return this.value===void 0?"":typeof this.value=="string"?this.value:new TextDecoder(a||void 0).decode(this.value)}}function kc(t,a){if(t&&t.includes(mt.sep))throw new Error("`"+a+"` cannot be a path: did not expect `"+mt.sep+"`")}function wc(t,a){if(!t)throw new Error("`"+a+"` cannot be empty")}function dg(t,a){if(!t)throw new Error("Setting `"+a+"` requires `path` to be set too")}function XC(t){return!!(t&&typeof t=="object"&&"byteLength"in t&&"byteOffset"in t)}const JC=(function(t){const u=this.constructor.prototype,s=u[t],c=function(){return s.apply(c,arguments)};return Object.setPrototypeOf(c,u),c}),QC={}.hasOwnProperty;class hf extends JC{constructor(){super("copy"),this.Compiler=void 0,this.Parser=void 0,this.attachers=[],this.compiler=void 0,this.freezeIndex=-1,this.frozen=void 0,this.namespace={},this.parser=void 0,this.transformers=zC()}copy(){const a=new hf;let l=-1;for(;++l<this.attachers.length;){const u=this.attachers[l];a.use(...u)}return a.data(vc(!0,{},this.namespace)),a}data(a,l){return typeof a=="string"?arguments.length===2?(Ec("data",this.frozen),this.namespace[a]=l,this):QC.call(this.namespace,a)&&this.namespace[a]||void 0:a?(Ec("data",this.frozen),this.namespace=a,this):this.namespace}freeze(){if(this.frozen)return this;const a=this;for(;++this.freezeIndex<this.attachers.length;){const[l,...u]=this.attachers[this.freezeIndex];if(u[0]===!1)continue;u[0]===!0&&(u[0]=void 0);const s=l.call(a,...u);typeof s=="function"&&this.transformers.use(s)}return this.frozen=!0,this.freezeIndex=Number.POSITIVE_INFINITY,this}parse(a){this.freeze();const l=ku(a),u=this.parser||this.Parser;return Cc("parse",u),u(String(l),l)}process(a,l){const u=this;return this.freeze(),Cc("process",this.parser||this.Parser),Tc("process",this.compiler||this.Compiler),l?s(void 0,l):new Promise(s);function s(c,f){const m=ku(a),p=u.parse(m);u.run(p,m,function(b,x,S){if(b||!x||!S)return h(b);const v=x,C=u.stringify(v,S);WC(C)?S.value=C:S.result=C,h(b,S)});function h(b,x){b||!x?f(b):c?c(x):l(void 0,x)}}}processSync(a){let l=!1,u;return this.freeze(),Cc("processSync",this.parser||this.Parser),Tc("processSync",this.compiler||this.Compiler),this.process(a,s),mg("processSync","process",l),u;function s(c,f){l=!0,cg(c),u=f}}run(a,l,u){hg(a),this.freeze();const s=this.transformers;return!u&&typeof l=="function"&&(u=l,l=void 0),u?c(void 0,u):new Promise(c);function c(f,m){const p=ku(l);s.run(a,p,h);function h(b,x,S){const v=x||a;b?m(b):f?f(v):u(void 0,v,S)}}}runSync(a,l){let u=!1,s;return this.run(a,l,c),mg("runSync","run",u),s;function c(f,m){cg(f),s=m,u=!0}}stringify(a,l){this.freeze();const u=ku(l),s=this.compiler||this.Compiler;return Tc("stringify",s),hg(a),s(a,u)}use(a,...l){const u=this.attachers,s=this.namespace;if(Ec("use",this.frozen),a!=null)if(typeof a=="function")p(a,l);else if(typeof a=="object")Array.isArray(a)?m(a):f(a);else throw new TypeError("Expected usable value, not `"+a+"`");return this;function c(h){if(typeof h=="function")p(h,[]);else if(typeof h=="object")if(Array.isArray(h)){const[b,...x]=h;p(b,x)}else f(h);else throw new TypeError("Expected usable value, not `"+h+"`")}function f(h){if(!("plugins"in h)&&!("settings"in h))throw new Error("Expected usable value but received an empty preset, which is probably a mistake: presets typically come with `plugins` and sometimes with `settings`, but this has neither");m(h.plugins),h.settings&&(s.settings=vc(!0,s.settings,h.settings))}function m(h){let b=-1;if(h!=null)if(Array.isArray(h))for(;++b<h.length;){const x=h[b];c(x)}else throw new TypeError("Expected a list of plugins, not `"+h+"`")}function p(h,b){let x=-1,S=-1;for(;++x<u.length;)if(u[x][0]===h){S=x;break}if(S===-1)u.push([h,...b]);else if(b.length>0){let[v,...C]=b;const O=u[S][1];Ic(O)&&Ic(v)&&(v=vc(!0,O,v)),u[S]=[h,v,...C]}}}}const ZC=new hf().freeze();function Cc(t,a){if(typeof a!="function")throw new TypeError("Cannot `"+t+"` without `parser`")}function Tc(t,a){if(typeof a!="function")throw new TypeError("Cannot `"+t+"` without `compiler`")}function Ec(t,a){if(a)throw new Error("Cannot call `"+t+"` on a frozen processor.\nCreate a new processor first, by calling it: use `processor()` instead of `processor`.")}function hg(t){if(!Ic(t)||typeof t.type!="string")throw new TypeError("Expected node, got `"+t+"`")}function mg(t,a,l){if(!l)throw new Error("`"+t+"` finished async. Use `"+a+"` instead")}function ku(t){return KC(t)?t:new Ax(t)}function KC(t){return!!(t&&typeof t=="object"&&"message"in t&&"messages"in t)}function WC(t){return typeof t=="string"||$C(t)}function $C(t){return!!(t&&typeof t=="object"&&"byteLength"in t&&"byteOffset"in t)}const e3="https://github.com/remarkjs/react-markdown/blob/main/changelog.md",pg=[],gg={allowDangerousHtml:!0},n3=/^(https?|ircs?|mailto|xmpp)$/i,t3=[{from:"astPlugins",id:"remove-buggy-html-in-markdown-parser"},{from:"allowDangerousHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"allowNode",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowElement"},{from:"allowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowedElements"},{from:"className",id:"remove-classname"},{from:"disallowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"disallowedElements"},{from:"escapeHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"includeElementIndex",id:"#remove-includeelementindex"},{from:"includeNodeIndex",id:"change-includenodeindex-to-includeelementindex"},{from:"linkTarget",id:"remove-linktarget"},{from:"plugins",id:"change-plugins-to-remarkplugins",to:"remarkPlugins"},{from:"rawSourcePos",id:"#remove-rawsourcepos"},{from:"renderers",id:"change-renderers-to-components",to:"components"},{from:"source",id:"change-source-to-children",to:"children"},{from:"sourcePos",id:"#remove-sourcepos"},{from:"transformImageUri",id:"#add-urltransform",to:"urlTransform"},{from:"transformLinkUri",id:"#add-urltransform",to:"urlTransform"}];function r3(t){const a=l3(t),l=a3(t);return i3(a.runSync(a.parse(l),l),t)}function l3(t){const a=t.rehypePlugins||pg,l=t.remarkPlugins||pg,u=t.remarkRehypeOptions?{...t.remarkRehypeOptions,...gg}:gg;return ZC().use(Bw).use(l).use(DC,u).use(a)}function a3(t){const a=t.children||"",l=new Ax;return typeof a=="string"&&(l.value=a),l}function i3(t,a){const l=a.allowedElements,u=a.allowElement,s=a.components,c=a.disallowedElements,f=a.skipHtml,m=a.unwrapDisallowed,p=a.urlTransform||u3;for(const b of t3)Object.hasOwn(a,b.from)&&(""+b.from+(b.to?"use `"+b.to+"` instead":"remove it")+e3+b.id,void 0);return df(t,h),S2(t,{Fragment:g.Fragment,components:s,ignoreInvalidStyle:!0,jsx:g.jsx,jsxs:g.jsxs,passKeys:!0,passNode:!0});function h(b,x,S){if(b.type==="raw"&&S&&typeof x=="number")return f?S.children.splice(x,1):S.children[x]={type:"text",value:b.value},x;if(b.type==="element"){let v;for(v in gc)if(Object.hasOwn(gc,v)&&Object.hasOwn(b.properties,v)){const C=b.properties[v],O=gc[v];(O===null||O.includes(b.tagName))&&(b.properties[v]=p(String(C||""),v,b))}}if(b.type==="element"){let v=l?!l.includes(b.tagName):c?c.includes(b.tagName):!1;if(!v&&u&&typeof x=="number"&&(v=!u(b,x,S)),v&&S&&typeof x=="number")return m&&b.children?S.children.splice(x,1,...b.children):S.children.splice(x,1),x}}}function u3(t){const a=t.indexOf(":"),l=t.indexOf("?"),u=t.indexOf("#"),s=t.indexOf("/");return a===-1||s!==-1&&a>s||l!==-1&&a>l||u!==-1&&a>u||n3.test(t.slice(0,a))?t:""}function xg(t,a){const l=String(t);if(typeof a!="string")throw new TypeError("Expected character");let u=0,s=l.indexOf(a);for(;s!==-1;)u++,s=l.indexOf(a,s+a.length);return u}function s3(t){if(typeof t!="string")throw new TypeError("Expected a string");return t.replace(/[|\\{}()[\]^$+*?.]/g,"\\$&").replace(/-/g,"\\x2d")}function o3(t,a,l){const s=Hu((l||{}).ignore||[]),c=c3(a);let f=-1;for(;++f<c.length;)Ex(t,"text",m);function m(h,b){let x=-1,S;for(;++x<b.length;){const v=b[x],C=S?S.children:void 0;if(s(v,C?C.indexOf(v):void 0,S))return;S=v}if(S)return p(h,b)}function p(h,b){const x=b[b.length-1],S=c[f][0],v=c[f][1];let C=0;const z=x.children.indexOf(h);let j=!1,H=[];S.lastIndex=0;let _=S.exec(h.value);for(;_;){const K=_.index,re={index:_.index,input:_.input,stack:[...b,h]};let I=v(..._,re);if(typeof I=="string"&&(I=I.length>0?{type:"text",value:I}:void 0),I===!1?S.lastIndex=K+1:(C!==K&&H.push({type:"text",value:h.value.slice(C,K)}),Array.isArray(I)?H.push(...I):I&&H.push(I),C=K+_[0].length,j=!0),!S.global)break;_=S.exec(h.value)}return j?(C<h.value.length&&H.push({type:"text",value:h.value.slice(C)}),x.children.splice(z,1,...H)):H=[h],z+H.length}}function c3(t){const a=[];if(!Array.isArray(t))throw new TypeError("Expected find and replace tuple or list of tuples");const l=!t[0]||Array.isArray(t[0])?t:[t];let u=-1;for(;++u<l.length;){const s=l[u];a.push([f3(s[0]),d3(s[1])])}return a}function f3(t){return typeof t=="string"?new RegExp(s3(t),"g"):t}function d3(t){return typeof t=="function"?t:function(){return t}}const Ac="phrasing",jc=["autolink","link","image","label"];function h3(){return{transforms:[v3],enter:{literalAutolink:p3,literalAutolinkEmail:Nc,literalAutolinkHttp:Nc,literalAutolinkWww:Nc},exit:{literalAutolink:y3,literalAutolinkEmail:b3,literalAutolinkHttp:g3,literalAutolinkWww:x3}}}function m3(){return{unsafe:[{character:"@",before:"[+\\-.\\w]",after:"[\\-.\\w]",inConstruct:Ac,notInConstruct:jc},{character:".",before:"[Ww]",after:"[\\-.\\w]",inConstruct:Ac,notInConstruct:jc},{character:":",before:"[ps]",after:"\\/",inConstruct:Ac,notInConstruct:jc}]}}function p3(t){this.enter({type:"link",title:null,url:"",children:[]},t)}function Nc(t){this.config.enter.autolinkProtocol.call(this,t)}function g3(t){this.config.exit.autolinkProtocol.call(this,t)}function x3(t){this.config.exit.data.call(this,t);const a=this.stack[this.stack.length-1];a.type,a.url="http://"+this.sliceSerialize(t)}function b3(t){this.config.exit.autolinkEmail.call(this,t)}function y3(t){this.exit(t)}function v3(t){o3(t,[[/(https?:\/\/|www(?=\.))([-.\w]+)([^ \t\r\n]*)/gi,S3],[new RegExp("(?<=^|\\s|\\p{P}|\\p{S})([-.\\w+]+)@([-\\w]+(?:\\.[-\\w]+)+)","gu"),k3]],{ignore:["link","linkReference"]})}function S3(t,a,l,u,s){let c="";if(!jx(s)||(/^w/i.test(a)&&(l=a+l,a="",c="http://"),!w3(l)))return!1;const f=C3(l+u);if(!f[0])return!1;const m={type:"link",title:null,url:c+a+f[0],children:[{type:"text",value:a+f[0]}]};return f[1]?[m,{type:"text",value:f[1]}]:m}function k3(t,a,l,u){return!jx(u,!0)||/[-\d_]$/.test(l)?!1:{type:"link",title:null,url:"mailto:"+a+"@"+l,children:[{type:"text",value:a+"@"+l}]}}function w3(t){const a=t.split(".");return!(a.length<2||a[a.length-1]&&(/_/.test(a[a.length-1])||!/[a-zA-Z\d]/.test(a[a.length-1]))||a[a.length-2]&&(/_/.test(a[a.length-2])||!/[a-zA-Z\d]/.test(a[a.length-2])))}function C3(t){const a=/[!"&'),.:;<>?\]}]+$/.exec(t);if(!a)return[t,void 0];t=t.slice(0,a.index);let l=a[0],u=l.indexOf(")");const s=xg(t,"(");let c=xg(t,")");for(;u!==-1&&s>c;)t+=l.slice(0,u+1),l=l.slice(u+1),u=l.indexOf(")"),c++;return[t,l]}function jx(t,a){const l=t.input.charCodeAt(t.index-1);return(t.index===0||zr(l)||Lu(l))&&(!a||l!==47)}Nx.peek=R3;function T3(){this.buffer()}function E3(t){this.enter({type:"footnoteReference",identifier:"",label:""},t)}function A3(){this.buffer()}function j3(t){this.enter({type:"footnoteDefinition",identifier:"",label:"",children:[]},t)}function N3(t){const a=this.resume(),l=this.stack[this.stack.length-1];l.type,l.identifier=ut(this.sliceSerialize(t)).toLowerCase(),l.label=a}function M3(t){this.exit(t)}function _3(t){const a=this.resume(),l=this.stack[this.stack.length-1];l.type,l.identifier=ut(this.sliceSerialize(t)).toLowerCase(),l.label=a}function D3(t){this.exit(t)}function R3(){return"["}function Nx(t,a,l,u){const s=l.createTracker(u);let c=s.move("[^");const f=l.enter("footnoteReference"),m=l.enter("reference");return c+=s.move(l.safe(l.associationId(t),{after:"]",before:c})),m(),f(),c+=s.move("]"),c}function O3(){return{enter:{gfmFootnoteCallString:T3,gfmFootnoteCall:E3,gfmFootnoteDefinitionLabelString:A3,gfmFootnoteDefinition:j3},exit:{gfmFootnoteCallString:N3,gfmFootnoteCall:M3,gfmFootnoteDefinitionLabelString:_3,gfmFootnoteDefinition:D3}}}function z3(t){let a=!1;return t&&t.firstLineBlank&&(a=!0),{handlers:{footnoteDefinition:l,footnoteReference:Nx},unsafe:[{character:"[",inConstruct:["label","phrasing","reference"]}]};function l(u,s,c,f){const m=c.createTracker(f);let p=m.move("[^");const h=c.enter("footnoteDefinition"),b=c.enter("label");return p+=m.move(c.safe(c.associationId(u),{before:p,after:"]"})),b(),p+=m.move("]:"),u.children&&u.children.length>0&&(m.shift(4),p+=m.move((a?`
`:" ")+c.indentLines(c.containerFlow(u,m.current()),a?Mx:L3))),h(),p}}function L3(t,a,l){return a===0?t:Mx(t,a,l)}function Mx(t,a,l){return(l?"":"    ")+t}const U3=["autolink","destinationLiteral","destinationRaw","reference","titleQuote","titleApostrophe"];_x.peek=V3;function B3(){return{canContainEols:["delete"],enter:{strikethrough:q3},exit:{strikethrough:I3}}}function H3(){return{unsafe:[{character:"~",inConstruct:"phrasing",notInConstruct:U3}],handlers:{delete:_x}}}function q3(t){this.enter({type:"delete",children:[]},t)}function I3(t){this.exit(t)}function _x(t,a,l,u){const s=l.createTracker(u),c=l.enter("strikethrough");let f=s.move("~~");return f+=l.containerPhrasing(t,{...s.current(),before:f,after:"~"}),f+=s.move("~~"),c(),f}function V3(){return"~"}function F3(t){return t.length}function G3(t,a){const l=a||{},u=(l.align||[]).concat(),s=l.stringLength||F3,c=[],f=[],m=[],p=[];let h=0,b=-1;for(;++b<t.length;){const O=[],z=[];let j=-1;for(t[b].length>h&&(h=t[b].length);++j<t[b].length;){const H=Y3(t[b][j]);if(l.alignDelimiters!==!1){const _=s(H);z[j]=_,(p[j]===void 0||_>p[j])&&(p[j]=_)}O.push(H)}f[b]=O,m[b]=z}let x=-1;if(typeof u=="object"&&"length"in u)for(;++x<h;)c[x]=bg(u[x]);else{const O=bg(u);for(;++x<h;)c[x]=O}x=-1;const S=[],v=[];for(;++x<h;){const O=c[x];let z="",j="";O===99?(z=":",j=":"):O===108?z=":":O===114&&(j=":");let H=l.alignDelimiters===!1?1:Math.max(1,p[x]-z.length-j.length);const _=z+"-".repeat(H)+j;l.alignDelimiters!==!1&&(H=z.length+H+j.length,H>p[x]&&(p[x]=H),v[x]=H),S[x]=_}f.splice(1,0,S),m.splice(1,0,v),b=-1;const C=[];for(;++b<f.length;){const O=f[b],z=m[b];x=-1;const j=[];for(;++x<h;){const H=O[x]||"";let _="",K="";if(l.alignDelimiters!==!1){const re=p[x]-(z[x]||0),I=c[x];I===114?_=" ".repeat(re):I===99?re%2?(_=" ".repeat(re/2+.5),K=" ".repeat(re/2-.5)):(_=" ".repeat(re/2),K=_):K=" ".repeat(re)}l.delimiterStart!==!1&&!x&&j.push("|"),l.padding!==!1&&!(l.alignDelimiters===!1&&H==="")&&(l.delimiterStart!==!1||x)&&j.push(" "),l.alignDelimiters!==!1&&j.push(_),j.push(H),l.alignDelimiters!==!1&&j.push(K),l.padding!==!1&&j.push(" "),(l.delimiterEnd!==!1||x!==h-1)&&j.push("|")}C.push(l.delimiterEnd===!1?j.join("").replace(/ +$/,""):j.join(""))}return C.join(`
`)}function Y3(t){return t==null?"":String(t)}function bg(t){const a=typeof t=="string"?t.codePointAt(0):0;return a===67||a===99?99:a===76||a===108?108:a===82||a===114?114:0}function P3(t,a,l,u){const s=l.enter("blockquote"),c=l.createTracker(u);c.move("> "),c.shift(2);const f=l.indentLines(l.containerFlow(t,c.current()),X3);return s(),f}function X3(t,a,l){return">"+(l?"":" ")+t}function J3(t,a){return yg(t,a.inConstruct,!0)&&!yg(t,a.notInConstruct,!1)}function yg(t,a,l){if(typeof a=="string"&&(a=[a]),!a||a.length===0)return l;let u=-1;for(;++u<a.length;)if(t.includes(a[u]))return!0;return!1}function vg(t,a,l,u){let s=-1;for(;++s<l.unsafe.length;)if(l.unsafe[s].character===`
`&&J3(l.stack,l.unsafe[s]))return/[ \t]/.test(u.before)?"":" ";return`\\
`}function Q3(t,a){const l=String(t);let u=l.indexOf(a),s=u,c=0,f=0;if(typeof a!="string")throw new TypeError("Expected substring");for(;u!==-1;)u===s?++c>f&&(f=c):c=1,s=u+a.length,u=l.indexOf(a,s);return f}function Z3(t,a){return!!(a.options.fences===!1&&t.value&&!t.lang&&/[^ \r\n]/.test(t.value)&&!/^[\t ]*(?:[\r\n]|$)|(?:^|[\r\n])[\t ]*$/.test(t.value))}function K3(t){const a=t.options.fence||"`";if(a!=="`"&&a!=="~")throw new Error("Cannot serialize code with `"+a+"` for `options.fence`, expected `` ` `` or `~`");return a}function W3(t,a,l,u){const s=K3(l),c=t.value||"",f=s==="`"?"GraveAccent":"Tilde";if(Z3(t,l)){const x=l.enter("codeIndented"),S=l.indentLines(c,$3);return x(),S}const m=l.createTracker(u),p=s.repeat(Math.max(Q3(c,s)+1,3)),h=l.enter("codeFenced");let b=m.move(p);if(t.lang){const x=l.enter(`codeFencedLang${f}`);b+=m.move(l.safe(t.lang,{before:b,after:" ",encode:["`"],...m.current()})),x()}if(t.lang&&t.meta){const x=l.enter(`codeFencedMeta${f}`);b+=m.move(" "),b+=m.move(l.safe(t.meta,{before:b,after:`
`,encode:["`"],...m.current()})),x()}return b+=m.move(`
`),c&&(b+=m.move(c+`
`)),b+=m.move(p),h(),b}function $3(t,a,l){return(l?"":"    ")+t}function mf(t){const a=t.options.quote||'"';if(a!=='"'&&a!=="'")throw new Error("Cannot serialize title with `"+a+"` for `options.quote`, expected `\"`, or `'`");return a}function eT(t,a,l,u){const s=mf(l),c=s==='"'?"Quote":"Apostrophe",f=l.enter("definition");let m=l.enter("label");const p=l.createTracker(u);let h=p.move("[");return h+=p.move(l.safe(l.associationId(t),{before:h,after:"]",...p.current()})),h+=p.move("]: "),m(),!t.url||/[\0- \u007F]/.test(t.url)?(m=l.enter("destinationLiteral"),h+=p.move("<"),h+=p.move(l.safe(t.url,{before:h,after:">",...p.current()})),h+=p.move(">")):(m=l.enter("destinationRaw"),h+=p.move(l.safe(t.url,{before:h,after:t.title?" ":`
`,...p.current()}))),m(),t.title&&(m=l.enter(`title${c}`),h+=p.move(" "+s),h+=p.move(l.safe(t.title,{before:h,after:s,...p.current()})),h+=p.move(s),m()),f(),h}function nT(t){const a=t.options.emphasis||"*";if(a!=="*"&&a!=="_")throw new Error("Cannot serialize emphasis with `"+a+"` for `options.emphasis`, expected `*`, or `_`");return a}function Ya(t){return"&#x"+t.toString(16).toUpperCase()+";"}function Ru(t,a,l){const u=Nl(t),s=Nl(a);return u===void 0?s===void 0?l==="_"?{inside:!0,outside:!0}:{inside:!1,outside:!1}:s===1?{inside:!0,outside:!0}:{inside:!1,outside:!0}:u===1?s===void 0?{inside:!1,outside:!1}:s===1?{inside:!0,outside:!0}:{inside:!1,outside:!1}:s===void 0?{inside:!1,outside:!1}:s===1?{inside:!0,outside:!1}:{inside:!1,outside:!1}}Dx.peek=tT;function Dx(t,a,l,u){const s=nT(l),c=l.enter("emphasis"),f=l.createTracker(u),m=f.move(s);let p=f.move(l.containerPhrasing(t,{after:s,before:m,...f.current()}));const h=p.charCodeAt(0),b=Ru(u.before.charCodeAt(u.before.length-1),h,s);b.inside&&(p=Ya(h)+p.slice(1));const x=p.charCodeAt(p.length-1),S=Ru(u.after.charCodeAt(0),x,s);S.inside&&(p=p.slice(0,-1)+Ya(x));const v=f.move(s);return c(),l.attentionEncodeSurroundingInfo={after:S.outside,before:b.outside},m+p+v}function tT(t,a,l){return l.options.emphasis||"*"}function rT(t,a){let l=!1;return df(t,function(u){if("value"in u&&/\r?\n|\r/.test(u.value)||u.type==="break")return l=!0,Hc}),!!((!t.depth||t.depth<3)&&lf(t)&&(a.options.setext||l))}function lT(t,a,l,u){const s=Math.max(Math.min(6,t.depth||1),1),c=l.createTracker(u);if(rT(t,l)){const b=l.enter("headingSetext"),x=l.enter("phrasing"),S=l.containerPhrasing(t,{...c.current(),before:`
`,after:`
`});return x(),b(),S+`
...
`,...c.current()});return/^[\t ]/.test(h)&&(h=Ya(h.charCodeAt(0))+h.slice(1)),h=h?f+" "+h:f,l.options.closeAtx&&(h+=" "+f),p(),m(),h}Rx.peek=aT;function Rx(t){return t.value||""}function aT(){return"<"}Ox.peek=iT;function Ox(t,a,l,u){const s=mf(l),c=s==='"'?"Quote":"Apostrophe",f=l.enter("image");let m=l.enter("label");const p=l.createTracker(u);let h=p.move("![");return h+=p.move(l.safe(t.alt,{before:h,after:"]",...p.current()})),h+=p.move("]("),m(),!t.url&&t.title||/[\0- \u007F]/.test(t.url)?(m=l.enter("destinationLiteral"),h+=p.move("<"),h+=p.move(l.safe(t.url,{before:h,after:">",...p.current()})),h+=p.move(">")):(m=l.enter("destinationRaw"),h+=p.move(l.safe(t.url,{before:h,after:t.title?" ":")",...p.current()}))),m(),t.title&&(m=l.enter(`title${c}`),h+=p.move(" "+s),h+=p.move(l.safe(t.title,{before:h,after:s,...p.current()})),h+=p.move(s),m()),h+=p.move(")"),f(),h}function iT(){return"!"}zx.peek=uT;function zx(t,a,l,u){const s=t.referenceType,c=l.enter("imageReference");let f=l.enter("label");const m=l.createTracker(u);let p=m.move("![");const h=l.safe(t.alt,{before:p,after:"]",...m.current()});p+=m.move(h+"]["),f();const b=l.stack;l.stack=[],f=l.enter("reference");const x=l.safe(l.associationId(t),{before:p,after:"]",...m.current()});return f(),l.stack=b,c(),s==="full"||!h||h!==x?p+=m.move(x+"]"):s==="shortcut"?p=p.slice(0,-1):p+=m.move("]"),p}function uT(){return"!"}Lx.peek=sT;function Lx(t,a,l){let u=t.value||"",s="`",c=-1;for(;new RegExp("(^|[^`])"+s+"([^`]|$)").test(u);)s+="`";for(/[^ \r\n]/.test(u)&&(/^[ \r\n]/.test(u)&&/[ \r\n]$/.test(u)||/^`|`$/.test(u))&&(u=" "+u+" ");++c<l.unsafe.length;){const f=l.unsafe[c],m=l.compilePattern(f);let p;if(f.atBreak)for(;p=m.exec(u);){let h=p.index;u.charCodeAt(h)===10&&u.charCodeAt(h-1)===13&&h--,u=u.slice(0,h)+" "+u.slice(p.index+1)}}return s+u+s}function sT(){return"`"}function Ux(t,a){const l=lf(t);return!!(!a.options.resourceLink&&t.url&&!t.title&&t.children&&t.children.length===1&&t.children[0].type==="text"&&(l===t.url||"mailto:"+l===t.url)&&/^[a-z][a-z+.-]+:/i.test(t.url)&&!/[\0- <>\u007F]/.test(t.url))}Bx.peek=oT;function Bx(t,a,l,u){const s=mf(l),c=s==='"'?"Quote":"Apostrophe",f=l.createTracker(u);let m,p;if(Ux(t,l)){const b=l.stack;l.stack=[],m=l.enter("autolink");let x=f.move("<");return x+=f.move(l.containerPhrasing(t,{before:x,after:">",...f.current()})),x+=f.move(">"),m(),l.stack=b,x}m=l.enter("link"),p=l.enter("label");let h=f.move("[");return h+=f.move(l.containerPhrasing(t,{before:h,after:"](",...f.current()})),h+=f.move("]("),p(),!t.url&&t.title||/[\0- \u007F]/.test(t.url)?(p=l.enter("destinationLiteral"),h+=f.move("<"),h+=f.move(l.safe(t.url,{before:h,after:">",...f.current()})),h+=f.move(">")):(p=l.enter("destinationRaw"),h+=f.move(l.safe(t.url,{before:h,after:t.title?" ":")",...f.current()}))),p(),t.title&&(p=l.enter(`title${c}`),h+=f.move(" "+s),h+=f.move(l.safe(t.title,{before:h,after:s,...f.current()})),h+=f.move(s),p()),h+=f.move(")"),m(),h}function oT(t,a,l){return Ux(t,l)?"<":"["}Hx.peek=cT;function Hx(t,a,l,u){const s=t.referenceType,c=l.enter("linkReference");let f=l.enter("label");const m=l.createTracker(u);let p=m.move("[");const h=l.containerPhrasing(t,{before:p,after:"]",...m.current()});p+=m.move(h+"]["),f();const b=l.stack;l.stack=[],f=l.enter("reference");const x=l.safe(l.associationId(t),{before:p,after:"]",...m.current()});return f(),l.stack=b,c(),s==="full"||!h||h!==x?p+=m.move(x+"]"):s==="shortcut"?p=p.slice(0,-1):p+=m.move("]"),p}function cT(){return"["}function pf(t){const a=t.options.bullet||"*";if(a!=="*"&&a!=="+"&&a!=="-")throw new Error("Cannot serialize items with `"+a+"` for `options.bullet`, expected `*`, `+`, or `-`");return a}function fT(t){const a=pf(t),l=t.options.bulletOther;if(!l)return a==="*"?"-":"*";if(l!=="*"&&l!=="+"&&l!=="-")throw new Error("Cannot serialize items with `"+l+"` for `options.bulletOther`, expected `*`, `+`, or `-`");if(l===a)throw new Error("Expected `bullet` (`"+a+"`) and `bulletOther` (`"+l+"`) to be different");return l}function dT(t){const a=t.options.bulletOrdered||".";if(a!=="."&&a!==")")throw new Error("Cannot serialize items with `"+a+"` for `options.bulletOrdered`, expected `.` or `)`");return a}function qx(t){const a=t.options.rule||"*";if(a!=="*"&&a!=="-"&&a!=="_")throw new Error("Cannot serialize rules with `"+a+"` for `options.rule`, expected `*`, `-`, or `_`");return a}function hT(t,a,l,u){const s=l.enter("list"),c=l.bulletCurrent;let f=t.ordered?dT(l):pf(l);const m=t.ordered?f==="."?")":".":fT(l);let p=a&&l.bulletLastUsed?f===l.bulletLastUsed:!1;if(!t.ordered){const b=t.children?t.children[0]:void 0;if((f==="*"||f==="-")&&b&&(!b.children||!b.children[0])&&l.stack[l.stack.length-1]==="list"&&l.stack[l.stack.length-2]==="listItem"&&l.stack[l.stack.length-3]==="list"&&l.stack[l.stack.length-4]==="listItem"&&l.indexStack[l.indexStack.length-1]===0&&l.indexStack[l.indexStack.length-2]===0&&l.indexStack[l.indexStack.length-3]===0&&(p=!0),qx(l)===f&&b){let x=-1;for(;++x<t.children.length;){const S=t.children[x];if(S&&S.type==="listItem"&&S.children&&S.children[0]&&S.children[0].type==="thematicBreak"){p=!0;break}}}}p&&(f=m),l.bulletCurrent=f;const h=l.containerFlow(t,u);return l.bulletLastUsed=f,l.bulletCurrent=c,s(),h}function mT(t){const a=t.options.listItemIndent||"one";if(a!=="tab"&&a!=="one"&&a!=="mixed")throw new Error("Cannot serialize items with `"+a+"` for `options.listItemIndent`, expected `tab`, `one`, or `mixed`");return a}function pT(t,a,l,u){const s=mT(l);let c=l.bulletCurrent||pf(l);a&&a.type==="list"&&a.ordered&&(c=(typeof a.start=="number"&&a.start>-1?a.start:1)+(l.options.incrementListMarker===!1?0:a.children.indexOf(t))+c);let f=c.length+1;(s==="tab"||s==="mixed"&&(a&&a.type==="list"&&a.spread||t.spread))&&(f=Math.ceil(f/4)*4);const m=l.createTracker(u);m.move(c+" ".repeat(f-c.length)),m.shift(f);const p=l.enter("listItem"),h=l.indentLines(l.containerFlow(t,m.current()),b);return p(),h;function b(x,S,v){return S?(v?"":" ".repeat(f))+x:(v?c:c+" ".repeat(f-c.length))+x}}function gT(t,a,l,u){const s=l.enter("paragraph"),c=l.enter("phrasing"),f=l.containerPhrasing(t,u);return c(),s(),f}const xT=Hu(["break","delete","emphasis","footnote","footnoteReference","image","imageReference","inlineCode","inlineMath","link","linkReference","mdxJsxTextElement","mdxTextExpression","strong","text","textDirective"]);function bT(t,a,l,u){return(t.children.some(function(f){return xT(f)})?l.containerPhrasing:l.containerFlow).call(l,t,u)}function yT(t){const a=t.options.strong||"*";if(a!=="*"&&a!=="_")throw new Error("Cannot serialize strong with `"+a+"` for `options.strong`, expected `*`, or `_`");return a}Ix.peek=vT;function Ix(t,a,l,u){const s=yT(l),c=l.enter("strong"),f=l.createTracker(u),m=f.move(s+s);let p=f.move(l.containerPhrasing(t,{after:s,before:m,...f.current()}));const h=p.charCodeAt(0),b=Ru(u.before.charCodeAt(u.before.length-1),h,s);b.inside&&(p=Ya(h)+p.slice(1));const x=p.charCodeAt(p.length-1),S=Ru(u.after.charCodeAt(0),x,s);S.inside&&(p=p.slice(0,-1)+Ya(x));const v=f.move(s+s);return c(),l.attentionEncodeSurroundingInfo={after:S.outside,before:b.outside},m+p+v}function vT(t,a,l){return l.options.strong||"*"}function ST(t,a,l,u){return l.safe(t.value,u)}function kT(t){const a=t.options.ruleRepetition||3;if(a<3)throw new Error("Cannot serialize rules with repetition `"+a+"` for `options.ruleRepetition`, expected `3` or more");return a}function wT(t,a,l){const u=(qx(l)+(l.options.ruleSpaces?" ":"")).repeat(kT(l));return l.options.ruleSpaces?u.slice(0,-1):u}const Vx={blockquote:P3,break:vg,code:W3,definition:eT,emphasis:Dx,hardBreak:vg,heading:lT,html:Rx,image:Ox,imageReference:zx,inlineCode:Lx,link:Bx,linkReference:Hx,list:hT,listItem:pT,paragraph:gT,root:bT,strong:Ix,text:ST,thematicBreak:wT};function CT(){return{enter:{table:TT,tableData:Sg,tableHeader:Sg,tableRow:AT},exit:{codeText:jT,table:ET,tableData:Mc,tableHeader:Mc,tableRow:Mc}}}function TT(t){const a=t._align;this.enter({type:"table",align:a.map(function(l){return l==="none"?null:l}),children:[]},t),this.data.inTable=!0}function ET(t){this.exit(t),this.data.inTable=void 0}function AT(t){this.enter({type:"tableRow",children:[]},t)}function Mc(t){this.exit(t)}function Sg(t){this.enter({type:"tableCell",children:[]},t)}function jT(t){let a=this.resume();this.data.inTable&&(a=a.replace(/\\([\\|])/g,NT));const l=this.stack[this.stack.length-1];l.type,l.value=a,this.exit(t)}function NT(t,a){return a==="|"?a:t}function MT(t){const a=t||{},l=a.tableCellPadding,u=a.tablePipeAlign,s=a.stringLength,c=l?" ":"|";return{unsafe:[{character:"\r",inConstruct:"tableCell"},{character:`
...
`);let c=!1;const f=[];for(const m of s){const p=m.trimEnd();if(p.trimStart().startsWith("```")){c=!c;continue}if(c)continue;const h=/^(#{1,6})\s+(.+?)\s*$/.exec(p);if(!h)continue;const b=h[1].length;if(b<a||b>l)continue;const x=h[2].replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/[*_`]/g,"").trim(),S=u(x);f.push({id:S,text:x,level:b})}return f}const bE=({toc:t,activeId:a,onClickItem:l})=>t.length?g.jsx("aside",{className:"fixed left-[calc(50%+870px/2+48px)] top-[calc(var(--header-height)+48px)] hidden xl:block w-56 2xl:w-64 h-[calc(100vh-var(--header-height)-96px)] overflow-y-auto overflow-x-hidden",children:g.jsx("div",{className:"border-l border-(--border-subtle) pl-4 pr-2",children:g.jsx("nav",{"aria-label":"Table of contents",children:g.jsx("ul",{className:"space-y-2",children:t.map(u=>{const s=u.id===a,c=u.level===1?"pl-0":u.level===2?"pl-3":"pl-6";return g.jsx("li",{className:c,children:g.jsxs("button",{type:"button",onClick:()=>l(u.id),className:["group relative block w-full text-left cursor-pointer","text-[13px] leading-[1.65]","transition-all duration-200 origin-left","focus:outline-none focus-visible:ring-2 focus-visible:ring-(--accent)/60 focus-visible:ring-offset-2 focus-visible:ring-offset-(--bg-base)",s?"text-(--fg-base) scale-110":"text-gray-500 hover:text-gray-500/80 hover:scale-105"].join(" "),children:[g.jsx("span",{className:["absolute -left-[22px] top-[9px] h-1.5 w-1.5 rounded-full","bg-(--fg-base)","transition-opacity duration-200",s?"opacity-100":"opacity-0 group-hover:opacity-60"].join(" ")}),u.text]})},u.id)})})})})}):null,Cg=({dir:t})=>g.jsx("span",{className:["shrink-0 w-11 h-11 rounded-full flex items-center justify-center","border border-green-400 text-green-400","bg-transparent group-hover:bg-green-400/10","transition-colors duration-200"].join(" "),children:g.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:t==="left"?g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"}):g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})}),Tg=({children:t,align:a,onClick:l})=>g.jsxs("button",{type:"button",onClick:l,className:["group relative w-full overflow-hidden rounded-2xl","border border-white/10","bg-white/5 hover:bg-white/8","transition-colors duration-200","focus:outline-none focus-visible:ring-2 focus-visible:ring-(--accent)/60 focus-visible:ring-offset-2 focus-visible:ring-offset-(--bg-base)",a==="left"?"text-left":"text-right"].join(" "),children:[g.jsx("span",{className:"pointer-events-none absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-200",children:g.jsx("span",{className:"absolute inset-0 bg-gradient-to-r from-(--accent)/0 via-(--accent)/10 to-(--accent)/0"})}),g.jsx("div",{className:"relative p-6 cursor-pointer",children:t})]}),yE=({prevPost:t,nextPost:a,onNavigate:l})=>!t&&!a?null:g.jsx("nav",{className:"mt-16 pt-8 border-t border-(--border-subtle)",children:g.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[g.jsx("div",{className:"md:col-span-1 h-[88px]",children:t?g.jsx(Tg,{align:"left",onClick:()=>l(t.slug),children:g.jsxs("div",{className:"flex items-center justify-between gap-4 h-full",children:[g.jsx(Cg,{dir:"left"}),g.jsxs("div",{className:"min-w-0",children:[g.jsx("div",{className:"text-[12px] font-semibold text-fg-muted mb-1",children:"이전 포스트"}),g.jsx("h3",{className:`\r
                    ...
                    `,children:t.title})]})]})}):g.jsx("div",{className:"w-full h-full"})}),g.jsx("div",{className:"md:col-span-1  h-[88px]",children:a?g.jsx(Tg,{align:"right",onClick:()=>l(a.slug),children:g.jsxs("div",{className:"flex items-center justify-between gap-4 h-full",children:[g.jsxs("div",{className:"min-w-0 text-right",children:[g.jsx("div",{className:"text-[12px] font-semibold text-fg-muted mb-1",children:"다음 포스트"}),g.jsx("h3",{className:` \r
                      text-[18px] font-bold text-(--fg-base)\r
                      truncate overflow-hidden\r
                    `,children:a.title})]}),g.jsx(Cg,{dir:"right"})]})}):g.jsx("div",{className:"w-full h-full"})})]})}),vE=Au.memo(function({content:a}){const l=D.useMemo(()=>Kx(),[a]),u=D.useMemo(()=>[gE],[]),s=D.useMemo(()=>({h1:({children:c,...f})=>{const m=Va(c),p=l(m);return g.jsx("h1",{id:p,className:"scroll-mt-[calc(var(--header-height)+24px)]",...f,children:c})},h2:({children:c,...f})=>{const m=Va(c),p=l(m);return g.jsx("h2",{id:p,className:"scroll-mt-[calc(var(--header-height)+24px)]",...f,children:c})},h3:({children:c,...f})=>{const m=Va(c),p=l(m);return g.jsx("h3",{id:p,className:"scroll-mt-[calc(var(--header-height)+24px)]",...f,children:c})}}),[l]);return g.jsx(r3,{remarkPlugins:u,components:s,children:a})}),SE=()=>{const{slug:t}=$1(),a=Ja(),l=D.useMemo(()=>et.find(x=>x.slug===t),[t]),u=D.useMemo(()=>l?.content??"",[l]),s=D.useMemo(()=>u?xE(u,1,3):[],[u]),{prevPost:c,nextPost:f}=D.useMemo(()=>{const x=et.findIndex(S=>S.slug===t);return x===-1?{prevPost:null,nextPost:null}:{prevPost:x>0?et[x-1]:null,nextPost:x<et.length-1?et[x+1]:null}},[t]),[m,p]=D.useState(),h=Au.useRef(!1),b=x=>{const S=document.getElementById(x);if(!S)return;h.current=!0,p(K=>K===x?K:x),history.replaceState(null,"",`#${x}`);const v=parseFloat(getComputedStyle(document.documentElement).getPropertyValue("--header-height").trim())||80,z=S.getBoundingClientRect().top+window.pageYOffset-v-24;window.scrollTo({top:z,behavior:"smooth"});const j=performance.now();let H=0;const _=()=>{const K=window.scrollY;Math.abs(K-z)<2?H+=1:H=0;const re=performance.now()-j>2200;if(H>=3||re){h.current=!1;return}requestAnimationFrame(_)};requestAnimationFrame(_)};return D.useEffect(()=>{if(!s.length)return;const x=()=>{const z=getComputedStyle(document.documentElement).getPropertyValue("--header-height").trim(),j=parseFloat(z);return Number.isFinite(j)?j:80},S=24;let v=0;const C=()=>{if(v=0,h.current)return;const z=x(),j=window.scrollY+z+S+1;let H=s[0]?.id;for(const _ of s){const K=document.getElementById(_.id);if(K)if(K.offsetTop<=j)H=_.id;else break}p(_=>_===H?_:H)},O=()=>{v||(v=requestAnimationFrame(C))};return C(),window.addEventListener("scroll",O,{passive:!0}),window.addEventListener("resize",O),()=>{window.removeEventListener("scroll",O),window.removeEventListener("resize",O),v&&cancelAnimationFrame(v)}},[s,t]),l?g.jsxs("div",{className:"min-h-screen bg-(--bg-base) text-(--fg-base) overflow-x-hidden",children:[g.jsx("div",{className:"mx-auto max-w-[870px] px-5 md:px-8 pt-[calc(var(--header-height)+48px)] pb-16",children:g.jsxs("article",{className:"w-full",children:[g.jsxs("button",{onClick:()=>a("/blog"),className:"relative z-10 mb-5 text-[13px] text-fg-muted hover:text-fg transition-colors flex items-center gap-2",children:[g.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})}),"목록으로"]}),g.jsxs("div",{className:"mb-10",children:[g.jsx("h1",{className:"text-[36px] md:text-[42px] font-bold leading-tight mb-4",children:l.title}),g.jsxs("div",{className:"w-full flex flex-col md:flex-row md:justify-between md:items-center gap-4",children:[g.jsx("div",{className:"flex flex-wrap gap-2",children:l.tags.map(x=>g.jsx("span",{className:"text-[13px] text-green-300 px-2.5 py-1.5 rounded-full  border border-(--border-subtle) text-fg-muted",children:x},x))}),g.jsx("div",{className:"text-[13px] text-fg-muted whitespace-nowrap md:text-right",children:l.date})]})]}),l.cover&&g.jsx("div",{className:"relative h-[300px] md:h-[400px] rounded-2xl overflow-hidden mb-10 bg-(--bg-soft)",children:g.jsx("img",{src:l.cover,alt:l.title,className:"absolute inset-0 w-full h-full object-cover"})}),g.jsx("div",{className:"prose prose-invert max-w-none",children:u?g.jsx(vE,{content:u}):g.jsx("p",{className:"text-fg-muted",children:"콘텐츠가 없습니다."})}),g.jsx(yE,{prevPost:c,nextPost:f,onNavigate:x=>a(`/blog/${x}`)})]})}),g.jsx(bE,{toc:s,activeId:m,onClickItem:b})]}):g.jsx("div",{className:"min-h-screen bg-(--bg-base) text-(--fg-base) flex items-center justify-center",children:g.jsxs("div",{className:"text-center",children:[g.jsx("h1",{className:"text-[32px] font-bold mb-4",children:"포스트를 찾을 수 없습니다"}),g.jsx("button",{onClick:()=>a("/blog"),className:"px-4 py-2 rounded-full border border-(--border-subtle) bg-white/5 hover:bg-white/10 transition-colors",children:"블로그로 돌아가기"})]})})},kE="relative min-h-screen pt-[calc(var(--header-height)+56px)] pb-24 px-5 overflow-hidden",wE="pointer-events-none absolute inset-0 bg-[radial-gradient(900px_500px_at_20%_10%,rgba(125,211,252,0.16),transparent_60%),radial-gradient(800px_420px_at_80%_30%,rgba(167,139,250,0.14),transparent_60%),radial-gradient(700px_360px_at_50%_85%,rgba(34,197,94,0.10),transparent_60%)] [mask-image:radial-gradient(70%_60%_at_50%_40%,black,transparent)]",Eg="relative rounded-3xl border border-(--border-subtle) bg-(--bg-elevated)/70 p-6 backdrop-blur-xl shadow-[0_14px_34px_rgba(0,0,0,0.32)] transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-[0_20px_46px_rgba(0,0,0,0.55)] hover:border-white/20 [html[data-theme='light']_&]:bg-white/70 [html[data-theme='light']_&]:shadow-[0_10px_26px_rgba(0,0,0,0.08)] [html[data-theme='light']_&]:hover:shadow-[0_14px_34px_rgba(0,0,0,0.12)]",Ag="pointer-events-none absolute inset-0 rounded-3xl bg-[radial-gradient(900px_240px_at_10%_0%,rgba(255,255,255,0.14),transparent_55%)] [html[data-theme='light']_&]:bg-[radial-gradient(900px_240px_at_10%_0%,rgba(17,24,39,0.06),transparent_55%)]",CE="inline-flex items-center gap-2 text-[11px] uppercase tracking-[0.18em] text-fg-muted",Gc="inline-flex items-center rounded-full border border-(--border-subtle) bg-(--bg-soft) px-3 py-1 text-[11px] text-fg-muted [html[data-theme='light']_&]:bg-[#f5f5fb]",TE=()=>g.jsxs("main",{className:kE,children:[g.jsx("div",{className:wE}),g.jsxs("div",{className:"max-w-[760px] mx-auto relative",children:[g.jsxs("section",{className:"text-center mb-12",children:[g.jsx("div",{className:"flex justify-center mb-4",children:g.jsxs("span",{className:`${Gc} gap-2`,children:[g.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-green-400"}),g.jsx("span",{className:CE,children:"Contact"})]})}),g.jsx("h1",{className:"text-[34px] md:text-[44px] font-semibold tracking-[-0.02em] mb-4",children:"함께 이야기해요"}),g.jsxs("p",{className:"text-[15px] md:text-[16px] text-fg-muted leading-relaxed max-w-lg mx-auto",children:["프로젝트 제안, 협업, 채용 어떤 주제든 좋습니다.",g.jsx("br",{className:" md:block"}),"가능한 빠르게 확인하고 답변 드리겠습니다."]})]}),g.jsxs("div",{className:"grid gap-5",children:[g.jsxs("div",{className:Eg,children:[g.jsx("div",{className:Ag}),g.jsxs("div",{className:"flex items-center justify-between mb-4 relative",children:[g.jsx("h2",{className:"text-[16px] font-medium text-fg",children:"연락 채널"}),g.jsx("span",{className:Gc,children:"가장 빠른 답변: Email"})]}),g.jsxs("div",{className:"grid gap-3 relative",children:[g.jsx(La,{label:"Email",value:"lanos5019@ajou.ac.kr",href:"mailto:you@example.com",icon:g.jsx(_E,{})}),g.jsx(La,{label:"Phone",value:"010-3465-9425",href:"tel:010-3465-9425",icon:g.jsx(ME,{})}),g.jsx(La,{label:"GitHub",value:"@km-kwon",href:"https://github.com/km-kwon",external:!0,icon:g.jsx(DE,{})}),g.jsx(La,{label:"NPM",value:"@kwon-kyoungmin",href:"https://www.npmjs.com/~kwon-kyoungmin",external:!0,icon:g.jsx(OE,{})}),g.jsx(La,{label:"Apply",value:"Resume (PDF)",href:"/portfolio/resume.pdf",external:!0,icon:g.jsx(RE,{})})]})]}),g.jsxs("div",{className:Eg,children:[g.jsx("div",{className:Ag}),g.jsx("h2",{className:"text-[16px] font-medium text-fg mb-4 relative",children:"응답 안내"}),g.jsxs("div",{className:"grid md:grid-cols-2 gap-4 relative",children:[g.jsx(jg,{icon:g.jsx(EE,{}),title:"평균 응답 시간",value:"24시간 이내",sub:"최대한 빠르게 회신 드리겠습니다."}),g.jsx(jg,{icon:g.jsx(AE,{}),title:"위치",value:"대한민국, 성남",sub:"원격 협업도 가능합니다."})]})]})]})]})]}),La=({label:t,value:a,href:l,external:u,icon:s,download:c})=>g.jsxs("a",{href:l,target:u?"_blank":void 0,rel:u?"noreferrer":void 0,download:c,className:`group relative flex items-center gap-3 rounded-2xl px-4 py-3\r
               border border-(--border-subtle) bg-(--bg-soft)\r
               ...
               transition-all duration-150 ease-out`,children:[g.jsx("div",{className:`w-9 h-9 rounded-full bg-(--bg-elevated) border border-(--border-subtle)\r
                  ...
                  [html[data-theme='light']_&]:bg-[#f5f5fb]`,children:[g.jsx("div",{className:`w-10 h-10 rounded-full bg-(--bg-elevated) border border-(--border-subtle)\r
                    flex items-center justify-center shrink-0`,children:t}),g.jsxs("div",{className:"min-w-0",children:[g.jsx("p",{className:"text-[12px] font-medium text-fg",children:a}),g.jsx("p",{className:"text-[14px] font-semibold text-fg mt-1",children:l}),g.jsx("p",{className:"text-[12px] text-fg-muted mt-1 leading-relaxed",children:u})]})]}),EE=()=>g.jsx("svg",{className:"w-4 h-4 text-fg-muted",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"})}),AE=()=>g.jsxs("svg",{className:"w-4 h-4 text-fg-muted",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:[g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"}),g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M15 11a3 3 0 11-6 0 3 3 0 016 0z"})]}),jE=({className:t})=>g.jsxs("svg",{className:t??"",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:[g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M7 17L17 7"}),g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M10 7h7v7"})]}),NE=({className:t})=>g.jsxs("svg",{className:t??"",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:[g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M12 4v12m0 0l-4-4m4 4l4-4"}),g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M4 17v2a1 1 0 001 1h14a1 1 0 001-1v-2"})]}),ME=()=>g.jsx("svg",{className:"w-4 h-4 text-fg-muted",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"})}),_E=()=>g.jsxs("svg",{className:"w-4 h-4 text-fg-muted",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:[g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M3 8l9 6 9-6"}),g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M5 6h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2z"})]}),DE=()=>g.jsx("svg",{className:"w-4 h-4 text-fg-muted",viewBox:"0 0 24 24",fill:"currentColor",children:g.jsx("path",{d:"M12 .5A12 12 0 0 0 0 12.7c0 5.4 3.4 10 8.2 11.6.6.1.8-.3.8-.6v-2.2c-3.3.7-4-1.5-4-1.5-.6-1.6-1.5-2-1.5-2-1.2-.9.1-.9.1-.9 1.3.1 2 .9 2 .9 1.2 2.1 3.1 1.5 3.9 1.1.1-.9.5-1.5.8-1.9-2.7-.3-5.5-1.4-5.5-6.1 0-1.3.4-2.3 1.1-3.2-.1-.3-.5-1.5.1-3.1 0 0 .9-.3 3.1 1.2.9-.3 1.9-.4 2.9-.4s2 .1 2.9.4c2.2-1.5 3.1-1.2 3.1-1.2.6 1.6.2 2.8.1 3.1.7.9 1.1 1.9 1.1 3.2 0 4.7-2.8 5.8-5.5 6.1.5.4.9 1.2.9 2.4v3.5c0 .3.2.7.8.6A12.2 12.2 0 0 0 24 12.7 12 12 0 0 0 12 .5Z"})}),RE=()=>g.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"15",height:"15",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round",className:"lucide lucide-newspaper-icon lucide-newspaper",children:[g.jsx("path",{d:"M15 18h-5"}),g.jsx("path",{d:"M18 14h-8"}),g.jsx("path",{d:"M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-4 0v-9a2 2 0 0 1 2-2h2"}),g.jsx("rect",{width:"8",height:"4",x:"10",y:"6",rx:"1"})]}),OE=({className:t})=>g.jsxs("svg",{className:t??"w-4 h-4",viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",children:[g.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"6",stroke:"currentColor",strokeWidth:"1.6"}),g.jsx("path",{d:"M8 16V8l8 8V8",stroke:"currentColor",strokeWidth:"2.2",strokeLinecap:"round",strokeLinejoin:"round"})]}),zE=()=>{const[t,a]=D.useState(()=>{if(typeof window>"u")return"dark";try{return localStorage.getItem("portfolio-theme")||"dark"}catch{return"dark"}});D.useEffect(()=>{if(!(typeof document>"u")){document.documentElement.setAttribute("data-theme",t);try{localStorage.setItem("portfolio-theme",t)}catch{}}},[t]);const l=D.useCallback(()=>{a(c=>c==="dark"?"light":"dark")},[]),u=D.useCallback(c=>{const f=document.getElementById(c);if(f){const b=f.getBoundingClientRect().top+window.pageYOffset-64-20;window.scrollTo({top:b,behavior:"smooth"})}},[]),s="/portfolio/".replace(/\/$/,"");return g.jsxs(Uy,{basename:s===""?void 0:s,children:[g.jsx($y,{}),g.jsx(Xy,{theme:t,onToggleTheme:l,onNavClick:u}),g.jsxs(my,{children:[g.jsx(Ua,{path:"/",element:g.jsx(GS,{})}),g.jsx(Ua,{path:"/blog",element:g.jsx(PS,{})}),g.jsx(Ua,{path:"/blog/:slug",element:g.jsx(SE,{})}),g.jsx(Ua,{path:"/contact",element:g.jsx(TE,{})})]}),g.jsx(Wy,{})]})};S1.createRoot(document.getElementById("root")).render(g.jsx(zE,{}));
