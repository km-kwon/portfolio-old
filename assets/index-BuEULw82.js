...
`,Mv=`실차/로그 기반 모니터링 UI를 만들다 보면, 어느 순간부터 이런 문장이 몸에 새겨진다.\r
\r
...
`,Dv=`# useState → useReducer → 도메인  분리 → Store 까지의 이야기\r
\r
---\r
\r
...
\r
이제는 느낌이나 유행이 아니라, 요구사항과 제약, 팀의 운영 방식까지 포함한 **근거 기반의 최적 선택**이 더 중요하다고 생각한다.`,Rv=`## 0. 시니어는 AI를 싫어하지 않았다. 오히려 너무 좋아했다.\r
\r
...
`,zv=`HTML/CSS/JS는 아는데… 그래서 “웹”이 어떻게 화면이 되는 건데?\r
\r
...
이렇게 “반복되는 인자”가 보이면\r
커링을 한 번 떠올려볼 만하다.\r
`,Uv=`“함수가 변수 기억하는 거요”로 끝내면 나중에 꼭 크게 맞는다\r
\r
...
`});const h={type:"element",tagName:"li",properties:c,children:f};return t.patch(a,h),t.applyData(a,h)}function nC(t){let a=!1;if(t.type==="list"){a=t.spread||!1;const l=t.children;let u=-1;for(;!a&&++u<l.length;)a=Sx(l[u])}return a}function Sx(t){const a=t.spread;return a??t.children.length>1}function tC(t,a){const l={},u=t.all(a);let s=-1;for(typeof a.start=="number"&&a.start!==1&&(l.start=a.start);++s<u.length;){const f=u[s];if(f.type==="element"&&f.tagName==="li"&&f.properties&&Array.isArray(f.properties.className)&&f.properties.className.includes("task-list-item")){l.className=["contains-task-list"];break}}const c={type:"element",tagName:a.ordered?"ol":"ul",properties:l,children:t.wrap(u,!0)};return t.patch(a,c),t.applyData(a,c)}function rC(t,a){const l={type:"element",tagName:"p",properties:{},children:t.all(a)};return t.patch(a,l),t.applyData(a,l)}function lC(t,a){const l={type:"root",children:t.wrap(t.all(a))};return t.patch(a,l),t.applyData(a,l)}function aC(t,a){const l={type:"element",tagName:"strong",properties:{},children:t.all(a)};return t.patch(a,l),t.applyData(a,l)}function iC(t,a){const l=t.all(a),u=l.shift(),s=[];if(u){const f={type:"element",tagName:"thead",properties:{},children:t.wrap([u],!0)};t.patch(a.children[0],f),s.push(f)}if(l.length>0){const f={type:"element",tagName:"tbody",properties:{},children:t.wrap(l,!0)},m=ef(a.children[1]),p=ex(a.children[a.children.length-1]);m&&p&&(f.position={start:m,end:p}),s.push(f)}const c={type:"element",tagName:"table",properties:{},children:t.wrap(s,!0)};return t.patch(a,c),t.applyData(a,c)}function uC(t,a,l){const u=l?l.children:void 0,c=(u?u.indexOf(a):1)===0?"th":"td",f=l&&l.type==="table"?l.align:void 0,m=f?f.length:a.children.length;let p=-1;const h=[];for(;++p<m;){const x=a.children[p],S={},v=f?f[p]:void 0;v&&(S.align=v);let C={type:"element",tagName:c,properties:S,children:[]};x&&(C.children=t.all(x),t.patch(x,C),C=t.applyData(x,C)),h.push(C)}const b={type:"element",tagName:"tr",properties:{},children:t.wrap(h,!0)};return t.patch(a,b),t.applyData(a,b)}function sC(t,a){const l={type:"element",tagName:"td",properties:{},children:t.all(a)};return t.patch(a,l),t.applyData(a,l)}const tg=9,rg=32;function oC(t){const a=String(t),l=/\r?\n|\r/g;let u=l.exec(a),s=0;const c=[];for(;u;)c.push(lg(a.slice(s,u.index),s>0,!0),u[0]),s=u.index+u[0].length,u=l.exec(a);return c.push(lg(a.slice(s),s>0,!1)),c.join("")}function lg(t,a,l){let u=0,s=t.length;if(a){let c=t.codePointAt(u);for(;c===tg||c===rg;)u++,c=t.codePointAt(u)}if(l){let c=t.codePointAt(s-1);for(;c===tg||c===rg;)s--,c=t.codePointAt(s-1)}return s>u?t.slice(u,s):""}function cC(t,a){const l={type:"text",value:oC(String(a.value))};return t.patch(a,l),t.applyData(a,l)}function fC(t,a){const l={type:"element",tagName:"hr",properties:{},children:[]};return t.patch(a,l),t.applyData(a,l)}const dC={blockquote:qw,break:Vw,code:Fw,delete:Gw,emphasis:Yw,footnoteReference:Pw,heading:Xw,html:Jw,imageReference:Qw,image:Zw,inlineCode:Kw,linkReference:Ww,link:$w,listItem:eC,list:tC,paragraph:rC,root:lC,strong:aC,table:iC,tableCell:sC,tableRow:uC,text:cC,thematicBreak:fC,toml:vu,yaml:vu,definition:vu,footnoteDefinition:vu};function vu(){}const kx=-1,Bu=0,qa=1,Mu=2,sf=3,of=4,cf=5,ff=6,wx=7,Cx=8,ag=typeof self=="object"?self:globalThis,hC=(t,a)=>{const l=(s,c)=>(t.set(c,s),s),u=s=>{if(t.has(s))return t.get(s);const[c,f]=a[s];switch(c){case Bu:case kx:return l(f,s);case qa:{const m=l([],s);for(const p of f)m.push(u(p));return m}case Mu:{const m=l({},s);for(const[p,h]of f)m[u(p)]=u(h);return m}case sf:return l(new Date(f),s);case of:{const{source:m,flags:p}=f;return l(new RegExp(m,p),s)}case cf:{const m=l(new Map,s);for(const[p,h]of f)m.set(u(p),u(h));return m}case ff:{const m=l(new Set,s);for(const p of f)m.add(u(p));return m}case wx:{const{name:m,message:p}=f;return l(new ag[m](p),s)}case Cx:return l(BigInt(f),s);case"BigInt":return l(Object(BigInt(f)),s);case"ArrayBuffer":return l(new Uint8Array(f).buffer,f);case"DataView":{const{buffer:m}=new Uint8Array(f);return l(new DataView(m),f)}}return l(new ag[c](f),s)};return u},ig=t=>hC(new Map,t)(0),El="",{toString:mC}={},{keys:pC}=Object,za=t=>{const a=typeof t;if(a!=="object"||!t)return[Bu,a];const l=mC.call(t).slice(8,-1);switch(l){case"Array":return[qa,El];case"Object":return[Mu,El];case"Date":return[sf,El];case"RegExp":return[of,El];case"Map":return[cf,El];case"Set":return[ff,El];case"DataView":return[qa,l]}return l.includes("Array")?[qa,l]:l.includes("Error")?[wx,l]:[Mu,l]},Su=([t,a])=>t===Bu&&(a==="function"||a==="symbol"),gC=(t,a,l,u)=>{const s=(f,m)=>{const p=u.push(f)-1;return l.set(m,p),p},c=f=>{if(l.has(f))return l.get(f);let[m,p]=za(f);switch(m){case Bu:{let b=f;switch(p){case"bigint":m=Cx,b=f.toString();break;case"function":case"symbol":if(t)throw new TypeError("unable to serialize "+p);b=null;break;case"undefined":return s([kx],f)}return s([m,b],f)}case qa:{if(p){let S=f;return p==="DataView"?S=new Uint8Array(f.buffer):p==="ArrayBuffer"&&(S=new Uint8Array(f)),s([p,[...S]],f)}const b=[],x=s([m,b],f);for(const S of f)b.push(c(S));return x}case Mu:{if(p)switch(p){case"BigInt":return s([p,f.toString()],f);case"Boolean":case"Number":case"String":return s([p,f.valueOf()],f)}if(a&&"toJSON"in f)return c(f.toJSON());const b=[],x=s([m,b],f);for(const S of pC(f))(t||!Su(za(f[S])))&&b.push([c(S),c(f[S])]);return x}case sf:return s([m,f.toISOString()],f);case of:{const{source:b,flags:x}=f;return s([m,{source:b,flags:x}],f)}case cf:{const b=[],x=s([m,b],f);for(const[S,v]of f)(t||!(Su(za(S))||Su(za(v))))&&b.push([c(S),c(v)]);return x}case ff:{const b=[],x=s([m,b],f);for(const S of f)(t||!Su(za(S)))&&b.push(c(S));return x}}const{message:h}=f;return s([m,{name:p,message:h}],f)};return c},ug=(t,{json:a,lossy:l}={})=>{const u=[];return gC(!(a||l),!!a,new Map,u)(t),u},Du=typeof structuredClone=="function"?(t,a)=>a&&("json"in a||"lossy"in a)?ig(ug(t,a)):structuredClone(t):(t,a)=>ig(ug(t,a));function xC(t,a){const l=[{type:"text",value:"↩"}];return a>1&&l.push({type:"element",tagName:"sup",properties:{},children:[{type:"text",value:String(a)}]}),l}function bC(t,a){return"Back to reference "+(t+1)+(a>1?"-"+a:"")}function yC(t){const a=typeof t.options.clobberPrefix=="string"?t.options.clobberPrefix:"user-content-",l=t.options.footnoteBackContent||xC,u=t.options.footnoteBackLabel||bC,s=t.options.footnoteLabel||"Footnotes",c=t.options.footnoteLabelTagName||"h2",f=t.options.footnoteLabelProperties||{className:["sr-only"]},m=[];let p=-1;for(;++p<t.footnoteOrder.length;){const h=t.footnoteById.get(t.footnoteOrder[p]);if(!h)continue;const b=t.all(h),x=String(h.identifier).toUpperCase(),S=Rl(x.toLowerCase());let v=0;const C=[],O=t.footnoteCounts.get(x);for(;O!==void 0&&++v<=O;){C.length>0&&C.push({type:"text",value:" "});let H=typeof l=="string"?l:l(p,v);typeof H=="string"&&(H={type:"text",value:H}),C.push({type:"element",tagName:"a",properties:{href:"#"+a+"fnref-"+S+(v>1?"-"+v:""),dataFootnoteBackref:"",ariaLabel:typeof u=="string"?u:u(p,v),className:["data-footnote-backref"]},children:Array.isArray(H)?H:[H]})}const z=b[b.length-1];if(z&&z.type==="element"&&z.tagName==="p"){const H=z.children[z.children.length-1];H&&H.type==="text"?H.value+=" ":z.children.push({type:"text",value:" "}),z.children.push(...C)}else b.push(...C);const j={type:"element",tagName:"li",properties:{id:a+"fn-"+S},children:t.wrap(b,!0)};t.patch(h,j),m.push(j)}if(m.length!==0)return{type:"element",tagName:"section",properties:{dataFootnotes:!0,className:["footnotes"]},children:[{type:"element",tagName:c,properties:{...Du(f),id:"footnote-label"},children:[{type:"text",value:s}]},{type:"text",value:`
`},{type:"element",tagName:"ol",properties:{},children:t.wrap(m,!0)},{type:"text",value:`
`}]}}const Hu=(function(t){if(t==null)return wC;if(typeof t=="function")return Iu(t);if(typeof t=="object")return Array.isArray(t)?vC(t):SC(t);if(typeof t=="string")return kC(t);throw new Error("Expected function, string, or object as test")});function vC(t){const a=[];let l=-1;for(;++l<t.length;)a[l]=Hu(t[l]);return Iu(u);function u(...s){let c=-1;for(;++c<a.length;)if(a[c].apply(this,s))return!0;return!1}}function SC(t){const a=t;return Iu(l);function l(u){const s=u;let c;for(c in t)if(s[c]!==a[c])return!1;return!0}}function kC(t){return Iu(a);function a(l){return l&&l.type===t}}function Iu(t){return a;function a(l,u,s){return!!(CC(l)&&t.call(this,l,typeof u=="number"?u:void 0,s||void 0))}}function wC(){return!0}function CC(t){return t!==null&&typeof t=="object"&&"type"in t}const Tx=[],TC=!0,Hc=!1,EC="skip";function Ex(t,a,l,u){let s;typeof a=="function"&&typeof l!="function"?(u=l,l=a):s=a;const c=Hu(s),f=u?-1:1;m(t,void 0,[])();function m(p,h,b){const x=p&&typeof p=="object"?p:{};if(typeof x.type=="string"){const v=typeof x.tagName=="string"?x.tagName:typeof x.name=="string"?x.name:void 0;Object.defineProperty(S,"name",{value:"node ("+(p.type+(v?"<"+v+">":""))+")"})}return S;function S(){let v=Tx,C,O,z;if((!a||c(p,h,b[b.length-1]||void 0))&&(v=AC(l(p,b)),v[0]===Hc))return v;if("children"in p&&p.children){const j=p;if(j.children&&v[0]!==EC)for(O=(u?j.children.length:-1)+f,z=b.concat(j);O>-1&&O<j.children.length;){const H=j.children[O];if(C=m(H,O,z)(),C[0]===Hc)return C;O=typeof C[1]=="number"?C[1]:O+f}}return v}}}function AC(t){return Array.isArray(t)?t:typeof t=="number"?[TC,t]:t==null?Tx:[t]}function df(t,a,l,u){let s,c,f;typeof a=="function"&&typeof l!="function"?(c=void 0,f=a,s=l):(c=a,f=l,s=u),Ex(t,c,m,s);function m(p,h){const b=h[h.length-1],x=b?b.children.indexOf(p):void 0;return f(p,x,b)}}const Ic={}.hasOwnProperty,jC={};function NC(t,a){const l=a||jC,u=new Map,s=new Map,c=new Map,f={...dC,...l.handlers},m={all:h,applyData:MC,definitionById:u,footnoteById:s,footnoteCounts:c,footnoteOrder:[],handlers:f,one:p,options:l,patch:_C,wrap:RC};return df(t,function(b){if(b.type==="definition"||b.type==="footnoteDefinition"){const x=b.type==="definition"?u:s,S=String(b.identifier).toUpperCase();x.has(S)||x.set(S,b)}}),m;function p(b,x){const S=b.type,v=m.handlers[S];if(Ic.call(m.handlers,S)&&v)return v(m,b,x);if(m.options.passThrough&&m.options.passThrough.includes(S)){if("children"in b){const{children:O,...z}=b,j=Du(z);return j.children=m.all(b),j}return Du(b)}return(m.options.unknownHandler||DC)(m,b,x)}function h(b){const x=[];if("children"in b){const S=b.children;let v=-1;for(;++v<S.length;){const C=m.one(S[v],b);if(C){if(v&&S[v-1].type==="break"&&(!Array.isArray(C)&&C.type==="text"&&(C.value=sg(C.value)),!Array.isArray(C)&&C.type==="element")){const O=C.children[0];O&&O.type==="text"&&(O.value=sg(O.value))}Array.isArray(C)?x.push(...C):x.push(C)}}}return x}}function _C(t,a){t.position&&(a.position=b2(t))}function MC(t,a){let l=a;if(t&&t.data){const u=t.data.hName,s=t.data.hChildren,c=t.data.hProperties;if(typeof u=="string")if(l.type==="element")l.tagName=u;else{const f="children"in l?l.children:[l];l={type:"element",tagName:u,properties:{},children:f}}l.type==="element"&&c&&Object.assign(l.properties,Du(c)),"children"in l&&l.children&&s!==null&&s!==void 0&&(l.children=s)}return l}function DC(t,a){const l=a.data||{},u="value"in a&&!(Ic.call(l,"hProperties")||Ic.call(l,"hChildren"))?{type:"text",value:a.value}:{type:"element",tagName:"div",properties:{},children:t.all(a)};return t.patch(a,u),t.applyData(a,u)}function RC(t,a){const l=[];let u=-1;for(a&&l.push({type:"text",value:`
`});++u<t.length;)u&&l.push({type:"text",value:`
`}),l.push(t[u]);return a&&t.length>0&&l.push({type:"text",value:`
`}),l}function sg(t){let a=0,l=t.charCodeAt(a);for(;l===9||l===32;)a++,l=t.charCodeAt(a);return t.slice(a)}function og(t,a){const l=NC(t,a),u=l.one(t,void 0),s=yC(l),c=Array.isArray(u)?{type:"root",children:u}:u||{type:"root",children:[]};return s&&c.children.push({type:"text",value:`
`},s),c}function OC(t,a){return t&&"run"in t?async function(l,u){const s=og(l,{file:u,...a});await t.run(s,u)}:function(l,u){return og(l,{file:u,...t||a})}}function cg(t){if(t)throw t}var yc,fg;function zC(){if(fg)return yc;fg=1;var t=Object.prototype.hasOwnProperty,a=Object.prototype.toString,l=Object.defineProperty,u=Object.getOwnPropertyDescriptor,s=function(h){return typeof Array.isArray=="function"?Array.isArray(h):a.call(h)==="[object Array]"},c=function(h){if(!h||a.call(h)!=="[object Object]")return!1;var b=t.call(h,"constructor"),x=h.constructor&&h.constructor.prototype&&t.call(h.constructor.prototype,"isPrototypeOf");if(h.constructor&&!b&&!x)return!1;var S;for(S in h);return typeof S>"u"||t.call(h,S)},f=function(h,b){l&&b.name==="__proto__"?l(h,b.name,{enumerable:!0,configurable:!0,value:b.newValue,writable:!0}):h[b.name]=b.newValue},m=function(h,b){if(b==="__proto__")if(t.call(h,b)){if(u)return u(h,b).value}else return;return h[b]};return yc=function p(){var h,b,x,S,v,C,O=arguments[0],z=1,j=arguments.length,H=!1;for(typeof O=="boolean"&&(H=O,O=arguments[1]||{},z=2),(O==null||typeof O!="object"&&typeof O!="function")&&(O={});z<j;++z)if(h=arguments[z],h!=null)for(b in h)x=m(O,b),S=m(h,b),O!==S&&(H&&S&&(c(S)||(v=s(S)))?(v?(v=!1,C=x&&s(x)?x:[]):C=x&&c(x)?x:{},f(O,{name:b,newValue:p(H,C,S)})):typeof S<"u"&&f(O,{name:b,newValue:S}));return O},yc}var LC=zC();const vc=Yc(LC);function qc(t){if(typeof t!="object"||t===null)return!1;const a=Object.getPrototypeOf(t);return(a===null||a===Object.prototype||Object.getPrototypeOf(a)===null)&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)}function UC(){const t=[],a={run:l,use:u};return a;function l(...s){let c=-1;const f=s.pop();if(typeof f!="function")throw new TypeError("Expected function as last argument, not "+f);m(null,...s);function m(p,...h){const b=t[++c];let x=-1;if(p){f(p);return}for(;++x<s.length;)(h[x]===null||h[x]===void 0)&&(h[x]=s[x]);s=h,b?BC(b,m)(...h):f(null,...h)}}function u(s){if(typeof s!="function")throw new TypeError("Expected `middelware` to be a function, not "+s);return t.push(s),a}}function BC(t,a){let l;return u;function u(...f){const m=t.length>f.length;let p;m&&f.push(s);try{p=t.apply(this,f)}catch(h){const b=h;if(m&&l)throw b;return s(b)}m||(p&&p.then&&typeof p.then=="function"?p.then(c,s):p instanceof Error?s(p):c(p))}function s(f,...m){l||(l=!0,a(f,...m))}function c(f){s(null,f)}}const mt={basename:HC,dirname:IC,extname:qC,join:VC,sep:"/"};function HC(t,a){if(a!==void 0&&typeof a!="string")throw new TypeError('"ext" argument must be a string');Wa(t);let l=0,u=-1,s=t.length,c;if(a===void 0||a.length===0||a.length>t.length){for(;s--;)if(t.codePointAt(s)===47){if(c){l=s+1;break}}else u<0&&(c=!0,u=s+1);return u<0?"":t.slice(l,u)}if(a===t)return"";let f=-1,m=a.length-1;for(;s--;)if(t.codePointAt(s)===47){if(c){l=s+1;break}}else f<0&&(c=!0,f=s+1),m>-1&&(t.codePointAt(s)===a.codePointAt(m--)?m<0&&(u=s):(m=-1,u=f));return l===u?u=f:u<0&&(u=t.length),t.slice(l,u)}function IC(t){if(Wa(t),t.length===0)return".";let a=-1,l=t.length,u;for(;--l;)if(t.codePointAt(l)===47){if(u){a=l;break}}else u||(u=!0);return a<0?t.codePointAt(0)===47?"/":".":a===1&&t.codePointAt(0)===47?"//":t.slice(0,a)}function qC(t){Wa(t);let a=t.length,l=-1,u=0,s=-1,c=0,f;for(;a--;){const m=t.codePointAt(a);if(m===47){if(f){u=a+1;break}continue}l<0&&(f=!0,l=a+1),m===46?s<0?s=a:c!==1&&(c=1):s>-1&&(c=-1)}return s<0||l<0||c===0||c===1&&s===l-1&&s===u+1?"":t.slice(s,l)}function VC(...t){let a=-1,l;for(;++a<t.length;)Wa(t[a]),t[a]&&(l=l===void 0?t[a]:l+"/"+t[a]);return l===void 0?".":FC(l)}function FC(t){Wa(t);const a=t.codePointAt(0)===47;let l=GC(t,!a);return l.length===0&&!a&&(l="."),l.length>0&&t.codePointAt(t.length-1)===47&&(l+="/"),a?"/"+l:l}function GC(t,a){let l="",u=0,s=-1,c=0,f=-1,m,p;for(;++f<=t.length;){if(f<t.length)m=t.codePointAt(f);else{if(m===47)break;m=47}if(m===47){if(!(s===f-1||c===1))if(s!==f-1&&c===2){if(l.length<2||u!==2||l.codePointAt(l.length-1)!==46||l.codePointAt(l.length-2)!==46){if(l.length>2){if(p=l.lastIndexOf("/"),p!==l.length-1){p<0?(l="",u=0):(l=l.slice(0,p),u=l.length-1-l.lastIndexOf("/")),s=f,c=0;continue}}else if(l.length>0){l="",u=0,s=f,c=0;continue}}a&&(l=l.length>0?l+"/..":"..",u=2)}else l.length>0?l+="/"+t.slice(s+1,f):l=t.slice(s+1,f),u=f-s-1;s=f,c=0}else m===46&&c>-1?c++:c=-1}return l}function Wa(t){if(typeof t!="string")throw new TypeError("Path must be a string. Received "+JSON.stringify(t))}const YC={cwd:PC};function PC(){return"/"}function Vc(t){return!!(t!==null&&typeof t=="object"&&"href"in t&&t.href&&"protocol"in t&&t.protocol&&t.auth===void 0)}function XC(t){if(typeof t=="string")t=new URL(t);else if(!Vc(t)){const a=new TypeError('The "path" argument must be of type string or an instance of URL. Received `'+t+"`");throw a.code="ERR_INVALID_ARG_TYPE",a}if(t.protocol!=="file:"){const a=new TypeError("The URL must be of scheme file");throw a.code="ERR_INVALID_URL_SCHEME",a}return JC(t)}function JC(t){if(t.hostname!==""){const u=new TypeError('File URL host must be "localhost" or empty on darwin');throw u.code="ERR_INVALID_FILE_URL_HOST",u}const a=t.pathname;let l=-1;for(;++l<a.length;)if(a.codePointAt(l)===37&&a.codePointAt(l+1)===50){const u=a.codePointAt(l+2);if(u===70||u===102){const s=new TypeError("File URL path must not include encoded / characters");throw s.code="ERR_INVALID_FILE_URL_PATH",s}}return decodeURIComponent(a)}const Sc=["history","path","basename","stem","extname","dirname"];class Ax{constructor(a){let l;a?Vc(a)?l={path:a}:typeof a=="string"||QC(a)?l={value:a}:l=a:l={},this.cwd="cwd"in l?"":YC.cwd(),this.data={},this.history=[],this.messages=[],this.value,this.map,this.result,this.stored;let u=-1;for(;++u<Sc.length;){const c=Sc[u];c in l&&l[c]!==void 0&&l[c]!==null&&(this[c]=c==="history"?[...l[c]]:l[c])}let s;for(s in l)Sc.includes(s)||(this[s]=l[s])}get basename(){return typeof this.path=="string"?mt.basename(this.path):void 0}set basename(a){wc(a,"basename"),kc(a,"basename"),this.path=mt.join(this.dirname||"",a)}get dirname(){return typeof this.path=="string"?mt.dirname(this.path):void 0}set dirname(a){dg(this.basename,"dirname"),this.path=mt.join(a||"",this.basename)}get extname(){return typeof this.path=="string"?mt.extname(this.path):void 0}set extname(a){if(kc(a,"extname"),dg(this.dirname,"extname"),a){if(a.codePointAt(0)!==46)throw new Error("`extname` must start with `.`");if(a.includes(".",1))throw new Error("`extname` cannot contain multiple dots")}this.path=mt.join(this.dirname,this.stem+(a||""))}get path(){return this.history[this.history.length-1]}set path(a){Vc(a)&&(a=XC(a)),wc(a,"path"),this.path!==a&&this.history.push(a)}get stem(){return typeof this.path=="string"?mt.basename(this.path,this.extname):void 0}set stem(a){wc(a,"stem"),kc(a,"stem"),this.path=mt.join(this.dirname||"",a+(this.extname||""))}fail(a,l,u){const s=this.message(a,l,u);throw s.fatal=!0,s}info(a,l,u){const s=this.message(a,l,u);return s.fatal=void 0,s}message(a,l,u){const s=new xn(a,l,u);return this.path&&(s.name=this.path+":"+s.name,s.file=this.path),s.fatal=!1,this.messages.push(s),s}toString(a){return this.value===void 0?"":typeof this.value=="string"?this.value:new TextDecoder(a||void 0).decode(this.value)}}function kc(t,a){if(t&&t.includes(mt.sep))throw new Error("`"+a+"` cannot be a path: did not expect `"+mt.sep+"`")}function wc(t,a){if(!t)throw new Error("`"+a+"` cannot be empty")}function dg(t,a){if(!t)throw new Error("Setting `"+a+"` requires `path` to be set too")}function QC(t){return!!(t&&typeof t=="object"&&"byteLength"in t&&"byteOffset"in t)}const ZC=(function(t){const u=this.constructor.prototype,s=u[t],c=function(){return s.apply(c,arguments)};return Object.setPrototypeOf(c,u),c}),KC={}.hasOwnProperty;class hf extends ZC{constructor(){super("copy"),this.Compiler=void 0,this.Parser=void 0,this.attachers=[],this.compiler=void 0,this.freezeIndex=-1,this.frozen=void 0,this.namespace={},this.parser=void 0,this.transformers=UC()}copy(){const a=new hf;let l=-1;for(;++l<this.attachers.length;){const u=this.attachers[l];a.use(...u)}return a.data(vc(!0,{},this.namespace)),a}data(a,l){return typeof a=="string"?arguments.length===2?(Ec("data",this.frozen),this.namespace[a]=l,this):KC.call(this.namespace,a)&&this.namespace[a]||void 0:a?(Ec("data",this.frozen),this.namespace=a,this):this.namespace}freeze(){if(this.frozen)return this;const a=this;for(;++this.freezeIndex<this.attachers.length;){const[l,...u]=this.attachers[this.freezeIndex];if(u[0]===!1)continue;u[0]===!0&&(u[0]=void 0);const s=l.call(a,...u);typeof s=="function"&&this.transformers.use(s)}return this.frozen=!0,this.freezeIndex=Number.POSITIVE_INFINITY,this}parse(a){this.freeze();const l=ku(a),u=this.parser||this.Parser;return Cc("parse",u),u(String(l),l)}process(a,l){const u=this;return this.freeze(),Cc("process",this.parser||this.Parser),Tc("process",this.compiler||this.Compiler),l?s(void 0,l):new Promise(s);function s(c,f){const m=ku(a),p=u.parse(m);u.run(p,m,function(b,x,S){if(b||!x||!S)return h(b);const v=x,C=u.stringify(v,S);e3(C)?S.value=C:S.result=C,h(b,S)});function h(b,x){b||!x?f(b):c?c(x):l(void 0,x)}}}processSync(a){let l=!1,u;return this.freeze(),Cc("processSync",this.parser||this.Parser),Tc("processSync",this.compiler||this.Compiler),this.process(a,s),mg("processSync","process",l),u;function s(c,f){l=!0,cg(c),u=f}}run(a,l,u){hg(a),this.freeze();const s=this.transformers;return!u&&typeof l=="function"&&(u=l,l=void 0),u?c(void 0,u):new Promise(c);function c(f,m){const p=ku(l);s.run(a,p,h);function h(b,x,S){const v=x||a;b?m(b):f?f(v):u(void 0,v,S)}}}runSync(a,l){let u=!1,s;return this.run(a,l,c),mg("runSync","run",u),s;function c(f,m){cg(f),s=m,u=!0}}stringify(a,l){this.freeze();const u=ku(l),s=this.compiler||this.Compiler;return Tc("stringify",s),hg(a),s(a,u)}use(a,...l){const u=this.attachers,s=this.namespace;if(Ec("use",this.frozen),a!=null)if(typeof a=="function")p(a,l);else if(typeof a=="object")Array.isArray(a)?m(a):f(a);else throw new TypeError("Expected usable value, not `"+a+"`");return this;function c(h){if(typeof h=="function")p(h,[]);else if(typeof h=="object")if(Array.isArray(h)){const[b,...x]=h;p(b,x)}else f(h);else throw new TypeError("Expected usable value, not `"+h+"`")}function f(h){if(!("plugins"in h)&&!("settings"in h))throw new Error("Expected usable value but received an empty preset, which is probably a mistake: presets typically come with `plugins` and sometimes with `settings`, but this has neither");m(h.plugins),h.settings&&(s.settings=vc(!0,s.settings,h.settings))}function m(h){let b=-1;if(h!=null)if(Array.isArray(h))for(;++b<h.length;){const x=h[b];c(x)}else throw new TypeError("Expected a list of plugins, not `"+h+"`")}function p(h,b){let x=-1,S=-1;for(;++x<u.length;)if(u[x][0]===h){S=x;break}if(S===-1)u.push([h,...b]);else if(b.length>0){let[v,...C]=b;const O=u[S][1];qc(O)&&qc(v)&&(v=vc(!0,O,v)),u[S]=[h,v,...C]}}}}const WC=new hf().freeze();function Cc(t,a){if(typeof a!="function")throw new TypeError("Cannot `"+t+"` without `parser`")}function Tc(t,a){if(typeof a!="function")throw new TypeError("Cannot `"+t+"` without `compiler`")}function Ec(t,a){if(a)throw new Error("Cannot call `"+t+"` on a frozen processor.\nCreate a new processor first, by calling it: use `processor()` instead of `processor`.")}function hg(t){if(!qc(t)||typeof t.type!="string")throw new TypeError("Expected node, got `"+t+"`")}function mg(t,a,l){if(!l)throw new Error("`"+t+"` finished async. Use `"+a+"` instead")}function ku(t){return $C(t)?t:new Ax(t)}function $C(t){return!!(t&&typeof t=="object"&&"message"in t&&"messages"in t)}function e3(t){return typeof t=="string"||n3(t)}function n3(t){return!!(t&&typeof t=="object"&&"byteLength"in t&&"byteOffset"in t)}const t3="https://github.com/remarkjs/react-markdown/blob/main/changelog.md",pg=[],gg={allowDangerousHtml:!0},r3=/^(https?|ircs?|mailto|xmpp)$/i,l3=[{from:"astPlugins",id:"remove-buggy-html-in-markdown-parser"},{from:"allowDangerousHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"allowNode",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowElement"},{from:"allowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowedElements"},{from:"className",id:"remove-classname"},{from:"disallowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"disallowedElements"},{from:"escapeHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"includeElementIndex",id:"#remove-includeelementindex"},{from:"includeNodeIndex",id:"change-includenodeindex-to-includeelementindex"},{from:"linkTarget",id:"remove-linktarget"},{from:"plugins",id:"change-plugins-to-remarkplugins",to:"remarkPlugins"},{from:"rawSourcePos",id:"#remove-rawsourcepos"},{from:"renderers",id:"change-renderers-to-components",to:"components"},{from:"source",id:"change-source-to-children",to:"children"},{from:"sourcePos",id:"#remove-sourcepos"},{from:"transformImageUri",id:"#add-urltransform",to:"urlTransform"},{from:"transformLinkUri",id:"#add-urltransform",to:"urlTransform"}];function a3(t){const a=i3(t),l=u3(t);return s3(a.runSync(a.parse(l),l),t)}function i3(t){const a=t.rehypePlugins||pg,l=t.remarkPlugins||pg,u=t.remarkRehypeOptions?{...t.remarkRehypeOptions,...gg}:gg;return WC().use(Iw).use(l).use(OC,u).use(a)}function u3(t){const a=t.children||"",l=new Ax;return typeof a=="string"&&(l.value=a),l}function s3(t,a){const l=a.allowedElements,u=a.allowElement,s=a.components,c=a.disallowedElements,f=a.skipHtml,m=a.unwrapDisallowed,p=a.urlTransform||o3;for(const b of l3)Object.hasOwn(a,b.from)&&(""+b.from+(b.to?"use `"+b.to+"` instead":"remove it")+t3+b.id,void 0);return df(t,h),w2(t,{Fragment:g.Fragment,components:s,ignoreInvalidStyle:!0,jsx:g.jsx,jsxs:g.jsxs,passKeys:!0,passNode:!0});function h(b,x,S){if(b.type==="raw"&&S&&typeof x=="number")return f?S.children.splice(x,1):S.children[x]={type:"text",value:b.value},x;if(b.type==="element"){let v;for(v in gc)if(Object.hasOwn(gc,v)&&Object.hasOwn(b.properties,v)){const C=b.properties[v],O=gc[v];(O===null||O.includes(b.tagName))&&(b.properties[v]=p(String(C||""),v,b))}}if(b.type==="element"){let v=l?!l.includes(b.tagName):c?c.includes(b.tagName):!1;if(!v&&u&&typeof x=="number"&&(v=!u(b,x,S)),v&&S&&typeof x=="number")return m&&b.children?S.children.splice(x,1,...b.children):S.children.splice(x,1),x}}}function o3(t){const a=t.indexOf(":"),l=t.indexOf("?"),u=t.indexOf("#"),s=t.indexOf("/");return a===-1||s!==-1&&a>s||l!==-1&&a>l||u!==-1&&a>u||r3.test(t.slice(0,a))?t:""}function xg(t,a){const l=String(t);if(typeof a!="string")throw new TypeError("Expected character");let u=0,s=l.indexOf(a);for(;s!==-1;)u++,s=l.indexOf(a,s+a.length);return u}function c3(t){if(typeof t!="string")throw new TypeError("Expected a string");return t.replace(/[|\\{}()[\]^$+*?.]/g,"\\$&").replace(/-/g,"\\x2d")}function f3(t,a,l){const s=Hu((l||{}).ignore||[]),c=d3(a);let f=-1;for(;++f<c.length;)Ex(t,"text",m);function m(h,b){let x=-1,S;for(;++x<b.length;){const v=b[x],C=S?S.children:void 0;if(s(v,C?C.indexOf(v):void 0,S))return;S=v}if(S)return p(h,b)}function p(h,b){const x=b[b.length-1],S=c[f][0],v=c[f][1];let C=0;const z=x.children.indexOf(h);let j=!1,H=[];S.lastIndex=0;let M=S.exec(h.value);for(;M;){const K=M.index,re={index:M.index,input:M.input,stack:[...b,h]};let q=v(...M,re);if(typeof q=="string"&&(q=q.length>0?{type:"text",value:q}:void 0),q===!1?S.lastIndex=K+1:(C!==K&&H.push({type:"text",value:h.value.slice(C,K)}),Array.isArray(q)?H.push(...q):q&&H.push(q),C=K+M[0].length,j=!0),!S.global)break;M=S.exec(h.value)}return j?(C<h.value.length&&H.push({type:"text",value:h.value.slice(C)}),x.children.splice(z,1,...H)):H=[h],z+H.length}}function d3(t){const a=[];if(!Array.isArray(t))throw new TypeError("Expected find and replace tuple or list of tuples");const l=!t[0]||Array.isArray(t[0])?t:[t];let u=-1;for(;++u<l.length;){const s=l[u];a.push([h3(s[0]),m3(s[1])])}return a}function h3(t){return typeof t=="string"?new RegExp(c3(t),"g"):t}function m3(t){return typeof t=="function"?t:function(){return t}}const Ac="phrasing",jc=["autolink","link","image","label"];function p3(){return{transforms:[k3],enter:{literalAutolink:x3,literalAutolinkEmail:Nc,literalAutolinkHttp:Nc,literalAutolinkWww:Nc},exit:{literalAutolink:S3,literalAutolinkEmail:v3,literalAutolinkHttp:b3,literalAutolinkWww:y3}}}function g3(){return{unsafe:[{character:"@",before:"[+\\-.\\w]",after:"[\\-.\\w]",inConstruct:Ac,notInConstruct:jc},{character:".",before:"[Ww]",after:"[\\-.\\w]",inConstruct:Ac,notInConstruct:jc},{character:":",before:"[ps]",after:"\\/",inConstruct:Ac,notInConstruct:jc}]}}function x3(t){this.enter({type:"link",title:null,url:"",children:[]},t)}function Nc(t){this.config.enter.autolinkProtocol.call(this,t)}function b3(t){this.config.exit.autolinkProtocol.call(this,t)}function y3(t){this.config.exit.data.call(this,t);const a=this.stack[this.stack.length-1];a.type,a.url="http://"+this.sliceSerialize(t)}function v3(t){this.config.exit.autolinkEmail.call(this,t)}function S3(t){this.exit(t)}function k3(t){f3(t,[[/(https?:\/\/|www(?=\.))([-.\w]+)([^ \t\r\n]*)/gi,w3],[new RegExp("(?<=^|\\s|\\p{P}|\\p{S})([-.\\w+]+)@([-\\w]+(?:\\.[-\\w]+)+)","gu"),C3]],{ignore:["link","linkReference"]})}function w3(t,a,l,u,s){let c="";if(!jx(s)||(/^w/i.test(a)&&(l=a+l,a="",c="http://"),!T3(l)))return!1;const f=E3(l+u);if(!f[0])return!1;const m={type:"link",title:null,url:c+a+f[0],children:[{type:"text",value:a+f[0]}]};return f[1]?[m,{type:"text",value:f[1]}]:m}function C3(t,a,l,u){return!jx(u,!0)||/[-\d_]$/.test(l)?!1:{type:"link",title:null,url:"mailto:"+a+"@"+l,children:[{type:"text",value:a+"@"+l}]}}function T3(t){const a=t.split(".");return!(a.length<2||a[a.length-1]&&(/_/.test(a[a.length-1])||!/[a-zA-Z\d]/.test(a[a.length-1]))||a[a.length-2]&&(/_/.test(a[a.length-2])||!/[a-zA-Z\d]/.test(a[a.length-2])))}function E3(t){const a=/[!"&'),.:;<>?\]}]+$/.exec(t);if(!a)return[t,void 0];t=t.slice(0,a.index);let l=a[0],u=l.indexOf(")");const s=xg(t,"(");let c=xg(t,")");for(;u!==-1&&s>c;)t+=l.slice(0,u+1),l=l.slice(u+1),u=l.indexOf(")"),c++;return[t,l]}function jx(t,a){const l=t.input.charCodeAt(t.index-1);return(t.index===0||zr(l)||Lu(l))&&(!a||l!==47)}Nx.peek=z3;function A3(){this.buffer()}function j3(t){this.enter({type:"footnoteReference",identifier:"",label:""},t)}function N3(){this.buffer()}function _3(t){this.enter({type:"footnoteDefinition",identifier:"",label:"",children:[]},t)}function M3(t){const a=this.resume(),l=this.stack[this.stack.length-1];l.type,l.identifier=ut(this.sliceSerialize(t)).toLowerCase(),l.label=a}function D3(t){this.exit(t)}function R3(t){const a=this.resume(),l=this.stack[this.stack.length-1];l.type,l.identifier=ut(this.sliceSerialize(t)).toLowerCase(),l.label=a}function O3(t){this.exit(t)}function z3(){return"["}function Nx(t,a,l,u){const s=l.createTracker(u);let c=s.move("[^");const f=l.enter("footnoteReference"),m=l.enter("reference");return c+=s.move(l.safe(l.associationId(t),{after:"]",before:c})),m(),f(),c+=s.move("]"),c}function L3(){return{enter:{gfmFootnoteCallString:A3,gfmFootnoteCall:j3,gfmFootnoteDefinitionLabelString:N3,gfmFootnoteDefinition:_3},exit:{gfmFootnoteCallString:M3,gfmFootnoteCall:D3,gfmFootnoteDefinitionLabelString:R3,gfmFootnoteDefinition:O3}}}function U3(t){let a=!1;return t&&t.firstLineBlank&&(a=!0),{handlers:{footnoteDefinition:l,footnoteReference:Nx},unsafe:[{character:"[",inConstruct:["label","phrasing","reference"]}]};function l(u,s,c,f){const m=c.createTracker(f);let p=m.move("[^");const h=c.enter("footnoteDefinition"),b=c.enter("label");return p+=m.move(c.safe(c.associationId(u),{before:p,after:"]"})),b(),p+=m.move("]:"),u.children&&u.children.length>0&&(m.shift(4),p+=m.move((a?`
`:" ")+c.indentLines(c.containerFlow(u,m.current()),a?_x:B3))),h(),p}}function B3(t,a,l){return a===0?t:_x(t,a,l)}function _x(t,a,l){return(l?"":"    ")+t}const H3=["autolink","destinationLiteral","destinationRaw","reference","titleQuote","titleApostrophe"];Mx.peek=G3;function I3(){return{canContainEols:["delete"],enter:{strikethrough:V3},exit:{strikethrough:F3}}}function q3(){return{unsafe:[{character:"~",inConstruct:"phrasing",notInConstruct:H3}],handlers:{delete:Mx}}}function V3(t){this.enter({type:"delete",children:[]},t)}function F3(t){this.exit(t)}function Mx(t,a,l,u){const s=l.createTracker(u),c=l.enter("strikethrough");let f=s.move("~~");return f+=l.containerPhrasing(t,{...s.current(),before:f,after:"~"}),f+=s.move("~~"),c(),f}function G3(){return"~"}function Y3(t){return t.length}function P3(t,a){const l=a||{},u=(l.align||[]).concat(),s=l.stringLength||Y3,c=[],f=[],m=[],p=[];let h=0,b=-1;for(;++b<t.length;){const O=[],z=[];let j=-1;for(t[b].length>h&&(h=t[b].length);++j<t[b].length;){const H=X3(t[b][j]);if(l.alignDelimiters!==!1){const M=s(H);z[j]=M,(p[j]===void 0||M>p[j])&&(p[j]=M)}O.push(H)}f[b]=O,m[b]=z}let x=-1;if(typeof u=="object"&&"length"in u)for(;++x<h;)c[x]=bg(u[x]);else{const O=bg(u);for(;++x<h;)c[x]=O}x=-1;const S=[],v=[];for(;++x<h;){const O=c[x];let z="",j="";O===99?(z=":",j=":"):O===108?z=":":O===114&&(j=":");let H=l.alignDelimiters===!1?1:Math.max(1,p[x]-z.length-j.length);const M=z+"-".repeat(H)+j;l.alignDelimiters!==!1&&(H=z.length+H+j.length,H>p[x]&&(p[x]=H),v[x]=H),S[x]=M}f.splice(1,0,S),m.splice(1,0,v),b=-1;const C=[];for(;++b<f.length;){const O=f[b],z=m[b];x=-1;const j=[];for(;++x<h;){const H=O[x]||"";let M="",K="";if(l.alignDelimiters!==!1){const re=p[x]-(z[x]||0),q=c[x];q===114?M=" ".repeat(re):q===99?re%2?(M=" ".repeat(re/2+.5),K=" ".repeat(re/2-.5)):(M=" ".repeat(re/2),K=M):K=" ".repeat(re)}l.delimiterStart!==!1&&!x&&j.push("|"),l.padding!==!1&&!(l.alignDelimiters===!1&&H==="")&&(l.delimiterStart!==!1||x)&&j.push(" "),l.alignDelimiters!==!1&&j.push(M),j.push(H),l.alignDelimiters!==!1&&j.push(K),l.padding!==!1&&j.push(" "),(l.delimiterEnd!==!1||x!==h-1)&&j.push("|")}C.push(l.delimiterEnd===!1?j.join("").replace(/ +$/,""):j.join(""))}return C.join(`
`)}function X3(t){return t==null?"":String(t)}function bg(t){const a=typeof t=="string"?t.codePointAt(0):0;return a===67||a===99?99:a===76||a===108?108:a===82||a===114?114:0}function J3(t,a,l,u){const s=l.enter("blockquote"),c=l.createTracker(u);c.move("> "),c.shift(2);const f=l.indentLines(l.containerFlow(t,c.current()),Q3);return s(),f}function Q3(t,a,l){return">"+(l?"":" ")+t}function Z3(t,a){return yg(t,a.inConstruct,!0)&&!yg(t,a.notInConstruct,!1)}function yg(t,a,l){if(typeof a=="string"&&(a=[a]),!a||a.length===0)return l;let u=-1;for(;++u<a.length;)if(t.includes(a[u]))return!0;return!1}function vg(t,a,l,u){let s=-1;for(;++s<l.unsafe.length;)if(l.unsafe[s].character===`
`&&Z3(l.stack,l.unsafe[s]))return/[ \t]/.test(u.before)?"":" ";return`\\
`}function K3(t,a){const l=String(t);let u=l.indexOf(a),s=u,c=0,f=0;if(typeof a!="string")throw new TypeError("Expected substring");for(;u!==-1;)u===s?++c>f&&(f=c):c=1,s=u+a.length,u=l.indexOf(a,s);return f}function W3(t,a){return!!(a.options.fences===!1&&t.value&&!t.lang&&/[^ \r\n]/.test(t.value)&&!/^[\t ]*(?:[\r\n]|$)|(?:^|[\r\n])[\t ]*$/.test(t.value))}function $3(t){const a=t.options.fence||"`";if(a!=="`"&&a!=="~")throw new Error("Cannot serialize code with `"+a+"` for `options.fence`, expected `` ` `` or `~`");return a}function eT(t,a,l,u){const s=$3(l),c=t.value||"",f=s==="`"?"GraveAccent":"Tilde";if(W3(t,l)){const x=l.enter("codeIndented"),S=l.indentLines(c,nT);return x(),S}const m=l.createTracker(u),p=s.repeat(Math.max(K3(c,s)+1,3)),h=l.enter("codeFenced");let b=m.move(p);if(t.lang){const x=l.enter(`codeFencedLang${f}`);b+=m.move(l.safe(t.lang,{before:b,after:" ",encode:["`"],...m.current()})),x()}if(t.lang&&t.meta){const x=l.enter(`codeFencedMeta${f}`);b+=m.move(" "),b+=m.move(l.safe(t.meta,{before:b,after:`
`,encode:["`"],...m.current()})),x()}return b+=m.move(`
`),c&&(b+=m.move(c+`
`)),b+=m.move(p),h(),b}function nT(t,a,l){return(l?"":"    ")+t}function mf(t){const a=t.options.quote||'"';if(a!=='"'&&a!=="'")throw new Error("Cannot serialize title with `"+a+"` for `options.quote`, expected `\"`, or `'`");return a}function tT(t,a,l,u){const s=mf(l),c=s==='"'?"Quote":"Apostrophe",f=l.enter("definition");let m=l.enter("label");const p=l.createTracker(u);let h=p.move("[");return h+=p.move(l.safe(l.associationId(t),{before:h,after:"]",...p.current()})),h+=p.move("]: "),m(),!t.url||/[\0- \u007F]/.test(t.url)?(m=l.enter("destinationLiteral"),h+=p.move("<"),h+=p.move(l.safe(t.url,{before:h,after:">",...p.current()})),h+=p.move(">")):(m=l.enter("destinationRaw"),h+=p.move(l.safe(t.url,{before:h,after:t.title?" ":`
`,...p.current()}))),m(),t.title&&(m=l.enter(`title${c}`),h+=p.move(" "+s),h+=p.move(l.safe(t.title,{before:h,after:s,...p.current()})),h+=p.move(s),m()),f(),h}function rT(t){const a=t.options.emphasis||"*";if(a!=="*"&&a!=="_")throw new Error("Cannot serialize emphasis with `"+a+"` for `options.emphasis`, expected `*`, or `_`");return a}function Ya(t){return"&#x"+t.toString(16).toUpperCase()+";"}function Ru(t,a,l){const u=Nl(t),s=Nl(a);return u===void 0?s===void 0?l==="_"?{inside:!0,outside:!0}:{inside:!1,outside:!1}:s===1?{inside:!0,outside:!0}:{inside:!1,outside:!0}:u===1?s===void 0?{inside:!1,outside:!1}:s===1?{inside:!0,outside:!0}:{inside:!1,outside:!1}:s===void 0?{inside:!1,outside:!1}:s===1?{inside:!0,outside:!1}:{inside:!1,outside:!1}}Dx.peek=lT;function Dx(t,a,l,u){const s=rT(l),c=l.enter("emphasis"),f=l.createTracker(u),m=f.move(s);let p=f.move(l.containerPhrasing(t,{after:s,before:m,...f.current()}));const h=p.charCodeAt(0),b=Ru(u.before.charCodeAt(u.before.length-1),h,s);b.inside&&(p=Ya(h)+p.slice(1));const x=p.charCodeAt(p.length-1),S=Ru(u.after.charCodeAt(0),x,s);S.inside&&(p=p.slice(0,-1)+Ya(x));const v=f.move(s);return c(),l.attentionEncodeSurroundingInfo={after:S.outside,before:b.outside},m+p+v}function lT(t,a,l){return l.options.emphasis||"*"}function aT(t,a){let l=!1;return df(t,function(u){if("value"in u&&/\r?\n|\r/.test(u.value)||u.type==="break")return l=!0,Hc}),!!((!t.depth||t.depth<3)&&lf(t)&&(a.options.setext||l))}function iT(t,a,l,u){const s=Math.max(Math.min(6,t.depth||1),1),c=l.createTracker(u);if(aT(t,l)){const b=l.enter("headingSetext"),x=l.enter("phrasing"),S=l.containerPhrasing(t,{...c.current(),before:`
`,after:`
`});return x(),b(),S+`
...
`,...c.current()});return/^[\t ]/.test(h)&&(h=Ya(h.charCodeAt(0))+h.slice(1)),h=h?f+" "+h:f,l.options.closeAtx&&(h+=" "+f),p(),m(),h}Rx.peek=uT;function Rx(t){return t.value||""}function uT(){return"<"}Ox.peek=sT;function Ox(t,a,l,u){const s=mf(l),c=s==='"'?"Quote":"Apostrophe",f=l.enter("image");let m=l.enter("label");const p=l.createTracker(u);let h=p.move("![");return h+=p.move(l.safe(t.alt,{before:h,after:"]",...p.current()})),h+=p.move("]("),m(),!t.url&&t.title||/[\0- \u007F]/.test(t.url)?(m=l.enter("destinationLiteral"),h+=p.move("<"),h+=p.move(l.safe(t.url,{before:h,after:">",...p.current()})),h+=p.move(">")):(m=l.enter("destinationRaw"),h+=p.move(l.safe(t.url,{before:h,after:t.title?" ":")",...p.current()}))),m(),t.title&&(m=l.enter(`title${c}`),h+=p.move(" "+s),h+=p.move(l.safe(t.title,{before:h,after:s,...p.current()})),h+=p.move(s),m()),h+=p.move(")"),f(),h}function sT(){return"!"}zx.peek=oT;function zx(t,a,l,u){const s=t.referenceType,c=l.enter("imageReference");let f=l.enter("label");const m=l.createTracker(u);let p=m.move("![");const h=l.safe(t.alt,{before:p,after:"]",...m.current()});p+=m.move(h+"]["),f();const b=l.stack;l.stack=[],f=l.enter("reference");const x=l.safe(l.associationId(t),{before:p,after:"]",...m.current()});return f(),l.stack=b,c(),s==="full"||!h||h!==x?p+=m.move(x+"]"):s==="shortcut"?p=p.slice(0,-1):p+=m.move("]"),p}function oT(){return"!"}Lx.peek=cT;function Lx(t,a,l){let u=t.value||"",s="`",c=-1;for(;new RegExp("(^|[^`])"+s+"([^`]|$)").test(u);)s+="`";for(/[^ \r\n]/.test(u)&&(/^[ \r\n]/.test(u)&&/[ \r\n]$/.test(u)||/^`|`$/.test(u))&&(u=" "+u+" ");++c<l.unsafe.length;){const f=l.unsafe[c],m=l.compilePattern(f);let p;if(f.atBreak)for(;p=m.exec(u);){let h=p.index;u.charCodeAt(h)===10&&u.charCodeAt(h-1)===13&&h--,u=u.slice(0,h)+" "+u.slice(p.index+1)}}return s+u+s}function cT(){return"`"}function Ux(t,a){const l=lf(t);return!!(!a.options.resourceLink&&t.url&&!t.title&&t.children&&t.children.length===1&&t.children[0].type==="text"&&(l===t.url||"mailto:"+l===t.url)&&/^[a-z][a-z+.-]+:/i.test(t.url)&&!/[\0- <>\u007F]/.test(t.url))}Bx.peek=fT;function Bx(t,a,l,u){const s=mf(l),c=s==='"'?"Quote":"Apostrophe",f=l.createTracker(u);let m,p;if(Ux(t,l)){const b=l.stack;l.stack=[],m=l.enter("autolink");let x=f.move("<");return x+=f.move(l.containerPhrasing(t,{before:x,after:">",...f.current()})),x+=f.move(">"),m(),l.stack=b,x}m=l.enter("link"),p=l.enter("label");let h=f.move("[");return h+=f.move(l.containerPhrasing(t,{before:h,after:"](",...f.current()})),h+=f.move("]("),p(),!t.url&&t.title||/[\0- \u007F]/.test(t.url)?(p=l.enter("destinationLiteral"),h+=f.move("<"),h+=f.move(l.safe(t.url,{before:h,after:">",...f.current()})),h+=f.move(">")):(p=l.enter("destinationRaw"),h+=f.move(l.safe(t.url,{before:h,after:t.title?" ":")",...f.current()}))),p(),t.title&&(p=l.enter(`title${c}`),h+=f.move(" "+s),h+=f.move(l.safe(t.title,{before:h,after:s,...f.current()})),h+=f.move(s),p()),h+=f.move(")"),m(),h}function fT(t,a,l){return Ux(t,l)?"<":"["}Hx.peek=dT;function Hx(t,a,l,u){const s=t.referenceType,c=l.enter("linkReference");let f=l.enter("label");const m=l.createTracker(u);let p=m.move("[");const h=l.containerPhrasing(t,{before:p,after:"]",...m.current()});p+=m.move(h+"]["),f();const b=l.stack;l.stack=[],f=l.enter("reference");const x=l.safe(l.associationId(t),{before:p,after:"]",...m.current()});return f(),l.stack=b,c(),s==="full"||!h||h!==x?p+=m.move(x+"]"):s==="shortcut"?p=p.slice(0,-1):p+=m.move("]"),p}function dT(){return"["}function pf(t){const a=t.options.bullet||"*";if(a!=="*"&&a!=="+"&&a!=="-")throw new Error("Cannot serialize items with `"+a+"` for `options.bullet`, expected `*`, `+`, or `-`");return a}function hT(t){const a=pf(t),l=t.options.bulletOther;if(!l)return a==="*"?"-":"*";if(l!=="*"&&l!=="+"&&l!=="-")throw new Error("Cannot serialize items with `"+l+"` for `options.bulletOther`, expected `*`, `+`, or `-`");if(l===a)throw new Error("Expected `bullet` (`"+a+"`) and `bulletOther` (`"+l+"`) to be different");return l}function mT(t){const a=t.options.bulletOrdered||".";if(a!=="."&&a!==")")throw new Error("Cannot serialize items with `"+a+"` for `options.bulletOrdered`, expected `.` or `)`");return a}function Ix(t){const a=t.options.rule||"*";if(a!=="*"&&a!=="-"&&a!=="_")throw new Error("Cannot serialize rules with `"+a+"` for `options.rule`, expected `*`, `-`, or `_`");return a}function pT(t,a,l,u){const s=l.enter("list"),c=l.bulletCurrent;let f=t.ordered?mT(l):pf(l);const m=t.ordered?f==="."?")":".":hT(l);let p=a&&l.bulletLastUsed?f===l.bulletLastUsed:!1;if(!t.ordered){const b=t.children?t.children[0]:void 0;if((f==="*"||f==="-")&&b&&(!b.children||!b.children[0])&&l.stack[l.stack.length-1]==="list"&&l.stack[l.stack.length-2]==="listItem"&&l.stack[l.stack.length-3]==="list"&&l.stack[l.stack.length-4]==="listItem"&&l.indexStack[l.indexStack.length-1]===0&&l.indexStack[l.indexStack.length-2]===0&&l.indexStack[l.indexStack.length-3]===0&&(p=!0),Ix(l)===f&&b){let x=-1;for(;++x<t.children.length;){const S=t.children[x];if(S&&S.type==="listItem"&&S.children&&S.children[0]&&S.children[0].type==="thematicBreak"){p=!0;break}}}}p&&(f=m),l.bulletCurrent=f;const h=l.containerFlow(t,u);return l.bulletLastUsed=f,l.bulletCurrent=c,s(),h}function gT(t){const a=t.options.listItemIndent||"one";if(a!=="tab"&&a!=="one"&&a!=="mixed")throw new Error("Cannot serialize items with `"+a+"` for `options.listItemIndent`, expected `tab`, `one`, or `mixed`");return a}function xT(t,a,l,u){const s=gT(l);let c=l.bulletCurrent||pf(l);a&&a.type==="list"&&a.ordered&&(c=(typeof a.start=="number"&&a.start>-1?a.start:1)+(l.options.incrementListMarker===!1?0:a.children.indexOf(t))+c);let f=c.length+1;(s==="tab"||s==="mixed"&&(a&&a.type==="list"&&a.spread||t.spread))&&(f=Math.ceil(f/4)*4);const m=l.createTracker(u);m.move(c+" ".repeat(f-c.length)),m.shift(f);const p=l.enter("listItem"),h=l.indentLines(l.containerFlow(t,m.current()),b);return p(),h;function b(x,S,v){return S?(v?"":" ".repeat(f))+x:(v?c:c+" ".repeat(f-c.length))+x}}function bT(t,a,l,u){const s=l.enter("paragraph"),c=l.enter("phrasing"),f=l.containerPhrasing(t,u);return c(),s(),f}const yT=Hu(["break","delete","emphasis","footnote","footnoteReference","image","imageReference","inlineCode","inlineMath","link","linkReference","mdxJsxTextElement","mdxTextExpression","strong","text","textDirective"]);function vT(t,a,l,u){return(t.children.some(function(f){return yT(f)})?l.containerPhrasing:l.containerFlow).call(l,t,u)}function ST(t){const a=t.options.strong||"*";if(a!=="*"&&a!=="_")throw new Error("Cannot serialize strong with `"+a+"` for `options.strong`, expected `*`, or `_`");return a}qx.peek=kT;function qx(t,a,l,u){const s=ST(l),c=l.enter("strong"),f=l.createTracker(u),m=f.move(s+s);let p=f.move(l.containerPhrasing(t,{after:s,before:m,...f.current()}));const h=p.charCodeAt(0),b=Ru(u.before.charCodeAt(u.before.length-1),h,s);b.inside&&(p=Ya(h)+p.slice(1));const x=p.charCodeAt(p.length-1),S=Ru(u.after.charCodeAt(0),x,s);S.inside&&(p=p.slice(0,-1)+Ya(x));const v=f.move(s+s);return c(),l.attentionEncodeSurroundingInfo={after:S.outside,before:b.outside},m+p+v}function kT(t,a,l){return l.options.strong||"*"}function wT(t,a,l,u){return l.safe(t.value,u)}function CT(t){const a=t.options.ruleRepetition||3;if(a<3)throw new Error("Cannot serialize rules with repetition `"+a+"` for `options.ruleRepetition`, expected `3` or more");return a}function TT(t,a,l){const u=(Ix(l)+(l.options.ruleSpaces?" ":"")).repeat(CT(l));return l.options.ruleSpaces?u.slice(0,-1):u}const Vx={blockquote:J3,break:vg,code:eT,definition:tT,emphasis:Dx,hardBreak:vg,heading:iT,html:Rx,image:Ox,imageReference:zx,inlineCode:Lx,link:Bx,linkReference:Hx,list:pT,listItem:xT,paragraph:bT,root:vT,strong:qx,text:wT,thematicBreak:TT};function ET(){return{enter:{table:AT,tableData:Sg,tableHeader:Sg,tableRow:NT},exit:{codeText:_T,table:jT,tableData:_c,tableHeader:_c,tableRow:_c}}}function AT(t){const a=t._align;this.enter({type:"table",align:a.map(function(l){return l==="none"?null:l}),children:[]},t),this.data.inTable=!0}function jT(t){this.exit(t),this.data.inTable=void 0}function NT(t){this.enter({type:"tableRow",children:[]},t)}function _c(t){this.exit(t)}function Sg(t){this.enter({type:"tableCell",children:[]},t)}function _T(t){let a=this.resume();this.data.inTable&&(a=a.replace(/\\([\\|])/g,MT));const l=this.stack[this.stack.length-1];l.type,l.value=a,this.exit(t)}function MT(t,a){return a==="|"?a:t}function DT(t){const a=t||{},l=a.tableCellPadding,u=a.tablePipeAlign,s=a.stringLength,c=l?" ":"|";return{unsafe:[{character:"\r",inConstruct:"tableCell"},{character:`
...
`);let c=!1;const f=[];for(const m of s){const p=m.trimEnd();if(p.trimStart().startsWith("```")){c=!c;continue}if(c)continue;const h=/^(#{1,6})\s+(.+?)\s*$/.exec(p);if(!h)continue;const b=h[1].length;if(b<a||b>l)continue;const x=h[2].replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/[*_`]/g,"").trim(),S=u(x);f.push({id:S,text:x,level:b})}return f}const vE=({toc:t,activeId:a,onClickItem:l})=>t.length?g.jsx("aside",{className:"fixed left-[calc(50%+870px/2+48px)] top-[calc(var(--header-height)+48px)] hidden xl:block w-56 2xl:w-64 h-[calc(100vh-var(--header-height)-96px)] overflow-y-auto overflow-x-hidden",children:g.jsx("div",{className:"border-l border-(--border-subtle) pl-4 pr-2",children:g.jsx("nav",{"aria-label":"Table of contents",children:g.jsx("ul",{className:"space-y-2",children:t.map(u=>{const s=u.id===a,c=u.level===1?"pl-0":u.level===2?"pl-3":"pl-6";return g.jsx("li",{className:c,children:g.jsxs("button",{type:"button",onClick:()=>l(u.id),className:["group relative block w-full text-left cursor-pointer","text-[13px] leading-[1.65]","transition-all duration-200 origin-left","focus:outline-none focus-visible:ring-2 focus-visible:ring-(--accent)/60 focus-visible:ring-offset-2 focus-visible:ring-offset-(--bg-base)",s?"text-(--fg-base) scale-110":"text-gray-500 hover:text-gray-500/80 hover:scale-105"].join(" "),children:[g.jsx("span",{className:["absolute -left-[22px] top-[9px] h-1.5 w-1.5 rounded-full","bg-(--fg-base)","transition-opacity duration-200",s?"opacity-100":"opacity-0 group-hover:opacity-60"].join(" ")}),u.text]})},u.id)})})})})}):null,Cg=({dir:t})=>g.jsx("span",{className:["shrink-0 w-11 h-11 rounded-full flex items-center justify-center","border border-green-400 text-green-400","bg-transparent group-hover:bg-green-400/10","transition-colors duration-200"].join(" "),children:g.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:t==="left"?g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"}):g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})}),Tg=({children:t,align:a,onClick:l})=>g.jsxs("button",{type:"button",onClick:l,className:["group relative w-full overflow-hidden rounded-2xl","border border-white/10","bg-white/5 hover:bg-white/8","transition-colors duration-200","focus:outline-none focus-visible:ring-2 focus-visible:ring-(--accent)/60 focus-visible:ring-offset-2 focus-visible:ring-offset-(--bg-base)",a==="left"?"text-left":"text-right"].join(" "),children:[g.jsx("span",{className:"pointer-events-none absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-200",children:g.jsx("span",{className:"absolute inset-0 bg-gradient-to-r from-(--accent)/0 via-(--accent)/10 to-(--accent)/0"})}),g.jsx("div",{className:"relative p-6 cursor-pointer",children:t})]}),SE=({prevPost:t,nextPost:a,onNavigate:l})=>!t&&!a?null:g.jsx("nav",{className:"mt-16 pt-8 border-t border-(--border-subtle)",children:g.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[g.jsx("div",{className:"md:col-span-1 h-[88px]",children:t?g.jsx(Tg,{align:"left",onClick:()=>l(t.slug),children:g.jsxs("div",{className:"flex items-center justify-between gap-4 h-full",children:[g.jsx(Cg,{dir:"left"}),g.jsxs("div",{className:"min-w-0",children:[g.jsx("div",{className:"text-[12px] font-semibold text-fg-muted mb-1",children:"이전 포스트"}),g.jsx("h3",{className:`\r
               ...
               transition-all duration-150 ease-out`,children:[g.jsx("div",{className:`w-9 h-9 rounded-full bg-(--bg-elevated) border border-(--border-subtle)\r
                   ...
                   group-hover:translate-y-0.5 transition-transform`}):g.jsx(_E,{className:`w-4 h-4 text-fg-muted group-hover:text-fg transition-colors shrink-0\r
                  ...
                  [html[data-theme='light']_&]:bg-[#f5f5fb]`,children:[g.jsx("div",{className:`w-10 h-10 rounded-full bg-(--bg-elevated) border border-(--border-subtle)\r
                    flex items-center justify-center shrink-0`,children:t}),g.jsxs("div",{className:"min-w-0",children:[g.jsx("p",{className:"text-[12px] font-medium text-fg",children:a}),g.jsx("p",{className:"text-[14px] font-semibold text-fg mt-1",children:l}),g.jsx("p",{className:"text-[12px] text-fg-muted mt-1 leading-relaxed",children:u})]})]}),jE=()=>g.jsx("svg",{className:"w-4 h-4 text-fg-muted",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"})}),NE=()=>g.jsxs("svg",{className:"w-4 h-4 text-fg-muted",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:[g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"}),g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M15 11a3 3 0 11-6 0 3 3 0 016 0z"})]}),_E=({className:t})=>g.jsxs("svg",{className:t??"",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:[g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M7 17L17 7"}),g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M10 7h7v7"})]}),ME=({className:t})=>g.jsxs("svg",{className:t??"",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:[g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M12 4v12m0 0l-4-4m4 4l4-4"}),g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M4 17v2a1 1 0 001 1h14a1 1 0 001-1v-2"})]}),DE=()=>g.jsx("svg",{className:"w-4 h-4 text-fg-muted",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"})}),RE=()=>g.jsxs("svg",{className:"w-4 h-4 text-fg-muted",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:[g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M3 8l9 6 9-6"}),g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M5 6h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2z"})]}),OE=()=>g.jsx("svg",{className:"w-4 h-4 text-fg-muted",viewBox:"0 0 24 24",fill:"currentColor",children:g.jsx("path",{d:"M12 .5A12 12 0 0 0 0 12.7c0 5.4 3.4 10 8.2 11.6.6.1.8-.3.8-.6v-2.2c-3.3.7-4-1.5-4-1.5-.6-1.6-1.5-2-1.5-2-1.2-.9.1-.9.1-.9 1.3.1 2 .9 2 .9 1.2 2.1 3.1 1.5 3.9 1.1.1-.9.5-1.5.8-1.9-2.7-.3-5.5-1.4-5.5-6.1 0-1.3.4-2.3 1.1-3.2-.1-.3-.5-1.5.1-3.1 0 0 .9-.3 3.1 1.2.9-.3 1.9-.4 2.9-.4s2 .1 2.9.4c2.2-1.5 3.1-1.2 3.1-1.2.6 1.6.2 2.8.1 3.1.7.9 1.1 1.9 1.1 3.2 0 4.7-2.8 5.8-5.5 6.1.5.4.9 1.2.9 2.4v3.5c0 .3.2.7.8.6A12.2 12.2 0 0 0 24 12.7 12 12 0 0 0 12 .5Z"})}),zE=()=>g.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"15",height:"15",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round",className:"lucide lucide-newspaper-icon lucide-newspaper",children:[g.jsx("path",{d:"M15 18h-5"}),g.jsx("path",{d:"M18 14h-8"}),g.jsx("path",{d:"M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-4 0v-9a2 2 0 0 1 2-2h2"}),g.jsx("rect",{width:"8",height:"4",x:"10",y:"6",rx:"1"})]}),LE=({className:t})=>g.jsxs("svg",{className:t??"w-4 h-4",viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",children:[g.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"6",stroke:"currentColor",strokeWidth:"1.6"}),g.jsx("path",{d:"M8 16V8l8 8V8",stroke:"currentColor",strokeWidth:"2.2",strokeLinecap:"round",strokeLinejoin:"round"})]}),UE=()=>{const[t,a]=D.useState(()=>{if(typeof window>"u")return"dark";try{return localStorage.getItem("portfolio-theme")||"dark"}catch{return"dark"}});D.useEffect(()=>{if(!(typeof document>"u")){document.documentElement.setAttribute("data-theme",t);try{localStorage.setItem("portfolio-theme",t)}catch{}}},[t]);const l=D.useCallback(()=>{a(c=>c==="dark"?"light":"dark")},[]),u=D.useCallback(c=>{const f=document.getElementById(c);if(f){const b=f.getBoundingClientRect().top+window.pageYOffset-64-20;window.scrollTo({top:b,behavior:"smooth"})}},[]),s="/portfolio/".replace(/\/$/,"");return g.jsxs(Uy,{basename:s===""?void 0:s,children:[g.jsx($y,{}),g.jsx(Xy,{theme:t,onToggleTheme:l,onNavClick:u}),g.jsxs(my,{children:[g.jsx(Ua,{path:"/",element:g.jsx(PS,{})}),g.jsx(Ua,{path:"/blog",element:g.jsx(JS,{})}),g.jsx(Ua,{path:"/blog/:slug",element:g.jsx(wE,{})}),g.jsx(Ua,{path:"/contact",element:g.jsx(AE,{})})]}),g.jsx(Wy,{})]})};S1.createRoot(document.getElementById("root")).render(g.jsx(UE,{}));
