...
`,Ov=`HTML/CSS/JS는 아는데… 그래서 “웹”이 어떻게 화면이 되는 건데?\r
\r
...
`});const h={type:"element",tagName:"li",properties:c,children:f};return t.patch(a,h),t.applyData(a,h)}function e3(t){let a=!1;if(t.type==="list"){a=t.spread||!1;const l=t.children;let u=-1;for(;!a&&++u<l.length;)a=Sx(l[u])}return a}function Sx(t){const a=t.spread;return a??t.children.length>1}function n3(t,a){const l={},u=t.all(a);let s=-1;for(typeof a.start=="number"&&a.start!==1&&(l.start=a.start);++s<u.length;){const f=u[s];if(f.type==="element"&&f.tagName==="li"&&f.properties&&Array.isArray(f.properties.className)&&f.properties.className.includes("task-list-item")){l.className=["contains-task-list"];break}}const c={type:"element",tagName:a.ordered?"ol":"ul",properties:l,children:t.wrap(u,!0)};return t.patch(a,c),t.applyData(a,c)}function t3(t,a){const l={type:"element",tagName:"p",properties:{},children:t.all(a)};return t.patch(a,l),t.applyData(a,l)}function r3(t,a){const l={type:"root",children:t.wrap(t.all(a))};return t.patch(a,l),t.applyData(a,l)}function l3(t,a){const l={type:"element",tagName:"strong",properties:{},children:t.all(a)};return t.patch(a,l),t.applyData(a,l)}function a3(t,a){const l=t.all(a),u=l.shift(),s=[];if(u){const f={type:"element",tagName:"thead",properties:{},children:t.wrap([u],!0)};t.patch(a.children[0],f),s.push(f)}if(l.length>0){const f={type:"element",tagName:"tbody",properties:{},children:t.wrap(l,!0)},m=ef(a.children[1]),p=ex(a.children[a.children.length-1]);m&&p&&(f.position={start:m,end:p}),s.push(f)}const c={type:"element",tagName:"table",properties:{},children:t.wrap(s,!0)};return t.patch(a,c),t.applyData(a,c)}function i3(t,a,l){const u=l?l.children:void 0,c=(u?u.indexOf(a):1)===0?"th":"td",f=l&&l.type==="table"?l.align:void 0,m=f?f.length:a.children.length;let p=-1;const h=[];for(;++p<m;){const x=a.children[p],S={},v=f?f[p]:void 0;v&&(S.align=v);let C={type:"element",tagName:c,properties:S,children:[]};x&&(C.children=t.all(x),t.patch(x,C),C=t.applyData(x,C)),h.push(C)}const b={type:"element",tagName:"tr",properties:{},children:t.wrap(h,!0)};return t.patch(a,b),t.applyData(a,b)}function u3(t,a){const l={type:"element",tagName:"td",properties:{},children:t.all(a)};return t.patch(a,l),t.applyData(a,l)}const tg=9,rg=32;function s3(t){const a=String(t),l=/\r?\n|\r/g;let u=l.exec(a),s=0;const c=[];for(;u;)c.push(lg(a.slice(s,u.index),s>0,!0),u[0]),s=u.index+u[0].length,u=l.exec(a);return c.push(lg(a.slice(s),s>0,!1)),c.join("")}function lg(t,a,l){let u=0,s=t.length;if(a){let c=t.codePointAt(u);for(;c===tg||c===rg;)u++,c=t.codePointAt(u)}if(l){let c=t.codePointAt(s-1);for(;c===tg||c===rg;)s--,c=t.codePointAt(s-1)}return s>u?t.slice(u,s):""}function o3(t,a){const l={type:"text",value:s3(String(a.value))};return t.patch(a,l),t.applyData(a,l)}function c3(t,a){const l={type:"element",tagName:"hr",properties:{},children:[]};return t.patch(a,l),t.applyData(a,l)}const f3={blockquote:Iw,break:qw,code:Vw,delete:Fw,emphasis:Gw,footnoteReference:Yw,heading:Pw,html:Xw,imageReference:Qw,image:Jw,inlineCode:Zw,linkReference:Kw,link:Ww,listItem:$w,list:n3,paragraph:t3,root:r3,strong:l3,table:a3,tableCell:u3,tableRow:i3,text:o3,thematicBreak:c3,toml:vu,yaml:vu,definition:vu,footnoteDefinition:vu};function vu(){}const kx=-1,Bu=0,qa=1,_u=2,sf=3,of=4,cf=5,ff=6,wx=7,Cx=8,ag=typeof self=="object"?self:globalThis,d3=(t,a)=>{const l=(s,c)=>(t.set(c,s),s),u=s=>{if(t.has(s))return t.get(s);const[c,f]=a[s];switch(c){case Bu:case kx:return l(f,s);case qa:{const m=l([],s);for(const p of f)m.push(u(p));return m}case _u:{const m=l({},s);for(const[p,h]of f)m[u(p)]=u(h);return m}case sf:return l(new Date(f),s);case of:{const{source:m,flags:p}=f;return l(new RegExp(m,p),s)}case cf:{const m=l(new Map,s);for(const[p,h]of f)m.set(u(p),u(h));return m}case ff:{const m=l(new Set,s);for(const p of f)m.add(u(p));return m}case wx:{const{name:m,message:p}=f;return l(new ag[m](p),s)}case Cx:return l(BigInt(f),s);case"BigInt":return l(Object(BigInt(f)),s);case"ArrayBuffer":return l(new Uint8Array(f).buffer,f);case"DataView":{const{buffer:m}=new Uint8Array(f);return l(new DataView(m),f)}}return l(new ag[c](f),s)};return u},ig=t=>d3(new Map,t)(0),El="",{toString:h3}={},{keys:m3}=Object,za=t=>{const a=typeof t;if(a!=="object"||!t)return[Bu,a];const l=h3.call(t).slice(8,-1);switch(l){case"Array":return[qa,El];case"Object":return[_u,El];case"Date":return[sf,El];case"RegExp":return[of,El];case"Map":return[cf,El];case"Set":return[ff,El];case"DataView":return[qa,l]}return l.includes("Array")?[qa,l]:l.includes("Error")?[wx,l]:[_u,l]},Su=([t,a])=>t===Bu&&(a==="function"||a==="symbol"),p3=(t,a,l,u)=>{const s=(f,m)=>{const p=u.push(f)-1;return l.set(m,p),p},c=f=>{if(l.has(f))return l.get(f);let[m,p]=za(f);switch(m){case Bu:{let b=f;switch(p){case"bigint":m=Cx,b=f.toString();break;case"function":case"symbol":if(t)throw new TypeError("unable to serialize "+p);b=null;break;case"undefined":return s([kx],f)}return s([m,b],f)}case qa:{if(p){let S=f;return p==="DataView"?S=new Uint8Array(f.buffer):p==="ArrayBuffer"&&(S=new Uint8Array(f)),s([p,[...S]],f)}const b=[],x=s([m,b],f);for(const S of f)b.push(c(S));return x}case _u:{if(p)switch(p){case"BigInt":return s([p,f.toString()],f);case"Boolean":case"Number":case"String":return s([p,f.valueOf()],f)}if(a&&"toJSON"in f)return c(f.toJSON());const b=[],x=s([m,b],f);for(const S of m3(f))(t||!Su(za(f[S])))&&b.push([c(S),c(f[S])]);return x}case sf:return s([m,f.toISOString()],f);case of:{const{source:b,flags:x}=f;return s([m,{source:b,flags:x}],f)}case cf:{const b=[],x=s([m,b],f);for(const[S,v]of f)(t||!(Su(za(S))||Su(za(v))))&&b.push([c(S),c(v)]);return x}case ff:{const b=[],x=s([m,b],f);for(const S of f)(t||!Su(za(S)))&&b.push(c(S));return x}}const{message:h}=f;return s([m,{name:p,message:h}],f)};return c},ug=(t,{json:a,lossy:l}={})=>{const u=[];return p3(!(a||l),!!a,new Map,u)(t),u},Du=typeof structuredClone=="function"?(t,a)=>a&&("json"in a||"lossy"in a)?ig(ug(t,a)):structuredClone(t):(t,a)=>ig(ug(t,a));function g3(t,a){const l=[{type:"text",value:"↩"}];return a>1&&l.push({type:"element",tagName:"sup",properties:{},children:[{type:"text",value:String(a)}]}),l}function x3(t,a){return"Back to reference "+(t+1)+(a>1?"-"+a:"")}function b3(t){const a=typeof t.options.clobberPrefix=="string"?t.options.clobberPrefix:"user-content-",l=t.options.footnoteBackContent||g3,u=t.options.footnoteBackLabel||x3,s=t.options.footnoteLabel||"Footnotes",c=t.options.footnoteLabelTagName||"h2",f=t.options.footnoteLabelProperties||{className:["sr-only"]},m=[];let p=-1;for(;++p<t.footnoteOrder.length;){const h=t.footnoteById.get(t.footnoteOrder[p]);if(!h)continue;const b=t.all(h),x=String(h.identifier).toUpperCase(),S=Rl(x.toLowerCase());let v=0;const C=[],O=t.footnoteCounts.get(x);for(;O!==void 0&&++v<=O;){C.length>0&&C.push({type:"text",value:" "});let H=typeof l=="string"?l:l(p,v);typeof H=="string"&&(H={type:"text",value:H}),C.push({type:"element",tagName:"a",properties:{href:"#"+a+"fnref-"+S+(v>1?"-"+v:""),dataFootnoteBackref:"",ariaLabel:typeof u=="string"?u:u(p,v),className:["data-footnote-backref"]},children:Array.isArray(H)?H:[H]})}const z=b[b.length-1];if(z&&z.type==="element"&&z.tagName==="p"){const H=z.children[z.children.length-1];H&&H.type==="text"?H.value+=" ":z.children.push({type:"text",value:" "}),z.children.push(...C)}else b.push(...C);const j={type:"element",tagName:"li",properties:{id:a+"fn-"+S},children:t.wrap(b,!0)};t.patch(h,j),m.push(j)}if(m.length!==0)return{type:"element",tagName:"section",properties:{dataFootnotes:!0,className:["footnotes"]},children:[{type:"element",tagName:c,properties:{...Du(f),id:"footnote-label"},children:[{type:"text",value:s}]},{type:"text",value:`
`},{type:"element",tagName:"ol",properties:{},children:t.wrap(m,!0)},{type:"text",value:`
`}]}}const Hu=(function(t){if(t==null)return k3;if(typeof t=="function")return Iu(t);if(typeof t=="object")return Array.isArray(t)?y3(t):v3(t);if(typeof t=="string")return S3(t);throw new Error("Expected function, string, or object as test")});function y3(t){const a=[];let l=-1;for(;++l<t.length;)a[l]=Hu(t[l]);return Iu(u);function u(...s){let c=-1;for(;++c<a.length;)if(a[c].apply(this,s))return!0;return!1}}function v3(t){const a=t;return Iu(l);function l(u){const s=u;let c;for(c in t)if(s[c]!==a[c])return!1;return!0}}function S3(t){return Iu(a);function a(l){return l&&l.type===t}}function Iu(t){return a;function a(l,u,s){return!!(w3(l)&&t.call(this,l,typeof u=="number"?u:void 0,s||void 0))}}function k3(){return!0}function w3(t){return t!==null&&typeof t=="object"&&"type"in t}const Tx=[],C3=!0,Hc=!1,T3="skip";function Ex(t,a,l,u){let s;typeof a=="function"&&typeof l!="function"?(u=l,l=a):s=a;const c=Hu(s),f=u?-1:1;m(t,void 0,[])();function m(p,h,b){const x=p&&typeof p=="object"?p:{};if(typeof x.type=="string"){const v=typeof x.tagName=="string"?x.tagName:typeof x.name=="string"?x.name:void 0;Object.defineProperty(S,"name",{value:"node ("+(p.type+(v?"<"+v+">":""))+")"})}return S;function S(){let v=Tx,C,O,z;if((!a||c(p,h,b[b.length-1]||void 0))&&(v=E3(l(p,b)),v[0]===Hc))return v;if("children"in p&&p.children){const j=p;if(j.children&&v[0]!==T3)for(O=(u?j.children.length:-1)+f,z=b.concat(j);O>-1&&O<j.children.length;){const H=j.children[O];if(C=m(H,O,z)(),C[0]===Hc)return C;O=typeof C[1]=="number"?C[1]:O+f}}return v}}}function E3(t){return Array.isArray(t)?t:typeof t=="number"?[C3,t]:t==null?Tx:[t]}function df(t,a,l,u){let s,c,f;typeof a=="function"&&typeof l!="function"?(c=void 0,f=a,s=l):(c=a,f=l,s=u),Ex(t,c,m,s);function m(p,h){const b=h[h.length-1],x=b?b.children.indexOf(p):void 0;return f(p,x,b)}}const Ic={}.hasOwnProperty,A3={};function j3(t,a){const l=a||A3,u=new Map,s=new Map,c=new Map,f={...f3,...l.handlers},m={all:h,applyData:M3,definitionById:u,footnoteById:s,footnoteCounts:c,footnoteOrder:[],handlers:f,one:p,options:l,patch:N3,wrap:D3};return df(t,function(b){if(b.type==="definition"||b.type==="footnoteDefinition"){const x=b.type==="definition"?u:s,S=String(b.identifier).toUpperCase();x.has(S)||x.set(S,b)}}),m;function p(b,x){const S=b.type,v=m.handlers[S];if(Ic.call(m.handlers,S)&&v)return v(m,b,x);if(m.options.passThrough&&m.options.passThrough.includes(S)){if("children"in b){const{children:O,...z}=b,j=Du(z);return j.children=m.all(b),j}return Du(b)}return(m.options.unknownHandler||_3)(m,b,x)}function h(b){const x=[];if("children"in b){const S=b.children;let v=-1;for(;++v<S.length;){const C=m.one(S[v],b);if(C){if(v&&S[v-1].type==="break"&&(!Array.isArray(C)&&C.type==="text"&&(C.value=sg(C.value)),!Array.isArray(C)&&C.type==="element")){const O=C.children[0];O&&O.type==="text"&&(O.value=sg(O.value))}Array.isArray(C)?x.push(...C):x.push(C)}}}return x}}function N3(t,a){t.position&&(a.position=x2(t))}function M3(t,a){let l=a;if(t&&t.data){const u=t.data.hName,s=t.data.hChildren,c=t.data.hProperties;if(typeof u=="string")if(l.type==="element")l.tagName=u;else{const f="children"in l?l.children:[l];l={type:"element",tagName:u,properties:{},children:f}}l.type==="element"&&c&&Object.assign(l.properties,Du(c)),"children"in l&&l.children&&s!==null&&s!==void 0&&(l.children=s)}return l}function _3(t,a){const l=a.data||{},u="value"in a&&!(Ic.call(l,"hProperties")||Ic.call(l,"hChildren"))?{type:"text",value:a.value}:{type:"element",tagName:"div",properties:{},children:t.all(a)};return t.patch(a,u),t.applyData(a,u)}function D3(t,a){const l=[];let u=-1;for(a&&l.push({type:"text",value:`
`});++u<t.length;)u&&l.push({type:"text",value:`
`}),l.push(t[u]);return a&&t.length>0&&l.push({type:"text",value:`
`}),l}function sg(t){let a=0,l=t.charCodeAt(a);for(;l===9||l===32;)a++,l=t.charCodeAt(a);return t.slice(a)}function og(t,a){const l=j3(t,a),u=l.one(t,void 0),s=b3(l),c=Array.isArray(u)?{type:"root",children:u}:u||{type:"root",children:[]};return s&&c.children.push({type:"text",value:`
`},s),c}function R3(t,a){return t&&"run"in t?async function(l,u){const s=og(l,{file:u,...a});await t.run(s,u)}:function(l,u){return og(l,{file:u,...t||a})}}function cg(t){if(t)throw t}var yc,fg;function O3(){if(fg)return yc;fg=1;var t=Object.prototype.hasOwnProperty,a=Object.prototype.toString,l=Object.defineProperty,u=Object.getOwnPropertyDescriptor,s=function(h){return typeof Array.isArray=="function"?Array.isArray(h):a.call(h)==="[object Array]"},c=function(h){if(!h||a.call(h)!=="[object Object]")return!1;var b=t.call(h,"constructor"),x=h.constructor&&h.constructor.prototype&&t.call(h.constructor.prototype,"isPrototypeOf");if(h.constructor&&!b&&!x)return!1;var S;for(S in h);return typeof S>"u"||t.call(h,S)},f=function(h,b){l&&b.name==="__proto__"?l(h,b.name,{enumerable:!0,configurable:!0,value:b.newValue,writable:!0}):h[b.name]=b.newValue},m=function(h,b){if(b==="__proto__")if(t.call(h,b)){if(u)return u(h,b).value}else return;return h[b]};return yc=function p(){var h,b,x,S,v,C,O=arguments[0],z=1,j=arguments.length,H=!1;for(typeof O=="boolean"&&(H=O,O=arguments[1]||{},z=2),(O==null||typeof O!="object"&&typeof O!="function")&&(O={});z<j;++z)if(h=arguments[z],h!=null)for(b in h)x=m(O,b),S=m(h,b),O!==S&&(H&&S&&(c(S)||(v=s(S)))?(v?(v=!1,C=x&&s(x)?x:[]):C=x&&c(x)?x:{},f(O,{name:b,newValue:p(H,C,S)})):typeof S<"u"&&f(O,{name:b,newValue:S}));return O},yc}var z3=O3();const vc=Yc(z3);function qc(t){if(typeof t!="object"||t===null)return!1;const a=Object.getPrototypeOf(t);return(a===null||a===Object.prototype||Object.getPrototypeOf(a)===null)&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)}function L3(){const t=[],a={run:l,use:u};return a;function l(...s){let c=-1;const f=s.pop();if(typeof f!="function")throw new TypeError("Expected function as last argument, not "+f);m(null,...s);function m(p,...h){const b=t[++c];let x=-1;if(p){f(p);return}for(;++x<s.length;)(h[x]===null||h[x]===void 0)&&(h[x]=s[x]);s=h,b?U3(b,m)(...h):f(null,...h)}}function u(s){if(typeof s!="function")throw new TypeError("Expected `middelware` to be a function, not "+s);return t.push(s),a}}function U3(t,a){let l;return u;function u(...f){const m=t.length>f.length;let p;m&&f.push(s);try{p=t.apply(this,f)}catch(h){const b=h;if(m&&l)throw b;return s(b)}m||(p&&p.then&&typeof p.then=="function"?p.then(c,s):p instanceof Error?s(p):c(p))}function s(f,...m){l||(l=!0,a(f,...m))}function c(f){s(null,f)}}const mt={basename:B3,dirname:H3,extname:I3,join:q3,sep:"/"};function B3(t,a){if(a!==void 0&&typeof a!="string")throw new TypeError('"ext" argument must be a string');Wa(t);let l=0,u=-1,s=t.length,c;if(a===void 0||a.length===0||a.length>t.length){for(;s--;)if(t.codePointAt(s)===47){if(c){l=s+1;break}}else u<0&&(c=!0,u=s+1);return u<0?"":t.slice(l,u)}if(a===t)return"";let f=-1,m=a.length-1;for(;s--;)if(t.codePointAt(s)===47){if(c){l=s+1;break}}else f<0&&(c=!0,f=s+1),m>-1&&(t.codePointAt(s)===a.codePointAt(m--)?m<0&&(u=s):(m=-1,u=f));return l===u?u=f:u<0&&(u=t.length),t.slice(l,u)}function H3(t){if(Wa(t),t.length===0)return".";let a=-1,l=t.length,u;for(;--l;)if(t.codePointAt(l)===47){if(u){a=l;break}}else u||(u=!0);return a<0?t.codePointAt(0)===47?"/":".":a===1&&t.codePointAt(0)===47?"//":t.slice(0,a)}function I3(t){Wa(t);let a=t.length,l=-1,u=0,s=-1,c=0,f;for(;a--;){const m=t.codePointAt(a);if(m===47){if(f){u=a+1;break}continue}l<0&&(f=!0,l=a+1),m===46?s<0?s=a:c!==1&&(c=1):s>-1&&(c=-1)}return s<0||l<0||c===0||c===1&&s===l-1&&s===u+1?"":t.slice(s,l)}function q3(...t){let a=-1,l;for(;++a<t.length;)Wa(t[a]),t[a]&&(l=l===void 0?t[a]:l+"/"+t[a]);return l===void 0?".":V3(l)}function V3(t){Wa(t);const a=t.codePointAt(0)===47;let l=F3(t,!a);return l.length===0&&!a&&(l="."),l.length>0&&t.codePointAt(t.length-1)===47&&(l+="/"),a?"/"+l:l}function F3(t,a){let l="",u=0,s=-1,c=0,f=-1,m,p;for(;++f<=t.length;){if(f<t.length)m=t.codePointAt(f);else{if(m===47)break;m=47}if(m===47){if(!(s===f-1||c===1))if(s!==f-1&&c===2){if(l.length<2||u!==2||l.codePointAt(l.length-1)!==46||l.codePointAt(l.length-2)!==46){if(l.length>2){if(p=l.lastIndexOf("/"),p!==l.length-1){p<0?(l="",u=0):(l=l.slice(0,p),u=l.length-1-l.lastIndexOf("/")),s=f,c=0;continue}}else if(l.length>0){l="",u=0,s=f,c=0;continue}}a&&(l=l.length>0?l+"/..":"..",u=2)}else l.length>0?l+="/"+t.slice(s+1,f):l=t.slice(s+1,f),u=f-s-1;s=f,c=0}else m===46&&c>-1?c++:c=-1}return l}function Wa(t){if(typeof t!="string")throw new TypeError("Path must be a string. Received "+JSON.stringify(t))}const G3={cwd:Y3};function Y3(){return"/"}function Vc(t){return!!(t!==null&&typeof t=="object"&&"href"in t&&t.href&&"protocol"in t&&t.protocol&&t.auth===void 0)}function P3(t){if(typeof t=="string")t=new URL(t);else if(!Vc(t)){const a=new TypeError('The "path" argument must be of type string or an instance of URL. Received `'+t+"`");throw a.code="ERR_INVALID_ARG_TYPE",a}if(t.protocol!=="file:"){const a=new TypeError("The URL must be of scheme file");throw a.code="ERR_INVALID_URL_SCHEME",a}return X3(t)}function X3(t){if(t.hostname!==""){const u=new TypeError('File URL host must be "localhost" or empty on darwin');throw u.code="ERR_INVALID_FILE_URL_HOST",u}const a=t.pathname;let l=-1;for(;++l<a.length;)if(a.codePointAt(l)===37&&a.codePointAt(l+1)===50){const u=a.codePointAt(l+2);if(u===70||u===102){const s=new TypeError("File URL path must not include encoded / characters");throw s.code="ERR_INVALID_FILE_URL_PATH",s}}return decodeURIComponent(a)}const Sc=["history","path","basename","stem","extname","dirname"];class Ax{constructor(a){let l;a?Vc(a)?l={path:a}:typeof a=="string"||Q3(a)?l={value:a}:l=a:l={},this.cwd="cwd"in l?"":G3.cwd(),this.data={},this.history=[],this.messages=[],this.value,this.map,this.result,this.stored;let u=-1;for(;++u<Sc.length;){const c=Sc[u];c in l&&l[c]!==void 0&&l[c]!==null&&(this[c]=c==="history"?[...l[c]]:l[c])}let s;for(s in l)Sc.includes(s)||(this[s]=l[s])}get basename(){return typeof this.path=="string"?mt.basename(this.path):void 0}set basename(a){wc(a,"basename"),kc(a,"basename"),this.path=mt.join(this.dirname||"",a)}get dirname(){return typeof this.path=="string"?mt.dirname(this.path):void 0}set dirname(a){dg(this.basename,"dirname"),this.path=mt.join(a||"",this.basename)}get extname(){return typeof this.path=="string"?mt.extname(this.path):void 0}set extname(a){if(kc(a,"extname"),dg(this.dirname,"extname"),a){if(a.codePointAt(0)!==46)throw new Error("`extname` must start with `.`");if(a.includes(".",1))throw new Error("`extname` cannot contain multiple dots")}this.path=mt.join(this.dirname,this.stem+(a||""))}get path(){return this.history[this.history.length-1]}set path(a){Vc(a)&&(a=P3(a)),wc(a,"path"),this.path!==a&&this.history.push(a)}get stem(){return typeof this.path=="string"?mt.basename(this.path,this.extname):void 0}set stem(a){wc(a,"stem"),kc(a,"stem"),this.path=mt.join(this.dirname||"",a+(this.extname||""))}fail(a,l,u){const s=this.message(a,l,u);throw s.fatal=!0,s}info(a,l,u){const s=this.message(a,l,u);return s.fatal=void 0,s}message(a,l,u){const s=new xn(a,l,u);return this.path&&(s.name=this.path+":"+s.name,s.file=this.path),s.fatal=!1,this.messages.push(s),s}toString(a){return this.value===void 0?"":typeof this.value=="string"?this.value:new TextDecoder(a||void 0).decode(this.value)}}function kc(t,a){if(t&&t.includes(mt.sep))throw new Error("`"+a+"` cannot be a path: did not expect `"+mt.sep+"`")}function wc(t,a){if(!t)throw new Error("`"+a+"` cannot be empty")}function dg(t,a){if(!t)throw new Error("Setting `"+a+"` requires `path` to be set too")}function Q3(t){return!!(t&&typeof t=="object"&&"byteLength"in t&&"byteOffset"in t)}const J3=(function(t){const u=this.constructor.prototype,s=u[t],c=function(){return s.apply(c,arguments)};return Object.setPrototypeOf(c,u),c}),Z3={}.hasOwnProperty;class hf extends J3{constructor(){super("copy"),this.Compiler=void 0,this.Parser=void 0,this.attachers=[],this.compiler=void 0,this.freezeIndex=-1,this.frozen=void 0,this.namespace={},this.parser=void 0,this.transformers=L3()}copy(){const a=new hf;let l=-1;for(;++l<this.attachers.length;){const u=this.attachers[l];a.use(...u)}return a.data(vc(!0,{},this.namespace)),a}data(a,l){return typeof a=="string"?arguments.length===2?(Ec("data",this.frozen),this.namespace[a]=l,this):Z3.call(this.namespace,a)&&this.namespace[a]||void 0:a?(Ec("data",this.frozen),this.namespace=a,this):this.namespace}freeze(){if(this.frozen)return this;const a=this;for(;++this.freezeIndex<this.attachers.length;){const[l,...u]=this.attachers[this.freezeIndex];if(u[0]===!1)continue;u[0]===!0&&(u[0]=void 0);const s=l.call(a,...u);typeof s=="function"&&this.transformers.use(s)}return this.frozen=!0,this.freezeIndex=Number.POSITIVE_INFINITY,this}parse(a){this.freeze();const l=ku(a),u=this.parser||this.Parser;return Cc("parse",u),u(String(l),l)}process(a,l){const u=this;return this.freeze(),Cc("process",this.parser||this.Parser),Tc("process",this.compiler||this.Compiler),l?s(void 0,l):new Promise(s);function s(c,f){const m=ku(a),p=u.parse(m);u.run(p,m,function(b,x,S){if(b||!x||!S)return h(b);const v=x,C=u.stringify(v,S);$3(C)?S.value=C:S.result=C,h(b,S)});function h(b,x){b||!x?f(b):c?c(x):l(void 0,x)}}}processSync(a){let l=!1,u;return this.freeze(),Cc("processSync",this.parser||this.Parser),Tc("processSync",this.compiler||this.Compiler),this.process(a,s),mg("processSync","process",l),u;function s(c,f){l=!0,cg(c),u=f}}run(a,l,u){hg(a),this.freeze();const s=this.transformers;return!u&&typeof l=="function"&&(u=l,l=void 0),u?c(void 0,u):new Promise(c);function c(f,m){const p=ku(l);s.run(a,p,h);function h(b,x,S){const v=x||a;b?m(b):f?f(v):u(void 0,v,S)}}}runSync(a,l){let u=!1,s;return this.run(a,l,c),mg("runSync","run",u),s;function c(f,m){cg(f),s=m,u=!0}}stringify(a,l){this.freeze();const u=ku(l),s=this.compiler||this.Compiler;return Tc("stringify",s),hg(a),s(a,u)}use(a,...l){const u=this.attachers,s=this.namespace;if(Ec("use",this.frozen),a!=null)if(typeof a=="function")p(a,l);else if(typeof a=="object")Array.isArray(a)?m(a):f(a);else throw new TypeError("Expected usable value, not `"+a+"`");return this;function c(h){if(typeof h=="function")p(h,[]);else if(typeof h=="object")if(Array.isArray(h)){const[b,...x]=h;p(b,x)}else f(h);else throw new TypeError("Expected usable value, not `"+h+"`")}function f(h){if(!("plugins"in h)&&!("settings"in h))throw new Error("Expected usable value but received an empty preset, which is probably a mistake: presets typically come with `plugins` and sometimes with `settings`, but this has neither");m(h.plugins),h.settings&&(s.settings=vc(!0,s.settings,h.settings))}function m(h){let b=-1;if(h!=null)if(Array.isArray(h))for(;++b<h.length;){const x=h[b];c(x)}else throw new TypeError("Expected a list of plugins, not `"+h+"`")}function p(h,b){let x=-1,S=-1;for(;++x<u.length;)if(u[x][0]===h){S=x;break}if(S===-1)u.push([h,...b]);else if(b.length>0){let[v,...C]=b;const O=u[S][1];qc(O)&&qc(v)&&(v=vc(!0,O,v)),u[S]=[h,v,...C]}}}}const K3=new hf().freeze();function Cc(t,a){if(typeof a!="function")throw new TypeError("Cannot `"+t+"` without `parser`")}function Tc(t,a){if(typeof a!="function")throw new TypeError("Cannot `"+t+"` without `compiler`")}function Ec(t,a){if(a)throw new Error("Cannot call `"+t+"` on a frozen processor.\nCreate a new processor first, by calling it: use `processor()` instead of `processor`.")}function hg(t){if(!qc(t)||typeof t.type!="string")throw new TypeError("Expected node, got `"+t+"`")}function mg(t,a,l){if(!l)throw new Error("`"+t+"` finished async. Use `"+a+"` instead")}function ku(t){return W3(t)?t:new Ax(t)}function W3(t){return!!(t&&typeof t=="object"&&"message"in t&&"messages"in t)}function $3(t){return typeof t=="string"||eC(t)}function eC(t){return!!(t&&typeof t=="object"&&"byteLength"in t&&"byteOffset"in t)}const nC="https://github.com/remarkjs/react-markdown/blob/main/changelog.md",pg=[],gg={allowDangerousHtml:!0},tC=/^(https?|ircs?|mailto|xmpp)$/i,rC=[{from:"astPlugins",id:"remove-buggy-html-in-markdown-parser"},{from:"allowDangerousHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"allowNode",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowElement"},{from:"allowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowedElements"},{from:"className",id:"remove-classname"},{from:"disallowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"disallowedElements"},{from:"escapeHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"includeElementIndex",id:"#remove-includeelementindex"},{from:"includeNodeIndex",id:"change-includenodeindex-to-includeelementindex"},{from:"linkTarget",id:"remove-linktarget"},{from:"plugins",id:"change-plugins-to-remarkplugins",to:"remarkPlugins"},{from:"rawSourcePos",id:"#remove-rawsourcepos"},{from:"renderers",id:"change-renderers-to-components",to:"components"},{from:"source",id:"change-source-to-children",to:"children"},{from:"sourcePos",id:"#remove-sourcepos"},{from:"transformImageUri",id:"#add-urltransform",to:"urlTransform"},{from:"transformLinkUri",id:"#add-urltransform",to:"urlTransform"}];function lC(t){const a=aC(t),l=iC(t);return uC(a.runSync(a.parse(l),l),t)}function aC(t){const a=t.rehypePlugins||pg,l=t.remarkPlugins||pg,u=t.remarkRehypeOptions?{...t.remarkRehypeOptions,...gg}:gg;return K3().use(Hw).use(l).use(R3,u).use(a)}function iC(t){const a=t.children||"",l=new Ax;return typeof a=="string"&&(l.value=a),l}function uC(t,a){const l=a.allowedElements,u=a.allowElement,s=a.components,c=a.disallowedElements,f=a.skipHtml,m=a.unwrapDisallowed,p=a.urlTransform||sC;for(const b of rC)Object.hasOwn(a,b.from)&&(""+b.from+(b.to?"use `"+b.to+"` instead":"remove it")+nC+b.id,void 0);return df(t,h),k2(t,{Fragment:g.Fragment,components:s,ignoreInvalidStyle:!0,jsx:g.jsx,jsxs:g.jsxs,passKeys:!0,passNode:!0});function h(b,x,S){if(b.type==="raw"&&S&&typeof x=="number")return f?S.children.splice(x,1):S.children[x]={type:"text",value:b.value},x;if(b.type==="element"){let v;for(v in gc)if(Object.hasOwn(gc,v)&&Object.hasOwn(b.properties,v)){const C=b.properties[v],O=gc[v];(O===null||O.includes(b.tagName))&&(b.properties[v]=p(String(C||""),v,b))}}if(b.type==="element"){let v=l?!l.includes(b.tagName):c?c.includes(b.tagName):!1;if(!v&&u&&typeof x=="number"&&(v=!u(b,x,S)),v&&S&&typeof x=="number")return m&&b.children?S.children.splice(x,1,...b.children):S.children.splice(x,1),x}}}function sC(t){const a=t.indexOf(":"),l=t.indexOf("?"),u=t.indexOf("#"),s=t.indexOf("/");return a===-1||s!==-1&&a>s||l!==-1&&a>l||u!==-1&&a>u||tC.test(t.slice(0,a))?t:""}function xg(t,a){const l=String(t);if(typeof a!="string")throw new TypeError("Expected character");let u=0,s=l.indexOf(a);for(;s!==-1;)u++,s=l.indexOf(a,s+a.length);return u}function oC(t){if(typeof t!="string")throw new TypeError("Expected a string");return t.replace(/[|\\{}()[\]^$+*?.]/g,"\\$&").replace(/-/g,"\\x2d")}function cC(t,a,l){const s=Hu((l||{}).ignore||[]),c=fC(a);let f=-1;for(;++f<c.length;)Ex(t,"text",m);function m(h,b){let x=-1,S;for(;++x<b.length;){const v=b[x],C=S?S.children:void 0;if(s(v,C?C.indexOf(v):void 0,S))return;S=v}if(S)return p(h,b)}function p(h,b){const x=b[b.length-1],S=c[f][0],v=c[f][1];let C=0;const z=x.children.indexOf(h);let j=!1,H=[];S.lastIndex=0;let _=S.exec(h.value);for(;_;){const K=_.index,re={index:_.index,input:_.input,stack:[...b,h]};let q=v(..._,re);if(typeof q=="string"&&(q=q.length>0?{type:"text",value:q}:void 0),q===!1?S.lastIndex=K+1:(C!==K&&H.push({type:"text",value:h.value.slice(C,K)}),Array.isArray(q)?H.push(...q):q&&H.push(q),C=K+_[0].length,j=!0),!S.global)break;_=S.exec(h.value)}return j?(C<h.value.length&&H.push({type:"text",value:h.value.slice(C)}),x.children.splice(z,1,...H)):H=[h],z+H.length}}function fC(t){const a=[];if(!Array.isArray(t))throw new TypeError("Expected find and replace tuple or list of tuples");const l=!t[0]||Array.isArray(t[0])?t:[t];let u=-1;for(;++u<l.length;){const s=l[u];a.push([dC(s[0]),hC(s[1])])}return a}function dC(t){return typeof t=="string"?new RegExp(oC(t),"g"):t}function hC(t){return typeof t=="function"?t:function(){return t}}const Ac="phrasing",jc=["autolink","link","image","label"];function mC(){return{transforms:[SC],enter:{literalAutolink:gC,literalAutolinkEmail:Nc,literalAutolinkHttp:Nc,literalAutolinkWww:Nc},exit:{literalAutolink:vC,literalAutolinkEmail:yC,literalAutolinkHttp:xC,literalAutolinkWww:bC}}}function pC(){return{unsafe:[{character:"@",before:"[+\\-.\\w]",after:"[\\-.\\w]",inConstruct:Ac,notInConstruct:jc},{character:".",before:"[Ww]",after:"[\\-.\\w]",inConstruct:Ac,notInConstruct:jc},{character:":",before:"[ps]",after:"\\/",inConstruct:Ac,notInConstruct:jc}]}}function gC(t){this.enter({type:"link",title:null,url:"",children:[]},t)}function Nc(t){this.config.enter.autolinkProtocol.call(this,t)}function xC(t){this.config.exit.autolinkProtocol.call(this,t)}function bC(t){this.config.exit.data.call(this,t);const a=this.stack[this.stack.length-1];a.type,a.url="http://"+this.sliceSerialize(t)}function yC(t){this.config.exit.autolinkEmail.call(this,t)}function vC(t){this.exit(t)}function SC(t){cC(t,[[/(https?:\/\/|www(?=\.))([-.\w]+)([^ \t\r\n]*)/gi,kC],[new RegExp("(?<=^|\\s|\\p{P}|\\p{S})([-.\\w+]+)@([-\\w]+(?:\\.[-\\w]+)+)","gu"),wC]],{ignore:["link","linkReference"]})}function kC(t,a,l,u,s){let c="";if(!jx(s)||(/^w/i.test(a)&&(l=a+l,a="",c="http://"),!CC(l)))return!1;const f=TC(l+u);if(!f[0])return!1;const m={type:"link",title:null,url:c+a+f[0],children:[{type:"text",value:a+f[0]}]};return f[1]?[m,{type:"text",value:f[1]}]:m}function wC(t,a,l,u){return!jx(u,!0)||/[-\d_]$/.test(l)?!1:{type:"link",title:null,url:"mailto:"+a+"@"+l,children:[{type:"text",value:a+"@"+l}]}}function CC(t){const a=t.split(".");return!(a.length<2||a[a.length-1]&&(/_/.test(a[a.length-1])||!/[a-zA-Z\d]/.test(a[a.length-1]))||a[a.length-2]&&(/_/.test(a[a.length-2])||!/[a-zA-Z\d]/.test(a[a.length-2])))}function TC(t){const a=/[!"&'),.:;<>?\]}]+$/.exec(t);if(!a)return[t,void 0];t=t.slice(0,a.index);let l=a[0],u=l.indexOf(")");const s=xg(t,"(");let c=xg(t,")");for(;u!==-1&&s>c;)t+=l.slice(0,u+1),l=l.slice(u+1),u=l.indexOf(")"),c++;return[t,l]}function jx(t,a){const l=t.input.charCodeAt(t.index-1);return(t.index===0||zr(l)||Lu(l))&&(!a||l!==47)}Nx.peek=OC;function EC(){this.buffer()}function AC(t){this.enter({type:"footnoteReference",identifier:"",label:""},t)}function jC(){this.buffer()}function NC(t){this.enter({type:"footnoteDefinition",identifier:"",label:"",children:[]},t)}function MC(t){const a=this.resume(),l=this.stack[this.stack.length-1];l.type,l.identifier=ut(this.sliceSerialize(t)).toLowerCase(),l.label=a}function _C(t){this.exit(t)}function DC(t){const a=this.resume(),l=this.stack[this.stack.length-1];l.type,l.identifier=ut(this.sliceSerialize(t)).toLowerCase(),l.label=a}function RC(t){this.exit(t)}function OC(){return"["}function Nx(t,a,l,u){const s=l.createTracker(u);let c=s.move("[^");const f=l.enter("footnoteReference"),m=l.enter("reference");return c+=s.move(l.safe(l.associationId(t),{after:"]",before:c})),m(),f(),c+=s.move("]"),c}function zC(){return{enter:{gfmFootnoteCallString:EC,gfmFootnoteCall:AC,gfmFootnoteDefinitionLabelString:jC,gfmFootnoteDefinition:NC},exit:{gfmFootnoteCallString:MC,gfmFootnoteCall:_C,gfmFootnoteDefinitionLabelString:DC,gfmFootnoteDefinition:RC}}}function LC(t){let a=!1;return t&&t.firstLineBlank&&(a=!0),{handlers:{footnoteDefinition:l,footnoteReference:Nx},unsafe:[{character:"[",inConstruct:["label","phrasing","reference"]}]};function l(u,s,c,f){const m=c.createTracker(f);let p=m.move("[^");const h=c.enter("footnoteDefinition"),b=c.enter("label");return p+=m.move(c.safe(c.associationId(u),{before:p,after:"]"})),b(),p+=m.move("]:"),u.children&&u.children.length>0&&(m.shift(4),p+=m.move((a?`
`:" ")+c.indentLines(c.containerFlow(u,m.current()),a?Mx:UC))),h(),p}}function UC(t,a,l){return a===0?t:Mx(t,a,l)}function Mx(t,a,l){return(l?"":"    ")+t}const BC=["autolink","destinationLiteral","destinationRaw","reference","titleQuote","titleApostrophe"];_x.peek=FC;function HC(){return{canContainEols:["delete"],enter:{strikethrough:qC},exit:{strikethrough:VC}}}function IC(){return{unsafe:[{character:"~",inConstruct:"phrasing",notInConstruct:BC}],handlers:{delete:_x}}}function qC(t){this.enter({type:"delete",children:[]},t)}function VC(t){this.exit(t)}function _x(t,a,l,u){const s=l.createTracker(u),c=l.enter("strikethrough");let f=s.move("~~");return f+=l.containerPhrasing(t,{...s.current(),before:f,after:"~"}),f+=s.move("~~"),c(),f}function FC(){return"~"}function GC(t){return t.length}function YC(t,a){const l=a||{},u=(l.align||[]).concat(),s=l.stringLength||GC,c=[],f=[],m=[],p=[];let h=0,b=-1;for(;++b<t.length;){const O=[],z=[];let j=-1;for(t[b].length>h&&(h=t[b].length);++j<t[b].length;){const H=PC(t[b][j]);if(l.alignDelimiters!==!1){const _=s(H);z[j]=_,(p[j]===void 0||_>p[j])&&(p[j]=_)}O.push(H)}f[b]=O,m[b]=z}let x=-1;if(typeof u=="object"&&"length"in u)for(;++x<h;)c[x]=bg(u[x]);else{const O=bg(u);for(;++x<h;)c[x]=O}x=-1;const S=[],v=[];for(;++x<h;){const O=c[x];let z="",j="";O===99?(z=":",j=":"):O===108?z=":":O===114&&(j=":");let H=l.alignDelimiters===!1?1:Math.max(1,p[x]-z.length-j.length);const _=z+"-".repeat(H)+j;l.alignDelimiters!==!1&&(H=z.length+H+j.length,H>p[x]&&(p[x]=H),v[x]=H),S[x]=_}f.splice(1,0,S),m.splice(1,0,v),b=-1;const C=[];for(;++b<f.length;){const O=f[b],z=m[b];x=-1;const j=[];for(;++x<h;){const H=O[x]||"";let _="",K="";if(l.alignDelimiters!==!1){const re=p[x]-(z[x]||0),q=c[x];q===114?_=" ".repeat(re):q===99?re%2?(_=" ".repeat(re/2+.5),K=" ".repeat(re/2-.5)):(_=" ".repeat(re/2),K=_):K=" ".repeat(re)}l.delimiterStart!==!1&&!x&&j.push("|"),l.padding!==!1&&!(l.alignDelimiters===!1&&H==="")&&(l.delimiterStart!==!1||x)&&j.push(" "),l.alignDelimiters!==!1&&j.push(_),j.push(H),l.alignDelimiters!==!1&&j.push(K),l.padding!==!1&&j.push(" "),(l.delimiterEnd!==!1||x!==h-1)&&j.push("|")}C.push(l.delimiterEnd===!1?j.join("").replace(/ +$/,""):j.join(""))}return C.join(`
`)}function PC(t){return t==null?"":String(t)}function bg(t){const a=typeof t=="string"?t.codePointAt(0):0;return a===67||a===99?99:a===76||a===108?108:a===82||a===114?114:0}function XC(t,a,l,u){const s=l.enter("blockquote"),c=l.createTracker(u);c.move("> "),c.shift(2);const f=l.indentLines(l.containerFlow(t,c.current()),QC);return s(),f}function QC(t,a,l){return">"+(l?"":" ")+t}function JC(t,a){return yg(t,a.inConstruct,!0)&&!yg(t,a.notInConstruct,!1)}function yg(t,a,l){if(typeof a=="string"&&(a=[a]),!a||a.length===0)return l;let u=-1;for(;++u<a.length;)if(t.includes(a[u]))return!0;return!1}function vg(t,a,l,u){let s=-1;for(;++s<l.unsafe.length;)if(l.unsafe[s].character===`
`&&JC(l.stack,l.unsafe[s]))return/[ \t]/.test(u.before)?"":" ";return`\\
`}function ZC(t,a){const l=String(t);let u=l.indexOf(a),s=u,c=0,f=0;if(typeof a!="string")throw new TypeError("Expected substring");for(;u!==-1;)u===s?++c>f&&(f=c):c=1,s=u+a.length,u=l.indexOf(a,s);return f}function KC(t,a){return!!(a.options.fences===!1&&t.value&&!t.lang&&/[^ \r\n]/.test(t.value)&&!/^[\t ]*(?:[\r\n]|$)|(?:^|[\r\n])[\t ]*$/.test(t.value))}function WC(t){const a=t.options.fence||"`";if(a!=="`"&&a!=="~")throw new Error("Cannot serialize code with `"+a+"` for `options.fence`, expected `` ` `` or `~`");return a}function $C(t,a,l,u){const s=WC(l),c=t.value||"",f=s==="`"?"GraveAccent":"Tilde";if(KC(t,l)){const x=l.enter("codeIndented"),S=l.indentLines(c,eT);return x(),S}const m=l.createTracker(u),p=s.repeat(Math.max(ZC(c,s)+1,3)),h=l.enter("codeFenced");let b=m.move(p);if(t.lang){const x=l.enter(`codeFencedLang${f}`);b+=m.move(l.safe(t.lang,{before:b,after:" ",encode:["`"],...m.current()})),x()}if(t.lang&&t.meta){const x=l.enter(`codeFencedMeta${f}`);b+=m.move(" "),b+=m.move(l.safe(t.meta,{before:b,after:`
