...
`,Dv=`# useState → useReducer → 도메인  분리 → Store 까지의 이야기
...
이제는 느낌이나 유행이 아니라, 요구사항과 제약, 팀의 운영 방식까지 포함한 **근거 기반의 최적 선택**이 더 중요하다고 생각한다.`,Rv=`## 0. 시니어는 AI를 싫어하지 않았다. 오히려 너무 좋아했다.
