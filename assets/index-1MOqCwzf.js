...
Please change the parent <Route path="${H}"> to <Route path="${H==="/"?"*":`${H}/*`}">.`)}let S=qt(),v;if(a){let H=typeof a=="string"?Ml(a):a;Je(b==="/"||H.pathname?.startsWith(b),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${b}" but pathname "${H.pathname}" was given in the \`location\` prop.`),v=H}else v=S;let C=v.pathname||"/",R=C;if(b!=="/"){let H=b.replace(/^\//,"").split("/");R="/"+C.replace(/^\//,"").split("/").slice(H.length).join("/")}let z=Ng(t,{pathname:R});st(x||z!=null,`No routes matched location "${v.pathname}${v.search}${v.hash}" `),st(z==null||z[z.length-1].route.element!==void 0||z[z.length-1].route.Component!==void 0||z[z.length-1].route.lazy!==void 0,`Matched leaf route at location "${v.pathname}${v.search}${v.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let j=ay(z&&z.map(H=>Object.assign({},H,{params:Object.assign({},p,H.params),pathname:Ht([b,c.encodeLocation?c.encodeLocation(H.pathname.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:H.pathname]),pathnameBase:H.pathnameBase==="/"?b:Ht([b,c.encodeLocation?c.encodeLocation(H.pathnameBase.replace(/\?/g,"%3F").replace(/#/g,"%23")).pathname:H.pathnameBase])})),f,l,u,s);return a&&j?D.createElement(Pa.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...v},navigationType:"POP"}},j):j}function ny(){let t=cy(),a=P1(t)?`${t.status} ${t.statusText}`:t instanceof Error?t.message:JSON.stringify(t),l=t instanceof Error?t.stack:null,u="rgba(200,200,200, 0.5)",s={padding:"0.5rem",backgroundColor:u},c={padding:"2px 4px",backgroundColor:u},f=null;return console.error("Error handled by React Router default ErrorBoundary:",t),f=D.createElement(D.Fragment,null,D.createElement("p",null,"💿 Hey developer 👋"),D.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",D.createElement("code",{style:c},"ErrorBoundary")," or"," ",D.createElement("code",{style:c},"errorElement")," prop on your route.")),D.createElement(D.Fragment,null,D.createElement("h2",null,"Unexpected Application Error!"),D.createElement("h3",{style:{fontStyle:"italic"}},a),l?D.createElement("pre",{style:s},l):null,f)}var ty=D.createElement(ny,null),ry=class extends D.Component{constructor(t){super(t),this.state={location:t.location,revalidation:t.revalidation,error:t.error}}static getDerivedStateFromError(t){return{error:t}}static getDerivedStateFromProps(t,a){return a.location!==t.location||a.revalidation!=="idle"&&t.revalidation==="idle"?{error:t.error,location:t.location,revalidation:t.revalidation}:{error:t.error!==void 0?t.error:a.error,location:a.location,revalidation:t.revalidation||a.revalidation}}componentDidCatch(t,a){this.props.onError?this.props.onError(t,a):console.error("React Router caught the following error during render",t)}render(){return this.state.error!==void 0?D.createElement(pt.Provider,{value:this.props.routeContext},D.createElement(Xc.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function ly({routeContext:t,match:a,children:l}){let u=D.useContext(_l);return u&&u.static&&u.staticContext&&(a.route.errorElement||a.route.ErrorBoundary)&&(u.staticContext._deepestRenderedBoundaryId=a.route.id),D.createElement(pt.Provider,{value:t},l)}function ay(t,a=[],l=null,u=null,s=null){if(t==null){if(!l)return null;if(l.errors)t=l.matches;else if(a.length===0&&!l.initialized&&l.matches.length>0)t=l.matches;else return null}let c=t,f=l?.errors;if(f!=null){let b=c.findIndex(x=>x.route.id&&f?.[x.route.id]!==void 0);Je(b>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(f).join(",")}`),c=c.slice(0,Math.min(c.length,b+1))}let m=!1,p=-1;if(l)for(let b=0;b<c.length;b++){let x=c[b];if((x.route.HydrateFallback||x.route.hydrateFallbackElement)&&(p=b),x.route.id){let{loaderData:S,errors:v}=l,C=x.route.loader&&!S.hasOwnProperty(x.route.id)&&(!v||v[x.route.id]===void 0);if(x.route.lazy||C){m=!0,p>=0?c=c.slice(0,p+1):c=[c[0]];break}}}let h=l&&u?(b,x)=>{u(b,{location:l.location,params:l.matches?.[0]?.params??{},unstable_pattern:X1(l.matches),errorInfo:x})}:void 0;return c.reduceRight((b,x,S)=>{let v,C=!1,R=null,z=null;l&&(v=f&&x.route.id?f[x.route.id]:void 0,R=x.route.errorElement||ty,m&&(p<0&&S===0?(Hg("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),C=!0,z=null):p===S&&(C=!0,z=x.route.hydrateFallbackElement||null)));let j=a.concat(c.slice(0,S+1)),H=()=>{let _;return v?_=R:C?_=z:x.route.Component?_=D.createElement(x.route.Component,null):x.route.element?_=x.route.element:_=b,D.createElement(ly,{match:x,routeContext:{outlet:b,matches:j,isDataRoute:l!=null},children:_})};return l&&(x.route.ErrorBoundary||x.route.errorElement||S===0)?D.createElement(ry,{location:l.location,revalidation:l.revalidation,component:R,error:v,children:H(),routeContext:{outlet:null,matches:j,isDataRoute:!0},onError:h}):H()},null)}function Qc(t){return`${t} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function iy(t){let a=D.useContext(_l);return Je(a,Qc(t)),a}function uy(t){let a=D.useContext(Ru);return Je(a,Qc(t)),a}function sy(t){let a=D.useContext(pt);return Je(a,Qc(t)),a}function Jc(t){let a=sy(t),l=a.matches[a.matches.length-1];return Je(l.route.id,`${t} can only be used on routes that contain a unique "id"`),l.route.id}function oy(){return Jc("useRouteId")}function cy(){let t=D.useContext(Xc),a=uy("useRouteError"),l=Jc("useRouteError");return t!==void 0?t:a.errors?.[l]}function fy(){let{router:t}=iy("useNavigate"),a=Jc("useNavigate"),l=D.useRef(!1);return Ug(()=>{l.current=!0}),D.useCallback(async(s,c={})=>{st(l.current,Lg),l.current&&(typeof s=="number"?await t.navigate(s):await t.navigate(s,{fromRouteId:a,...c}))},[t,a])}var Ap={};function Hg(t,a,l){!a&&!Ap[t]&&(Ap[t]=!0,st(!1,l))}D.memo(dy);function dy({routes:t,future:a,state:l,unstable_onError:u}){return Bg(t,void 0,l,u,a)}function Ua(t){Je(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function hy({basename:t="/",children:a=null,location:l,navigationType:u="POP",navigator:s,static:c=!1,unstable_useTransitions:f}){Je(!Xa(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let m=t.replace(/^\/*/,"/"),p=D.useMemo(()=>({basename:m,navigator:s,static:c,unstable_useTransitions:f,future:{}}),[m,s,c,f]);typeof l=="string"&&(l=Ml(l));let{pathname:h="/",search:b="",hash:x="",state:S=null,key:v="default"}=l,C=D.useMemo(()=>{let R=It(h,m);return R==null?null:{location:{pathname:R,search:b,hash:x,state:S,key:v},navigationType:u}},[m,h,b,x,S,v,u]);return st(C!=null,`<Router basename="${m}"> is not able to match the URL "${h}${b}${x}" because it does not start with the basename, so the <Router> won't render anything.`),C==null?null:D.createElement(ot.Provider,{value:p},D.createElement(Pa.Provider,{children:a,value:C}))}function my({children:t,location:a}){return ey(Dc(t),a)}function Dc(t,a=[]){let l=[];return D.Children.forEach(t,(u,s)=>{if(!D.isValidElement(u))return;let c=[...a,s];if(u.type===D.Fragment){l.push.apply(l,Dc(u.props.children,c));return}Je(u.type===Ua,`[${typeof u.type=="string"?u.type:u.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Je(!u.props.index||!u.props.children,"An index route cannot have child routes.");let f={id:u.props.id||c.join("-"),caseSensitive:u.props.caseSensitive,element:u.props.element,Component:u.props.Component,index:u.props.index,path:u.props.path,middleware:u.props.middleware,loader:u.props.loader,action:u.props.action,hydrateFallbackElement:u.props.hydrateFallbackElement,HydrateFallback:u.props.HydrateFallback,errorElement:u.props.errorElement,ErrorBoundary:u.props.ErrorBoundary,hasErrorBoundary:u.props.hasErrorBoundary===!0||u.props.ErrorBoundary!=null||u.props.errorElement!=null,shouldRevalidate:u.props.shouldRevalidate,handle:u.props.handle,lazy:u.props.lazy};u.props.children&&(f.children=Dc(u.props.children,c)),l.push(f)}),l}var Cu="get",Tu="application/x-www-form-urlencoded";function zu(t){return typeof HTMLElement<"u"&&t instanceof HTMLElement}function py(t){return zu(t)&&t.tagName.toLowerCase()==="button"}function gy(t){return zu(t)&&t.tagName.toLowerCase()==="form"}function xy(t){return zu(t)&&t.tagName.toLowerCase()==="input"}function by(t){return!!(t.metaKey||t.altKey||t.ctrlKey||t.shiftKey)}function yy(t,a){return t.button===0&&(!a||a==="_self")&&!by(t)}var bu=null;function vy(){if(bu===null)try{new FormData(document.createElement("form"),0),bu=!1}catch{bu=!0}return bu}var Sy=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function cc(t){return t!=null&&!Sy.has(t)?(st(!1,`"${t}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Tu}"`),null):t}function ky(t,a){let l,u,s,c,f;if(gy(t)){let m=t.getAttribute("action");u=m?It(m,a):null,l=t.getAttribute("method")||Cu,s=cc(t.getAttribute("enctype"))||Tu,c=new FormData(t)}else if(py(t)||xy(t)&&(t.type==="submit"||t.type==="image")){let m=t.form;if(m==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let p=t.getAttribute("formaction")||m.getAttribute("action");if(u=p?It(p,a):null,l=t.getAttribute("formmethod")||m.getAttribute("method")||Cu,s=cc(t.getAttribute("formenctype"))||cc(m.getAttribute("enctype"))||Tu,c=new FormData(m,t),!vy()){let{name:h,type:b,value:x}=t;if(b==="image"){let S=h?`${h}.`:"";c.append(`${S}x`,"0"),c.append(`${S}y`,"0")}else h&&c.append(h,x)}}else{if(zu(t))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');l=Cu,u=null,s=Tu,f=t}return c&&s==="text/plain"&&(f=c,c=void 0),{action:u,method:l.toLowerCase(),encType:s,formData:c,body:f}}Object.getOwnPropertyNames(Object.prototype).sort().join("\0");function Zc(t,a){if(t===!1||t===null||typeof t>"u")throw new Error(a)}function wy(t,a,l){let u=typeof t=="string"?new URL(t,typeof window>"u"?"server://singlefetch/":window.location.origin):t;return u.pathname==="/"?u.pathname=`_root.${l}`:a&&It(u.pathname,a)==="/"?u.pathname=`${a.replace(/\/$/,"")}/_root.${l}`:u.pathname=`${u.pathname.replace(/\/$/,"")}.${l}`,u}async function Cy(t,a){if(t.id in a)return a[t.id];try{let l=await import(t.module);return a[t.id]=l,l}catch(l){return console.error(`Error loading route module \`${t.module}\`, reloading page...`),console.error(l),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function Ty(t){return t==null?!1:t.href==null?t.rel==="preload"&&typeof t.imageSrcSet=="string"&&typeof t.imageSizes=="string":typeof t.rel=="string"&&typeof t.href=="string"}async function Ey(t,a,l){let u=await Promise.all(t.map(async s=>{let c=a.routes[s.route.id];if(c){let f=await Cy(c,l);return f.links?f.links():[]}return[]}));return My(u.flat(1).filter(Ty).filter(s=>s.rel==="stylesheet"||s.rel==="preload").map(s=>s.rel==="stylesheet"?{...s,rel:"prefetch",as:"style"}:{...s,rel:"prefetch"}))}function jp(t,a,l,u,s,c){let f=(p,h)=>l[h]?p.route.id!==l[h].route.id:!0,m=(p,h)=>l[h].pathname!==p.pathname||l[h].route.path?.endsWith("*")&&l[h].params["*"]!==p.params["*"];return c==="assets"?a.filter((p,h)=>f(p,h)||m(p,h)):c==="data"?a.filter((p,h)=>{let b=u.routes[p.route.id];if(!b||!b.hasLoader)return!1;if(f(p,h)||m(p,h))return!0;if(p.route.shouldRevalidate){let x=p.route.shouldRevalidate({currentUrl:new URL(s.pathname+s.search+s.hash,window.origin),currentParams:l[0]?.params||{},nextUrl:new URL(t,window.origin),nextParams:p.params,defaultShouldRevalidate:!0});if(typeof x=="boolean")return x}return!0}):[]}function Ay(t,a,{includeHydrateFallback:l}={}){return jy(t.map(u=>{let s=a.routes[u.route.id];if(!s)return[];let c=[s.module];return s.clientActionModule&&(c=c.concat(s.clientActionModule)),s.clientLoaderModule&&(c=c.concat(s.clientLoaderModule)),l&&s.hydrateFallbackModule&&(c=c.concat(s.hydrateFallbackModule)),s.imports&&(c=c.concat(s.imports)),c}).flat(1))}function jy(t){return[...new Set(t)]}function Ny(t){let a={},l=Object.keys(t).sort();for(let u of l)a[u]=t[u];return a}function My(t,a){let l=new Set;return new Set(a),t.reduce((u,s)=>{let c=JSON.stringify(Ny(s));return l.has(c)||(l.add(c),u.push({key:c,link:s})),u},[])}function Ig(){let t=D.useContext(_l);return Zc(t,"You must render this element inside a <DataRouterContext.Provider> element"),t}function _y(){let t=D.useContext(Ru);return Zc(t,"You must render this element inside a <DataRouterStateContext.Provider> element"),t}var Kc=D.createContext(void 0);Kc.displayName="FrameworkContext";function qg(){let t=D.useContext(Kc);return Zc(t,"You must render this element inside a <HydratedRouter> element"),t}function Dy(t,a){let l=D.useContext(Kc),[u,s]=D.useState(!1),[c,f]=D.useState(!1),{onFocus:m,onBlur:p,onMouseEnter:h,onMouseLeave:b,onTouchStart:x}=a,S=D.useRef(null);D.useEffect(()=>{if(t==="render"&&f(!0),t==="viewport"){let R=j=>{j.forEach(H=>{f(H.isIntersecting)})},z=new IntersectionObserver(R,{threshold:.5});return S.current&&z.observe(S.current),()=>{z.disconnect()}}},[t]),D.useEffect(()=>{if(u){let R=setTimeout(()=>{f(!0)},100);return()=>{clearTimeout(R)}}},[u]);let v=()=>{s(!0)},C=()=>{s(!1),f(!1)};return l?t!=="intent"?[c,S,{}]:[c,S,{onFocus:Na(m,v),onBlur:Na(p,C),onMouseEnter:Na(h,v),onMouseLeave:Na(b,C),onTouchStart:Na(x,v)}]:[!1,S,{}]}function Na(t,a){return l=>{t&&t(l),l.defaultPrevented||a(l)}}function Oy({page:t,...a}){let{router:l}=Ig(),u=D.useMemo(()=>Ng(l.routes,t,l.basename),[l.routes,t,l.basename]);return u?D.createElement(zy,{page:t,matches:u,...a}):null}function Ry(t){let{manifest:a,routeModules:l}=qg(),[u,s]=D.useState([]);return D.useEffect(()=>{let c=!1;return Ey(t,a,l).then(f=>{c||s(f)}),()=>{c=!0}},[t,a,l]),u}function zy({page:t,matches:a,...l}){let u=qt(),{manifest:s,routeModules:c}=qg(),{basename:f}=Ig(),{loaderData:m,matches:p}=_y(),h=D.useMemo(()=>jp(t,a,p,s,u,"data"),[t,a,p,s,u]),b=D.useMemo(()=>jp(t,a,p,s,u,"assets"),[t,a,p,s,u]),x=D.useMemo(()=>{if(t===u.pathname+u.search+u.hash)return[];let C=new Set,R=!1;if(a.forEach(j=>{let H=s.routes[j.route.id];!H||!H.hasLoader||(!h.some(_=>_.route.id===j.route.id)&&j.route.id in m&&c[j.route.id]?.shouldRevalidate||H.hasClientLoader?R=!0:C.add(j.route.id))}),C.size===0)return[];let z=wy(t,f,"data");return R&&C.size>0&&z.searchParams.set("_routes",a.filter(j=>C.has(j.route.id)).map(j=>j.route.id).join(",")),[z.pathname+z.search]},[f,m,u,s,h,a,t,c]),S=D.useMemo(()=>Ay(b,s),[b,s]),v=Ry(b);return D.createElement(D.Fragment,null,x.map(C=>D.createElement("link",{key:C,rel:"prefetch",as:"fetch",href:C,...l})),S.map(C=>D.createElement("link",{key:C,rel:"modulepreload",href:C,...l})),v.map(({key:C,link:R})=>D.createElement("link",{key:C,nonce:l.nonce,...R})))}function Ly(...t){return a=>{t.forEach(l=>{typeof l=="function"?l(a):l!=null&&(l.current=a)})}}var Vg=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Vg&&(window.__reactRouterVersion="7.10.1")}catch{}function Uy({basename:t,children:a,unstable_useTransitions:l,window:u}){let s=D.useRef();s.current==null&&(s.current=k1({window:u,v5Compat:!0}));let c=s.current,[f,m]=D.useState({action:c.action,location:c.location}),p=D.useCallback(h=>{l===!1?m(h):D.startTransition(()=>m(h))},[l]);return D.useLayoutEffect(()=>c.listen(p),[c,p]),D.createElement(hy,{basename:t,children:a,location:f.location,navigationType:f.action,navigator:c,unstable_useTransitions:l===!0})}var Fg=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Bt=D.forwardRef(function({onClick:a,discover:l="render",prefetch:u="none",relative:s,reloadDocument:c,replace:f,state:m,target:p,to:h,preventScrollReset:b,viewTransition:x,...S},v){let{basename:C,unstable_useTransitions:R}=D.useContext(ot),z=typeof h=="string"&&Fg.test(h),j,H=!1;if(typeof h=="string"&&z&&(j=h,Vg))try{let A=new URL(window.location.href),P=h.startsWith("//")?new URL(A.protocol+h):new URL(h),J=It(P.pathname,C);P.origin===A.origin&&J!=null?h=J+P.search+P.hash:H=!0}catch{st(!1,`<Link to="${h}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let _=K1(h,{relative:s}),[K,re,q]=Dy(u,S),ee=qy(h,{replace:f,state:m,target:p,preventScrollReset:b,relative:s,viewTransition:x,unstable_useTransitions:R});function oe(A){a&&a(A),A.defaultPrevented||ee(A)}let W=D.createElement("a",{...S,...q,href:j||_,onClick:H||c?a:oe,ref:Ly(v,re),target:p,"data-discover":!z&&l==="render"?"true":void 0});return K&&!z?D.createElement(D.Fragment,null,W,D.createElement(Oy,{page:_})):W});Bt.displayName="Link";var By=D.forwardRef(function({"aria-current":a="page",caseSensitive:l=!1,className:u="",end:s=!1,style:c,to:f,viewTransition:m,children:p,...h},b){let x=Ja(f,{relative:h.relative}),S=qt(),v=D.useContext(Ru),{navigator:C,basename:R}=D.useContext(ot),z=v!=null&&Py(x)&&m===!0,j=C.encodeLocation?C.encodeLocation(x).pathname:x.pathname,H=S.pathname,_=v&&v.navigation&&v.navigation.location?v.navigation.location.pathname:null;l||(H=H.toLowerCase(),_=_?_.toLowerCase():null,j=j.toLowerCase()),_&&R&&(_=It(_,R)||_);const K=j!=="/"&&j.endsWith("/")?j.length-1:j.length;let re=H===j||!s&&H.startsWith(j)&&H.charAt(K)==="/",q=_!=null&&(_===j||!s&&_.startsWith(j)&&_.charAt(j.length)==="/"),ee={isActive:re,isPending:q,isTransitioning:z},oe=re?a:void 0,W;typeof u=="function"?W=u(ee):W=[u,re?"active":null,q?"pending":null,z?"transitioning":null].filter(Boolean).join(" ");let A=typeof c=="function"?c(ee):c;return D.createElement(Bt,{...h,"aria-current":oe,className:W,ref:b,style:A,to:f,viewTransition:m},typeof p=="function"?p(ee):p)});By.displayName="NavLink";var Hy=D.forwardRef(({discover:t="render",fetcherKey:a,navigate:l,reloadDocument:u,replace:s,state:c,method:f=Cu,action:m,onSubmit:p,relative:h,preventScrollReset:b,viewTransition:x,...S},v)=>{let{unstable_useTransitions:C}=D.useContext(ot),R=Gy(),z=Yy(m,{relative:h}),j=f.toLowerCase()==="get"?"get":"post",H=typeof m=="string"&&Fg.test(m),_=K=>{if(p&&p(K),K.defaultPrevented)return;K.preventDefault();let re=K.nativeEvent.submitter,q=re?.getAttribute("formmethod")||f,ee=()=>R(re||K.currentTarget,{fetcherKey:a,method:q,navigate:l,replace:s,state:c,relative:h,preventScrollReset:b,viewTransition:x});C&&l!==!1?D.startTransition(()=>ee()):ee()};return D.createElement("form",{ref:v,method:j,action:z,onSubmit:u?p:_,...S,"data-discover":!H&&t==="render"?"true":void 0})});Hy.displayName="Form";function Iy(t){return`${t} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Gg(t){let a=D.useContext(_l);return Je(a,Iy(t)),a}function qy(t,{target:a,replace:l,state:u,preventScrollReset:s,relative:c,viewTransition:f,unstable_useTransitions:m}={}){let p=Qa(),h=qt(),b=Ja(t,{relative:c});return D.useCallback(x=>{if(yy(x,a)){x.preventDefault();let S=l!==void 0?l:Fa(h)===Fa(b),v=()=>p(t,{replace:S,state:u,preventScrollReset:s,relative:c,viewTransition:f});m?D.startTransition(()=>v()):v()}},[h,p,b,l,u,a,t,s,c,f,m])}var Vy=0,Fy=()=>`__${String(++Vy)}__`;function Gy(){let{router:t}=Gg("useSubmit"),{basename:a}=D.useContext(ot),l=oy(),u=t.fetch,s=t.navigate;return D.useCallback(async(c,f={})=>{let{action:m,method:p,encType:h,formData:b,body:x}=ky(c,a);if(f.navigate===!1){let S=f.fetcherKey||Fy();await u(S,l,f.action||m,{preventScrollReset:f.preventScrollReset,formData:b,body:x,formMethod:f.method||p,formEncType:f.encType||h,flushSync:f.flushSync})}else await s(f.action||m,{preventScrollReset:f.preventScrollReset,formData:b,body:x,formMethod:f.method||p,formEncType:f.encType||h,replace:f.replace,state:f.state,fromRouteId:l,flushSync:f.flushSync,viewTransition:f.viewTransition})},[u,s,a,l])}function Yy(t,{relative:a}={}){let{basename:l}=D.useContext(ot),u=D.useContext(pt);Je(u,"useFormAction must be used inside a RouteContext");let[s]=u.matches.slice(-1),c={...Ja(t||".",{relative:a})},f=qt();if(t==null){c.search=f.search;let m=new URLSearchParams(c.search),p=m.getAll("index");if(p.some(b=>b==="")){m.delete("index"),p.filter(x=>x).forEach(x=>m.append("index",x));let b=m.toString();c.search=b?`?${b}`:""}}return(!t||t===".")&&s.route.index&&(c.search=c.search?c.search.replace(/^\?/,"?index&"):"?index"),l!=="/"&&(c.pathname=c.pathname==="/"?l:Ht([l,c.pathname])),Fa(c)}function Py(t,{relative:a}={}){let l=D.useContext(zg);Je(l!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:u}=Gg("useViewTransitionState"),s=Ja(t,{relative:a});if(!l.isTransitioning)return!1;let c=It(l.currentLocation.pathname,u)||l.currentLocation.pathname,f=It(l.nextLocation.pathname,u)||l.nextLocation.pathname;return ju(s.pathname,f)!=null||ju(s.pathname,c)!=null}const Xy=({theme:t,onToggleTheme:a,onNavClick:l})=>{const u=qt(),s=Qa(),c=u.pathname==="/",[f,m]=D.useState(!1),p=[{id:"about",label:"About"},{id:"skills",label:"Skills"},{id:"projects",label:"Projects"},{id:"lab",label:"Lab"}],h=b=>{m(!1),c?l(b):(s("/"),setTimeout(()=>{l(b)},100))};return D.useEffect(()=>(f?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[f]),g.jsxs(g.Fragment,{children:[g.jsx("header",{className:"fixed inset-x-0 top-0 h-(--header-height) z-20 border-b backdrop-blur-xl [html[data-theme='dark']_&]:border-white/5 [html[data-theme='light']_&]:border-black/5",children:g.jsxs("div",{className:"max-w-[1040px] mx-auto h-full px-5 flex items-center justify-between gap-3",children:[g.jsx(Bt,{to:"/",className:"tracking-[0.08em] uppercase text-[14px] text-fg-muted hover:text-fg transition-colors cursor-pointer",children:"Frontend · UX"}),g.jsxs("nav",{className:"hidden md:flex items-center gap-4 text-[13px]",children:[g.jsx(Bt,{to:"/",className:`px-2.5 py-1.5 rounded-full text-[13px] border border-transparent cursor-pointer
                         ...
                         flex items-center justify-center cursor-pointer\r
                         transition-all duration-150 ease-out\r
                         hover:-translate-y-px hover:bg-(--bg-soft) hover:border-(--accent)/50`,"aria-label":"Toggle theme",onClick:a,children:t==="dark"?g.jsx(Qy,{}):g.jsx(Jy,{})}),g.jsx(Bt,{to:"/contact",className:`hidden sm:inline-flex text-[13px] px-4 py-2 rounded-full border border-(--border-subtle)
...
`,Av=`JS 공부하다 보면 어느 순간 이런 상태가 된다.\r
\r
> “콜스택? 이벤트루프? 비동기?\r
>\r
...
`,jv=`자바스크립트 이벤트 루프를 공부하다 보면 꼭 이런 혼란이 온다.\r
\r
...
`,Nv=`React에서 Zustand를 쓰다 보면 “상태는 분명 바뀌었는데 이벤트 핸들러가 옛날 값을 찍는다” 같은 현상을 한 번쯤 만나게 된다.\r
...
`,_v=`실차/로그 기반 모니터링 UI를 만들다 보면, 어느 순간부터 이런 문장이 몸에 새겨진다.\r
\r
...
`,Rv=`HTML/CSS/JS는 아는데… 그래서 “웹”이 어떻게 화면이 되는 건데?\r
\r
...
이렇게 “반복되는 인자”가 보이면\r
커링을 한 번 떠올려볼 만하다.\r
`,Lv=`“함수가 변수 기억하는 거요”로 끝내면 나중에 꼭 크게 맞는다\r
\r
...
`,Bv=Object.assign({"./mdDatas/AI 시대, “유지보수도 AI가 하면 되지 않나요 ”라는 말에 대하여.md":Ev,"./mdDatas/JS 기본 동작원리, “진짜 뼈대”만 잡아보기.md":Av,"./mdDatas/JS 이벤트 루프를 이해하려면, 먼저 세 개의 레이어부터 갈라야 한다 (1편).md":jv,"./mdDatas/React × Zustand × Closure stale closure 방지 전략 기술.md":Nv,"./mdDatas/React 라이브러리 만들고 “테스트 + CI + 자동 배포” 붙이기.md":Mv,"./mdDatas/React 실시간 Trigger 처리 최적화 삽질기.md":_v,"./mdDatas/“AI로 업무 전체 자동화하면 끝 아니야 ”이라는 시니어를 보며 느낀 찝찝함.md":Dv,"./mdDatas/브라우저 안에서 JS와 렌더링은 어떻게 돌아가는가 (2편).md":Ov,"./mdDatas/웹(Web)이란 도대체 뭘까.md":Rv,"./mdDatas/커링 컬링도 아니고 이게뭐누.md":zv,"./mdDatas/클로저란 당최 무엇인가.md":Lv,"./mdDatas/프론트엔드에서 DDD와 FSD, 그리고 ‘도메인 슬라이스’ 아키텍처.md":Uv}),$n=t=>Bv[`./mdDatas/${t}.md`]||"",Hv=[{id:"react-zustand-closure",slug:"react-zustand-closure-stale-closure",title:"React × Zustand × Closure: stale closure 방지 전략 기술 정리",excerpt:"Zustand 쓰다가 '아니 왜 값이 안 바뀌지?' 하고 3시간 멍때린 적 있나요? 저도요. 결국 범인은 stale closure였습니다… 진짜 황당해서 정리해둔 글입니다. 나처럼 고통받지 말라고.",date:"2025년 12월 15일",tags:["React","Zustand","JavaScript","Closure","State Management"],cover:"https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=1800&q=80",category:"frontend",content:$n("React × Zustand × Closure stale closure 방지 전략 기술")},{id:"js-basic",slug:"js-basic",title:'JS 기본 동작원리, "진짜 뼈대"만 잡아보기',excerpt:"비동기 개념을 계속 외우기만 했다면, 이번엔 뼈대부터 잡자. Heap/Call Stack이 무엇이고, JS가 왜 싱글 스레드인지, 비동기는 누가 처리하는지(Web APIs/Node APIs), 그리고 Task Queue vs Microtask Queue가 실행 순서를 어떻게 갈라놓는지. 딱 이 흐름만 머리에 넣으면 async/await도 결국 같은 얘기라는 걸 이해하게 된다.",date:"2025년 12월 5일",tags:["JavaScript","기초","동작원리"],cover:"https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=1800&q=80",category:"frontend",content:$n("JS 기본 동작원리, “진짜 뼈대”만 잡아보기")},{id:"react-trigger-optimization",slug:"react-realtime-trigger-optimization",title:"React 실시간 Trigger 처리 최적화 삽질기 (Worker, Throttle, Time-slicing… 결국 Baseline이 이겼다.)",excerpt:"실시간 이벤트 들어올 때 UI가 뚝뚝 끊기길래, WebWorker부터 throttle까지 별짓 다 해봤습니다. 근데 결국… 가장 단순한 방법이 이겼습니다. 내 삽질의 역사 공유합니다.",date:"2025년 11월 28일",tags:["React","Performance","WebWorker","Optimization"],cover:"https://images.unsplash.com/photo-1547658719-da2b51169166?auto=format&fit=crop&w=1800&q=80",category:"frontend",content:$n("React 실시간 Trigger 처리 최적화 삽질기")},{id:"web-fundamentals",slug:"what-is-web",title:"웹(Web)이란 도대체 뭘까?",excerpt:"HTML/CSS/JS는 아는데 ‘그래서 웹이 어떻게 화면이 되는 건데?’ 하고 멈춰본 적 있나요? 저도 그래서 한 번 아주 기초부터 갈아엎고 정리해봤습니다. 웹의 원리 이해하면 프론트가 더 잘 보임.",date:"2025년 10월 20일",tags:["Web","HTTP","Browser","Fundamentals"],cover:"https://images.unsplash.com/photo-1573867639040-6dd25fa5f597?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",category:"frontend",content:$n("웹(Web)이란 도대체 뭘까")},{id:"closure-deep-dive",slug:"what-is-closure",title:"클로저란 당최 무엇인가",excerpt:"면접만 가면 꼭 나오는 게 클로저인데… 정작 설명하려면 머릿속이 하얘지는 그 개념. 그래서 빡쳐서(?) 제대로 다시 정리했습니다. 이 글 읽고 나면 최소한 면접에서 우는 일은 없습니다.",date:"2025년 9월 15일",tags:["JavaScript","Closure","Scope","Fundamentals"],cover:"https://images.unsplash.com/photo-1555066931-4365d14bab8c?auto=format&fit=crop&w=1800&q=80",category:"frontend",content:$n("클로저란 당최 무엇인가")},{id:"currying",slug:"what-is-currying",title:"커링?? 컬링도 아니고 이게뭐누",excerpt:"커링 처음 보면 ‘이걸 왜 씀?’ 싶은데, 막상 알아두면 코드가 맘 편해지는 순간이 옵니다. 이 글은 커링을 드디어 사람 언어로 설명해본 글입니다. 예제 많음. 자존감 지킴.",date:"2025년 8월 25일",tags:["JavaScript","Functional Programming","Currying"],cover:"https://images.unsplash.com/photo-1522542550221-31fd19575a2d?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",category:"frontend",content:$n("커링 컬링도 아니고 이게뭐누")},{id:"react-library-ci-cd",slug:"react-library-test-ci-cd",title:'React 라이브러리 만들고 "테스트 + CI + 자동 배포" 붙이기',excerpt:"npm 배포 한 번 해보겠다고 시작했다가 GitHub Actions, semantic-release, 토큰 지옥까지 거쳐온 이야기. 진짜 별별 오류 다 봄. 그래도 자동 배포 되면 감동합니다. (눈물)",date:"2025년 12월 10일",tags:["React","Library","Testing","CI/CD","npm"],cover:"https://images.unsplash.com/photo-1542831371-d531d36971e6?auto=format&fit=crop&w=1800&q=80",category:"frontend",content:$n("React 라이브러리 만들고 “테스트 + CI + 자동 배포” 붙이기")},{id:"js-event-loop-part1",slug:"js-event-loop-understanding-part1",title:"JS 이벤트 루프를 이해하려면, 먼저 세 개의 레이어부터 갈라야 한다 (1편)",excerpt:"비동기 헷갈리는 사람들 99%가 ‘레이어 구분’을 안 해서 그렇습니다. 엔진 / 런타임 / 브라우저 구분하면 진짜 다 이해됩니다. 나도 이거 알기 전엔 async/await이랑 싸움 중이었음.",date:"2025년 6월 18일",tags:["JavaScript","Event Loop","Asynchronous","Architecture"],cover:"https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1800&q=80",category:"frontend",content:$n("JS 이벤트 루프를 이해하려면, 먼저 세 개의 레이어부터 갈라야 한다 (1편)")},{id:"browser-rendering-part2",slug:"browser-js-rendering-mechanism-part2",title:"브라우저 안에서 JS와 렌더링은 어떻게 돌아가는가 (2편)",excerpt:"브라우저는 생각보다 훨씬 복잡합니다. 렌더링 파이프라인 보면 ‘아 그래서 리렌더링이 느렸구나…’ 하고 현타 오는 그 글. 성능 최적화 힌트도 같이 담겨있음.",date:"2025년 6월 20일",tags:["Browser","Rendering","JavaScript","Performance"],cover:"https://images.unsplash.com/photo-1617854818583-09e7f077a156?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",category:"frontend",content:$n("브라우저 안에서 JS와 렌더링은 어떻게 돌아가는가 (2편)")},{id:"frontend-ddd-fsd",slug:"frontend-ddd-fsd-domain-slice",title:"프론트엔드에서 DDD와 FSD, 그리고 '도메인 슬라이스' 아키텍처",excerpt:"프로젝트가 커질수록 파일이 정신없어지는 이유, 사실 구조 때문입니다. DDD/FSD를 프론트에 맞게 해석해서 ‘아 이래서 구조가 필요한 거구나’ 감이 오도록 써본 글.",date:"2025년 5월 15일",tags:["Architecture","DDD","FSD","Frontend","Design Pattern"],cover:"https://images.unsplash.com/photo-1515879218367-8466d910aaa4?q=80&w=1169&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",category:"frontend",content:$n("프론트엔드에서 DDD와 FSD, 그리고 ‘도메인 슬라이스’ 아키텍처")},{id:"ai-era-maintenance",slug:"ai-era-code-maintenance",title:'AI 시대, "유지보수도 AI가 하면 되지 않나요?"라는 말에 대하여',excerpt:"‘AI가 코드도 짜주는데 유지보수도 하겠지?’라는 말을 들었는데… 현실은 전혀 다릅니다. AI가 잘하는 것과 진짜 사람이 해야 하는 일이 뭐가 다른지 정리한 글. 약간 분노도 섞여 있음.",date:"2026년 1월 1일",tags:["AI","Software Engineering","Maintenance","Opinion"],cover:"https://images.unsplash.com/photo-1526378722484-bd91ca387e72?auto=format&fit=crop&w=1800&q=80",category:"devloper",content:$n("AI 시대, “유지보수도 AI가 하면 되지 않나요 ”라는 말에 대하여")},{id:"senior-ai-idea",slug:"senior-ai-idea",title:"“AI로 업무 전체 자동화하면 끝 아니야?” 라고 말씀하시는 시니어를 보며 느낀 찝찝함",excerpt:"요즘 들어서 AI 쓰면 금방이잖아? 라는 말을 너무 많이 듣는다. 그리고 마치 구호처럼 느껴진다... 나에게 와닿지 않았던 이유에 대한 고찰과정과 개발자란 직업은 어떻게 변화되어가는지에 대해서 스스로 생각해 보았다. (제발 해피엔딩이었으면!!!!! 젭알!!!)",date:"2026년 1월 15일",tags:["AI","Automation","Technical Debt","Junior Developers","Engineering Culture"],cover:"https://plus.unsplash.com/premium_photo-1764695396810-3992d6bc4e51?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",category:"devloper",content:$n("“AI로 업무 전체 자동화하면 끝 아니야 ”이라는 시니어를 보며 느낀 찝찝함")}],nt=[...Hv].sort((t,a)=>{const l=c=>{const f=c.match(/(\d+)년\s*(\d+)월\s*(\d+)일/);if(f){const[,m,p,h]=f;return new Date(parseInt(m),parseInt(p)-1,parseInt(h))}return new Date(0)},u=l(t.date);return l(a.date).getTime()-u.getTime()}),Iv="flex flex-col gap-3 md:flex-row md:items-baseline md:justify-between mb-5 w-full",qv="text-[11px] uppercase tracking-[0.16em] text-fg-muted mb-3",Vv="text-[20px] font-semibold tracking-[0.02em]",Fv="text-[13px] text-fg-muted leading-relaxed cursor-pointer",Gv=()=>[...nt].sort(()=>Math.random()-.5).slice(0,2),Yv=()=>{const t=Qa(),[a]=D.useState(Gv),l=s=>{t(`/blog/${s}`)},u=()=>{t("/blog")};return g.jsxs("section",{id:"experience",className:"mb-14",children:[g.jsx("div",{className:Iv,children:g.jsxs("div",{className:"w-full",children:[g.jsx("p",{className:qv,children:"Blog"}),g.jsxs("div",{className:"w-full flex justify-between",children:[g.jsx("h2",{className:Vv,children:"기술 블로그"}),g.jsx("p",{className:Fv,onClick:u,children:"포스팅 전체 보기 →"})]})]})}),g.jsx("div",{className:"grid gap-6",children:a.map(s=>g.jsx("article",{onClick:()=>l(s.slug),role:"button",tabIndex:0,onKeyDown:c=>{(c.key==="Enter"||c.key===" ")&&l(s.slug)},className:"group overflow-hidden rounded-2xl border bg-(--bg-elevated) border-(--border-subtle) cursor-pointer transition-colors hover:border-(--accent) focus:outline-none focus:ring-2 focus:ring-(--accent)/40",children:g.jsxs("div",{className:"grid md:grid-cols-[240px_1fr] md:h-[200px]",children:[s.cover&&g.jsxs("div",{className:"relative h-[180px] md:h-[200px] bg-(--bg-soft)",children:[g.jsx("img",{src:s.cover,alt:"",className:"absolute inset-0 w-full h-full object-cover opacity-90 group-hover:opacity-100 transition-opacity",loading:"lazy"}),g.jsx("div",{className:"absolute inset-0 bg-gradient-to-t md:bg-gradient-to-r from-black/55 via-black/15 to-transparent"})]}),g.jsxs("div",{className:"p-6 md:overflow-hidden",children:[g.jsx("h3",{className:"text-[20px] font-semibold leading-snug mb-2",children:s.title}),g.jsx("p",{className:"text-[13px] text-fg-muted leading-relaxed mb-4 line-clamp-2",children:s.excerpt}),g.jsx("div",{className:"flex flex-wrap gap-2 mb-4",children:s.tags.slice(0,8).map(c=>g.jsx("span",{className:"text-[11px] px-2.5 py-1.5 rounded-full bg-(--bg-soft) border border-(--border-subtle) text-fg-muted",children:c},c))}),g.jsx("div",{className:"flex items-center justify-between text-[12px] text-fg-muted",children:g.jsx("span",{children:s.date})})]})]})},s.id))})]})};function Pv(t){return new Worker("/portfolio/assets/fibWorker-cslZksJc.js",{name:t?.name})}const Xv="rounded-3xl border border-(--border-subtle) bg-(--bg-elevated) p-5 shadow-[0_14px_34px_rgba(0,0,0,0.32)] transition-transform transition-shadow transition-colors duration-200 ease-out hover:-translate-y-0.5 hover:shadow-[0_18px_45px_rgba(0,0,0,0.5)] hover:border-white/20 [html[data-theme='light']_&]:shadow-[0_8px_20px_rgba(0,0,0,0.08)] [html[data-theme='light']_&]:hover:shadow-[0_12px_28px_rgba(0,0,0,0.12)]",Qv="flex flex-col gap-3 md:flex-row md:items-baseline md:justify-between mb-5",Jv="text-[11px] uppercase tracking-[0.16em] text-fg-muted mb-3",Zv="text-[20px] font-semibold tracking-[0.02em]",Kv="text-[13px] text-fg-muted leading-relaxed",Wv="text-[11px] px-2.5 py-1 rounded-full border border-(--border-subtle) text-fg-muted",$v=()=>{const[t,a]=D.useState(null),[l,u]=D.useState(null),[s,c]=D.useState(!1),[f,m]=D.useState(0),p=D.useRef(null);D.useEffect(()=>{const b=new Pv;return p.current=b,b.onmessage=x=>{a(x.data.result),u(x.data.time),c(!1)},()=>{p.current?.terminate(),p.current=null}},[]),D.useEffect(()=>{let b;const x=()=>{m(S=>(S+2)%360),b=requestAnimationFrame(x)};return b=requestAnimationFrame(x),()=>cancelAnimationFrame(b)},[]);const h=()=>{p.current&&(c(!0),a(null),u(null),p.current.postMessage({type:"CALCULATE_FIBONACCI",number:45}))};return g.jsxs("section",{id:"lab",className:"mb-14",children:[g.jsxs("div",{className:Qv,children:[g.jsxs("div",{children:[g.jsx("p",{className:Jv,children:"Web Worker Lab"}),g.jsx("h2",{className:Zv,children:"스레드 분리 실험"})]}),g.jsx("p",{className:Kv,children:"무거운 계산을 Worker로 분리하여 메인 스레드(UI)를 보호합니다."})]}),g.jsx("div",{className:Xv,children:g.jsxs("div",{className:"grid items-center gap-5 md:grid-cols-2",children:[g.jsxs("div",{children:[g.jsxs("div",{className:"flex items-center justify-between gap-2 mb-2",children:[g.jsx("h3",{className:"text-[15px] font-medium",children:"Fibonacci Calculator"}),g.jsx("span",{className:Wv,children:"Worker Thread"})]}),g.jsxs("p",{className:"text-[13px] text-fg-muted leading-[1.7] mb-5",children:["'계산 시작'을 누르면"," ",g.jsx("strong",{children:"DP가 아닌 피보나치 수열(45번째)"}),"을 계산합니다. 메인 스레드였다면 화면이 멈췄겠지만, Web Worker 덕분에 우측 애니메이션은 멈추지 않습니다."]}),g.jsx("button",{onClick:h,disabled:s,className:"w-full inline-flex items-center justify-center gap-2 text-[13px] px-4 py-2.5 rounded-full border border-(--border-subtle) bg-(--bg-elevated) text-fg enabled:hover:bg-(--bg-soft) enabled:hover:border-white/20 enabled:hover:-translate-y-0.5 transition-all duration-200 ease-out cursor-pointer disabled:cursor-not-allowed disabled:opacity-60",children:s?g.jsxs(g.Fragment,{children:[g.jsx("span",{className:"inline-flex h-4 w-4 items-center justify-center",children:g.jsx("span",{className:"h-3 w-3 rounded-full border border-current border-t-transparent animate-spin"})}),g.jsx("span",{children:"계산 중..."})]}):"▶ 무거운 계산 시작 (Fib 45)"})]}),g.jsxs("div",{className:"relative flex flex-col items-center justify-center min-h-[160px] h-full rounded-2xl border border-(--border-subtle) bg-(--bg) px-5 py-4 overflow-hidden",children:[g.jsx("div",{className:"absolute top-3 right-3 text-[10px] text-fg-muted",children:"Main Thread UI"}),g.jsx("div",{className:"w-6 h-6 rounded-md mb-3 bg-[linear-gradient(135deg,var(--fg),var(--fg-muted))]",style:{transform:`rotate(${f}deg)`}}),g.jsx("span",{className:"text-[11px] text-fg-muted",children:"▲ UI Frame (Always Running)"}),g.jsx("div",{className:"w-full h-px my-4 bg-(--border-subtle)"}),g.jsxs("div",{className:"text-center",children:[g.jsx("div",{className:"text-[11px] text-fg-muted",children:"Result (Fib 45)"}),g.jsx("div",{className:"text-[24px] font-semibold my-1",children:t!==null?t.toLocaleString():"-"}),g.jsx("div",{className:"text-[10px] text-fg-muted",children:l!==null?`Time: ${l.toFixed(1)}ms`:"-"})]})]})]})})]})},eS={id:"gdsc-1st-team-lead-ai-project",title:"Google Developer Student Clubs (GDSC) 1기 팀장",subTitle:"AI 분리수거 리워드 앱 개발 (팀장)",period:["2022.09","2023.08"],mainContent:["GDSC 1기 멤버이자 팀장으로서 Flutter, TensorFlow, Firebase를 활용한 AI 분리수거 리워드 앱 개발 프로젝트 주도.","3개월 단기 프로젝트의 성공을 위해 기획 단계에서 기능 우선순위를 명확히 선정하고, 일정 및 리스크를 면밀히 관리.","TensorFlow 기반 이미지 분류 모델 학습을 수행하고 모바일 환경에 맞춰 최적화.","Firebase를 활용하여 실시간 데이터베이스 연동 및 리워드 시스템 백엔드 기능 구현.","프론트엔드부터 AI 모델 서빙까지 전체적인 엔드투엔드(End-to-End) 시스템을 설계하고 운영."],result:"국내 50개 팀 중 8위달성, 전사적 시스템의 전략적 설계 및 통합 운영 역량 강화.",tags:["GDSC","Team Lead","Project Manager","AI/ML","Flutter","TensorFlow","Firebase","Agile","Git"],type:"activity"},nS=Object.freeze(Object.defineProperty({__proto__:null,gdscActivity:eS},Symbol.toStringTag,{value:"Module"})),tS={id:"ics-lab-research-tor-vpn",title:"ICS Lab 자기주도연구 (교내활동)",subTitle:"Tor와 VPN의 익명성 메커니즘 비교 및 다크웹 포렌식 기법 연구",period:["2024.03","2024.06"],mainContent:["Tor와 VPN의 암호화 프로토콜 및 익명성 메커니즘을 심층적으로 비교 분석.","다크웹 환경에서의 사용자 행위 추적 한계점을 파악하고 기술적 난제를 식별.","네트워크 트래픽, 메모리, 시스템 로그 분석을 통합한 실질적인 포렌식 기법 설계.","실제 환경과 유사한 시나리오를 구축하여 설계한 포렌식 기법의 유효성을 검증.","네트워크 보안 및 디지털 포렌식 분야에 기여하며 문제 해결 능력과 독립적인 연구 수행 역량을 향상."],result:"Tor와 VPN의 익명성 차이를 명확히 규명 및 다크웹 사용자 행위 추적을 위한 실질적 포렌식 기법 논문 작성.",tags:["Research","Security","Forensics","Darkweb","Network"],type:"activity"},rS=Object.freeze(Object.defineProperty({__proto__:null,icsLabActivity:tS},Symbol.toStringTag,{value:"Module"})),lS={id:"samteo-night-school-vp",title:"봉사 중앙 동아리 샘터야학 (부회장)",subTitle:"야학 봉사 중앙 동아리 샘터야학 (부회장)",period:["2022.09","2024.08"],mainContent:["지역사회 어르신 대상 기초 국어, 수학, 영어 검정고시반 운영 및 수업 봉사 진행 (총 2년 활동).","2023년부터 부회장직을 수행하며 동아리 운영, 기획, 홍보 전반을 총괄.","체계적인 수업 커리큘럼을 구성하고 신규 봉사자 교육을 주도하여 수업 질 향상.","동아리원들의 협력을 유도하고 어르신 맞춤형 학습 지원을 통해 성공적인 운영 견인.","조직 관리 및 기획 경험을 통해 실질적인 리더십과 조직 운영 능력을 발전."],result:"교내 동아리 콘테스트 금상 수상, VMS 우수 지역사회 봉사단 선정(2023.06).",tags:["Volunteering","Education","Club","Leadership","Management"],type:"activity"},aS=Object.freeze(Object.defineProperty({__proto__:null,samteoActivity:lS},Symbol.toStringTag,{value:"Module"})),iS={id:"whois-mentor-cl123",title:"Whois 정보보안 소학회 (멘토)",subTitle:"사이버보안학과 내 정보보안 소학회 (멘토)",period:["2019.03","2024.08"],mainContent:["1학년부터 Whois 정보보안 소학회 회원으로 활동하며 웹 프로그래밍, C 언어, 자료구조 스터디에 참여.","3학년부터는 '멘토'로 참여하여 후배 대상 보안 및 개발 관련 교육을 주도적으로 진행.","5년 6개월간 회원 → 멘토로 성장하며 보안 교육 주도","체계적인 커리큘럼 설계와 실습 중심 교육 방식을 도입하여 후배들의 이해도와 학습 효과를 크게 향상."],result:"기술적인 전문성 향상뿐만 아니라, 멘토로서의 리더십과 교육 능력 발전.",tags:["Security","Mentoring","Club","Education","Leadership"],type:"activity"},uS=Object.freeze(Object.defineProperty({__proto__:null,whoisMentorActivity:iS},Symbol.toStringTag,{value:"Module"})),sS={id:"likelion-11th-scrum-master",title:"멋쟁이 사자처럼 11기 (스크럼 마스터)",subTitle:"React.js 및 Flutter WebView 활용 일정 관리 앱 개발 (스크럼 마스터)",period:["2023.03","2023.09"],mainContent:["멋쟁이 사자처럼 11기 멤버로 활동하며 React.js와 Flutter WebView를 활용한 일정 관리 애플리케이션 제작 프로젝트 참여.","프로젝트 개발 과정에 스크럼(Scrum) 애자일 방법론을 적극적으로 적용.","스크럼 마스터 역할을 맡아 전반적인 프로젝트 관리(일정, 이슈 조율)와 팀워크 강화를 주도.","멘토링을 통해 스크럼 마스터로서 효과적인 스프린트 계획 및 실행 방법에 대한 실무적 인사이트를 학습하고 적용."],result:"스크럼 마스터 경험을 통해 프로젝트 관리 능력 및 팀워크 역량 강화, 애자일 스크럼 프로세스에 대한 실무적 이해를 증진.",tags:["Like Lion","Club","Project Development","Scrum Master","Agile","React.js","Flutter","Teamwork"],type:"activity"},oS=Object.freeze(Object.defineProperty({__proto__:null,likelionActivity:sS},Symbol.toStringTag,{value:"Module"})),cS={id:"cyber-security-student-council-director",title:"사이버보안학과 학생회 (집행국장)",subTitle:"사이버보안학과 학생회",period:["2022.09","2023.12"],mainContent:["사이버보안학과 학생회 `Cloud`의 집행국장으로서 학과 내 주요 행사 및 학습 커뮤니티 운영을 기획하고 실행.","SW 교육과 IT 트렌드 공유를 위한 스터디 프로그램을 직접 기획 및 운영.","학우들의 요구사항을 면밀히 조사하여 다양한 학습 스타일과 참여 가능 시간을 고려한 커리큘럼 설계 및 조율을 주도.","단순 행사를 넘어 세미나 등 참여 중심의 운영과 피드백 기반의 개선 활동을 주기적으로 수행.","다른 학생회원들과의 협력 과정에서 의견 조율, 역할 분담, 갈등 완화 등 리더십을 발휘."],result:"후배와 학우들의 학습 성장을 이끌며 학생회 목표 설정 및 강점 활용 역할 배분으로 조직 주도, 프로젝트 기획 및 이해관계자간 조율 역량을 향상.",tags:["Student Council","Leadership","Planning","Communication","Management","Community"],type:"activity"},fS=Object.freeze(Object.defineProperty({__proto__:null,studentCouncilActivity:cS},Symbol.toStringTag,{value:"Module"})),dS="text-[11px] px-2.5 py-1.5 rounded-full bg-(--bg-soft) border border-(--border-subtle) text-fg-muted",hS={"trouble-shooting":"text-red-400 border-red-400/30",learning:"text-blue-400 border-blue-400/30",achievement:"text-green-400 border-green-400/30","side-project":"text-purple-400 border-purple-400/30",activity:"text-yellow-400 border-yellow-400/30"},mS={"trouble-shooting":"Trouble Shooting",learning:"Learning",achievement:"Achievement","side-project":"Side Project",activity:"Activity"},_p=({activity:t,isActive:a})=>g.jsx("article",{className:"w-full min-h-[320px] flex flex-col","aria-hidden":!a,children:g.jsxs("div",{className:"w-full flex-1 px-5 py-5 md:px-7 md:py-6 flex flex-col justify-between",children:[g.jsxs("div",{className:"flex w-full flex-col gap-3",children:[g.jsxs("div",{className:"flex w-full justify-between items-center gap-2",children:[g.jsx("span",{className:`inline-flex items-center text-[10px] uppercase tracking-wider px-2.5 py-1 rounded-full border ${hS[t.type]}`,children:mS[t.type]}),g.jsx("span",{className:`hidden md:inline-block px-3 py-1 rounded-full\r
                         border border-(--border-subtle) bg-(--bg-soft)\r
                         text-[11px] text-fg-muted`,children:t.period.join(" ~ ")})]}),g.jsx("h3",{className:"text-[18px] md:text-[19px] font-semibold text-fg leading-snug",children:t.title}),g.jsx("p",{className:"text-[12px] md:text-[13px] text-fg-muted",children:t.subTitle}),g.jsx("div",{className:"text-[13px] text-fg-muted leading-[1.7]",children:g.jsx("ul",{className:"space-y-1.5",children:t.mainContent.map((l,u)=>g.jsxs("li",{className:"flex",children:[g.jsx("span",{className:"mt-[3px] mr-1 text-[10px]",children:"•"}),g.jsx("span",{children:l})]},u))})}),t.result&&g.jsx("p",{className:"text-[12px] md:text-[13px] text-green-400",children:t.result}),g.jsx("div",{className:"flex flex-wrap gap-1.5",children:t.tags.map(l=>g.jsx("span",{className:dS,children:l},l))})]}),t.link&&g.jsx("div",{className:"mt-3",children:g.jsxs("a",{href:t.link.href,target:"_blank",rel:"noreferrer",className:`inline-flex items-center gap-1 text-[12px] text-fg-muted\r
                         hover:text-fg transition-colors duration-200`,children:[g.jsx("span",{children:t.link.label}),g.jsx("span",{children:"↗"})]})})]})}),Nu=({isActive:t,isPaused:a,duration:l,size:u=16,strokeWidth:s=2})=>{const c=(u-s)/2,f=2*Math.PI*c;return g.jsxs("div",{className:"relative flex items-center justify-center",style:{width:u,height:u},children:[g.jsx("svg",{className:"absolute",width:u,height:u,style:{transform:"rotate(-90deg)"},children:g.jsx("circle",{cx:u/2,cy:u/2,r:c,fill:"none",className:"stroke-(--border-subtle)",strokeWidth:s,opacity:.4})}),g.jsx("svg",{className:"absolute",width:u,height:u,style:{transform:"rotate(-90deg)"},children:g.jsx("circle",{cx:u/2,cy:u/2,r:c,fill:"none",className:"stroke-(--accent)",strokeWidth:s,strokeLinecap:"round",style:{strokeDasharray:f,strokeDashoffset:t?0:f,transition:t?`stroke-dashoffset ${l}ms linear`:"stroke-dashoffset 0ms",animationPlayState:a?"paused":"running"}})}),g.jsx("span",{className:["w-2 h-2 rounded-full","transition-all duration-200 ease-out",t?"bg-(--accent)":"bg-(--bg-elevated) border border-(--border-subtle)"].join(" ")})]})},dc=4e3,Dp=500,pS=Object.assign({"./data/GDSC/index.ts":nS,"./data/ICSLab/index.ts":rS,"./data/Samtor/index.ts":aS,"./data/Whois/index.ts":uS,"./data/lion/index.ts":oS,"./data/majorClub/index.ts":fS}),Ma=Object.values(pS).map(t=>t.default??Object.values(t)[0]),gS="flex flex-col gap-3 md:flex-row md:items-baseline md:justify-between mb-3",xS="text-[11px] uppercase tracking-[0.16em] text-fg-muted mb-3",bS="text-[20px] font-semibold tracking-[0.02em]",yS=()=>{const[t,a]=D.useState(0),[l,u]=D.useState(!0),[s,c]=D.useState(!1),[f,m]=D.useState(!1),p=D.useRef(null),h=D.useRef(null),b=D.useRef(0),x=D.useRef(0),S=Ma.length;D.useEffect(()=>{const _=()=>{typeof window>"u"||m(window.innerWidth<1e3)};return _(),window.addEventListener("resize",_),()=>window.removeEventListener("resize",_)},[]);const v=D.useCallback(()=>{a(_=>(_+1)%S)},[S]),C=D.useCallback(()=>{a(_=>(_-1+S)%S)},[S]),R=D.useCallback(_=>{a(_),u(!1),setTimeout(()=>u(!0),3e3)},[]);D.useEffect(()=>{if(!l||s){h.current&&(clearInterval(h.current),h.current=null);return}return h.current=setInterval(()=>{v()},dc),()=>{h.current&&clearInterval(h.current)}},[l,s,v]),D.useEffect(()=>{const _=K=>{K.key==="ArrowLeft"?C():K.key==="ArrowRight"&&v()};return window.addEventListener("keydown",_),()=>window.removeEventListener("keydown",_)},[v,C]);const z=_=>{b.current=_.touches[0].clientX},j=_=>{x.current=_.touches[0].clientX},H=()=>{if(!b.current||!x.current)return;const _=b.current-x.current;Math.abs(_)>50&&(_>0?v():C()),b.current=0,x.current=0};return g.jsxs("section",{id:"activity",className:"mb-13",children:[g.jsx("div",{className:gS,children:g.jsxs("div",{children:[g.jsx("p",{className:xS,children:"Activity"}),g.jsx("h2",{className:bS,children:"대외 활동"})]})}),f?g.jsxs("div",{className:"flex flex-col gap-6",onMouseEnter:()=>c(!0),onMouseLeave:()=>c(!1),children:[g.jsx("div",{ref:p,className:"w-full overflow-hidden",onTouchStart:z,onTouchMove:j,onTouchEnd:H,children:g.jsx("div",{className:`\r
                flex w-full\r
                transition-transform\r
                duration-700\r
                ease-[cubic-bezier(0.22,0.61,0.36,1)]\r
                will-change-transform\r
              `,style:{transform:`translate3d(-${t*100}%, 0, 0)`},children:Ma.map((_,K)=>g.jsx("div",{className:"w-full shrink-0 flex justify-center px-3",children:g.jsx("div",{className:"w-full max-w-3xl rounded-3xl border border-(--border-subtle) bg-(--bg-elevated) shadow-[0_14px_34px_rgba(0,0,0,0.32)] [html[data-theme='light']_&]:shadow-[0_8px_20px_rgba(0,0,0,0.08)]",children:g.jsx(_p,{activity:_,isActive:K===t})})},_.id))})}),g.jsxs("div",{className:"relative mt-2 flex justify-center w-full px-3 overflow-visible min-h-[60px]",children:[g.jsx("div",{className:"h-px w-full max-w-3xl bg-(--border-subtle) opacity-70"}),g.jsx("div",{className:"absolute inset-x-0 -top-2 flex justify-between max-w-3xl mx-auto px-4 sm:px-6",children:Ma.map((_,K)=>{const re=K===t;return g.jsxs("button",{type:"button",className:"relative flex flex-col items-center outline-none cursor-pointer shrink-0",onMouseEnter:()=>R(K),onClick:()=>R(K),"aria-label":`${_.title}로 이동`,children:[g.jsx("span",{className:["mb-1 h-[3px] w-5 sm:w-7 rounded-full","bg-(--border-subtle)",re?"animate-border-pulse":"opacity-40"].join(" ")}),g.jsx(Nu,{isActive:re,isPaused:s||!l,duration:dc,size:16,strokeWidth:2}),g.jsx("span",{className:"mt-1 text-[9px] sm:text-[10px] text-fg-muted max-w-[60px] sm:max-w-[80px] text-center line-clamp-2",children:_.subTitle})]},_.id)})})]})]}):g.jsxs("div",{className:"flex flex-col md:flex-row gap-8",onMouseEnter:()=>c(!0),onMouseLeave:()=>c(!1),children:[g.jsx("div",{className:"w-64 shrink-0",children:g.jsxs("div",{className:"relative py-4",style:{height:Dp},children:[g.jsx("div",{className:"absolute left-[19px] top-4 bottom-4 w-px bg-(--border-subtle) opacity-70"}),g.jsx("div",{className:"relative h-full flex flex-col justify-evenly",children:Ma.map((_,K)=>{const re=K===t;return g.jsxs("button",{type:"button",className:"relative flex items-center gap-4 outline-none cursor-pointer group/point text-left pl-1",onMouseEnter:()=>R(K),onClick:()=>R(K),"aria-label":`${_.title}로 이동`,children:[g.jsxs("div",{className:"relative z-10 flex items-center justify-center w-8 h-8 shrink-0",children:[re&&g.jsx("div",{className:"absolute inset-0 bg-blue-500/10 rounded-full blur-sm"}),g.jsx(Nu,{isActive:re,isPaused:s||!l,duration:dc,size:18,strokeWidth:2})]}),g.jsx("div",{className:"flex flex-col",children:g.jsx("span",{className:["text-[13px] font-medium transition-colors duration-200",re?"text-fg":"text-fg-muted group-hover/point:text-fg-subtle"].join(" "),children:_.subTitle})})]},_.id)})})]})}),g.jsx("div",{ref:p,className:"flex-1 w-full overflow-hidden",style:{height:Dp},children:g.jsx("div",{className:`\r
                flex flex-col \r
                h-full w-full\r
                transition-transform \r
                duration-700 \r
                ease-[cubic-bezier(0.22,0.61,0.36,1)]\r
                will-change-transform\r
              `,style:{transform:`translate3d(0, -${t*100}%, 0)`},children:Ma.map((_,K)=>g.jsx("div",{className:"h-full w-full shrink-0 flex items-center justify-center",children:g.jsx("div",{className:"w-full max-h-full overflow-y-auto rounded-3xl border border-(--border-subtle) bg-(--bg-elevated) shadow-[0_14px_34px_rgba(0,0,0,0.32)] [html[data-theme='light']_&]:shadow-[0_8px_20px_rgba(0,0,0,0.08)]",children:g.jsx(_p,{activity:_,isActive:K===t})})},_.id))})})]})]})},vS="/portfolio/assets/banner-DP2kVVDA.png",SS={id:"llm-lstm-bert",banner:vS,title:"리뷰 왓수다 (감성 분석 & 평점 예측)",subTitle:"리뷰 왓수다",subtitle:"SNS/포털 영화 리뷰 감성 분석 및 평점 예측 AI 서비스",summary:"자연어 처리(NLP)와 딥러닝(LSTM/BERT)을 활용하여 텍스트 리뷰의 감성을 분석하고 평점을 예측하는 AI 모델을 개발했습니다. 정형화되지 않은 SNS 리뷰 데이터의 가치를 재발견했습니다.",tags:["Python","TensorFlow","KoNLPy","BERT","Selenium"],links:[{label:"Github",href:"#"},{label:"Demo",href:"#"}],period:"2022.09 – 2022.12",team:"AI Developer 2명, Data Analyst 1명",overview:"단순 별점만으로는 알 수 없는 구체적인 영화 평가를 분석하기 위해 시작된 프로젝트입니다. 네이버 영화 리뷰뿐만 아니라 유튜브, 인스타그램 등 평점 시스템이 없는 SNS의 텍스트 리뷰를 크롤링하여, LSTM과 BERT 모델을 통해 감성(긍정/부정)을 분류하고 예상 평점을 도출하는 시스템을 구축했습니다.",why:[{title:"Why NLP? (KoNLPy & Okt)",desc:"한글은 조사와 어미가 발달한 교착어이므로, 단순 띄어쓰기 기준 토큰화로는 의미 파악이 어렵습니다. 형태소 분석기(Okt)를 도입하여 불용어를 제거하고 실질 형태소만 추출함으로써 모델의 학습 효율을 극대화했습니다."},{title:"Why Hybrid Model? (LSTM & BERT)",desc:"순차적 데이터 처리에 강한 LSTM으로 가벼운 초기 모델을 구축하고, 문맥 양방향 이해도가 높은 BERT(KoBERT)를 도입하여 복잡한 구어체 리뷰의 감성 분류 정확도를 높이는 비교 연구를 수행했습니다."}],role:{percentage:"40% (Data Engineering & Model Training)",tasks:["데이터 파이프라인 구축: Selenium을 활용한 네이버 영화/SNS 리뷰 크롤링 및 CSV 데이터셋(200,000+) 구축","데이터 전처리(Preprocessing): 중복/결측치 제거, 정규 표현식을 이용한 특수문자 정제, KoNLPy 활용 형태소 분석 및 불용어 처리","LSTM 모델 설계 및 학습: Keras Tokenizer를 이용한 정수 인코딩, Padding 처리, 임베딩 레이어 및 LSTM 레이어 구성","성능 최적화: 리뷰 길이 분포 분석을 통한 최적 max_len 설정, 과적합(Overfitting) 방지를 위한 Dropout 및 Early Stopping 적용"]},troubleshooting:[{title:"데이터 불균형으로 인한 예측 편향(Bias) 문제 해결",problem:"초기 모델 학습 시, 긍정 리뷰(평점 8~10점)가 압도적으로 많아 모델이 무조건 '긍정'으로 예측하는 경향(Overfitting) 발생.",cause:"영화 리뷰 데이터 특성상 고평점 리뷰가 저평점보다 3배 이상 많은 'Class Imbalance' 상태였음.",solution:"Oversampling(SMOTE) 대신 데이터의 현실성을 유지하기 위해 Undersampling 기법을 적용하여 라벨별 비율을 1:1로 맞추고, 평점 구간을 1~10에서 1~5로 축소(Binning)하여 클래스 간 경계를 명확히 함.",learning:"모델의 아키텍처만큼이나 '데이터의 질과 분포'가 성능에 결정적인 영향을 미친다는 것을 체감함."},{title:"OOV(Out-Of-Vocabulary) 문제와 임베딩 품질 저하",problem:"신조어나 오타가 많은 SNS 리뷰 특성상, 학습된 단어 사전에 없는 단어(OOV)가 많아 모델의 정확도가 떨어짐.",cause:"기존 형태소 분석기 사전이 최신 인터넷 용어(예: '존잼', '노잼', '핵노잼')를 제대로 인식하지 못함.",solution:"Soynlp와 같은 비지도 학습 기반 토크나이저를 검토했으나, 데이터양의 한계로 사용자 지정 사전(User Dictionary)에 빈도수 높은 신조어를 수동으로 추가하여 형태소 분석기의 커버리지를 넓힘.",learning:"도메인 특화 데이터(SNS 리뷰)를 다룰 때는 범용 라이브러리에만 의존하지 않고, 데이터 특성에 맞는 전처리 커스터마이징이 필수적임을 배움."}],results:["LSTM 모델 정확도 85% 달성 (기존 베이스라인 대비 15% 향상)","평점 없는 SNS 텍스트 리뷰를 1~5점 척도로 정량화하는 모델 구축","비정형 데이터(댓글)의 시각화를 통해 영화 마케팅 인사이트 도출 가능성 확인"],images:[]},kS=Object.freeze(Object.defineProperty({__proto__:null,llmProject:SS},Symbol.toStringTag,{value:"Module"})),wS="/portfolio/assets/banner-CHMNdFhc.png",CS={id:"mogang",banner:wS,title:"모강(SW 강의용 다나와 서비스)",subTitle:"모강",subtitle:"SW 강의용 다나와 서비스 (강의 비교 플랫폼)",summary:"수강하고 싶은 SW 강의를 선택하기 어려운 소비자들을 위해 1000+개의 강의 데이터를 수집·비교하는 플랫폼입니다. 2024학년도 후배들을 대상으로 배포하여 50+명의 긍정적인 반응을 얻었습니다.",tags:["Next.js","TypeScript","SSR","Styled-Components"],links:[{label:"Github",href:"#"}],period:"2023.9 ~ 2024.03",team:"Frontend 1명, Backend 1명, 기획 2명, Designer 1명",overview:"수강하고 싶은 SW 강의를 선택하기 어려운 소비자들을 위한 'SW 강의용 다나와' 서비스입니다. 1000개 이상의 방대한 강의 데이터를 효율적으로 처리하고 비교하기 위해 Next.js(SSR)를 도입했습니다. 실제 교내 후배들을 대상으로 서비스를 제공하여 50명 이상의 유저로부터 긍정적인 피드백을 도출했습니다.",why:[{title:"Why Next.js? (SSR 도입)",desc:"1000개 이상의 강의 데이터를 처리하는 데 있어 클라이언트 사이드 렌더링(CSR)보다 서버 사이드 렌더링(SSR) 방식이 초기 로딩 속도와 검색 엔진 최적화(SEO) 측면에서 효율적이라 판단했습니다."},{title:"성장과 학습",desc:"CSR과 SSR의 차이를 이론을 넘어 직접 구현하며 비교해보고 싶었습니다. SSR이 모던 웹의 주요 렌더링 방식으로 떠오름에 따라, 기존 React 기반 지식과 비교하며 기술적 성장을 이루고자 했습니다."}],role:{percentage:"100% (Frontend Lead)",tasks:["Next.js 기반 SSR 아키텍처 설계: 초기 페이지 SSR 렌더링으로 SEO 및 LCP(Largest Contentful Paint) 최적화","SEO 및 성능 최적화: getServerSideProps, next/head 활용 메타 태그 동적 구성, Code Splitting(dynamic import) 및 next/image로 Lighthouse 90점+ 달성","추천 알고리즘 기반 렌더링: 유저 프로필/로그 기반 추천 리스트 UI 구현 및 Context API를 활용한 전역 상태 관리로 Props Drilling 해결","UI/UX 고도화: Atomic Design 패턴 일부 도입으로 컴포넌트 재사용성 강화, Skeleton UI 및 Framer-Motion 애니메이션 적용","반응형 웹 및 크로스 브라우징: Styled-Components 활용, viewport-units-buggyfill로 모바일(iOS/Android) 뷰포트 이슈 해결"]},troubleshooting:[{title:"무한 스크롤 중복 호출(Race Condition) 이슈 해결",problem:"스크롤이 하단에 도달할 때 데이터 로딩 중임에도 fetchNextPage()가 중복 호출되어, 불필요한 API 요청과 UI 중복 렌더링 발생. 특히 네트워크가 느리거나 Skeleton UI가 작을 때 심화됨.",cause:"react-infinite-scroll-component 라이브러리의 내부 스크롤 이벤트 감지 속도가 상태 업데이트(loading state)보다 빨라, 로딩 상태가 true로 변하기 전에 이벤트가 다시 트리거되는 Race Condition 발생.",solution:"1차로 isLoading 플래그를 도입해 중복 실행을 Guard Clause로 차단하고, 2차로 IntersectionObserver를 직접 구현하여 DOM 요소의 가시성(Visibility)을 정밀하게 감지하는 방식으로 제어권을 확보.",learning:"라이브러리에 의존하기보다 내부 동작 원리(DOM 감지 등)를 이해하는 것이 중요함을 깨달음. 비동기 상태 관리 시 Race Condition 위험을 인지하고 IntersectionObserver를 직접 다루며 제어 경험을 쌓음."}],results:["2023년 창업 동아리 캡스톤 디자인 평가 5위 (전체 25개 팀 중)","교내 소학회 내 소스코드 오픈 및 웹 개발 스터디 교재로 활용 (지식 공유)","실제 후배 50+명 대상 베타 테스트 진행 및 긍정적 반응 도출"],images:[]},TS=Object.freeze(Object.defineProperty({__proto__:null,mogangProject:CS},Symbol.toStringTag,{value:"Module"})),ES="/portfolio/assets/banner-DIUHLUxm.png",AS={id:"p2p-service",banner:ES,title:"Multi-Client FTP Server",subTitle:"P2P Service",subtitle:"리눅스 시스템 콜 기반의 동시성 파일 전송 서버",summary:"C언어와 리눅스 시스템 콜을 직접 활용하여 다중 접속을 지원하는 FTP 서버입니다. Fork 기반 멀티프로세싱과 파일 락(Flock)을 통해 데이터 무결성을 보장하는 동시성 제어를 구현했습니다.",tags:["C","Linux","Socket Programming","System Call","Multi-Processing"],links:[{label:"Github",href:"#"}],period:"2023.09 ~ 2023.12",team:"Individual (100%)",overview:"네트워크 프로그래밍의 핵심인 소켓(Socket)과 리눅스 시스템 콜(System Call)을 깊이 있게 이해하기 위해 시작된 프로젝트입니다. 단순 1:1 전송을 넘어, `fork()`를 활용해 여러 클라이언트가 동시에 접속하여 파일을 업로드/다운로드할 수 있는 환경을 구축했고, 이 과정에서 발생하는 경쟁 상태(Race Condition)를 제어하기 위한 동기화 메커니즘을 설계했습니다.",why:[{title:"Why Low-Level Implementation?",desc:"고수준 라이브러리 없이 `open`, `read`, `write`, `socket` 등 커널 수준의 시스템 콜을 직접 다루며 OS가 I/O와 네트워크를 처리하는 방식을 근본적으로 이해하고자 했습니다."},{title:"Why Multi-Processing?",desc:"단일 프로세스 모델의 한계를 극복하고, 다수의 클라이언트 요청을 병렬적으로 처리하기 위해 `fork()`를 통한 자식 프로세스 생성 방식을 채택하여 독립적인 세션을 보장했습니다."}],role:{percentage:"100% (Individual)",tasks:["Socket 통신 아키텍처: TCP/IP 기반의 연결 지향형 통신 구현 (Bind, Listen, Accept, Connect)","동시성 처리 (Concurrency): `fork()` 시스템 콜을 활용한 다중 클라이언트 접속 처리 및 좀비 프로세스 방지(`waitpid`)","동기화 및 무결성: `flock`을 활용한 파일 잠금(Reader/Writer Lock) 메커니즘 구현으로 데이터 손상 방지","프로토콜 설계 및 기능 구현: 로그인 인증, 파일 리스트(ls), 업로드/다운로드, 삭제 등 커스텀 FTP 명령어 처리 로직 개발","예외 처리 및 시그널 핸들링: `SIGINT` 등 시그널 포착을 통한 안전한 서버/클라이언트 종료 처리"]},troubleshooting:[{title:"동시 파일 접근 시 데이터 무결성 훼손 (Race Condition)",problem:"여러 클라이언트가 동시에 같은 파일에 업로드하거나 삭제를 시도할 때, 파일 내용이 뒤섞이거나 손상되는 경쟁 상태가 발생함.",cause:"운영체제 레벨에서 파일 디스크립터에 대한 동시 접근 제어가 기본적으로 보장되지 않아, Critical Section에 대한 보호 장치가 부재했음.",solution:"`flock()` 시스템 콜을 도입하여 파일 접근 시 Advisory Lock을 걸도록 구현. 쓰기 작업 시에는 Exclusive Lock(배타적 잠금)을, 읽기 시에는 Shared Lock(공유 잠금)을 적용하여 동시성을 제어함.",learning:"멀티 프로세스 환경에서 공유 자원(파일) 관리의 중요성과 OS가 제공하는 동기화 도구(Lock)의 동작 원리를 체득함."},{title:"예기치 않은 연결 종료와 좀비 프로세스 이슈",problem:"클라이언트가 강제 종료(`Ctrl+C`)될 때 서버 측의 자식 프로세스가 제대로 회수되지 않고 좀비 프로세스로 남아 리소스를 점유하는 현상.",cause:"부모 프로세스가 자식 프로세스의 종료 상태를 수신(`wait`)하지 않아 프로세스 테이블에 엔트리가 남음.",solution:"`signal(SIGCHLD)` 핸들러를 등록하고, 핸들러 내부에서 `waitpid()`를 비봉쇄(WNOHANG) 모드로 호출하여 종료된 자식 프로세스를 즉시 회수하도록 로직 개선.",learning:"프로세스 생명주기 관리와 시그널(Signal) 처리를 통한 안정적인 데몬(Daemon) 서버 구조의 필요성을 배움."}],results:["다중 클라이언트 환경에서 안정적인 파일 업로드/다운로드/삭제 기능 구현 완료","Flock 적용 후 동시 접근 시 데이터 오염 0건 달성 (무결성 확보)","로그인 보안 및 접근 제어 로직을 통해 기본적인 보안 파일 서버 구축"],images:[]},jS=Object.freeze(Object.defineProperty({__proto__:null,p2pProject:AS},Symbol.toStringTag,{value:"Module"})),NS="/portfolio/assets/banner-h9P_7FQW.png",MS={id:"secure-chat",banner:NS,title:"Secure Chat (보안 채팅 프로그램)",subTitle:"Secure-Chat",subtitle:"Java Socket & RSA/AES 하이브리드 암호화 메신저",summary:"Java 소켓 프로그래밍으로 1:1 통신을 구현하고, RSA 비대칭키로 AES 대칭키를 안전하게 교환하여 도청이 불가능한 보안 채팅 시스템을 구축했습니다.",tags:["Java","Socket","RSA","AES-256","Multi-Thread"],links:[{label:"Github",href:"#"}],period:"2023.03 ~ 2023.06",team:"Individual (100%)",overview:"네트워크 통신의 기초인 소켓(Socket)을 활용해 1:1 채팅 프로그램을 구현하고, 그 위에 보안 계층을 입힌 프로젝트입니다. RSA 공개키 암호화 방식으로 대칭키(AES)를 안전하게 교환(Key Exchange)한 뒤, 실제 대화 내용은 AES-256으로 고속 암호화하여 전송하는 '하이브리드 암호화 시스템'을 직접 설계했습니다.",why:[{title:"Why Hybrid Encryption? (RSA + AES)",desc:"RSA는 보안성이 높지만 연산 속도가 느려 실시간 채팅에 부적합하고, AES는 빠르지만 키 배송(Key Distribution) 보안 문제가 있습니다. 이 둘을 결합해 '키 교환은 RSA, 메시지는 AES'로 처리하는 SSL/TLS의 기본 원리를 구현해보고자 했습니다."},{title:"Why Java Sockets?",desc:"고수준 라이브러리에 의존하지 않고, TCP 연결 수립(3-way handshake)부터 스트림(Stream) 데이터 처리, 스레드 관리까지 네트워크 통신의 로우 레벨 메커니즘을 깊이 있게 이해하기 위해 선택했습니다."}],role:{percentage:"100% (Individual)",tasks:["Socket 통신 아키텍처 설계: Server/Client 구조 및 Multi-thread(SendThread, ReceiveThread)를 이용한 양방향 비동기 통신 구현","RSA 키 교환 프로토콜 구현: Server의 공개키(Public Key) 생성 및 배포, Client의 AES 키 암호화 전송 및 Server의 복호화 로직(Key Exchange) 개발","AES-256 메시지 암호화: 대칭키 기반의 실시간 메시지 암호화/복호화 모듈(encryptAES256/decryptAES256) 구현","보안 무결성 검증: 송수신 양측의 평문(Plaintext)과 암호문(Ciphertext) 로그 비교를 통한 기밀성 및 해킹 안전성 검증"]},troubleshooting:[{title:"Socket 입력 스트림의 블로킹(Blocking I/O) 문제 해결",problem:"메시지를 수신하는 동안(readUTF) 스레드가 입력 대기 상태에 빠져, 내가 메시지를 보내고 싶어도(writeUTF) 전송이 불가능해지는 '반이중(Half-duplex)' 현상 발생.",cause:"Java의 기본 InputStream은 블로킹 방식이므로, 단일 스레드에서 송수신을 순차적으로 처리하려다 데드락과 유사한 대기 상태가 됨.",solution:"송신(SendThread)과 수신(ReceiveThread)을 담당하는 스레드를 분리(Multi-threading)하여, 입출력 작업이 서로를 차단하지 않고 독립적으로 수행되도록 아키텍처를 재설계함.",learning:"네트워크 I/O 처리 시 스레드 분리의 필요성과 동시성(Concurrency) 제어의 중요성을 체감함."},{title:"RSA 암호화 데이터 크기 제한(BadPaddingException) 해결",problem:"RSA로 데이터를 암호화할 때 간헐적으로 `javax.crypto.BadPaddingException` 오류가 발생하며 암호화에 실패함.",cause:"RSA 알고리즘은 키 크기(예: 2048bit)에 따라 한 번에 암호화할 수 있는 평문의 길이가 제한됨. 긴 문자열을 RSA로 직접 처리하려다 허용 범위를 초과함.",solution:"RSA는 오직 짧은 데이터인 'AES 대칭키' 교환에만 사용하고, 실제 긴 채팅 메시지는 블록 암호화 방식인 AES로 처리하도록 역할 분담을 명확히 하여 해결.",learning:"비대칭키 암호화의 용도(키 교환/서명)와 대칭키 암호화의 용도(데이터 암호화)를 구분해야 하는 기술적 이유를 명확히 이해함."}],results:["RSA-2048 및 AES-256 기반의 안전한 1:1 채팅 통신 성공","Wireshark 패킷 캡처 시 평문이 노출되지 않음을 확인 (기밀성 확보)","Server/Client 간 키 교환 및 암호화 통신 시연 성공 (터미널 로그 검증)"],images:[]},_S=Object.freeze(Object.defineProperty({__proto__:null,secureChatProject:MS},Symbol.toStringTag,{value:"Module"})),DS="/portfolio/assets/banner-xAa91UBm.png",OS={id:"ssangsang",banner:DS,title:"쌍상 (봉사 매칭 서비스)",subTitle:"쌍상",subtitle:"자원봉사자-수요자 매칭 크로스 플랫폼 웹앱",summary:"100+명의 동아리 회원이 사용하는 봉사 매칭 서비스. React 웹앱으로 개발하여 접근성을 높이고, 애자일 프로세스로 운영 중입니다.",tags:["React.js","TypeScript","Progressive Web App","Axios","Agile-Scrum"],links:[{label:"Github",href:"https://github.com/your-repo"},{label:"Live",href:"https://your-service.com"}],period:"2023.01 ~ 현재 운영중",team:"Frontend 2명, Backend 1명",overview:"자원봉사자와 봉사를 받고 싶어하는 사람들을 매칭하기 위한 웹/앱 크로스 플랫폼 서비스입니다. 현재 100명 이상의 동아리 회원들이 실제 봉사 신청 및 관리에 사용하고 있습니다.",why:[{title:"Why React?",desc:"컴포넌트 기반 아키텍처와 선언형 UI를 통해 재사용성과 유지보수성을 확보했습니다. 방대한 커뮤니티와 라이브러리 생태계를 활용해 개발 생산성을 높였습니다."},{title:"Why WebApp?",desc:"하나의 코드로 웹과 모바일 환경(크로스 플랫폼)에 모두 대응하며, 스토어 심사 없이 빠른 배포와 수정이 가능하여 애자일한 운영에 적합하다고 판단했습니다."}],role:{percentage:"60%",tasks:["React-Router-Dom을 활용한 SPA 페이지 전환 및 유저 권한별 접근 제어 (Protected Route) 구현","사용자 경험(UX) 개선: Percentage Loading Indicator, 스크롤 기반 페이지네이션(Infinite Scroll), Skeleton UI 적용","반응형 디자인: viewport width 기준 rem/flex Layout으로 다양한 디바이스 대응","Axios Interceptor를 활용한 Access Token 자동 갱신 및 공통 에러 핸들링 로직 구현","GitHub/Jira/Notion 기반의 애자일 스프린트 운영 및 코드 리뷰 주도"]},troubleshooting:[{title:"React StrictMode와 useEffect 중복 실행 문제",problem:"초기 렌더링 시 useEffect 내 API 호출이 두 번 발생하여 불필요한 트래픽 유발.",cause:"React 18 StrictMode의 개발 환경 특성(마운트-언마운트-마운트)으로 인한 현상. Side-Effect 검증 과정임을 이해.",solution:"AbortController를 활용하여 언마운트 시 이전 요청을 취소(Clean-up)하도록 리팩토링하여 안전한 비동기 처리 구현.",learning:"StrictMode가 잠재적 버그를 찾아주는 도구임을 이해하고, 클린업 함수(Clean-up) 작성의 중요성을 체감."},{title:"비동기 State 업데이트 시점 차이로 인한 필터링 오류",problem:"API로 데이터를 받아온(setVolunteers) 직후 필터링을 수행했으나, 빈 배열이 반환되는 문제 발생.",cause:"setState는 비동기적으로 동작하므로, 상태 업데이트가 완료되기 전에 다음 코드가 실행되어 초기값(빈 배열)을 참조함.",solution:"필터링 로직을 별도의 useEffect로 분리하고, volunteers 상태를 의존성 배열(dependency array)에 추가하여 데이터 변경 시점에 필터링이 수행되도록 수정.",learning:"React의 상태 업데이트 사이클과 의존성 배열의 역할을 명확히 이해하게 됨."}],results:["2023 동아리 콘테스트 금상 수상 (교내 2위)","2023년 6월 우수지역사회봉사단 선정 (VMS 인증)","실사용자 100+명 확보 및 주 단위 기능 개선 사이클 정착"],images:[]},RS=Object.freeze(Object.defineProperty({__proto__:null,ssangsangProjects:OS},Symbol.toStringTag,{value:"Module"})),zS="/portfolio/assets/banner-xHcB6NbG.png",LS={id:"vary-recycle",banner:zS,title:"Vary Recycle (분리수거 리워드 서비스)",subTitle:"Vary Recycle",subtitle:"Google 기술 기반, 분리수거 인식 및 리워드 제공 환경 문제 해결 서비스",summary:"UN SDGs(지속 가능한 개발 목표) 중 환경 분야를 대상으로 한 분리수거 리워드 서비스입니다. 80% 정확도의 Computer Vision AI로 쓰레기 종류를 인식하고, 올바른 분리수거 가이드를 제공하여 사용자 행동 변화를 이끌었습니다.",tags:["Flutter","Firebase Realtime Database","Firebase Authentication","TensorFlow","Computer Vision","Google Solution Challenge"],links:[{label:"Github",href:"https://github.com/your-vary-recycle"},{label:"프로젝트 진행과정",href:"https://your-notion-or-blog.com/vary-recycle"},{label:"소개영상",href:"https://youtu.be/your-vary-recycle-demo"}],period:"2022.09 ~ 2023.08",team:"Frontend 2명, Backend 1명, AI 모델 2명, 데이터 생성 1명",overview:"Vary Recycle은 사용자가 쓰레기를 촬영하면, AI가 실시간으로 종류를 인식하고 맞는 분리수거 방법을 안내해주는 리워드형 서비스입니다. 촬영–인식–가이드–리워드까지 하나의 플로우로 연결하여, 게임처럼 재미있게 분리수거 습관을 만들도록 설계했습니다.",why:[{title:"Why Flutter?",desc:"iOS/Android를 동시에 대응해야 했기 때문에, 단일 코드베이스로 크로스 플랫폼 개발이 가능한 Flutter를 선택했습니다. 위젯 기반 UI와 Hot Reload를 활용해 짧은 기간 내에 여러 화면을 빠르게 설계·반복 개선할 수 있었습니다."},{title:"Why Computer Vision 기반 분리수거?",desc:"환경 문제 해결의 가장 큰 허들은 '귀찮음'과 '정보 부족'이라고 보았습니다. 사용자가 이름을 일일이 입력하는 대신, 카메라 한 번으로 유리병/캔/종이/PET를 자동 분류하고, 바로 분리수거 가이드를 보여줌으로써 진입장벽을 최소화했습니다."}],role:{percentage:"50%",tasks:["Flutter 기반 하이브리드 앱 프론트엔드 개발 50% 담당: 홈, 촬영 화면, 결과 출력, 로그인 등 주요 화면 직접 설계 및 구현","LayoutBuilder, MediaQuery, Flexible 등을 활용해 다양한 해상도·비율에서 깨지지 않는 반응형 UI 구성","AnimatedContainer를 이용해 분리수거 결과에 따라 카드 색상/크기/위치를 애니메이션으로 표현, 사용자 피드백 강화","Firebase Realtime Database 연동: 분리수거 결과 및 AI 학습 로그를 실시간 저장·조회하는 데이터 플로우 구현","Firebase Authentication 적용: 이메일 로그인, 인증 토큰 만료 처리, 세션 유지 로직 설계 및 예외 상황(토큰 만료, 네트워크 에러) 처리","Firebase Security Rules 작성으로 사용자별 데이터 접근 제어 및 읽기/쓰기 권한 분리","TensorFlow 기반 Computer Vision 모델과의 연동을 위해 HTTP 인터페이스(REST API) 설계 및 Flutter 클라이언트 구현","AI 인퍼런스 결과(예: 라벨, 신뢰도)에 따라 UI가 자동으로 상태를 전환하도록 상태 기반 화면 전환 로직 구현","유리병/캔/종이/PET 4종에 대해 약 7,500장의 학습용 이미지 촬영 및 정제, 조명·각도·배경을 달리하여 데이터 다양성 확보 및 오버피팅 방지"]},troubleshooting:[{title:"앱 재실행 시 로그인 상태인데도 로그인 화면으로 라우팅되는 문제",problem:"Firebase Authentication을 사용해 이메일 로그인 기능을 구현했는데, 최초 로그인 후에는 정상 동작하지만 앱을 완전히 종료 후 재실행하면 로그인되어 있음에도 로그인 페이지로 잘못 라우팅되는 문제가 발생.",cause:"앱 시작 직후 FirebaseAuth.instance.currentUser를 바로 조회하면, Firebase가 아직 내부적으로 인증 상태를 복구하기 전이라 null을 반환할 수 있음. 인증 상태 복구가 비동기적으로 동작함에도 이를 고려하지 않고 currentUser만으로 초기 라우팅을 결정한 것이 원인이었음.",solution:"FirebaseAuth.instance.authStateChanges() 스트림을 StreamBuilder로 구독하는 방식으로 초기 라우팅 구조를 전면 수정. 인증 상태 복구 중에는 SplashScreen을 보여주고, snapshot.hasData 여부에 따라 HomePage 또는 LoginPage로 분기하도록 설계하여 비동기 복구 구간을 안전하게 처리함.",learning:"Firebase Authentication의 인증 상태 복구는 비동기이며, ‘로그인 여부’뿐만 아니라 ‘복구가 끝났는지 여부’까지 UI 상태로 분리해야 한다는 것을 배웠음. 이를 계기로 Flutter 위젯 생명주기, 비동기 흐름 제어, 상태 기반 라우팅의 중요성을 몸으로 이해하게 되었고, 이후 다른 프로젝트에서도 모든 초기 라우팅을 스트림/상태 기반으로 설계하게 되는 계기가 되었음."}],results:["2022년 교내 동계 모각소 활동 ‘최우수상’ 수상 (31개 팀 중 1위)","Google Solution Challenge Winter Cup 국내 Top 8 (40+팀 중 8위)","환경·분리수거 문화를 주제로 한 실제 사용자 테스트에서 ‘분리수거 가이드가 직관적이고 재미있다’는 피드백 다수 확보"],images:[]},US=Object.freeze(Object.defineProperty({__proto__:null,varyRecycleProjects:LS},Symbol.toStringTag,{value:"Module"})),BS=({project:t,isVisible:a,fromOffset:l,onClose:u})=>g.jsxs("div",{className:"fixed inset-0 z-[9999] flex items-center justify-center px-4 transition-opacity duration-200 "+(a?"opacity-100":"opacity-0 pointer-events-none"),children:[g.jsx("button",{className:"absolute inset-0 bg-black/60 backdrop-blur-sm",onClick:u,"aria-label":"Close project detail"}),g.jsx("div",{className:"relative z-50 w-full max-w-3xl max-h-[85vh] overflow-y-auto rounded-2xl border border-(--border-subtle) bg-(--bg-elevated) shadow-[0_20px_60px_rgba(0,0,0,0.7)] transition-[transform,opacity] duration-200 [&::-webkit-scrollbar]:w-3 [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-track]:rounded-r-2xl [&::-webkit-scrollbar-track]:my-2 [&::-webkit-scrollbar-thumb]:bg-gray-500 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:border-[3px] [&::-webkit-scrollbar-thumb]:border-(--bg-elevated) [&::-webkit-scrollbar-thumb:hover]:bg-gray-300",style:l?{transform:a?"translate3d(0,0,0) scale(1)":`translate3d(${l.x}px, ${l.y}px, 0) scale(0.9)`,transformOrigin:"center center"}:void 0,children:g.jsxs("div",{className:"p-6 md:p-8",children:[g.jsxs("div",{className:"flex justify-between items-start mb-6",children:[g.jsxs("div",{children:[g.jsx("h3",{className:"text-2xl font-bold mb-1",children:t.title}),t.subtitle&&g.jsx("p",{className:"text-sm text-fg-muted",children:t.subtitle})]}),g.jsx("button",{onClick:u,className:"p-2 rounded-full hover:bg-(--bg-soft) transition-colors",children:"✕"})]}),g.jsxs("div",{className:"flex flex-wrap gap-4 text-xs text-fg-muted mb-8 p-4 bg-(--bg-soft) rounded-xl",children:[t.period&&g.jsxs("div",{children:["📅 ",t.period]}),t.team&&g.jsxs(g.Fragment,{children:[g.jsx("div",{className:"w-px h-3 bg-(--border-subtle) self-center"}),g.jsxs("div",{children:["👥 ",t.team]})]})]}),g.jsxs("div",{className:"space-y-10 text-sm leading-relaxed text-fg-muted",children:[g.jsxs("section",{children:[g.jsx("h4",{className:"text-fg font-semibold text-base mb-3",children:"🔎 프로젝트 개요"}),g.jsx("p",{children:t.overview})]}),t.images&&t.images.length>0&&g.jsxs("section",{children:[g.jsx("h4",{className:"text-fg font-semibold text-base mb-3",children:"📸 Screen & Architecture"}),g.jsx("div",{className:"grid gap-4 md:grid-cols-2",children:t.images.map((s,c)=>g.jsxs("div",{className:"space-y-2",children:[g.jsx("div",{className:"rounded-lg overflow-hidden border border-(--border-subtle) bg-(--bg) aspect-video relative",children:g.jsx("img",{src:s.src,alt:s.caption,className:"object-cover w-full h-full"})}),s.caption&&g.jsx("p",{className:"text-xs text-center text-fg-muted",children:s.caption})]},c))})]}),t.why&&g.jsxs("section",{children:[g.jsx("h4",{className:"text-fg font-semibold text-base mb-3",children:"💡 기술적 의사결정 (Why?)"}),g.jsx("div",{className:"grid gap-4 md:grid-cols-2",children:t.why.map((s,c)=>g.jsxs("div",{className:"p-4 rounded-xl border border-(--border-subtle) bg-(--bg)",children:[g.jsx("div",{className:"font-medium text-fg mb-2",children:s.title}),g.jsx("p",{className:"text-xs",children:s.desc})]},c))})]}),t.role&&g.jsxs("section",{children:[g.jsxs("h4",{className:"text-fg font-semibold text-base mb-3",children:["👩🏻‍💻 수행 역할 ( 기여도 ",t.role.percentage," )"]}),g.jsx("ul",{className:"list-disc pl-5 space-y-2",children:t.role.tasks.map((s,c)=>g.jsx("li",{children:s},c))})]}),t.troubleshooting&&g.jsxs("section",{children:[g.jsx("h4",{className:"text-fg font-semibold text-base mb-3",children:"🚨 트러블 슈팅"}),g.jsx("div",{className:"space-y-4",children:t.troubleshooting.map((s,c)=>g.jsxs("div",{className:"p-4 rounded-xl bg-[rgba(255,100,100,0.05)] border border-[rgba(255,100,100,0.1)]",children:[g.jsx("div",{className:"font-semibold text-fg mb-2",children:s.title}),g.jsxs("div",{className:"grid gap-2 text-xs",children:[g.jsxs("div",{children:[g.jsx("span",{className:"font-medium text-(--fg)",children:"문제:"})," ",s.problem]}),g.jsxs("div",{children:[g.jsx("span",{className:"font-medium text-(--fg)",children:"원인:"})," ",s.cause]}),g.jsxs("div",{children:[g.jsx("span",{className:"font-medium text-(--fg)",children:"해결:"})," ",s.solution]}),g.jsxs("div",{children:[g.jsx("span",{className:"font-medium text-(--fg)",children:"배움:"})," ",s.learning]})]})]},c))})]}),t.results&&g.jsxs("section",{children:[g.jsx("h4",{className:"text-fg font-semibold text-base mb-3",children:"✨ 성과"}),g.jsx("ul",{className:"space-y-2",children:t.results.map((s,c)=>g.jsxs("li",{className:"flex gap-2 items-center",children:[g.jsx("span",{className:"text-yellow-500",children:"🏆"}),g.jsx("span",{children:s})]},c))})]})]})]})})]}),hc=3e3,HS=Object.assign({"./data/LLM/LLM(LSTM-BERT).tsx":kS,"./data/Mogang/mogangData.tsx":TS,"./data/P2P/P2PService.tsx":jS,"./data/Secure-Chat/Secure-chat.tsx":_S,"./data/Ssang-sang/ssang-sangData.tsx":RS,"./data/Vary-Recycle/varyRecycle.tsx":US}),et=Object.values(HS).map(t=>t.default??Object.values(t)[0]),IS="flex flex-col gap-3 md:flex-row md:items-baseline md:justify-between mb-8",qS="text-[11px] uppercase tracking-[0.16em] text-fg-muted mb-3",VS="text-[20px] font-semibold tracking-[0.02em]",FS="text-[13px] text-fg-muted leading-relaxed",Op="text-[11px] px-2.5 py-1.5 rounded-full bg-(--bg-soft) border border-(--border-subtle) text-fg-muted",GS=()=>{const[t,a]=D.useState(0),[l,u]=D.useState(!1),[s,c]=D.useState(!1),[f,m]=D.useState(null),[p,h]=D.useState(!1),[b,x]=D.useState(null),S=Au.useRef(0),v=Au.useRef(0);D.useEffect(()=>{if(l||f)return;const A=setInterval(()=>{a(P=>(P+1)%et.length)},hc);return()=>clearInterval(A)},[l,f]);const[C]=D.useState(()=>et.map(()=>({jitterX:Math.random()*20-15,jitterY:Math.random()*30-15,baseRotate:Math.random()*16-10}))),[R,z]=D.useState(null);D.useEffect(()=>{if(typeof window>"u")return;const A=()=>{const P=window.innerWidth,J=P<768;console.log("Projects resize:",{width:P,mobile:J}),z(P),c(J)};return A(),window.addEventListener("resize",A),()=>window.removeEventListener("resize",A)},[]);const j=et.find(A=>A.id===f)||null,H=(A,P)=>{const J=P.getBoundingClientRect(),de=window.innerWidth,ae=window.innerHeight,ne=J.left+J.width/2,B=J.top+J.height/2,Z=de/2,ie=ae/2,be=ne-Z,T=B-ie;m(A),x({x:be,y:T}),requestAnimationFrame(()=>{h(!0)})},_=()=>{h(!1),setTimeout(()=>{m(null),x(null)},220)};D.useEffect(()=>{if(!j)return;const A=P=>{P.key==="Escape"&&_()};return window.addEventListener("keydown",A),()=>window.removeEventListener("keydown",A)},[j]),D.useEffect(()=>(j?document.body.style.overflow="hidden":document.body.style.overflow="",()=>{document.body.style.overflow=""}),[j]);const re=(()=>{if(!R)return 140;const A=R/(et.length+1);return Math.min(180,Math.max(70,A*.8))})(),q=(et.length-1)/2,ee=A=>{S.current=A.touches[0].clientX},oe=A=>{v.current=A.touches[0].clientX},W=()=>{if(!S.current||!v.current)return;const A=S.current-v.current;Math.abs(A)>50&&(A>0?a(J=>(J+1)%et.length):a(J=>(J-1+et.length)%et.length)),S.current=0,v.current=0};return g.jsxs(g.Fragment,{children:[g.jsxs("section",{id:"projects",className:"mb-16",children:[g.jsxs("div",{className:IS,children:[g.jsxs("div",{children:[g.jsx("p",{className:qS,children:"Projects"}),g.jsx("h2",{className:VS,children:"주요 프로젝트"})]}),g.jsx("p",{className:FS,children:"아래 포인트나 카드를 클릭하면 상세 모달을 볼 수 있습니다."})]}),s?g.jsxs("div",{className:"flex flex-col gap-6",onMouseEnter:()=>u(!0),onMouseLeave:()=>u(!1),children:[g.jsx("div",{className:"w-full overflow-hidden",onTouchStart:ee,onTouchMove:oe,onTouchEnd:W,children:g.jsx("div",{className:"flex w-full transition-transform duration-700 ease-[cubic-bezier(0.22,0.61,0.36,1)] will-change-transform",style:{transform:`translate3d(-${t*100}%, 0, 0)`},children:et.map(A=>g.jsx("div",{className:"w-full shrink-0 flex justify-center px-3",children:g.jsxs("article",{"data-project-id":A.id,className:"w-full max-w-3xl min-h-[320px] flex flex-col rounded-2xl bg-(--bg-elevated) shadow-[0_16px_36px_rgba(0,0,0,0.55)] [html[data-theme='light']_&]:shadow-[0_10px_24px_rgba(0,0,0,0.12)] border border-(--border-subtle) cursor-pointer overflow-hidden",onClick:P=>H(A.id,P.currentTarget),children:[A.banner&&g.jsxs("div",{className:"relative w-full h-32 shrink-0 overflow-hidden",children:[g.jsx("img",{src:A.banner,alt:"",className:"w-full h-full object-cover grayscale-[30%]"}),g.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-[color:rgba(0,0,0,0.6)] to-transparent"})]}),g.jsxs("div",{className:"relative flex flex-col flex-1 justify-between z-10 p-4 text-[13px] text-fg-muted leading-[1.6]",children:[g.jsxs("div",{children:[g.jsx("h3",{className:"mb-1.5 text-fg text-[15px] font-semibold tracking-[0.02em]",children:A.title}),g.jsx("p",{className:"text-[12px] mb-2.5 line-clamp-2 text-fg opacity-100",children:A.summary}),g.jsx("div",{className:"flex flex-wrap gap-1.5",children:A.tags.slice(0,6).map(P=>g.jsx("span",{className:Op,children:P},P))})]}),g.jsx("div",{className:"flex gap-3 text-[11px]  mt-3",children:A.links.map(P=>g.jsxs("a",{href:P.href,target:"_blank",rel:"noreferrer",className:"inline-flex items-center gap-1 text-fg-muted hover:text-fg hover:-translate-y-px transition-all duration-150 ease-out",onClick:J=>J.stopPropagation(),children:[g.jsx("span",{children:P.label}),g.jsx("span",{children:"↗"})]},P.label))})]})]})},A.id))})}),g.jsxs("div",{className:"relative mt-2 flex justify-center w-full px-3 overflow-visible min-h-[60px]",children:[g.jsx("div",{className:"h-px w-full max-w-3xl bg-(--border-subtle) opacity-70"}),g.jsx("div",{className:"absolute inset-x-0 -top-2 flex justify-between max-w-3xl mx-auto px-4 sm:px-6",children:et.map((A,P)=>{const J=P===t;return g.jsxs("button",{type:"button",className:"relative flex flex-col items-center outline-none cursor-pointer shrink-0",onMouseEnter:()=>a(P),onClick:()=>a(P),"aria-label":`${A.title}로 이동`,children:[g.jsx("span",{className:["mb-1 h-[3px] w-5 sm:w-7 rounded-full","bg-(--border-subtle)",J?"animate-border-pulse":"opacity-40"].join(" ")}),g.jsx(Nu,{isActive:J,isPaused:l,duration:hc,size:16,strokeWidth:2}),g.jsx("span",{className:"mt-1 text-[9px] sm:text-[10px] text-fg-muted max-w-[60px] sm:max-w-[80px] text-center line-clamp-2",children:A.subTitle})]},A.id)})})]})]}):g.jsxs("div",{className:"relative flex flex-col items-center",children:[g.jsx("div",{className:"relative w-full max-w-5xl h-[260px] flex items-center justify-center mb-10 overflow-visible",onMouseEnter:()=>u(!0),onMouseLeave:()=>u(!1),children:et.map((A,P)=>{const J=C[P],de=P===t,ne=(P-q)*re+J.jitterX,B=J.jitterY,Z=Math.round(ne),ie=Math.round(B+(de?-10:6)),be=de?`translateX(${Z}px) translateY(${ie}px) scale(1.05)`:`translateX(${Z}px) translateY(${ie}px) rotate(${J.baseRotate}deg) scale(0.96)`,T=de?999:100+P,N=de?1:.8,G=de?"none":"blur(0.8px)";return g.jsxs("article",{"data-project-id":A.id,className:["group absolute w-full","max-w-[260px] sm:max-w-[300px] lg:max-w-[320px]","rounded-2xl bg-(--bg-elevated)","shadow-[0_16px_36px_rgba(0,0,0,0.55)]","[html[data-theme='light']_&]:shadow-[0_10px_24px_rgba(0,0,0,0.12)]","border border-(--border-subtle)","cursor-pointer overflow-hidden","transition-all duration-250 ease-out",de?["ring-2 ring-(--accent)","ring-offset-2","ring-offset-[color:var(--bg-soft)]"].join(" "):"ring-0"].join(" "),style:{zIndex:T,transform:be,opacity:N,filter:G},onClick:w=>H(A.id,w.currentTarget),onMouseEnter:()=>a(P),onFocus:()=>a(P),tabIndex:0,onKeyDown:w=>{(w.key==="Enter"||w.key===" ")&&(w.preventDefault(),H(A.id,w.currentTarget))},role:"button",children:[A.banner&&g.jsxs("div",{className:["absolute inset-0 z-0 pointer-events-none","transition-all duration-200",de?"opacity-20":"opacity-40"].join(" "),children:[g.jsx("img",{src:A.banner,alt:"",className:"w-full h-full object-cover grayscale-[30%]"}),g.jsx("div",{className:["absolute inset-0 bg-gradient-to-t to-transparent transition-colors duration-200",de?"from-[color:rgba(0,0,0,0.6)] [html[data-theme='light']_&]:from-[color:rgba(0,0,0,0.52)]":"from-[color:rgba(0,0,0,0.35)] [html[data-theme='light']_&]:from-[color:rgba(0,0,0,0.3)]"].join(" ")})]}),g.jsxs("div",{className:"relative z-10 p-4 text-[13px] text-fg-muted leading-[1.6]",children:[g.jsx("h3",{className:["mb-1.5","text-fg","transition-all duration-200",de?"text-[15px] font-semibold tracking-[0.02em]":"text-[14px] font-medium tracking-[0.01em]"].join(" "),children:A.title}),g.jsx("p",{className:["transition-all duration-200","text-[12px] mb-2.5 line-clamp-2",de?"text-fg opacity-100":"text-fg-muted opacity-80"].join(" "),children:A.summary}),g.jsx("div",{className:"flex flex-wrap gap-1.5 mb-2.5",children:A.tags.slice(0,6).map(w=>g.jsx("span",{className:Op,children:w},w))}),g.jsx("div",{className:"flex gap-3 text-[11px] mt-1",children:A.links.map(w=>g.jsxs("a",{href:w.href,target:"_blank",rel:"noreferrer",className:"inline-flex items-center gap-1 text-fg-muted hover:text-fg hover:-translate-y-px transition-all duration-150 ease-out",onClick:le=>le.stopPropagation(),children:[g.jsx("span",{children:w.label}),g.jsx("span",{children:"↗"})]},w.label))})]})]},A.id)})}),g.jsxs("div",{className:"relative w-full max-w-3xl",onMouseEnter:()=>u(!0),onMouseLeave:()=>u(!1),children:[g.jsx("div",{className:"h-px w-full bg-(--border-subtle) opacity-70"}),g.jsx("div",{className:"absolute inset-x-0 -top-2 flex justify-between",children:et.map((A,P)=>{const J=P===t,de=()=>{a(P);const ae=document.querySelector(`[data-project-id="${A.id}"]`);ae&&H(A.id,ae)};return g.jsxs("button",{type:"button",className:"relative flex flex-col cursor-pointer items-center outline-none",onMouseEnter:()=>a(P),onFocus:()=>a(P),onClick:de,onKeyDown:ae=>{(ae.key==="Enter"||ae.key===" ")&&(ae.preventDefault(),de())},children:[g.jsx("span",{className:["mb-1 h-[3px] w-7 rounded-full","bg-(--border-subtle)",J?"animate-border-pulse":"opacity-40"].join(" ")}),g.jsx(Nu,{isActive:J,isPaused:l,duration:hc,size:16,strokeWidth:2}),g.jsx("span",{className:"mt-1 text-[10px] text-fg-muted max-w-[80px] text-center line-clamp-2",children:A.subTitle})]},A.id)})})]})]})]}),j&&g.jsx(BS,{project:j,isVisible:p,fromOffset:b,onClose:_})]})},YS=()=>{const t=D.useCallback(a=>{const l=document.getElementById(a);if(l){const f=l.getBoundingClientRect().top+window.pageYOffset-64-20;window.scrollTo({top:f,behavior:"smooth"})}},[]);return g.jsxs("main",{className:"max-w-[1040px] mx-auto px-5 pt-[calc(var(--header-height)+32px)] pb-16 text-sm text-fg",children:[g.jsx(nv,{onScrollTo:t}),g.jsx(uv,{}),g.jsx(Tv,{}),g.jsx(yS,{}),g.jsx(GS,{}),g.jsx($v,{}),g.jsx(Yv,{})]})},PS=4200,Rp=260;function _a(...t){return t.filter(Boolean).join(" ")}const XS=()=>{const t=Qa(),a=D.useMemo(()=>{const W=new Map;for(const A of nt)for(const P of A.tags)W.set(P,(W.get(P)??0)+1);return Array.from(W.entries()).sort((A,P)=>P[1]-A[1]).slice(0,12)},[]),[l,u]=D.useState("ALL"),s=D.useMemo(()=>nt.slice(0,Math.min(3,nt.length)),[]),[c,f]=D.useState(0),[m,p]=D.useState(!1);D.useEffect(()=>{if(s.length<=1)return;const W=()=>{p(!0),window.setTimeout(()=>{f(P=>(P+1)%s.length),window.setTimeout(()=>p(!1),20)},Rp)},A=window.setInterval(W,PS);return()=>window.clearInterval(A)},[s.length]);const h=s[c],b=D.useMemo(()=>l==="ALL"?nt:nt.filter(W=>W.tags.includes(l)),[l]),x=D.useMemo(()=>b,[b]),S=10,[v,C]=D.useState(S),[R,z]=D.useState(!1),[j,H]=D.useState(!1),_=D.useMemo(()=>x.slice(0,v),[x,v]),K=v<x.length,re=W=>{W!==l&&(H(!0),setTimeout(()=>{u(W),C(S),z(!1),setTimeout(()=>H(!1),20)},200))},q=D.useCallback(async()=>{!K||R||(z(!0),await new Promise(W=>setTimeout(W,450)),C(W=>Math.min(W+S,x.length)),z(!1))},[K,R,x.length]),ee=D.useRef(null);D.useEffect(()=>{const W=ee.current;if(!W)return;const A=new IntersectionObserver(P=>{P[0]?.isIntersecting&&q()},{root:null,rootMargin:"800px 0px",threshold:0});return A.observe(W),()=>A.disconnect()},[q]);const oe=W=>{t(`/blog/${W.slug}`)};return g.jsx("div",{className:"min-h-screen bg-(--bg-base) text-(--fg-base)",children:g.jsxs("div",{className:"max-w-[1040px] mx-auto px-5 pt-[calc(var(--header-height)+32px)] pb-16",children:[g.jsx("div",{className:"flex items-end justify-between gap-4 mb-6",children:g.jsxs("div",{children:[g.jsx("h1",{className:"text-[32px] font-bold tracking-[-0.02em]",children:"Posting"}),g.jsx("p",{className:"text-[13px] text-fg-muted mt-2",children:"Front-End를 공부하며 배운 알뜰신잡"})]})}),h&&g.jsx("section",{className:"mb-10",children:g.jsx("article",{role:"button",tabIndex:0,onClick:()=>oe(h),onKeyDown:W=>{(W.key==="Enter"||W.key===" ")&&oe(h)},className:_a("group relative overflow-hidden rounded-3xl border bg-(--bg-elevated) border-(--border-subtle)","cursor-pointer transition-colors hover:border-(--accent)","focus:outline-none focus:ring-2 focus:ring-(--accent)/40",m?"opacity-0":"opacity-100","transition-opacity"),style:{transitionDuration:`${Rp}ms`},children:g.jsxs("div",{className:"grid md:grid-cols-[320px_1fr]",children:[g.jsxs("div",{className:"relative h-[250px] md:h-[250px] bg-(--bg-soft)",children:[h.cover?g.jsxs(g.Fragment,{children:[g.jsx("img",{src:h.cover,alt:"",className:"absolute inset-0 w-full h-full object-cover opacity-90 group-hover:opacity-100 transition-opacity",loading:"lazy"}),g.jsx("div",{className:"absolute inset-0 bg-gradient-to-t from-black/55 via-black/15 to-transparent"})]}):g.jsx("div",{className:"absolute inset-0 bg-(--bg-soft)"}),g.jsx("div",{className:"absolute left-5 top-5",children:g.jsx("span",{className:"text-[11px] px-2.5 py-1.5 rounded-full bg-black/45 border border-white/10 text-white/90",children:"Today's"})})]}),g.jsxs("div",{className:"p-5 h-full flex flex-col justify-between",children:[g.jsx("h2",{className:"text-[22px] md:text-[24px] font-bold leading-snug tracking-[-0.02em] mb-3",children:h.title}),g.jsx("p",{className:"text-[13px] text-fg-muted leading-relaxed mb-5 line-clamp-3",children:h.excerpt}),g.jsxs("div",{className:"flex flex-col text-[12px] text-fg-muted w-full",children:[g.jsx("div",{className:"flex flex-wrap gap-2 mb-4",children:h.tags.slice(0,6).map(W=>g.jsx("span",{className:"text-[11px] px-2.5 py-1.5 rounded-full bg-(--bg-soft) border border-(--border-subtle) text-fg-muted",children:W},W))}),g.jsx("span",{children:h.date})]})]})]})})}),g.jsxs("div",{className:"flex flex-wrap gap-2 mb-8",children:[g.jsxs("button",{type:"button",onClick:()=>re("ALL"),className:_a("text-[12px] px-3 py-1.5 rounded-full border transition-colors",l==="ALL"?"bg-(--bg-elevated) border-(--accent) text-(--fg-base)":"bg-(--bg-soft) border-(--border-subtle) text-fg-muted hover:border-(--accent)"),children:["전체보기 (",nt.length,")"]}),a.map(([W,A])=>g.jsxs("button",{type:"button",onClick:()=>re(W),className:_a("text-[12px] px-3 py-1.5 rounded-full border transition-colors",l===W?"bg-(--bg-elevated) border-(--accent) text-(--fg-base)":"bg-(--bg-soft) border-(--border-subtle) text-fg-muted hover:border-(--accent)"),children:[W," (",A,")"]},W))]}),g.jsxs("section",{className:_a("grid gap-6 transition-opacity duration-200",j?"opacity-0":"opacity-100"),children:[_.map(W=>g.jsx("article",{onClick:()=>oe(W),role:"button",tabIndex:0,onKeyDown:A=>{(A.key==="Enter"||A.key===" ")&&oe(W)},className:_a("group overflow-hidden rounded-2xl border bg-(--bg-elevated) border-(--border-subtle)","cursor-pointer transition-colors hover:border-(--accent)","focus:outline-none focus:ring-2 focus:ring-(--accent)/40"),children:g.jsxs("div",{className:"grid md:grid-cols-[240px_1fr] md:h-56",children:[W.cover&&g.jsxs("div",{className:"relative h-[180px] md:h-56 bg-(--bg-soft)",children:[g.jsx("img",{src:W.cover,alt:"",className:"absolute inset-0 w-full h-full object-cover opacity-90 group-hover:opacity-100 transition-opacity",loading:"lazy"}),g.jsx("div",{className:"absolute inset-0 bg-gradient-to-t md:bg-gradient-to-r from-black/55 via-black/15 to-transparent"})]}),g.jsxs("div",{className:"p-6 md:overflow-hidden flex flex-col h-full",children:[g.jsx("h3",{className:"text-[20px] font-semibold leading-snug mb-2 line-clamp-2",children:W.title}),g.jsx("p",{className:"text-[13px] text-fg-muted leading-relaxed mb-4 line-clamp-2 shrink-0",children:W.excerpt}),g.jsx("div",{className:"flex flex-wrap gap-2 mb-4 overflow-hidden max-h-[52px]",children:W.tags.slice(0,8).map(A=>g.jsx("span",{className:"text-[11px] px-2.5 py-1.5 rounded-full bg-(--bg-soft) border border-(--border-subtle) text-fg-muted",children:A},A))}),g.jsx("div",{className:"flex items-center justify-between text-[12px] text-fg-muted mt-auto",children:g.jsx("span",{children:W.date})})]})]})},W.id)),g.jsx("div",{ref:ee,className:"h-10"}),R&&g.jsx("div",{className:"py-6 text-center text-[13px] text-fg-muted",children:"불러오는 중..."}),!K&&g.jsx("div",{className:"py-10 text-center text-[13px] text-fg-muted",children:"더 이상 글이 없습니다."})]})]})})};function QS(t,a){const l={};return(t[t.length-1]===""?[...t,""]:t).join((l.padRight?" ":"")+","+(l.padLeft===!1?"":" ")).trim()}const JS=/^[$_\p{ID_Start}][$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,ZS=/^[$_\p{ID_Start}][-$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,KS={};function zp(t,a){return(KS.jsx?ZS:JS).test(t)}const WS=/[ \t\n\f\r]/g;function $S(t){return typeof t=="object"?t.type==="text"?Lp(t.value):!1:Lp(t)}function Lp(t){return t.replace(WS,"")===""}class Za{constructor(a,l,u){this.normal=l,this.property=a,u&&(this.space=u)}}Za.prototype.normal={};Za.prototype.property={};Za.prototype.space=void 0;function Xg(t,a){const l={},u={};for(const s of t)Object.assign(l,s.property),Object.assign(u,s.normal);return new Za(l,u,a)}function Oc(t){return t.toLowerCase()}class _n{constructor(a,l){this.attribute=l,this.property=a}}_n.prototype.attribute="";_n.prototype.booleanish=!1;_n.prototype.boolean=!1;_n.prototype.commaOrSpaceSeparated=!1;_n.prototype.commaSeparated=!1;_n.prototype.defined=!1;_n.prototype.mustUseProperty=!1;_n.prototype.number=!1;_n.prototype.overloadedBoolean=!1;_n.prototype.property="";_n.prototype.spaceSeparated=!1;_n.prototype.space=void 0;let e2=0;const Se=Lr(),ln=Lr(),Rc=Lr(),$=Lr(),Ge=Lr(),jl=Lr(),In=Lr();function Lr(){return 2**++e2}const zc=Object.freeze(Object.defineProperty({__proto__:null,boolean:Se,booleanish:ln,commaOrSpaceSeparated:In,commaSeparated:jl,number:$,overloadedBoolean:Rc,spaceSeparated:Ge},Symbol.toStringTag,{value:"Module"})),mc=Object.keys(zc);class Wc extends _n{constructor(a,l,u,s){let c=-1;if(super(a,l),Up(this,"space",s),typeof u=="number")for(;++c<mc.length;){const f=mc[c];Up(this,mc[c],(u&zc[f])===zc[f])}}}Wc.prototype.defined=!0;function Up(t,a,l){l&&(t[a]=l)}function Dl(t){const a={},l={};for(const[u,s]of Object.entries(t.properties)){const c=new Wc(u,t.transform(t.attributes||{},u),s,t.space);t.mustUseProperty&&t.mustUseProperty.includes(u)&&(c.mustUseProperty=!0),a[u]=c,l[Oc(u)]=u,l[Oc(c.attribute)]=u}return new Za(a,l,t.space)}const Qg=Dl({properties:{ariaActiveDescendant:null,ariaAtomic:ln,ariaAutoComplete:null,ariaBusy:ln,ariaChecked:ln,ariaColCount:$,ariaColIndex:$,ariaColSpan:$,ariaControls:Ge,ariaCurrent:null,ariaDescribedBy:Ge,ariaDetails:null,ariaDisabled:ln,ariaDropEffect:Ge,ariaErrorMessage:null,ariaExpanded:ln,ariaFlowTo:Ge,ariaGrabbed:ln,ariaHasPopup:null,ariaHidden:ln,ariaInvalid:null,ariaKeyShortcuts:null,ariaLabel:null,ariaLabelledBy:Ge,ariaLevel:$,ariaLive:null,ariaModal:ln,ariaMultiLine:ln,ariaMultiSelectable:ln,ariaOrientation:null,ariaOwns:Ge,ariaPlaceholder:null,ariaPosInSet:$,ariaPressed:ln,ariaReadOnly:ln,ariaRelevant:null,ariaRequired:ln,ariaRoleDescription:Ge,ariaRowCount:$,ariaRowIndex:$,ariaRowSpan:$,ariaSelected:ln,ariaSetSize:$,ariaSort:null,ariaValueMax:$,ariaValueMin:$,ariaValueNow:$,ariaValueText:null,role:null},transform(t,a){return a==="role"?a:"aria-"+a.slice(4).toLowerCase()}});function Jg(t,a){return a in t?t[a]:a}function Zg(t,a){return Jg(t,a.toLowerCase())}const n2=Dl({attributes:{acceptcharset:"accept-charset",classname:"class",htmlfor:"for",httpequiv:"http-equiv"},mustUseProperty:["checked","multiple","muted","selected"],properties:{abbr:null,accept:jl,acceptCharset:Ge,accessKey:Ge,action:null,allow:null,allowFullScreen:Se,allowPaymentRequest:Se,allowUserMedia:Se,alt:null,as:null,async:Se,autoCapitalize:null,autoComplete:Ge,autoFocus:Se,autoPlay:Se,blocking:Ge,capture:null,charSet:null,checked:Se,cite:null,className:Ge,cols:$,colSpan:null,content:null,contentEditable:ln,controls:Se,controlsList:Ge,coords:$|jl,crossOrigin:null,data:null,dateTime:null,decoding:null,default:Se,defer:Se,dir:null,dirName:null,disabled:Se,download:Rc,draggable:ln,encType:null,enterKeyHint:null,fetchPriority:null,form:null,formAction:null,formEncType:null,formMethod:null,formNoValidate:Se,formTarget:null,headers:Ge,height:$,hidden:Rc,high:$,href:null,hrefLang:null,htmlFor:Ge,httpEquiv:Ge,id:null,imageSizes:null,imageSrcSet:null,inert:Se,inputMode:null,integrity:null,is:null,isMap:Se,itemId:null,itemProp:Ge,itemRef:Ge,itemScope:Se,itemType:Ge,kind:null,label:null,lang:null,language:null,list:null,loading:null,loop:Se,low:$,manifest:null,max:null,maxLength:$,media:null,method:null,min:null,minLength:$,multiple:Se,muted:Se,name:null,nonce:null,noModule:Se,noValidate:Se,onAbort:null,onAfterPrint:null,onAuxClick:null,onBeforeMatch:null,onBeforePrint:null,onBeforeToggle:null,onBeforeUnload:null,onBlur:null,onCancel:null,onCanPlay:null,onCanPlayThrough:null,onChange:null,onClick:null,onClose:null,onContextLost:null,onContextMenu:null,onContextRestored:null,onCopy:null,onCueChange:null,onCut:null,onDblClick:null,onDrag:null,onDragEnd:null,onDragEnter:null,onDragExit:null,onDragLeave:null,onDragOver:null,onDragStart:null,onDrop:null,onDurationChange:null,onEmptied:null,onEnded:null,onError:null,onFocus:null,onFormData:null,onHashChange:null,onInput:null,onInvalid:null,onKeyDown:null,onKeyPress:null,onKeyUp:null,onLanguageChange:null,onLoad:null,onLoadedData:null,onLoadedMetadata:null,onLoadEnd:null,onLoadStart:null,onMessage:null,onMessageError:null,onMouseDown:null,onMouseEnter:null,onMouseLeave:null,onMouseMove:null,onMouseOut:null,onMouseOver:null,onMouseUp:null,onOffline:null,onOnline:null,onPageHide:null,onPageShow:null,onPaste:null,onPause:null,onPlay:null,onPlaying:null,onPopState:null,onProgress:null,onRateChange:null,onRejectionHandled:null,onReset:null,onResize:null,onScroll:null,onScrollEnd:null,onSecurityPolicyViolation:null,onSeeked:null,onSeeking:null,onSelect:null,onSlotChange:null,onStalled:null,onStorage:null,onSubmit:null,onSuspend:null,onTimeUpdate:null,onToggle:null,onUnhandledRejection:null,onUnload:null,onVolumeChange:null,onWaiting:null,onWheel:null,open:Se,optimum:$,pattern:null,ping:Ge,placeholder:null,playsInline:Se,popover:null,popoverTarget:null,popoverTargetAction:null,poster:null,preload:null,readOnly:Se,referrerPolicy:null,rel:Ge,required:Se,reversed:Se,rows:$,rowSpan:$,sandbox:Ge,scope:null,scoped:Se,seamless:Se,selected:Se,shadowRootClonable:Se,shadowRootDelegatesFocus:Se,shadowRootMode:null,shape:null,size:$,sizes:null,slot:null,span:$,spellCheck:ln,src:null,srcDoc:null,srcLang:null,srcSet:null,start:$,step:null,style:null,tabIndex:$,target:null,title:null,translate:null,type:null,typeMustMatch:Se,useMap:null,value:ln,width:$,wrap:null,writingSuggestions:null,align:null,aLink:null,archive:Ge,axis:null,background:null,bgColor:null,border:$,borderColor:null,bottomMargin:$,cellPadding:null,cellSpacing:null,char:null,charOff:null,classId:null,clear:null,code:null,codeBase:null,codeType:null,color:null,compact:Se,declare:Se,event:null,face:null,frame:null,frameBorder:null,hSpace:$,leftMargin:$,link:null,longDesc:null,lowSrc:null,marginHeight:$,marginWidth:$,noResize:Se,noHref:Se,noShade:Se,noWrap:Se,object:null,profile:null,prompt:null,rev:null,rightMargin:$,rules:null,scheme:null,scrolling:ln,standby:null,summary:null,text:null,topMargin:$,valueType:null,version:null,vAlign:null,vLink:null,vSpace:$,allowTransparency:null,autoCorrect:null,autoSave:null,disablePictureInPicture:Se,disableRemotePlayback:Se,prefix:null,property:null,results:$,security:null,unselectable:null},space:"html",transform:Zg}),t2=Dl({attributes:{accentHeight:"accent-height",alignmentBaseline:"alignment-baseline",arabicForm:"arabic-form",baselineShift:"baseline-shift",capHeight:"cap-height",className:"class",clipPath:"clip-path",clipRule:"clip-rule",colorInterpolation:"color-interpolation",colorInterpolationFilters:"color-interpolation-filters",colorProfile:"color-profile",colorRendering:"color-rendering",crossOrigin:"crossorigin",dataType:"datatype",dominantBaseline:"dominant-baseline",enableBackground:"enable-background",fillOpacity:"fill-opacity",fillRule:"fill-rule",floodColor:"flood-color",floodOpacity:"flood-opacity",fontFamily:"font-family",fontSize:"font-size",fontSizeAdjust:"font-size-adjust",fontStretch:"font-stretch",fontStyle:"font-style",fontVariant:"font-variant",fontWeight:"font-weight",glyphName:"glyph-name",glyphOrientationHorizontal:"glyph-orientation-horizontal",glyphOrientationVertical:"glyph-orientation-vertical",hrefLang:"hreflang",horizAdvX:"horiz-adv-x",horizOriginX:"horiz-origin-x",horizOriginY:"horiz-origin-y",imageRendering:"image-rendering",letterSpacing:"letter-spacing",lightingColor:"lighting-color",markerEnd:"marker-end",markerMid:"marker-mid",markerStart:"marker-start",navDown:"nav-down",navDownLeft:"nav-down-left",navDownRight:"nav-down-right",navLeft:"nav-left",navNext:"nav-next",navPrev:"nav-prev",navRight:"nav-right",navUp:"nav-up",navUpLeft:"nav-up-left",navUpRight:"nav-up-right",onAbort:"onabort",onActivate:"onactivate",onAfterPrint:"onafterprint",onBeforePrint:"onbeforeprint",onBegin:"onbegin",onCancel:"oncancel",onCanPlay:"oncanplay",onCanPlayThrough:"oncanplaythrough",onChange:"onchange",onClick:"onclick",onClose:"onclose",onCopy:"oncopy",onCueChange:"oncuechange",onCut:"oncut",onDblClick:"ondblclick",onDrag:"ondrag",onDragEnd:"ondragend",onDragEnter:"ondragenter",onDragExit:"ondragexit",onDragLeave:"ondragleave",onDragOver:"ondragover",onDragStart:"ondragstart",onDrop:"ondrop",onDurationChange:"ondurationchange",onEmptied:"onemptied",onEnd:"onend",onEnded:"onended",onError:"onerror",onFocus:"onfocus",onFocusIn:"onfocusin",onFocusOut:"onfocusout",onHashChange:"onhashchange",onInput:"oninput",onInvalid:"oninvalid",onKeyDown:"onkeydown",onKeyPress:"onkeypress",onKeyUp:"onkeyup",onLoad:"onload",onLoadedData:"onloadeddata",onLoadedMetadata:"onloadedmetadata",onLoadStart:"onloadstart",onMessage:"onmessage",onMouseDown:"onmousedown",onMouseEnter:"onmouseenter",onMouseLeave:"onmouseleave",onMouseMove:"onmousemove",onMouseOut:"onmouseout",onMouseOver:"onmouseover",onMouseUp:"onmouseup",onMouseWheel:"onmousewheel",onOffline:"onoffline",onOnline:"ononline",onPageHide:"onpagehide",onPageShow:"onpageshow",onPaste:"onpaste",onPause:"onpause",onPlay:"onplay",onPlaying:"onplaying",onPopState:"onpopstate",onProgress:"onprogress",onRateChange:"onratechange",onRepeat:"onrepeat",onReset:"onreset",onResize:"onresize",onScroll:"onscroll",onSeeked:"onseeked",onSeeking:"onseeking",onSelect:"onselect",onShow:"onshow",onStalled:"onstalled",onStorage:"onstorage",onSubmit:"onsubmit",onSuspend:"onsuspend",onTimeUpdate:"ontimeupdate",onToggle:"ontoggle",onUnload:"onunload",onVolumeChange:"onvolumechange",onWaiting:"onwaiting",onZoom:"onzoom",overlinePosition:"overline-position",overlineThickness:"overline-thickness",paintOrder:"paint-order",panose1:"panose-1",pointerEvents:"pointer-events",referrerPolicy:"referrerpolicy",renderingIntent:"rendering-intent",shapeRendering:"shape-rendering",stopColor:"stop-color",stopOpacity:"stop-opacity",strikethroughPosition:"strikethrough-position",strikethroughThickness:"strikethrough-thickness",strokeDashArray:"stroke-dasharray",strokeDashOffset:"stroke-dashoffset",strokeLineCap:"stroke-linecap",strokeLineJoin:"stroke-linejoin",strokeMiterLimit:"stroke-miterlimit",strokeOpacity:"stroke-opacity",strokeWidth:"stroke-width",tabIndex:"tabindex",textAnchor:"text-anchor",textDecoration:"text-decoration",textRendering:"text-rendering",transformOrigin:"transform-origin",typeOf:"typeof",underlinePosition:"underline-position",underlineThickness:"underline-thickness",unicodeBidi:"unicode-bidi",unicodeRange:"unicode-range",unitsPerEm:"units-per-em",vAlphabetic:"v-alphabetic",vHanging:"v-hanging",vIdeographic:"v-ideographic",vMathematical:"v-mathematical",vectorEffect:"vector-effect",vertAdvY:"vert-adv-y",vertOriginX:"vert-origin-x",vertOriginY:"vert-origin-y",wordSpacing:"word-spacing",writingMode:"writing-mode",xHeight:"x-height",playbackOrder:"playbackorder",timelineBegin:"timelinebegin"},properties:{about:In,accentHeight:$,accumulate:null,additive:null,alignmentBaseline:null,alphabetic:$,amplitude:$,arabicForm:null,ascent:$,attributeName:null,attributeType:null,azimuth:$,bandwidth:null,baselineShift:null,baseFrequency:null,baseProfile:null,bbox:null,begin:null,bias:$,by:null,calcMode:null,capHeight:$,className:Ge,clip:null,clipPath:null,clipPathUnits:null,clipRule:null,color:null,colorInterpolation:null,colorInterpolationFilters:null,colorProfile:null,colorRendering:null,content:null,contentScriptType:null,contentStyleType:null,crossOrigin:null,cursor:null,cx:null,cy:null,d:null,dataType:null,defaultAction:null,descent:$,diffuseConstant:$,direction:null,display:null,dur:null,divisor:$,dominantBaseline:null,download:Se,dx:null,dy:null,edgeMode:null,editable:null,elevation:$,enableBackground:null,end:null,event:null,exponent:$,externalResourcesRequired:null,fill:null,fillOpacity:$,fillRule:null,filter:null,filterRes:null,filterUnits:null,floodColor:null,floodOpacity:null,focusable:null,focusHighlight:null,fontFamily:null,fontSize:null,fontSizeAdjust:null,fontStretch:null,fontStyle:null,fontVariant:null,fontWeight:null,format:null,fr:null,from:null,fx:null,fy:null,g1:jl,g2:jl,glyphName:jl,glyphOrientationHorizontal:null,glyphOrientationVertical:null,glyphRef:null,gradientTransform:null,gradientUnits:null,handler:null,hanging:$,hatchContentUnits:null,hatchUnits:null,height:null,href:null,hrefLang:null,horizAdvX:$,horizOriginX:$,horizOriginY:$,id:null,ideographic:$,imageRendering:null,initialVisibility:null,in:null,in2:null,intercept:$,k:$,k1:$,k2:$,k3:$,k4:$,kernelMatrix:In,kernelUnitLength:null,keyPoints:null,keySplines:null,keyTimes:null,kerning:null,lang:null,lengthAdjust:null,letterSpacing:null,lightingColor:null,limitingConeAngle:$,local:null,markerEnd:null,markerMid:null,markerStart:null,markerHeight:null,markerUnits:null,markerWidth:null,mask:null,maskContentUnits:null,maskUnits:null,mathematical:null,max:null,media:null,mediaCharacterEncoding:null,mediaContentEncodings:null,mediaSize:$,mediaTime:null,method:null,min:null,mode:null,name:null,navDown:null,navDownLeft:null,navDownRight:null,navLeft:null,navNext:null,navPrev:null,navRight:null,navUp:null,navUpLeft:null,navUpRight:null,numOctaves:null,observer:null,offset:null,onAbort:null,onActivate:null,onAfterPrint:null,onBeforePrint:null,onBegin:null,onCancel:null,onCanPlay:null,onCanPlayThrough:null,onChange:null,onClick:null,onClose:null,onCopy:null,onCueChange:null,onCut:null,onDblClick:null,onDrag:null,onDragEnd:null,onDragEnter:null,onDragExit:null,onDragLeave:null,onDragOver:null,onDragStart:null,onDrop:null,onDurationChange:null,onEmptied:null,onEnd:null,onEnded:null,onError:null,onFocus:null,onFocusIn:null,onFocusOut:null,onHashChange:null,onInput:null,onInvalid:null,onKeyDown:null,onKeyPress:null,onKeyUp:null,onLoad:null,onLoadedData:null,onLoadedMetadata:null,onLoadStart:null,onMessage:null,onMouseDown:null,onMouseEnter:null,onMouseLeave:null,onMouseMove:null,onMouseOut:null,onMouseOver:null,onMouseUp:null,onMouseWheel:null,onOffline:null,onOnline:null,onPageHide:null,onPageShow:null,onPaste:null,onPause:null,onPlay:null,onPlaying:null,onPopState:null,onProgress:null,onRateChange:null,onRepeat:null,onReset:null,onResize:null,onScroll:null,onSeeked:null,onSeeking:null,onSelect:null,onShow:null,onStalled:null,onStorage:null,onSubmit:null,onSuspend:null,onTimeUpdate:null,onToggle:null,onUnload:null,onVolumeChange:null,onWaiting:null,onZoom:null,opacity:null,operator:null,order:null,orient:null,orientation:null,origin:null,overflow:null,overlay:null,overlinePosition:$,overlineThickness:$,paintOrder:null,panose1:null,path:null,pathLength:$,patternContentUnits:null,patternTransform:null,patternUnits:null,phase:null,ping:Ge,pitch:null,playbackOrder:null,pointerEvents:null,points:null,pointsAtX:$,pointsAtY:$,pointsAtZ:$,preserveAlpha:null,preserveAspectRatio:null,primitiveUnits:null,propagate:null,property:In,r:null,radius:null,referrerPolicy:null,refX:null,refY:null,rel:In,rev:In,renderingIntent:null,repeatCount:null,repeatDur:null,requiredExtensions:In,requiredFeatures:In,requiredFonts:In,requiredFormats:In,resource:null,restart:null,result:null,rotate:null,rx:null,ry:null,scale:null,seed:null,shapeRendering:null,side:null,slope:null,snapshotTime:null,specularConstant:$,specularExponent:$,spreadMethod:null,spacing:null,startOffset:null,stdDeviation:null,stemh:null,stemv:null,stitchTiles:null,stopColor:null,stopOpacity:null,strikethroughPosition:$,strikethroughThickness:$,string:null,stroke:null,strokeDashArray:In,strokeDashOffset:null,strokeLineCap:null,strokeLineJoin:null,strokeMiterLimit:$,strokeOpacity:$,strokeWidth:null,style:null,surfaceScale:$,syncBehavior:null,syncBehaviorDefault:null,syncMaster:null,syncTolerance:null,syncToleranceDefault:null,systemLanguage:In,tabIndex:$,tableValues:null,target:null,targetX:$,targetY:$,textAnchor:null,textDecoration:null,textRendering:null,textLength:null,timelineBegin:null,title:null,transformBehavior:null,type:null,typeOf:In,to:null,transform:null,transformOrigin:null,u1:null,u2:null,underlinePosition:$,underlineThickness:$,unicode:null,unicodeBidi:null,unicodeRange:null,unitsPerEm:$,values:null,vAlphabetic:$,vMathematical:$,vectorEffect:null,vHanging:$,vIdeographic:$,version:null,vertAdvY:$,vertOriginX:$,vertOriginY:$,viewBox:null,viewTarget:null,visibility:null,width:null,widths:null,wordSpacing:null,writingMode:null,x:null,x1:null,x2:null,xChannelSelector:null,xHeight:$,y:null,y1:null,y2:null,yChannelSelector:null,z:null,zoomAndPan:null},space:"svg",transform:Jg}),Kg=Dl({properties:{xLinkActuate:null,xLinkArcRole:null,xLinkHref:null,xLinkRole:null,xLinkShow:null,xLinkTitle:null,xLinkType:null},space:"xlink",transform(t,a){return"xlink:"+a.slice(5).toLowerCase()}}),Wg=Dl({attributes:{xmlnsxlink:"xmlns:xlink"},properties:{xmlnsXLink:null,xmlns:null},space:"xmlns",transform:Zg}),$g=Dl({properties:{xmlBase:null,xmlLang:null,xmlSpace:null},space:"xml",transform(t,a){return"xml:"+a.slice(3).toLowerCase()}}),r2={classId:"classID",dataType:"datatype",itemId:"itemID",strokeDashArray:"strokeDasharray",strokeDashOffset:"strokeDashoffset",strokeLineCap:"strokeLinecap",strokeLineJoin:"strokeLinejoin",strokeMiterLimit:"strokeMiterlimit",typeOf:"typeof",xLinkActuate:"xlinkActuate",xLinkArcRole:"xlinkArcrole",xLinkHref:"xlinkHref",xLinkRole:"xlinkRole",xLinkShow:"xlinkShow",xLinkTitle:"xlinkTitle",xLinkType:"xlinkType",xmlnsXLink:"xmlnsXlink"},l2=/[A-Z]/g,Bp=/-[a-z]/g,a2=/^data[-\w.:]+$/i;function i2(t,a){const l=Oc(a);let u=a,s=_n;if(l in t.normal)return t.property[t.normal[l]];if(l.length>4&&l.slice(0,4)==="data"&&a2.test(a)){if(a.charAt(4)==="-"){const c=a.slice(5).replace(Bp,s2);u="data"+c.charAt(0).toUpperCase()+c.slice(1)}else{const c=a.slice(4);if(!Bp.test(c)){let f=c.replace(l2,u2);f.charAt(0)!=="-"&&(f="-"+f),a="data"+f}}s=Wc}return new s(u,a)}function u2(t){return"-"+t.toLowerCase()}function s2(t){return t.charAt(1).toUpperCase()}const o2=Xg([Qg,n2,Kg,Wg,$g],"html"),$c=Xg([Qg,t2,Kg,Wg,$g],"svg");function c2(t){return t.join(" ").trim()}var Tl={},pc,Hp;function f2(){if(Hp)return pc;Hp=1;var t=/\/\*[^*]*\*+([^/*][^*]*\*+)*\//g,a=/\n/g,l=/^\s*/,u=/^(\*?[-#/*\\\w]+(\[[0-9a-z_-]+\])?)\s*/,s=/^:\s*/,c=/^((?:'(?:\\'|.)*?'|"(?:\\"|.)*?"|\([^)]*?\)|[^};])+)/,f=/^[;\s]*/,m=/^\s+|\s+$/g,p=`
`,h="/",b="*",x="",S="comment",v="declaration";function C(z,j){if(typeof z!="string")throw new TypeError("First argument must be a string");if(!z)return[];j=j||{};var H=1,_=1;function K(ae){var ne=ae.match(a);ne&&(H+=ne.length);var B=ae.lastIndexOf(p);_=~B?ae.length-B:_+ae.length}function re(){var ae={line:H,column:_};return function(ne){return ne.position=new q(ae),W(),ne}}function q(ae){this.start=ae,this.end={line:H,column:_},this.source=j.source}q.prototype.content=z;function ee(ae){var ne=new Error(j.source+":"+H+":"+_+": "+ae);if(ne.reason=ae,ne.filename=j.source,ne.line=H,ne.column=_,ne.source=z,!j.silent)throw ne}function oe(ae){var ne=ae.exec(z);if(ne){var B=ne[0];return K(B),z=z.slice(B.length),ne}}function W(){oe(l)}function A(ae){var ne;for(ae=ae||[];ne=P();)ne!==!1&&ae.push(ne);return ae}function P(){var ae=re();if(!(h!=z.charAt(0)||b!=z.charAt(1))){for(var ne=2;x!=z.charAt(ne)&&(b!=z.charAt(ne)||h!=z.charAt(ne+1));)++ne;if(ne+=2,x===z.charAt(ne-1))return ee("End of comment missing");var B=z.slice(2,ne-2);return _+=2,K(B),z=z.slice(ne),_+=2,ae({type:S,comment:B})}}function J(){var ae=re(),ne=oe(u);if(ne){if(P(),!oe(s))return ee("property missing ':'");var B=oe(c),Z=ae({type:v,property:R(ne[0].replace(t,x)),value:B?R(B[0].replace(t,x)):x});return oe(f),Z}}function de(){var ae=[];A(ae);for(var ne;ne=J();)ne!==!1&&(ae.push(ne),A(ae));return ae}return W(),de()}function R(z){return z?z.replace(m,x):x}return pc=C,pc}var Ip;function d2(){if(Ip)return Tl;Ip=1;var t=Tl&&Tl.__importDefault||function(u){return u&&u.__esModule?u:{default:u}};Object.defineProperty(Tl,"__esModule",{value:!0}),Tl.default=l;const a=t(f2());function l(u,s){let c=null;if(!u||typeof u!="string")return c;const f=(0,a.default)(u),m=typeof s=="function";return f.forEach(p=>{if(p.type!=="declaration")return;const{property:h,value:b}=p;m?s(h,b,p):b&&(c=c||{},c[h]=b)}),c}return Tl}var Da={},qp;function h2(){if(qp)return Da;qp=1,Object.defineProperty(Da,"__esModule",{value:!0}),Da.camelCase=void 0;var t=/^--[a-zA-Z0-9_-]+$/,a=/-([a-z])/g,l=/^[^-]+$/,u=/^-(webkit|moz|ms|o|khtml)-/,s=/^-(ms)-/,c=function(h){return!h||l.test(h)||t.test(h)},f=function(h,b){return b.toUpperCase()},m=function(h,b){return"".concat(b,"-")},p=function(h,b){return b===void 0&&(b={}),c(h)?h:(h=h.toLowerCase(),b.reactCompat?h=h.replace(s,m):h=h.replace(u,m),h.replace(a,f))};return Da.camelCase=p,Da}var Oa,Vp;function m2(){if(Vp)return Oa;Vp=1;var t=Oa&&Oa.__importDefault||function(s){return s&&s.__esModule?s:{default:s}},a=t(d2()),l=h2();function u(s,c){var f={};return!s||typeof s!="string"||(0,a.default)(s,function(m,p){m&&p&&(f[(0,l.camelCase)(m,c)]=p)}),f}return u.default=u,Oa=u,Oa}var p2=m2();const g2=Yc(p2),ex=nx("end"),ef=nx("start");function nx(t){return a;function a(l){const u=l&&l.position&&l.position[t]||{};if(typeof u.line=="number"&&u.line>0&&typeof u.column=="number"&&u.column>0)return{line:u.line,column:u.column,offset:typeof u.offset=="number"&&u.offset>-1?u.offset:void 0}}}function x2(t){const a=ef(t),l=ex(t);if(a&&l)return{start:a,end:l}}function Ha(t){return!t||typeof t!="object"?"":"position"in t||"type"in t?Fp(t.position):"start"in t||"end"in t?Fp(t):"line"in t||"column"in t?Lc(t):""}function Lc(t){return Gp(t&&t.line)+":"+Gp(t&&t.column)}function Fp(t){return Lc(t&&t.start)+"-"+Lc(t&&t.end)}function Gp(t){return t&&typeof t=="number"?t:1}class xn extends Error{constructor(a,l,u){super(),typeof l=="string"&&(u=l,l=void 0);let s="",c={},f=!1;if(l&&("line"in l&&"column"in l?c={place:l}:"start"in l&&"end"in l?c={place:l}:"type"in l?c={ancestors:[l],place:l.position}:c={...l}),typeof a=="string"?s=a:!c.cause&&a&&(f=!0,s=a.message,c.cause=a),!c.ruleId&&!c.source&&typeof u=="string"){const p=u.indexOf(":");p===-1?c.ruleId=u:(c.source=u.slice(0,p),c.ruleId=u.slice(p+1))}if(!c.place&&c.ancestors&&c.ancestors){const p=c.ancestors[c.ancestors.length-1];p&&(c.place=p.position)}const m=c.place&&"start"in c.place?c.place.start:c.place;this.ancestors=c.ancestors||void 0,this.cause=c.cause||void 0,this.column=m?m.column:void 0,this.fatal=void 0,this.file="",this.message=s,this.line=m?m.line:void 0,this.name=Ha(c.place)||"1:1",this.place=c.place||void 0,this.reason=this.message,this.ruleId=c.ruleId||void 0,this.source=c.source||void 0,this.stack=f&&c.cause&&typeof c.cause.stack=="string"?c.cause.stack:"",this.actual=void 0,this.expected=void 0,this.note=void 0,this.url=void 0}}xn.prototype.file="";xn.prototype.name="";xn.prototype.reason="";xn.prototype.message="";xn.prototype.stack="";xn.prototype.column=void 0;xn.prototype.line=void 0;xn.prototype.ancestors=void 0;xn.prototype.cause=void 0;xn.prototype.fatal=void 0;xn.prototype.place=void 0;xn.prototype.ruleId=void 0;xn.prototype.source=void 0;const nf={}.hasOwnProperty,b2=new Map,y2=/[A-Z]/g,v2=new Set(["table","tbody","thead","tfoot","tr"]),S2=new Set(["td","th"]),tx="https://github.com/syntax-tree/hast-util-to-jsx-runtime";function k2(t,a){if(!a||a.Fragment===void 0)throw new TypeError("Expected `Fragment` in options");const l=a.filePath||void 0;let u;if(a.development){if(typeof a.jsxDEV!="function")throw new TypeError("Expected `jsxDEV` in options when `development: true`");u=M2(l,a.jsxDEV)}else{if(typeof a.jsx!="function")throw new TypeError("Expected `jsx` in production options");if(typeof a.jsxs!="function")throw new TypeError("Expected `jsxs` in production options");u=N2(l,a.jsx,a.jsxs)}const s={Fragment:a.Fragment,ancestors:[],components:a.components||{},create:u,elementAttributeNameCase:a.elementAttributeNameCase||"react",evaluater:a.createEvaluater?a.createEvaluater():void 0,filePath:l,ignoreInvalidStyle:a.ignoreInvalidStyle||!1,passKeys:a.passKeys!==!1,passNode:a.passNode||!1,schema:a.space==="svg"?$c:o2,stylePropertyNameCase:a.stylePropertyNameCase||"dom",tableCellAlignToStyle:a.tableCellAlignToStyle!==!1},c=rx(s,t,void 0);return c&&typeof c!="string"?c:s.create(t,s.Fragment,{children:c||void 0},void 0)}function rx(t,a,l){if(a.type==="element")return w2(t,a,l);if(a.type==="mdxFlowExpression"||a.type==="mdxTextExpression")return C2(t,a);if(a.type==="mdxJsxFlowElement"||a.type==="mdxJsxTextElement")return E2(t,a,l);if(a.type==="mdxjsEsm")return T2(t,a);if(a.type==="root")return A2(t,a,l);if(a.type==="text")return j2(t,a)}function w2(t,a,l){const u=t.schema;let s=u;a.tagName.toLowerCase()==="svg"&&u.space==="html"&&(s=$c,t.schema=s),t.ancestors.push(a);const c=ax(t,a.tagName,!1),f=_2(t,a);let m=rf(t,a);return v2.has(a.tagName)&&(m=m.filter(function(p){return typeof p=="string"?!$S(p):!0})),lx(t,f,c,a),tf(f,m),t.ancestors.pop(),t.schema=u,t.create(a,c,f,l)}function C2(t,a){if(a.data&&a.data.estree&&t.evaluater){const u=a.data.estree.body[0];return u.type,t.evaluater.evaluateExpression(u.expression)}Ga(t,a.position)}function T2(t,a){if(a.data&&a.data.estree&&t.evaluater)return t.evaluater.evaluateProgram(a.data.estree);Ga(t,a.position)}function E2(t,a,l){const u=t.schema;let s=u;a.name==="svg"&&u.space==="html"&&(s=$c,t.schema=s),t.ancestors.push(a);const c=a.name===null?t.Fragment:ax(t,a.name,!0),f=D2(t,a),m=rf(t,a);return lx(t,f,c,a),tf(f,m),t.ancestors.pop(),t.schema=u,t.create(a,c,f,l)}function A2(t,a,l){const u={};return tf(u,rf(t,a)),t.create(a,t.Fragment,u,l)}function j2(t,a){return a.value}function lx(t,a,l,u){typeof l!="string"&&l!==t.Fragment&&t.passNode&&(a.node=u)}function tf(t,a){if(a.length>0){const l=a.length>1?a:a[0];l&&(t.children=l)}}function N2(t,a,l){return u;function u(s,c,f,m){const h=Array.isArray(f.children)?l:a;return m?h(c,f,m):h(c,f)}}function M2(t,a){return l;function l(u,s,c,f){const m=Array.isArray(c.children),p=ef(u);return a(s,c,f,m,{columnNumber:p?p.column-1:void 0,fileName:t,lineNumber:p?p.line:void 0},void 0)}}function _2(t,a){const l={};let u,s;for(s in a.properties)if(s!=="children"&&nf.call(a.properties,s)){const c=O2(t,s,a.properties[s]);if(c){const[f,m]=c;t.tableCellAlignToStyle&&f==="align"&&typeof m=="string"&&S2.has(a.tagName)?u=m:l[f]=m}}if(u){const c=l.style||(l.style={});c[t.stylePropertyNameCase==="css"?"text-align":"textAlign"]=u}return l}function D2(t,a){const l={};for(const u of a.attributes)if(u.type==="mdxJsxExpressionAttribute")if(u.data&&u.data.estree&&t.evaluater){const c=u.data.estree.body[0];c.type;const f=c.expression;f.type;const m=f.properties[0];m.type,Object.assign(l,t.evaluater.evaluateExpression(m.argument))}else Ga(t,a.position);else{const s=u.name;let c;if(u.value&&typeof u.value=="object")if(u.value.data&&u.value.data.estree&&t.evaluater){const m=u.value.data.estree.body[0];m.type,c=t.evaluater.evaluateExpression(m.expression)}else Ga(t,a.position);else c=u.value===null?!0:u.value;l[s]=c}return l}function rf(t,a){const l=[];let u=-1;const s=t.passKeys?new Map:b2;for(;++u<a.children.length;){const c=a.children[u];let f;if(t.passKeys){const p=c.type==="element"?c.tagName:c.type==="mdxJsxFlowElement"||c.type==="mdxJsxTextElement"?c.name:void 0;if(p){const h=s.get(p)||0;f=p+"-"+h,s.set(p,h+1)}}const m=rx(t,c,f);m!==void 0&&l.push(m)}return l}function O2(t,a,l){const u=i2(t.schema,a);if(!(l==null||typeof l=="number"&&Number.isNaN(l))){if(Array.isArray(l)&&(l=u.commaSeparated?QS(l):c2(l)),u.property==="style"){let s=typeof l=="object"?l:R2(t,String(l));return t.stylePropertyNameCase==="css"&&(s=z2(s)),["style",s]}return[t.elementAttributeNameCase==="react"&&u.space?r2[u.property]||u.property:u.attribute,l]}}function R2(t,a){try{return g2(a,{reactCompat:!0})}catch(l){if(t.ignoreInvalidStyle)return{};const u=l,s=new xn("Cannot parse `style` attribute",{ancestors:t.ancestors,cause:u,ruleId:"style",source:"hast-util-to-jsx-runtime"});throw s.file=t.filePath||void 0,s.url=tx+"#cannot-parse-style-attribute",s}}function ax(t,a,l){let u;if(!l)u={type:"Literal",value:a};else if(a.includes(".")){const s=a.split(".");let c=-1,f;for(;++c<s.length;){const m=zp(s[c])?{type:"Identifier",name:s[c]}:{type:"Literal",value:s[c]};f=f?{type:"MemberExpression",object:f,property:m,computed:!!(c&&m.type==="Literal"),optional:!1}:m}u=f}else u=zp(a)&&!/^[a-z]/.test(a)?{type:"Identifier",name:a}:{type:"Literal",value:a};if(u.type==="Literal"){const s=u.value;return nf.call(t.components,s)?t.components[s]:s}if(t.evaluater)return t.evaluater.evaluateExpression(u);Ga(t)}function Ga(t,a){const l=new xn("Cannot handle MDX estrees without `createEvaluater`",{ancestors:t.ancestors,place:a,ruleId:"mdx-estree",source:"hast-util-to-jsx-runtime"});throw l.file=t.filePath||void 0,l.url=tx+"#cannot-handle-mdx-estrees-without-createevaluater",l}function z2(t){const a={};let l;for(l in t)nf.call(t,l)&&(a[L2(l)]=t[l]);return a}function L2(t){let a=t.replace(y2,U2);return a.slice(0,3)==="ms-"&&(a="-"+a),a}function U2(t){return"-"+t.toLowerCase()}const gc={action:["form"],cite:["blockquote","del","ins","q"],data:["object"],formAction:["button","input"],href:["a","area","base","link"],icon:["menuitem"],itemId:null,manifest:["html"],ping:["a","area"],poster:["video"],src:["audio","embed","iframe","img","input","script","source","track","video"]},B2={};function lf(t,a){const l=B2,u=typeof l.includeImageAlt=="boolean"?l.includeImageAlt:!0,s=typeof l.includeHtml=="boolean"?l.includeHtml:!0;return ix(t,u,s)}function ix(t,a,l){if(H2(t)){if("value"in t)return t.type==="html"&&!l?"":t.value;if(a&&"alt"in t&&t.alt)return t.alt;if("children"in t)return Yp(t.children,a,l)}return Array.isArray(t)?Yp(t,a,l):""}function Yp(t,a,l){const u=[];let s=-1;for(;++s<t.length;)u[s]=ix(t[s],a,l);return u.join("")}function H2(t){return!!(t&&typeof t=="object")}const Pp=document.createElement("i");function af(t){const a="&"+t+";";Pp.innerHTML=a;const l=Pp.textContent;return l.charCodeAt(l.length-1)===59&&t!=="semi"||l===a?!1:l}function qn(t,a,l,u){const s=t.length;let c=0,f;if(a<0?a=-a>s?0:s+a:a=a>s?s:a,l=l>0?l:0,u.length<1e4)f=Array.from(u),f.unshift(a,l),t.splice(...f);else for(l&&t.splice(a,l);c<u.length;)f=u.slice(c,c+1e4),f.unshift(a,0),t.splice(...f),c+=1e4,a+=1e4}function tt(t,a){return t.length>0?(qn(t,t.length,0,a),t):a}const Xp={}.hasOwnProperty;function ux(t){const a={};let l=-1;for(;++l<t.length;)I2(a,t[l]);return a}function I2(t,a){let l;for(l in a){const s=(Xp.call(t,l)?t[l]:void 0)||(t[l]={}),c=a[l];let f;if(c)for(f in c){Xp.call(s,f)||(s[f]=[]);const m=c[f];q2(s[f],Array.isArray(m)?m:m?[m]:[])}}}function q2(t,a){let l=-1;const u=[];for(;++l<a.length;)(a[l].add==="after"?t:u).push(a[l]);qn(t,0,0,u)}function sx(t,a){const l=Number.parseInt(t,a);return l<9||l===11||l>13&&l<32||l>126&&l<160||l>55295&&l<57344||l>64975&&l<65008||(l&65535)===65535||(l&65535)===65534||l>1114111?"�":String.fromCodePoint(l)}function ut(t){return t.replace(/[\t\n\r ]+/g," ").replace(/^ | $/g,"").toLowerCase().toUpperCase()}const Sn=pr(/[A-Za-z]/),gn=pr(/[\dA-Za-z]/),V2=pr(/[#-'*+\--9=?A-Z^-~]/);function Mu(t){return t!==null&&(t<32||t===127)}const Uc=pr(/\d/),F2=pr(/[\dA-Fa-f]/),G2=pr(/[!-/:-@[-`{-~]/);function he(t){return t!==null&&t<-2}function Fe(t){return t!==null&&(t<0||t===32)}function Te(t){return t===-2||t===-1||t===32}const Lu=pr(new RegExp("\\p{P}|\\p{S}","u")),zr=pr(/\s/);function pr(t){return a;function a(l){return l!==null&&l>-1&&t.test(String.fromCharCode(l))}}function Ol(t){const a=[];let l=-1,u=0,s=0;for(;++l<t.length;){const c=t.charCodeAt(l);let f="";if(c===37&&gn(t.charCodeAt(l+1))&&gn(t.charCodeAt(l+2)))s=2;else if(c<128)/[!#$&-;=?-Z_a-z~]/.test(String.fromCharCode(c))||(f=String.fromCharCode(c));else if(c>55295&&c<57344){const m=t.charCodeAt(l+1);c<56320&&m>56319&&m<57344?(f=String.fromCharCode(c,m),s=1):f="�"}else f=String.fromCharCode(c);f&&(a.push(t.slice(u,l),encodeURIComponent(f)),u=l+s+1,f=""),s&&(l+=s,s=0)}return a.join("")+t.slice(u)}function Me(t,a,l,u){const s=u?u-1:Number.POSITIVE_INFINITY;let c=0;return f;function f(p){return Te(p)?(t.enter(l),m(p)):a(p)}function m(p){return Te(p)&&c++<s?(t.consume(p),m):(t.exit(l),a(p))}}const Y2={tokenize:P2};function P2(t){const a=t.attempt(this.parser.constructs.contentInitial,u,s);let l;return a;function u(m){if(m===null){t.consume(m);return}return t.enter("lineEnding"),t.consume(m),t.exit("lineEnding"),Me(t,a,"linePrefix")}function s(m){return t.enter("paragraph"),c(m)}function c(m){const p=t.enter("chunkText",{contentType:"text",previous:l});return l&&(l.next=p),l=p,f(m)}function f(m){if(m===null){t.exit("chunkText"),t.exit("paragraph"),t.consume(m);return}return he(m)?(t.consume(m),t.exit("chunkText"),c):(t.consume(m),f)}}const X2={tokenize:Q2},Qp={tokenize:J2};function Q2(t){const a=this,l=[];let u=0,s,c,f;return m;function m(_){if(u<l.length){const K=l[u];return a.containerState=K[1],t.attempt(K[0].continuation,p,h)(_)}return h(_)}function p(_){if(u++,a.containerState._closeFlow){a.containerState._closeFlow=void 0,s&&H();const K=a.events.length;let re=K,q;for(;re--;)if(a.events[re][0]==="exit"&&a.events[re][1].type==="chunkFlow"){q=a.events[re][1].end;break}j(u);let ee=K;for(;ee<a.events.length;)a.events[ee][1].end={...q},ee++;return qn(a.events,re+1,0,a.events.slice(K)),a.events.length=ee,h(_)}return m(_)}function h(_){if(u===l.length){if(!s)return S(_);if(s.currentConstruct&&s.currentConstruct.concrete)return C(_);a.interrupt=!!(s.currentConstruct&&!s._gfmTableDynamicInterruptHack)}return a.containerState={},t.check(Qp,b,x)(_)}function b(_){return s&&H(),j(u),S(_)}function x(_){return a.parser.lazy[a.now().line]=u!==l.length,f=a.now().offset,C(_)}function S(_){return a.containerState={},t.attempt(Qp,v,C)(_)}function v(_){return u++,l.push([a.currentConstruct,a.containerState]),S(_)}function C(_){if(_===null){s&&H(),j(0),t.consume(_);return}return s=s||a.parser.flow(a.now()),t.enter("chunkFlow",{_tokenizer:s,contentType:"flow",previous:c}),R(_)}function R(_){if(_===null){z(t.exit("chunkFlow"),!0),j(0),t.consume(_);return}return he(_)?(t.consume(_),z(t.exit("chunkFlow")),u=0,a.interrupt=void 0,m):(t.consume(_),R)}function z(_,K){const re=a.sliceStream(_);if(K&&re.push(null),_.previous=c,c&&(c.next=_),c=_,s.defineSkip(_.start),s.write(re),a.parser.lazy[_.start.line]){let q=s.events.length;for(;q--;)if(s.events[q][1].start.offset<f&&(!s.events[q][1].end||s.events[q][1].end.offset>f))return;const ee=a.events.length;let oe=ee,W,A;for(;oe--;)if(a.events[oe][0]==="exit"&&a.events[oe][1].type==="chunkFlow"){if(W){A=a.events[oe][1].end;break}W=!0}for(j(u),q=ee;q<a.events.length;)a.events[q][1].end={...A},q++;qn(a.events,oe+1,0,a.events.slice(ee)),a.events.length=q}}function j(_){let K=l.length;for(;K-- >_;){const re=l[K];a.containerState=re[1],re[0].exit.call(a,t)}l.length=_}function H(){s.write([null]),c=void 0,s=void 0,a.containerState._closeFlow=void 0}}function J2(t,a,l){return Me(t,t.attempt(this.parser.constructs.document,a,l),"linePrefix",this.parser.constructs.disable.null.includes("codeIndented")?void 0:4)}function Nl(t){if(t===null||Fe(t)||zr(t))return 1;if(Lu(t))return 2}function Uu(t,a,l){const u=[];let s=-1;for(;++s<t.length;){const c=t[s].resolveAll;c&&!u.includes(c)&&(a=c(a,l),u.push(c))}return a}const Bc={name:"attention",resolveAll:Z2,tokenize:K2};function Z2(t,a){let l=-1,u,s,c,f,m,p,h,b;for(;++l<t.length;)if(t[l][0]==="enter"&&t[l][1].type==="attentionSequence"&&t[l][1]._close){for(u=l;u--;)if(t[u][0]==="exit"&&t[u][1].type==="attentionSequence"&&t[u][1]._open&&a.sliceSerialize(t[u][1]).charCodeAt(0)===a.sliceSerialize(t[l][1]).charCodeAt(0)){if((t[u][1]._close||t[l][1]._open)&&(t[l][1].end.offset-t[l][1].start.offset)%3&&!((t[u][1].end.offset-t[u][1].start.offset+t[l][1].end.offset-t[l][1].start.offset)%3))continue;p=t[u][1].end.offset-t[u][1].start.offset>1&&t[l][1].end.offset-t[l][1].start.offset>1?2:1;const x={...t[u][1].end},S={...t[l][1].start};Jp(x,-p),Jp(S,p),f={type:p>1?"strongSequence":"emphasisSequence",start:x,end:{...t[u][1].end}},m={type:p>1?"strongSequence":"emphasisSequence",start:{...t[l][1].start},end:S},c={type:p>1?"strongText":"emphasisText",start:{...t[u][1].end},end:{...t[l][1].start}},s={type:p>1?"strong":"emphasis",start:{...f.start},end:{...m.end}},t[u][1].end={...f.start},t[l][1].start={...m.end},h=[],t[u][1].end.offset-t[u][1].start.offset&&(h=tt(h,[["enter",t[u][1],a],["exit",t[u][1],a]])),h=tt(h,[["enter",s,a],["enter",f,a],["exit",f,a],["enter",c,a]]),h=tt(h,Uu(a.parser.constructs.insideSpan.null,t.slice(u+1,l),a)),h=tt(h,[["exit",c,a],["enter",m,a],["exit",m,a],["exit",s,a]]),t[l][1].end.offset-t[l][1].start.offset?(b=2,h=tt(h,[["enter",t[l][1],a],["exit",t[l][1],a]])):b=0,qn(t,u-1,l-u+3,h),l=u+h.length-b-2;break}}for(l=-1;++l<t.length;)t[l][1].type==="attentionSequence"&&(t[l][1].type="data");return t}function K2(t,a){const l=this.parser.constructs.attentionMarkers.null,u=this.previous,s=Nl(u);let c;return f;function f(p){return c=p,t.enter("attentionSequence"),m(p)}function m(p){if(p===c)return t.consume(p),m;const h=t.exit("attentionSequence"),b=Nl(p),x=!b||b===2&&s||l.includes(p),S=!s||s===2&&b||l.includes(u);return h._open=!!(c===42?x:x&&(s||!S)),h._close=!!(c===42?S:S&&(b||!x)),a(p)}}function Jp(t,a){t.column+=a,t.offset+=a,t._bufferIndex+=a}const W2={name:"autolink",tokenize:$2};function $2(t,a,l){let u=0;return s;function s(v){return t.enter("autolink"),t.enter("autolinkMarker"),t.consume(v),t.exit("autolinkMarker"),t.enter("autolinkProtocol"),c}function c(v){return Sn(v)?(t.consume(v),f):v===64?l(v):h(v)}function f(v){return v===43||v===45||v===46||gn(v)?(u=1,m(v)):h(v)}function m(v){return v===58?(t.consume(v),u=0,p):(v===43||v===45||v===46||gn(v))&&u++<32?(t.consume(v),m):(u=0,h(v))}function p(v){return v===62?(t.exit("autolinkProtocol"),t.enter("autolinkMarker"),t.consume(v),t.exit("autolinkMarker"),t.exit("autolink"),a):v===null||v===32||v===60||Mu(v)?l(v):(t.consume(v),p)}function h(v){return v===64?(t.consume(v),b):V2(v)?(t.consume(v),h):l(v)}function b(v){return gn(v)?x(v):l(v)}function x(v){return v===46?(t.consume(v),u=0,b):v===62?(t.exit("autolinkProtocol").type="autolinkEmail",t.enter("autolinkMarker"),t.consume(v),t.exit("autolinkMarker"),t.exit("autolink"),a):S(v)}function S(v){if((v===45||gn(v))&&u++<63){const C=v===45?S:x;return t.consume(v),C}return l(v)}}const Ka={partial:!0,tokenize:ek};function ek(t,a,l){return u;function u(c){return Te(c)?Me(t,s,"linePrefix")(c):s(c)}function s(c){return c===null||he(c)?a(c):l(c)}}const ox={continuation:{tokenize:tk},exit:rk,name:"blockQuote",tokenize:nk};function nk(t,a,l){const u=this;return s;function s(f){if(f===62){const m=u.containerState;return m.open||(t.enter("blockQuote",{_container:!0}),m.open=!0),t.enter("blockQuotePrefix"),t.enter("blockQuoteMarker"),t.consume(f),t.exit("blockQuoteMarker"),c}return l(f)}function c(f){return Te(f)?(t.enter("blockQuotePrefixWhitespace"),t.consume(f),t.exit("blockQuotePrefixWhitespace"),t.exit("blockQuotePrefix"),a):(t.exit("blockQuotePrefix"),a(f))}}function tk(t,a,l){const u=this;return s;function s(f){return Te(f)?Me(t,c,"linePrefix",u.parser.constructs.disable.null.includes("codeIndented")?void 0:4)(f):c(f)}function c(f){return t.attempt(ox,a,l)(f)}}function rk(t){t.exit("blockQuote")}const cx={name:"characterEscape",tokenize:lk};function lk(t,a,l){return u;function u(c){return t.enter("characterEscape"),t.enter("escapeMarker"),t.consume(c),t.exit("escapeMarker"),s}function s(c){return G2(c)?(t.enter("characterEscapeValue"),t.consume(c),t.exit("characterEscapeValue"),t.exit("characterEscape"),a):l(c)}}const fx={name:"characterReference",tokenize:ak};function ak(t,a,l){const u=this;let s=0,c,f;return m;function m(x){return t.enter("characterReference"),t.enter("characterReferenceMarker"),t.consume(x),t.exit("characterReferenceMarker"),p}function p(x){return x===35?(t.enter("characterReferenceMarkerNumeric"),t.consume(x),t.exit("characterReferenceMarkerNumeric"),h):(t.enter("characterReferenceValue"),c=31,f=gn,b(x))}function h(x){return x===88||x===120?(t.enter("characterReferenceMarkerHexadecimal"),t.consume(x),t.exit("characterReferenceMarkerHexadecimal"),t.enter("characterReferenceValue"),c=6,f=F2,b):(t.enter("characterReferenceValue"),c=7,f=Uc,b(x))}function b(x){if(x===59&&s){const S=t.exit("characterReferenceValue");return f===gn&&!af(u.sliceSerialize(S))?l(x):(t.enter("characterReferenceMarker"),t.consume(x),t.exit("characterReferenceMarker"),t.exit("characterReference"),a)}return f(x)&&s++<c?(t.consume(x),b):l(x)}}const Zp={partial:!0,tokenize:uk},Kp={concrete:!0,name:"codeFenced",tokenize:ik};function ik(t,a,l){const u=this,s={partial:!0,tokenize:re};let c=0,f=0,m;return p;function p(q){return h(q)}function h(q){const ee=u.events[u.events.length-1];return c=ee&&ee[1].type==="linePrefix"?ee[2].sliceSerialize(ee[1],!0).length:0,m=q,t.enter("codeFenced"),t.enter("codeFencedFence"),t.enter("codeFencedFenceSequence"),b(q)}function b(q){return q===m?(f++,t.consume(q),b):f<3?l(q):(t.exit("codeFencedFenceSequence"),Te(q)?Me(t,x,"whitespace")(q):x(q))}function x(q){return q===null||he(q)?(t.exit("codeFencedFence"),u.interrupt?a(q):t.check(Zp,R,K)(q)):(t.enter("codeFencedFenceInfo"),t.enter("chunkString",{contentType:"string"}),S(q))}function S(q){return q===null||he(q)?(t.exit("chunkString"),t.exit("codeFencedFenceInfo"),x(q)):Te(q)?(t.exit("chunkString"),t.exit("codeFencedFenceInfo"),Me(t,v,"whitespace")(q)):q===96&&q===m?l(q):(t.consume(q),S)}function v(q){return q===null||he(q)?x(q):(t.enter("codeFencedFenceMeta"),t.enter("chunkString",{contentType:"string"}),C(q))}function C(q){return q===null||he(q)?(t.exit("chunkString"),t.exit("codeFencedFenceMeta"),x(q)):q===96&&q===m?l(q):(t.consume(q),C)}function R(q){return t.attempt(s,K,z)(q)}function z(q){return t.enter("lineEnding"),t.consume(q),t.exit("lineEnding"),j}function j(q){return c>0&&Te(q)?Me(t,H,"linePrefix",c+1)(q):H(q)}function H(q){return q===null||he(q)?t.check(Zp,R,K)(q):(t.enter("codeFlowValue"),_(q))}function _(q){return q===null||he(q)?(t.exit("codeFlowValue"),H(q)):(t.consume(q),_)}function K(q){return t.exit("codeFenced"),a(q)}function re(q,ee,oe){let W=0;return A;function A(ne){return q.enter("lineEnding"),q.consume(ne),q.exit("lineEnding"),P}function P(ne){return q.enter("codeFencedFence"),Te(ne)?Me(q,J,"linePrefix",u.parser.constructs.disable.null.includes("codeIndented")?void 0:4)(ne):J(ne)}function J(ne){return ne===m?(q.enter("codeFencedFenceSequence"),de(ne)):oe(ne)}function de(ne){return ne===m?(W++,q.consume(ne),de):W>=f?(q.exit("codeFencedFenceSequence"),Te(ne)?Me(q,ae,"whitespace")(ne):ae(ne)):oe(ne)}function ae(ne){return ne===null||he(ne)?(q.exit("codeFencedFence"),ee(ne)):oe(ne)}}}function uk(t,a,l){const u=this;return s;function s(f){return f===null?l(f):(t.enter("lineEnding"),t.consume(f),t.exit("lineEnding"),c)}function c(f){return u.parser.lazy[u.now().line]?l(f):a(f)}}const xc={name:"codeIndented",tokenize:ok},sk={partial:!0,tokenize:ck};function ok(t,a,l){const u=this;return s;function s(h){return t.enter("codeIndented"),Me(t,c,"linePrefix",5)(h)}function c(h){const b=u.events[u.events.length-1];return b&&b[1].type==="linePrefix"&&b[2].sliceSerialize(b[1],!0).length>=4?f(h):l(h)}function f(h){return h===null?p(h):he(h)?t.attempt(sk,f,p)(h):(t.enter("codeFlowValue"),m(h))}function m(h){return h===null||he(h)?(t.exit("codeFlowValue"),f(h)):(t.consume(h),m)}function p(h){return t.exit("codeIndented"),a(h)}}function ck(t,a,l){const u=this;return s;function s(f){return u.parser.lazy[u.now().line]?l(f):he(f)?(t.enter("lineEnding"),t.consume(f),t.exit("lineEnding"),s):Me(t,c,"linePrefix",5)(f)}function c(f){const m=u.events[u.events.length-1];return m&&m[1].type==="linePrefix"&&m[2].sliceSerialize(m[1],!0).length>=4?a(f):he(f)?s(f):l(f)}}const fk={name:"codeText",previous:hk,resolve:dk,tokenize:mk};function dk(t){let a=t.length-4,l=3,u,s;if((t[l][1].type==="lineEnding"||t[l][1].type==="space")&&(t[a][1].type==="lineEnding"||t[a][1].type==="space")){for(u=l;++u<a;)if(t[u][1].type==="codeTextData"){t[l][1].type="codeTextPadding",t[a][1].type="codeTextPadding",l+=2,a-=2;break}}for(u=l-1,a++;++u<=a;)s===void 0?u!==a&&t[u][1].type!=="lineEnding"&&(s=u):(u===a||t[u][1].type==="lineEnding")&&(t[s][1].type="codeTextData",u!==s+2&&(t[s][1].end=t[u-1][1].end,t.splice(s+2,u-s-2),a-=u-s-2,u=s+2),s=void 0);return t}function hk(t){return t!==96||this.events[this.events.length-1][1].type==="characterEscape"}function mk(t,a,l){let u=0,s,c;return f;function f(x){return t.enter("codeText"),t.enter("codeTextSequence"),m(x)}function m(x){return x===96?(t.consume(x),u++,m):(t.exit("codeTextSequence"),p(x))}function p(x){return x===null?l(x):x===32?(t.enter("space"),t.consume(x),t.exit("space"),p):x===96?(c=t.enter("codeTextSequence"),s=0,b(x)):he(x)?(t.enter("lineEnding"),t.consume(x),t.exit("lineEnding"),p):(t.enter("codeTextData"),h(x))}function h(x){return x===null||x===32||x===96||he(x)?(t.exit("codeTextData"),p(x)):(t.consume(x),h)}function b(x){return x===96?(t.consume(x),s++,b):s===u?(t.exit("codeTextSequence"),t.exit("codeText"),a(x)):(c.type="codeTextData",h(x))}}class pk{constructor(a){this.left=a?[...a]:[],this.right=[]}get(a){if(a<0||a>=this.left.length+this.right.length)throw new RangeError("Cannot access index `"+a+"` in a splice buffer of size `"+(this.left.length+this.right.length)+"`");return a<this.left.length?this.left[a]:this.right[this.right.length-a+this.left.length-1]}get length(){return this.left.length+this.right.length}shift(){return this.setCursor(0),this.right.pop()}slice(a,l){const u=l??Number.POSITIVE_INFINITY;return u<this.left.length?this.left.slice(a,u):a>this.left.length?this.right.slice(this.right.length-u+this.left.length,this.right.length-a+this.left.length).reverse():this.left.slice(a).concat(this.right.slice(this.right.length-u+this.left.length).reverse())}splice(a,l,u){const s=l||0;this.setCursor(Math.trunc(a));const c=this.right.splice(this.right.length-s,Number.POSITIVE_INFINITY);return u&&Ra(this.left,u),c.reverse()}pop(){return this.setCursor(Number.POSITIVE_INFINITY),this.left.pop()}push(a){this.setCursor(Number.POSITIVE_INFINITY),this.left.push(a)}pushMany(a){this.setCursor(Number.POSITIVE_INFINITY),Ra(this.left,a)}unshift(a){this.setCursor(0),this.right.push(a)}unshiftMany(a){this.setCursor(0),Ra(this.right,a.reverse())}setCursor(a){if(!(a===this.left.length||a>this.left.length&&this.right.length===0||a<0&&this.left.length===0))if(a<this.left.length){const l=this.left.splice(a,Number.POSITIVE_INFINITY);Ra(this.right,l.reverse())}else{const l=this.right.splice(this.left.length+this.right.length-a,Number.POSITIVE_INFINITY);Ra(this.left,l.reverse())}}}function Ra(t,a){let l=0;if(a.length<1e4)t.push(...a);else for(;l<a.length;)t.push(...a.slice(l,l+1e4)),l+=1e4}function dx(t){const a={};let l=-1,u,s,c,f,m,p,h;const b=new pk(t);for(;++l<b.length;){for(;l in a;)l=a[l];if(u=b.get(l),l&&u[1].type==="chunkFlow"&&b.get(l-1)[1].type==="listItemPrefix"&&(p=u[1]._tokenizer.events,c=0,c<p.length&&p[c][1].type==="lineEndingBlank"&&(c+=2),c<p.length&&p[c][1].type==="content"))for(;++c<p.length&&p[c][1].type!=="content";)p[c][1].type==="chunkText"&&(p[c][1]._isInFirstContentOfListItem=!0,c++);if(u[0]==="enter")u[1].contentType&&(Object.assign(a,gk(b,l)),l=a[l],h=!0);else if(u[1]._container){for(c=l,s=void 0;c--;)if(f=b.get(c),f[1].type==="lineEnding"||f[1].type==="lineEndingBlank")f[0]==="enter"&&(s&&(b.get(s)[1].type="lineEndingBlank"),f[1].type="lineEnding",s=c);else if(!(f[1].type==="linePrefix"||f[1].type==="listItemIndent"))break;s&&(u[1].end={...b.get(s)[1].start},m=b.slice(s,l),m.unshift(u),b.splice(s,l-s+1,m))}}return qn(t,0,Number.POSITIVE_INFINITY,b.slice(0)),!h}function gk(t,a){const l=t.get(a)[1],u=t.get(a)[2];let s=a-1;const c=[];let f=l._tokenizer;f||(f=u.parser[l.contentType](l.start),l._contentTypeTextTrailing&&(f._contentTypeTextTrailing=!0));const m=f.events,p=[],h={};let b,x,S=-1,v=l,C=0,R=0;const z=[R];for(;v;){for(;t.get(++s)[1]!==v;);c.push(s),v._tokenizer||(b=u.sliceStream(v),v.next||b.push(null),x&&f.defineSkip(v.start),v._isInFirstContentOfListItem&&(f._gfmTasklistFirstContentOfListItem=!0),f.write(b),v._isInFirstContentOfListItem&&(f._gfmTasklistFirstContentOfListItem=void 0)),x=v,v=v.next}for(v=l;++S<m.length;)m[S][0]==="exit"&&m[S-1][0]==="enter"&&m[S][1].type===m[S-1][1].type&&m[S][1].start.line!==m[S][1].end.line&&(R=S+1,z.push(R),v._tokenizer=void 0,v.previous=void 0,v=v.next);for(f.events=[],v?(v._tokenizer=void 0,v.previous=void 0):z.pop(),S=z.length;S--;){const j=m.slice(z[S],z[S+1]),H=c.pop();p.push([H,H+j.length-1]),t.splice(H,2,j)}for(p.reverse(),S=-1;++S<p.length;)h[C+p[S][0]]=C+p[S][1],C+=p[S][1]-p[S][0]-1;return h}const xk={resolve:yk,tokenize:vk},bk={partial:!0,tokenize:Sk};function yk(t){return dx(t),t}function vk(t,a){let l;return u;function u(m){return t.enter("content"),l=t.enter("chunkContent",{contentType:"content"}),s(m)}function s(m){return m===null?c(m):he(m)?t.check(bk,f,c)(m):(t.consume(m),s)}function c(m){return t.exit("chunkContent"),t.exit("content"),a(m)}function f(m){return t.consume(m),t.exit("chunkContent"),l.next=t.enter("chunkContent",{contentType:"content",previous:l}),l=l.next,s}}function Sk(t,a,l){const u=this;return s;function s(f){return t.exit("chunkContent"),t.enter("lineEnding"),t.consume(f),t.exit("lineEnding"),Me(t,c,"linePrefix")}function c(f){if(f===null||he(f))return l(f);const m=u.events[u.events.length-1];return!u.parser.constructs.disable.null.includes("codeIndented")&&m&&m[1].type==="linePrefix"&&m[2].sliceSerialize(m[1],!0).length>=4?a(f):t.interrupt(u.parser.constructs.flow,l,a)(f)}}function hx(t,a,l,u,s,c,f,m,p){const h=p||Number.POSITIVE_INFINITY;let b=0;return x;function x(j){return j===60?(t.enter(u),t.enter(s),t.enter(c),t.consume(j),t.exit(c),S):j===null||j===32||j===41||Mu(j)?l(j):(t.enter(u),t.enter(f),t.enter(m),t.enter("chunkString",{contentType:"string"}),R(j))}function S(j){return j===62?(t.enter(c),t.consume(j),t.exit(c),t.exit(s),t.exit(u),a):(t.enter(m),t.enter("chunkString",{contentType:"string"}),v(j))}function v(j){return j===62?(t.exit("chunkString"),t.exit(m),S(j)):j===null||j===60||he(j)?l(j):(t.consume(j),j===92?C:v)}function C(j){return j===60||j===62||j===92?(t.consume(j),v):v(j)}function R(j){return!b&&(j===null||j===41||Fe(j))?(t.exit("chunkString"),t.exit(m),t.exit(f),t.exit(u),a(j)):b<h&&j===40?(t.consume(j),b++,R):j===41?(t.consume(j),b--,R):j===null||j===32||j===40||Mu(j)?l(j):(t.consume(j),j===92?z:R)}function z(j){return j===40||j===41||j===92?(t.consume(j),R):R(j)}}function mx(t,a,l,u,s,c){const f=this;let m=0,p;return h;function h(v){return t.enter(u),t.enter(s),t.consume(v),t.exit(s),t.enter(c),b}function b(v){return m>999||v===null||v===91||v===93&&!p||v===94&&!m&&"_hiddenFootnoteSupport"in f.parser.constructs?l(v):v===93?(t.exit(c),t.enter(s),t.consume(v),t.exit(s),t.exit(u),a):he(v)?(t.enter("lineEnding"),t.consume(v),t.exit("lineEnding"),b):(t.enter("chunkString",{contentType:"string"}),x(v))}function x(v){return v===null||v===91||v===93||he(v)||m++>999?(t.exit("chunkString"),b(v)):(t.consume(v),p||(p=!Te(v)),v===92?S:x)}function S(v){return v===91||v===92||v===93?(t.consume(v),m++,x):x(v)}}function px(t,a,l,u,s,c){let f;return m;function m(S){return S===34||S===39||S===40?(t.enter(u),t.enter(s),t.consume(S),t.exit(s),f=S===40?41:S,p):l(S)}function p(S){return S===f?(t.enter(s),t.consume(S),t.exit(s),t.exit(u),a):(t.enter(c),h(S))}function h(S){return S===f?(t.exit(c),p(f)):S===null?l(S):he(S)?(t.enter("lineEnding"),t.consume(S),t.exit("lineEnding"),Me(t,h,"linePrefix")):(t.enter("chunkString",{contentType:"string"}),b(S))}function b(S){return S===f||S===null||he(S)?(t.exit("chunkString"),h(S)):(t.consume(S),S===92?x:b)}function x(S){return S===f||S===92?(t.consume(S),b):b(S)}}function Ia(t,a){let l;return u;function u(s){return he(s)?(t.enter("lineEnding"),t.consume(s),t.exit("lineEnding"),l=!0,u):Te(s)?Me(t,u,l?"linePrefix":"lineSuffix")(s):a(s)}}const kk={name:"definition",tokenize:Ck},wk={partial:!0,tokenize:Tk};function Ck(t,a,l){const u=this;let s;return c;function c(v){return t.enter("definition"),f(v)}function f(v){return mx.call(u,t,m,l,"definitionLabel","definitionLabelMarker","definitionLabelString")(v)}function m(v){return s=ut(u.sliceSerialize(u.events[u.events.length-1][1]).slice(1,-1)),v===58?(t.enter("definitionMarker"),t.consume(v),t.exit("definitionMarker"),p):l(v)}function p(v){return Fe(v)?Ia(t,h)(v):h(v)}function h(v){return hx(t,b,l,"definitionDestination","definitionDestinationLiteral","definitionDestinationLiteralMarker","definitionDestinationRaw","definitionDestinationString")(v)}function b(v){return t.attempt(wk,x,x)(v)}function x(v){return Te(v)?Me(t,S,"whitespace")(v):S(v)}function S(v){return v===null||he(v)?(t.exit("definition"),u.parser.defined.push(s),a(v)):l(v)}}function Tk(t,a,l){return u;function u(m){return Fe(m)?Ia(t,s)(m):l(m)}function s(m){return px(t,c,l,"definitionTitle","definitionTitleMarker","definitionTitleString")(m)}function c(m){return Te(m)?Me(t,f,"whitespace")(m):f(m)}function f(m){return m===null||he(m)?a(m):l(m)}}const Ek={name:"hardBreakEscape",tokenize:Ak};function Ak(t,a,l){return u;function u(c){return t.enter("hardBreakEscape"),t.consume(c),s}function s(c){return he(c)?(t.exit("hardBreakEscape"),a(c)):l(c)}}const jk={name:"headingAtx",resolve:Nk,tokenize:Mk};function Nk(t,a){let l=t.length-2,u=3,s,c;return t[u][1].type==="whitespace"&&(u+=2),l-2>u&&t[l][1].type==="whitespace"&&(l-=2),t[l][1].type==="atxHeadingSequence"&&(u===l-1||l-4>u&&t[l-2][1].type==="whitespace")&&(l-=u+1===l?2:4),l>u&&(s={type:"atxHeadingText",start:t[u][1].start,end:t[l][1].end},c={type:"chunkText",start:t[u][1].start,end:t[l][1].end,contentType:"text"},qn(t,u,l-u+1,[["enter",s,a],["enter",c,a],["exit",c,a],["exit",s,a]])),t}function Mk(t,a,l){let u=0;return s;function s(b){return t.enter("atxHeading"),c(b)}function c(b){return t.enter("atxHeadingSequence"),f(b)}function f(b){return b===35&&u++<6?(t.consume(b),f):b===null||Fe(b)?(t.exit("atxHeadingSequence"),m(b)):l(b)}function m(b){return b===35?(t.enter("atxHeadingSequence"),p(b)):b===null||he(b)?(t.exit("atxHeading"),a(b)):Te(b)?Me(t,m,"whitespace")(b):(t.enter("atxHeadingText"),h(b))}function p(b){return b===35?(t.consume(b),p):(t.exit("atxHeadingSequence"),m(b))}function h(b){return b===null||b===35||Fe(b)?(t.exit("atxHeadingText"),m(b)):(t.consume(b),h)}}const _k=["address","article","aside","base","basefont","blockquote","body","caption","center","col","colgroup","dd","details","dialog","dir","div","dl","dt","fieldset","figcaption","figure","footer","form","frame","frameset","h1","h2","h3","h4","h5","h6","head","header","hr","html","iframe","legend","li","link","main","menu","menuitem","nav","noframes","ol","optgroup","option","p","param","search","section","summary","table","tbody","td","tfoot","th","thead","title","tr","track","ul"],Wp=["pre","script","style","textarea"],Dk={concrete:!0,name:"htmlFlow",resolveTo:zk,tokenize:Lk},Ok={partial:!0,tokenize:Bk},Rk={partial:!0,tokenize:Uk};function zk(t){let a=t.length;for(;a--&&!(t[a][0]==="enter"&&t[a][1].type==="htmlFlow"););return a>1&&t[a-2][1].type==="linePrefix"&&(t[a][1].start=t[a-2][1].start,t[a+1][1].start=t[a-2][1].start,t.splice(a-2,2)),t}function Lk(t,a,l){const u=this;let s,c,f,m,p;return h;function h(w){return b(w)}function b(w){return t.enter("htmlFlow"),t.enter("htmlFlowData"),t.consume(w),x}function x(w){return w===33?(t.consume(w),S):w===47?(t.consume(w),c=!0,R):w===63?(t.consume(w),s=3,u.interrupt?a:T):Sn(w)?(t.consume(w),f=String.fromCharCode(w),z):l(w)}function S(w){return w===45?(t.consume(w),s=2,v):w===91?(t.consume(w),s=5,m=0,C):Sn(w)?(t.consume(w),s=4,u.interrupt?a:T):l(w)}function v(w){return w===45?(t.consume(w),u.interrupt?a:T):l(w)}function C(w){const le="CDATA[";return w===le.charCodeAt(m++)?(t.consume(w),m===le.length?u.interrupt?a:J:C):l(w)}function R(w){return Sn(w)?(t.consume(w),f=String.fromCharCode(w),z):l(w)}function z(w){if(w===null||w===47||w===62||Fe(w)){const le=w===47,pe=f.toLowerCase();return!le&&!c&&Wp.includes(pe)?(s=1,u.interrupt?a(w):J(w)):_k.includes(f.toLowerCase())?(s=6,le?(t.consume(w),j):u.interrupt?a(w):J(w)):(s=7,u.interrupt&&!u.parser.lazy[u.now().line]?l(w):c?H(w):_(w))}return w===45||gn(w)?(t.consume(w),f+=String.fromCharCode(w),z):l(w)}function j(w){return w===62?(t.consume(w),u.interrupt?a:J):l(w)}function H(w){return Te(w)?(t.consume(w),H):A(w)}function _(w){return w===47?(t.consume(w),A):w===58||w===95||Sn(w)?(t.consume(w),K):Te(w)?(t.consume(w),_):A(w)}function K(w){return w===45||w===46||w===58||w===95||gn(w)?(t.consume(w),K):re(w)}function re(w){return w===61?(t.consume(w),q):Te(w)?(t.consume(w),re):_(w)}function q(w){return w===null||w===60||w===61||w===62||w===96?l(w):w===34||w===39?(t.consume(w),p=w,ee):Te(w)?(t.consume(w),q):oe(w)}function ee(w){return w===p?(t.consume(w),p=null,W):w===null||he(w)?l(w):(t.consume(w),ee)}function oe(w){return w===null||w===34||w===39||w===47||w===60||w===61||w===62||w===96||Fe(w)?re(w):(t.consume(w),oe)}function W(w){return w===47||w===62||Te(w)?_(w):l(w)}function A(w){return w===62?(t.consume(w),P):l(w)}function P(w){return w===null||he(w)?J(w):Te(w)?(t.consume(w),P):l(w)}function J(w){return w===45&&s===2?(t.consume(w),B):w===60&&s===1?(t.consume(w),Z):w===62&&s===4?(t.consume(w),N):w===63&&s===3?(t.consume(w),T):w===93&&s===5?(t.consume(w),be):he(w)&&(s===6||s===7)?(t.exit("htmlFlowData"),t.check(Ok,G,de)(w)):w===null||he(w)?(t.exit("htmlFlowData"),de(w)):(t.consume(w),J)}function de(w){return t.check(Rk,ae,G)(w)}function ae(w){return t.enter("lineEnding"),t.consume(w),t.exit("lineEnding"),ne}function ne(w){return w===null||he(w)?de(w):(t.enter("htmlFlowData"),J(w))}function B(w){return w===45?(t.consume(w),T):J(w)}function Z(w){return w===47?(t.consume(w),f="",ie):J(w)}function ie(w){if(w===62){const le=f.toLowerCase();return Wp.includes(le)?(t.consume(w),N):J(w)}return Sn(w)&&f.length<8?(t.consume(w),f+=String.fromCharCode(w),ie):J(w)}function be(w){return w===93?(t.consume(w),T):J(w)}function T(w){return w===62?(t.consume(w),N):w===45&&s===2?(t.consume(w),T):J(w)}function N(w){return w===null||he(w)?(t.exit("htmlFlowData"),G(w)):(t.consume(w),N)}function G(w){return t.exit("htmlFlow"),a(w)}}function Uk(t,a,l){const u=this;return s;function s(f){return he(f)?(t.enter("lineEnding"),t.consume(f),t.exit("lineEnding"),c):l(f)}function c(f){return u.parser.lazy[u.now().line]?l(f):a(f)}}function Bk(t,a,l){return u;function u(s){return t.enter("lineEnding"),t.consume(s),t.exit("lineEnding"),t.attempt(Ka,a,l)}}const Hk={name:"htmlText",tokenize:Ik};function Ik(t,a,l){const u=this;let s,c,f;return m;function m(T){return t.enter("htmlText"),t.enter("htmlTextData"),t.consume(T),p}function p(T){return T===33?(t.consume(T),h):T===47?(t.consume(T),re):T===63?(t.consume(T),_):Sn(T)?(t.consume(T),oe):l(T)}function h(T){return T===45?(t.consume(T),b):T===91?(t.consume(T),c=0,C):Sn(T)?(t.consume(T),H):l(T)}function b(T){return T===45?(t.consume(T),v):l(T)}function x(T){return T===null?l(T):T===45?(t.consume(T),S):he(T)?(f=x,Z(T)):(t.consume(T),x)}function S(T){return T===45?(t.consume(T),v):x(T)}function v(T){return T===62?B(T):T===45?S(T):x(T)}function C(T){const N="CDATA[";return T===N.charCodeAt(c++)?(t.consume(T),c===N.length?R:C):l(T)}function R(T){return T===null?l(T):T===93?(t.consume(T),z):he(T)?(f=R,Z(T)):(t.consume(T),R)}function z(T){return T===93?(t.consume(T),j):R(T)}function j(T){return T===62?B(T):T===93?(t.consume(T),j):R(T)}function H(T){return T===null||T===62?B(T):he(T)?(f=H,Z(T)):(t.consume(T),H)}function _(T){return T===null?l(T):T===63?(t.consume(T),K):he(T)?(f=_,Z(T)):(t.consume(T),_)}function K(T){return T===62?B(T):_(T)}function re(T){return Sn(T)?(t.consume(T),q):l(T)}function q(T){return T===45||gn(T)?(t.consume(T),q):ee(T)}function ee(T){return he(T)?(f=ee,Z(T)):Te(T)?(t.consume(T),ee):B(T)}function oe(T){return T===45||gn(T)?(t.consume(T),oe):T===47||T===62||Fe(T)?W(T):l(T)}function W(T){return T===47?(t.consume(T),B):T===58||T===95||Sn(T)?(t.consume(T),A):he(T)?(f=W,Z(T)):Te(T)?(t.consume(T),W):B(T)}function A(T){return T===45||T===46||T===58||T===95||gn(T)?(t.consume(T),A):P(T)}function P(T){return T===61?(t.consume(T),J):he(T)?(f=P,Z(T)):Te(T)?(t.consume(T),P):W(T)}function J(T){return T===null||T===60||T===61||T===62||T===96?l(T):T===34||T===39?(t.consume(T),s=T,de):he(T)?(f=J,Z(T)):Te(T)?(t.consume(T),J):(t.consume(T),ae)}function de(T){return T===s?(t.consume(T),s=void 0,ne):T===null?l(T):he(T)?(f=de,Z(T)):(t.consume(T),de)}function ae(T){return T===null||T===34||T===39||T===60||T===61||T===96?l(T):T===47||T===62||Fe(T)?W(T):(t.consume(T),ae)}function ne(T){return T===47||T===62||Fe(T)?W(T):l(T)}function B(T){return T===62?(t.consume(T),t.exit("htmlTextData"),t.exit("htmlText"),a):l(T)}function Z(T){return t.exit("htmlTextData"),t.enter("lineEnding"),t.consume(T),t.exit("lineEnding"),ie}function ie(T){return Te(T)?Me(t,be,"linePrefix",u.parser.constructs.disable.null.includes("codeIndented")?void 0:4)(T):be(T)}function be(T){return t.enter("htmlTextData"),f(T)}}const uf={name:"labelEnd",resolveAll:Gk,resolveTo:Yk,tokenize:Pk},qk={tokenize:Xk},Vk={tokenize:Qk},Fk={tokenize:Jk};function Gk(t){let a=-1;const l=[];for(;++a<t.length;){const u=t[a][1];if(l.push(t[a]),u.type==="labelImage"||u.type==="labelLink"||u.type==="labelEnd"){const s=u.type==="labelImage"?4:2;u.type="data",a+=s}}return t.length!==l.length&&qn(t,0,t.length,l),t}function Yk(t,a){let l=t.length,u=0,s,c,f,m;for(;l--;)if(s=t[l][1],c){if(s.type==="link"||s.type==="labelLink"&&s._inactive)break;t[l][0]==="enter"&&s.type==="labelLink"&&(s._inactive=!0)}else if(f){if(t[l][0]==="enter"&&(s.type==="labelImage"||s.type==="labelLink")&&!s._balanced&&(c=l,s.type!=="labelLink")){u=2;break}}else s.type==="labelEnd"&&(f=l);const p={type:t[c][1].type==="labelLink"?"link":"image",start:{...t[c][1].start},end:{...t[t.length-1][1].end}},h={type:"label",start:{...t[c][1].start},end:{...t[f][1].end}},b={type:"labelText",start:{...t[c+u+2][1].end},end:{...t[f-2][1].start}};return m=[["enter",p,a],["enter",h,a]],m=tt(m,t.slice(c+1,c+u+3)),m=tt(m,[["enter",b,a]]),m=tt(m,Uu(a.parser.constructs.insideSpan.null,t.slice(c+u+4,f-3),a)),m=tt(m,[["exit",b,a],t[f-2],t[f-1],["exit",h,a]]),m=tt(m,t.slice(f+1)),m=tt(m,[["exit",p,a]]),qn(t,c,t.length,m),t}function Pk(t,a,l){const u=this;let s=u.events.length,c,f;for(;s--;)if((u.events[s][1].type==="labelImage"||u.events[s][1].type==="labelLink")&&!u.events[s][1]._balanced){c=u.events[s][1];break}return m;function m(S){return c?c._inactive?x(S):(f=u.parser.defined.includes(ut(u.sliceSerialize({start:c.end,end:u.now()}))),t.enter("labelEnd"),t.enter("labelMarker"),t.consume(S),t.exit("labelMarker"),t.exit("labelEnd"),p):l(S)}function p(S){return S===40?t.attempt(qk,b,f?b:x)(S):S===91?t.attempt(Vk,b,f?h:x)(S):f?b(S):x(S)}function h(S){return t.attempt(Fk,b,x)(S)}function b(S){return a(S)}function x(S){return c._balanced=!0,l(S)}}function Xk(t,a,l){return u;function u(x){return t.enter("resource"),t.enter("resourceMarker"),t.consume(x),t.exit("resourceMarker"),s}function s(x){return Fe(x)?Ia(t,c)(x):c(x)}function c(x){return x===41?b(x):hx(t,f,m,"resourceDestination","resourceDestinationLiteral","resourceDestinationLiteralMarker","resourceDestinationRaw","resourceDestinationString",32)(x)}function f(x){return Fe(x)?Ia(t,p)(x):b(x)}function m(x){return l(x)}function p(x){return x===34||x===39||x===40?px(t,h,l,"resourceTitle","resourceTitleMarker","resourceTitleString")(x):b(x)}function h(x){return Fe(x)?Ia(t,b)(x):b(x)}function b(x){return x===41?(t.enter("resourceMarker"),t.consume(x),t.exit("resourceMarker"),t.exit("resource"),a):l(x)}}function Qk(t,a,l){const u=this;return s;function s(m){return mx.call(u,t,c,f,"reference","referenceMarker","referenceString")(m)}function c(m){return u.parser.defined.includes(ut(u.sliceSerialize(u.events[u.events.length-1][1]).slice(1,-1)))?a(m):l(m)}function f(m){return l(m)}}function Jk(t,a,l){return u;function u(c){return t.enter("reference"),t.enter("referenceMarker"),t.consume(c),t.exit("referenceMarker"),s}function s(c){return c===93?(t.enter("referenceMarker"),t.consume(c),t.exit("referenceMarker"),t.exit("reference"),a):l(c)}}const Zk={name:"labelStartImage",resolveAll:uf.resolveAll,tokenize:Kk};function Kk(t,a,l){const u=this;return s;function s(m){return t.enter("labelImage"),t.enter("labelImageMarker"),t.consume(m),t.exit("labelImageMarker"),c}function c(m){return m===91?(t.enter("labelMarker"),t.consume(m),t.exit("labelMarker"),t.exit("labelImage"),f):l(m)}function f(m){return m===94&&"_hiddenFootnoteSupport"in u.parser.constructs?l(m):a(m)}}const Wk={name:"labelStartLink",resolveAll:uf.resolveAll,tokenize:$k};function $k(t,a,l){const u=this;return s;function s(f){return t.enter("labelLink"),t.enter("labelMarker"),t.consume(f),t.exit("labelMarker"),t.exit("labelLink"),c}function c(f){return f===94&&"_hiddenFootnoteSupport"in u.parser.constructs?l(f):a(f)}}const bc={name:"lineEnding",tokenize:ew};function ew(t,a){return l;function l(u){return t.enter("lineEnding"),t.consume(u),t.exit("lineEnding"),Me(t,a,"linePrefix")}}const Eu={name:"thematicBreak",tokenize:nw};function nw(t,a,l){let u=0,s;return c;function c(h){return t.enter("thematicBreak"),f(h)}function f(h){return s=h,m(h)}function m(h){return h===s?(t.enter("thematicBreakSequence"),p(h)):u>=3&&(h===null||he(h))?(t.exit("thematicBreak"),a(h)):l(h)}function p(h){return h===s?(t.consume(h),u++,p):(t.exit("thematicBreakSequence"),Te(h)?Me(t,m,"whitespace")(h):m(h))}}const Mn={continuation:{tokenize:aw},exit:uw,name:"list",tokenize:lw},tw={partial:!0,tokenize:sw},rw={partial:!0,tokenize:iw};function lw(t,a,l){const u=this,s=u.events[u.events.length-1];let c=s&&s[1].type==="linePrefix"?s[2].sliceSerialize(s[1],!0).length:0,f=0;return m;function m(v){const C=u.containerState.type||(v===42||v===43||v===45?"listUnordered":"listOrdered");if(C==="listUnordered"?!u.containerState.marker||v===u.containerState.marker:Uc(v)){if(u.containerState.type||(u.containerState.type=C,t.enter(C,{_container:!0})),C==="listUnordered")return t.enter("listItemPrefix"),v===42||v===45?t.check(Eu,l,h)(v):h(v);if(!u.interrupt||v===49)return t.enter("listItemPrefix"),t.enter("listItemValue"),p(v)}return l(v)}function p(v){return Uc(v)&&++f<10?(t.consume(v),p):(!u.interrupt||f<2)&&(u.containerState.marker?v===u.containerState.marker:v===41||v===46)?(t.exit("listItemValue"),h(v)):l(v)}function h(v){return t.enter("listItemMarker"),t.consume(v),t.exit("listItemMarker"),u.containerState.marker=u.containerState.marker||v,t.check(Ka,u.interrupt?l:b,t.attempt(tw,S,x))}function b(v){return u.containerState.initialBlankLine=!0,c++,S(v)}function x(v){return Te(v)?(t.enter("listItemPrefixWhitespace"),t.consume(v),t.exit("listItemPrefixWhitespace"),S):l(v)}function S(v){return u.containerState.size=c+u.sliceSerialize(t.exit("listItemPrefix"),!0).length,a(v)}}function aw(t,a,l){const u=this;return u.containerState._closeFlow=void 0,t.check(Ka,s,c);function s(m){return u.containerState.furtherBlankLines=u.containerState.furtherBlankLines||u.containerState.initialBlankLine,Me(t,a,"listItemIndent",u.containerState.size+1)(m)}function c(m){return u.containerState.furtherBlankLines||!Te(m)?(u.containerState.furtherBlankLines=void 0,u.containerState.initialBlankLine=void 0,f(m)):(u.containerState.furtherBlankLines=void 0,u.containerState.initialBlankLine=void 0,t.attempt(rw,a,f)(m))}function f(m){return u.containerState._closeFlow=!0,u.interrupt=void 0,Me(t,t.attempt(Mn,a,l),"linePrefix",u.parser.constructs.disable.null.includes("codeIndented")?void 0:4)(m)}}function iw(t,a,l){const u=this;return Me(t,s,"listItemIndent",u.containerState.size+1);function s(c){const f=u.events[u.events.length-1];return f&&f[1].type==="listItemIndent"&&f[2].sliceSerialize(f[1],!0).length===u.containerState.size?a(c):l(c)}}function uw(t){t.exit(this.containerState.type)}function sw(t,a,l){const u=this;return Me(t,s,"listItemPrefixWhitespace",u.parser.constructs.disable.null.includes("codeIndented")?void 0:5);function s(c){const f=u.events[u.events.length-1];return!Te(c)&&f&&f[1].type==="listItemPrefixWhitespace"?a(c):l(c)}}const $p={name:"setextUnderline",resolveTo:ow,tokenize:cw};function ow(t,a){let l=t.length,u,s,c;for(;l--;)if(t[l][0]==="enter"){if(t[l][1].type==="content"){u=l;break}t[l][1].type==="paragraph"&&(s=l)}else t[l][1].type==="content"&&t.splice(l,1),!c&&t[l][1].type==="definition"&&(c=l);const f={type:"setextHeading",start:{...t[u][1].start},end:{...t[t.length-1][1].end}};return t[s][1].type="setextHeadingText",c?(t.splice(s,0,["enter",f,a]),t.splice(c+1,0,["exit",t[u][1],a]),t[u][1].end={...t[c][1].end}):t[u][1]=f,t.push(["exit",f,a]),t}function cw(t,a,l){const u=this;let s;return c;function c(h){let b=u.events.length,x;for(;b--;)if(u.events[b][1].type!=="lineEnding"&&u.events[b][1].type!=="linePrefix"&&u.events[b][1].type!=="content"){x=u.events[b][1].type==="paragraph";break}return!u.parser.lazy[u.now().line]&&(u.interrupt||x)?(t.enter("setextHeadingLine"),s=h,f(h)):l(h)}function f(h){return t.enter("setextHeadingLineSequence"),m(h)}function m(h){return h===s?(t.consume(h),m):(t.exit("setextHeadingLineSequence"),Te(h)?Me(t,p,"lineSuffix")(h):p(h))}function p(h){return h===null||he(h)?(t.exit("setextHeadingLine"),a(h)):l(h)}}const fw={tokenize:dw};function dw(t){const a=this,l=t.attempt(Ka,u,t.attempt(this.parser.constructs.flowInitial,s,Me(t,t.attempt(this.parser.constructs.flow,s,t.attempt(xk,s)),"linePrefix")));return l;function u(c){if(c===null){t.consume(c);return}return t.enter("lineEndingBlank"),t.consume(c),t.exit("lineEndingBlank"),a.currentConstruct=void 0,l}function s(c){if(c===null){t.consume(c);return}return t.enter("lineEnding"),t.consume(c),t.exit("lineEnding"),a.currentConstruct=void 0,l}}const hw={resolveAll:xx()},mw=gx("string"),pw=gx("text");function gx(t){return{resolveAll:xx(t==="text"?gw:void 0),tokenize:a};function a(l){const u=this,s=this.parser.constructs[t],c=l.attempt(s,f,m);return f;function f(b){return h(b)?c(b):m(b)}function m(b){if(b===null){l.consume(b);return}return l.enter("data"),l.consume(b),p}function p(b){return h(b)?(l.exit("data"),c(b)):(l.consume(b),p)}function h(b){if(b===null)return!0;const x=s[b];let S=-1;if(x)for(;++S<x.length;){const v=x[S];if(!v.previous||v.previous.call(u,u.previous))return!0}return!1}}}function xx(t){return a;function a(l,u){let s=-1,c;for(;++s<=l.length;)c===void 0?l[s]&&l[s][1].type==="data"&&(c=s,s++):(!l[s]||l[s][1].type!=="data")&&(s!==c+2&&(l[c][1].end=l[s-1][1].end,l.splice(c+2,s-c-2),s=c+2),c=void 0);return t?t(l,u):l}}function gw(t,a){let l=0;for(;++l<=t.length;)if((l===t.length||t[l][1].type==="lineEnding")&&t[l-1][1].type==="data"){const u=t[l-1][1],s=a.sliceStream(u);let c=s.length,f=-1,m=0,p;for(;c--;){const h=s[c];if(typeof h=="string"){for(f=h.length;h.charCodeAt(f-1)===32;)m++,f--;if(f)break;f=-1}else if(h===-2)p=!0,m++;else if(h!==-1){c++;break}}if(a._contentTypeTextTrailing&&l===t.length&&(m=0),m){const h={type:l===t.length||p||m<2?"lineSuffix":"hardBreakTrailing",start:{_bufferIndex:c?f:u.start._bufferIndex+f,_index:u.start._index+c,line:u.end.line,column:u.end.column-m,offset:u.end.offset-m},end:{...u.end}};u.end={...h.start},u.start.offset===u.end.offset?Object.assign(u,h):(t.splice(l,0,["enter",h,a],["exit",h,a]),l+=2)}l++}return t}const xw={42:Mn,43:Mn,45:Mn,48:Mn,49:Mn,50:Mn,51:Mn,52:Mn,53:Mn,54:Mn,55:Mn,56:Mn,57:Mn,62:ox},bw={91:kk},yw={[-2]:xc,[-1]:xc,32:xc},vw={35:jk,42:Eu,45:[$p,Eu],60:Dk,61:$p,95:Eu,96:Kp,126:Kp},Sw={38:fx,92:cx},kw={[-5]:bc,[-4]:bc,[-3]:bc,33:Zk,38:fx,42:Bc,60:[W2,Hk],91:Wk,92:[Ek,cx],93:uf,95:Bc,96:fk},ww={null:[Bc,hw]},Cw={null:[42,95]},Tw={null:[]},Ew=Object.freeze(Object.defineProperty({__proto__:null,attentionMarkers:Cw,contentInitial:bw,disable:Tw,document:xw,flow:vw,flowInitial:yw,insideSpan:ww,string:Sw,text:kw},Symbol.toStringTag,{value:"Module"}));function Aw(t,a,l){let u={_bufferIndex:-1,_index:0,line:l&&l.line||1,column:l&&l.column||1,offset:l&&l.offset||0};const s={},c=[];let f=[],m=[];const p={attempt:ee(re),check:ee(q),consume:H,enter:_,exit:K,interrupt:ee(q,{interrupt:!0})},h={code:null,containerState:{},defineSkip:R,events:[],now:C,parser:t,previous:null,sliceSerialize:S,sliceStream:v,write:x};let b=a.tokenize.call(h,p);return a.resolveAll&&c.push(a),h;function x(P){return f=tt(f,P),z(),f[f.length-1]!==null?[]:(oe(a,0),h.events=Uu(c,h.events,h),h.events)}function S(P,J){return Nw(v(P),J)}function v(P){return jw(f,P)}function C(){const{_bufferIndex:P,_index:J,line:de,column:ae,offset:ne}=u;return{_bufferIndex:P,_index:J,line:de,column:ae,offset:ne}}function R(P){s[P.line]=P.column,A()}function z(){let P;for(;u._index<f.length;){const J=f[u._index];if(typeof J=="string")for(P=u._index,u._bufferIndex<0&&(u._bufferIndex=0);u._index===P&&u._bufferIndex<J.length;)j(J.charCodeAt(u._bufferIndex));else j(J)}}function j(P){b=b(P)}function H(P){he(P)?(u.line++,u.column=1,u.offset+=P===-3?2:1,A()):P!==-1&&(u.column++,u.offset++),u._bufferIndex<0?u._index++:(u._bufferIndex++,u._bufferIndex===f[u._index].length&&(u._bufferIndex=-1,u._index++)),h.previous=P}function _(P,J){const de=J||{};return de.type=P,de.start=C(),h.events.push(["enter",de,h]),m.push(de),de}function K(P){const J=m.pop();return J.end=C(),h.events.push(["exit",J,h]),J}function re(P,J){oe(P,J.from)}function q(P,J){J.restore()}function ee(P,J){return de;function de(ae,ne,B){let Z,ie,be,T;return Array.isArray(ae)?G(ae):"tokenize"in ae?G([ae]):N(ae);function N(ce){return Ee;function Ee(Xe){const Ue=Xe!==null&&ce[Xe],Vn=Xe!==null&&ce.null,xt=[...Array.isArray(Ue)?Ue:Ue?[Ue]:[],...Array.isArray(Vn)?Vn:Vn?[Vn]:[]];return G(xt)(Xe)}}function G(ce){return Z=ce,ie=0,ce.length===0?B:w(ce[ie])}function w(ce){return Ee;function Ee(Xe){return T=W(),be=ce,ce.partial||(h.currentConstruct=ce),ce.name&&h.parser.constructs.disable.null.includes(ce.name)?pe():ce.tokenize.call(J?Object.assign(Object.create(h),J):h,p,le,pe)(Xe)}}function le(ce){return P(be,T),ne}function pe(ce){return T.restore(),++ie<Z.length?w(Z[ie]):B}}}function oe(P,J){P.resolveAll&&!c.includes(P)&&c.push(P),P.resolve&&qn(h.events,J,h.events.length-J,P.resolve(h.events.slice(J),h)),P.resolveTo&&(h.events=P.resolveTo(h.events,h))}function W(){const P=C(),J=h.previous,de=h.currentConstruct,ae=h.events.length,ne=Array.from(m);return{from:ae,restore:B};function B(){u=P,h.previous=J,h.currentConstruct=de,h.events.length=ae,m=ne,A()}}function A(){u.line in s&&u.column<2&&(u.column=s[u.line],u.offset+=s[u.line]-1)}}function jw(t,a){const l=a.start._index,u=a.start._bufferIndex,s=a.end._index,c=a.end._bufferIndex;let f;if(l===s)f=[t[l].slice(u,c)];else{if(f=t.slice(l,s),u>-1){const m=f[0];typeof m=="string"?f[0]=m.slice(u):f.shift()}c>0&&f.push(t[s].slice(0,c))}return f}function Nw(t,a){let l=-1;const u=[];let s;for(;++l<t.length;){const c=t[l];let f;if(typeof c=="string")f=c;else switch(c){case-5:{f="\r";break}case-4:{f=`
`;break}case-3:{f=`\r
`;break}case-2:{f=a?" ":"	";break}case-1:{if(!a&&s)continue;f=" ";break}default:f=String.fromCharCode(c)}s=c===-2,u.push(f)}return u.join("")}function Mw(t){const u={constructs:ux([Ew,...(t||{}).extensions||[]]),content:s(Y2),defined:[],document:s(X2),flow:s(fw),lazy:{},string:s(mw),text:s(pw)};return u;function s(c){return f;function f(m){return Aw(u,c,m)}}}function _w(t){for(;!dx(t););return t}const eg=/[\0\t\n\r]/g;function Dw(){let t=1,a="",l=!0,u;return s;function s(c,f,m){const p=[];let h,b,x,S,v;for(c=a+(typeof c=="string"?c.toString():new TextDecoder(f||void 0).decode(c)),x=0,a="",l&&(c.charCodeAt(0)===65279&&x++,l=void 0);x<c.length;){if(eg.lastIndex=x,h=eg.exec(c),S=h&&h.index!==void 0?h.index:c.length,v=c.charCodeAt(S),!h){a=c.slice(x);break}if(v===10&&x===S&&u)p.push(-3),u=void 0;else switch(u&&(p.push(-5),u=void 0),x<S&&(p.push(c.slice(x,S)),t+=S-x),v){case 0:{p.push(65533),t++;break}case 9:{for(b=Math.ceil(t/4)*4,p.push(-2);t++<b;)p.push(-1);break}case 10:{p.push(-4),t=1;break}default:u=!0,t=1}x=S+1}return m&&(u&&p.push(-5),a&&p.push(a),p.push(null)),p}}const Ow=/\\([!-/:-@[-`{-~])|&(#(?:\d{1,7}|x[\da-f]{1,6})|[\da-z]{1,31});/gi;function Rw(t){return t.replace(Ow,zw)}function zw(t,a,l){if(a)return a;if(l.charCodeAt(0)===35){const s=l.charCodeAt(1),c=s===120||s===88;return sx(l.slice(c?2:1),c?16:10)}return af(l)||t}const bx={}.hasOwnProperty;function Lw(t,a,l){return typeof a!="string"&&(l=a,a=void 0),Uw(l)(_w(Mw(l).document().write(Dw()(t,a,!0))))}function Uw(t){const a={transforms:[],canContainEols:["emphasis","fragment","heading","paragraph","strong"],enter:{autolink:c(Hr),autolinkProtocol:W,autolinkEmail:W,atxHeading:c(Ur),blockQuote:c(Vn),characterEscape:W,characterReference:W,codeFenced:c(xt),codeFencedFenceInfo:f,codeFencedFenceMeta:f,codeIndented:c(xt,f),codeText:c(Rl,f),codeTextData:W,data:W,codeFlowValue:W,definition:c($a),definitionDestinationString:f,definitionLabelString:f,definitionTitleString:f,emphasis:c(bt),hardBreakEscape:c(Br),hardBreakTrailing:c(Br),htmlFlow:c(ei,f),htmlFlowData:W,htmlText:c(ei,f),htmlTextData:W,image:c(ni),label:f,link:c(Hr),listItem:c(zl),listItemValue:S,listOrdered:c(Ir,x),listUnordered:c(Ir),paragraph:c(qu),reference:w,referenceString:f,resourceDestinationString:f,resourceTitleString:f,setextHeading:c(Ur),strong:c(Vu),thematicBreak:c(Fu)},exit:{atxHeading:p(),atxHeadingSequence:re,autolink:p(),autolinkEmail:Ue,autolinkProtocol:Xe,blockQuote:p(),characterEscapeValue:A,characterReferenceMarkerHexadecimal:pe,characterReferenceMarkerNumeric:pe,characterReferenceValue:ce,characterReference:Ee,codeFenced:p(z),codeFencedFence:R,codeFencedFenceInfo:v,codeFencedFenceMeta:C,codeFlowValue:A,codeIndented:p(j),codeText:p(ne),codeTextData:A,data:A,definition:p(),definitionDestinationString:K,definitionLabelString:H,definitionTitleString:_,emphasis:p(),hardBreakEscape:p(J),hardBreakTrailing:p(J),htmlFlow:p(de),htmlFlowData:A,htmlText:p(ae),htmlTextData:A,image:p(Z),label:be,labelText:ie,lineEnding:P,link:p(B),listItem:p(),listOrdered:p(),listUnordered:p(),paragraph:p(),referenceString:le,resourceDestinationString:T,resourceTitleString:N,resource:G,setextHeading:p(oe),setextHeadingLineSequence:ee,setextHeadingText:q,strong:p(),thematicBreak:p()}};yx(a,(t||{}).mdastExtensions||[]);const l={};return u;function u(Y){let te={type:"root",children:[]};const ge={stack:[te],tokenStack:[],config:a,enter:m,exit:h,buffer:f,resume:b,data:l},ke=[];let Re=-1;for(;++Re<Y.length;)if(Y[Re][1].type==="listOrdered"||Y[Re][1].type==="listUnordered")if(Y[Re][0]==="enter")ke.push(Re);else{const Dn=ke.pop();Re=s(Y,Dn,Re)}for(Re=-1;++Re<Y.length;){const Dn=a[Y[Re][0]];bx.call(Dn,Y[Re][1].type)&&Dn[Y[Re][1].type].call(Object.assign({sliceSerialize:Y[Re][2].sliceSerialize},ge),Y[Re][1])}if(ge.tokenStack.length>0){const Dn=ge.tokenStack[ge.tokenStack.length-1];(Dn[1]||ng).call(ge,void 0,Dn[0])}for(te.position={start:mr(Y.length>0?Y[0][1].start:{line:1,column:1,offset:0}),end:mr(Y.length>0?Y[Y.length-2][1].end:{line:1,column:1,offset:0})},Re=-1;++Re<a.transforms.length;)te=a.transforms[Re](te)||te;return te}function s(Y,te,ge){let ke=te-1,Re=-1,Dn=!1,yt,yn,an,kn;for(;++ke<=ge;){const qe=Y[ke];switch(qe[1].type){case"listUnordered":case"listOrdered":case"blockQuote":{qe[0]==="enter"?Re++:Re--,kn=void 0;break}case"lineEndingBlank":{qe[0]==="enter"&&(yt&&!kn&&!Re&&!an&&(an=ke),kn=void 0);break}case"linePrefix":case"listItemValue":case"listItemMarker":case"listItemPrefix":case"listItemPrefixWhitespace":break;default:kn=void 0}if(!Re&&qe[0]==="enter"&&qe[1].type==="listItemPrefix"||Re===-1&&qe[0]==="exit"&&(qe[1].type==="listUnordered"||qe[1].type==="listOrdered")){if(yt){let Ft=ke;for(yn=void 0;Ft--;){const rt=Y[Ft];if(rt[1].type==="lineEnding"||rt[1].type==="lineEndingBlank"){if(rt[0]==="exit")continue;yn&&(Y[yn][1].type="lineEndingBlank",Dn=!0),rt[1].type="lineEnding",yn=Ft}else if(!(rt[1].type==="linePrefix"||rt[1].type==="blockQuotePrefix"||rt[1].type==="blockQuotePrefixWhitespace"||rt[1].type==="blockQuoteMarker"||rt[1].type==="listItemIndent"))break}an&&(!yn||an<yn)&&(yt._spread=!0),yt.end=Object.assign({},yn?Y[yn][1].start:qe[1].end),Y.splice(yn||ke,0,["exit",yt,qe[2]]),ke++,ge++}if(qe[1].type==="listItemPrefix"){const Ft={type:"listItem",_spread:!1,start:Object.assign({},qe[1].start),end:void 0};yt=Ft,Y.splice(ke,0,["enter",Ft,qe[2]]),ke++,ge++,an=void 0,kn=!0}}}return Y[te][1]._spread=Dn,ge}function c(Y,te){return ge;function ge(ke){m.call(this,Y(ke),ke),te&&te.call(this,ke)}}function f(){this.stack.push({type:"fragment",children:[]})}function m(Y,te,ge){this.stack[this.stack.length-1].children.push(Y),this.stack.push(Y),this.tokenStack.push([te,ge||void 0]),Y.position={start:mr(te.start),end:void 0}}function p(Y){return te;function te(ge){Y&&Y.call(this,ge),h.call(this,ge)}}function h(Y,te){const ge=this.stack.pop(),ke=this.tokenStack.pop();if(ke)ke[0].type!==Y.type&&(te?te.call(this,Y,ke[0]):(ke[1]||ng).call(this,Y,ke[0]));else throw new Error("Cannot close `"+Y.type+"` ("+Ha({start:Y.start,end:Y.end})+"): it’s not open");ge.position.end=mr(Y.end)}function b(){return lf(this.stack.pop())}function x(){this.data.expectingFirstListItemValue=!0}function S(Y){if(this.data.expectingFirstListItemValue){const te=this.stack[this.stack.length-2];te.start=Number.parseInt(this.sliceSerialize(Y),10),this.data.expectingFirstListItemValue=void 0}}function v(){const Y=this.resume(),te=this.stack[this.stack.length-1];te.lang=Y}function C(){const Y=this.resume(),te=this.stack[this.stack.length-1];te.meta=Y}function R(){this.data.flowCodeInside||(this.buffer(),this.data.flowCodeInside=!0)}function z(){const Y=this.resume(),te=this.stack[this.stack.length-1];te.value=Y.replace(/^(\r?\n|\r)|(\r?\n|\r)$/g,""),this.data.flowCodeInside=void 0}function j(){const Y=this.resume(),te=this.stack[this.stack.length-1];te.value=Y.replace(/(\r?\n|\r)$/g,"")}function H(Y){const te=this.resume(),ge=this.stack[this.stack.length-1];ge.label=te,ge.identifier=ut(this.sliceSerialize(Y)).toLowerCase()}function _(){const Y=this.resume(),te=this.stack[this.stack.length-1];te.title=Y}function K(){const Y=this.resume(),te=this.stack[this.stack.length-1];te.url=Y}function re(Y){const te=this.stack[this.stack.length-1];if(!te.depth){const ge=this.sliceSerialize(Y).length;te.depth=ge}}function q(){this.data.setextHeadingSlurpLineEnding=!0}function ee(Y){const te=this.stack[this.stack.length-1];te.depth=this.sliceSerialize(Y).codePointAt(0)===61?1:2}function oe(){this.data.setextHeadingSlurpLineEnding=void 0}function W(Y){const ge=this.stack[this.stack.length-1].children;let ke=ge[ge.length-1];(!ke||ke.type!=="text")&&(ke=bn(),ke.position={start:mr(Y.start),end:void 0},ge.push(ke)),this.stack.push(ke)}function A(Y){const te=this.stack.pop();te.value+=this.sliceSerialize(Y),te.position.end=mr(Y.end)}function P(Y){const te=this.stack[this.stack.length-1];if(this.data.atHardBreak){const ge=te.children[te.children.length-1];ge.position.end=mr(Y.end),this.data.atHardBreak=void 0;return}!this.data.setextHeadingSlurpLineEnding&&a.canContainEols.includes(te.type)&&(W.call(this,Y),A.call(this,Y))}function J(){this.data.atHardBreak=!0}function de(){const Y=this.resume(),te=this.stack[this.stack.length-1];te.value=Y}function ae(){const Y=this.resume(),te=this.stack[this.stack.length-1];te.value=Y}function ne(){const Y=this.resume(),te=this.stack[this.stack.length-1];te.value=Y}function B(){const Y=this.stack[this.stack.length-1];if(this.data.inReference){const te=this.data.referenceType||"shortcut";Y.type+="Reference",Y.referenceType=te,delete Y.url,delete Y.title}else delete Y.identifier,delete Y.label;this.data.referenceType=void 0}function Z(){const Y=this.stack[this.stack.length-1];if(this.data.inReference){const te=this.data.referenceType||"shortcut";Y.type+="Reference",Y.referenceType=te,delete Y.url,delete Y.title}else delete Y.identifier,delete Y.label;this.data.referenceType=void 0}function ie(Y){const te=this.sliceSerialize(Y),ge=this.stack[this.stack.length-2];ge.label=Rw(te),ge.identifier=ut(te).toLowerCase()}function be(){const Y=this.stack[this.stack.length-1],te=this.resume(),ge=this.stack[this.stack.length-1];if(this.data.inReference=!0,ge.type==="link"){const ke=Y.children;ge.children=ke}else ge.alt=te}function T(){const Y=this.resume(),te=this.stack[this.stack.length-1];te.url=Y}function N(){const Y=this.resume(),te=this.stack[this.stack.length-1];te.title=Y}function G(){this.data.inReference=void 0}function w(){this.data.referenceType="collapsed"}function le(Y){const te=this.resume(),ge=this.stack[this.stack.length-1];ge.label=te,ge.identifier=ut(this.sliceSerialize(Y)).toLowerCase(),this.data.referenceType="full"}function pe(Y){this.data.characterReferenceType=Y.type}function ce(Y){const te=this.sliceSerialize(Y),ge=this.data.characterReferenceType;let ke;ge?(ke=sx(te,ge==="characterReferenceMarkerNumeric"?10:16),this.data.characterReferenceType=void 0):ke=af(te);const Re=this.stack[this.stack.length-1];Re.value+=ke}function Ee(Y){const te=this.stack.pop();te.position.end=mr(Y.end)}function Xe(Y){A.call(this,Y);const te=this.stack[this.stack.length-1];te.url=this.sliceSerialize(Y)}function Ue(Y){A.call(this,Y);const te=this.stack[this.stack.length-1];te.url="mailto:"+this.sliceSerialize(Y)}function Vn(){return{type:"blockquote",children:[]}}function xt(){return{type:"code",lang:null,meta:null,value:""}}function Rl(){return{type:"inlineCode",value:""}}function $a(){return{type:"definition",identifier:"",label:null,title:null,url:""}}function bt(){return{type:"emphasis",children:[]}}function Ur(){return{type:"heading",depth:0,children:[]}}function Br(){return{type:"break"}}function ei(){return{type:"html",value:""}}function ni(){return{type:"image",title:null,url:"",alt:null}}function Hr(){return{type:"link",title:null,url:"",children:[]}}function Ir(Y){return{type:"list",ordered:Y.type==="listOrdered",start:null,spread:Y._spread,children:[]}}function zl(Y){return{type:"listItem",spread:Y._spread,checked:null,children:[]}}function qu(){return{type:"paragraph",children:[]}}function Vu(){return{type:"strong",children:[]}}function bn(){return{type:"text",value:""}}function Fu(){return{type:"thematicBreak"}}}function mr(t){return{line:t.line,column:t.column,offset:t.offset}}function yx(t,a){let l=-1;for(;++l<a.length;){const u=a[l];Array.isArray(u)?yx(t,u):Bw(t,u)}}function Bw(t,a){let l;for(l in a)if(bx.call(a,l))switch(l){case"canContainEols":{const u=a[l];u&&t[l].push(...u);break}case"transforms":{const u=a[l];u&&t[l].push(...u);break}case"enter":case"exit":{const u=a[l];u&&Object.assign(t[l],u);break}}}function ng(t,a){throw t?new Error("Cannot close `"+t.type+"` ("+Ha({start:t.start,end:t.end})+"): a different token (`"+a.type+"`, "+Ha({start:a.start,end:a.end})+") is open"):new Error("Cannot close document, a token (`"+a.type+"`, "+Ha({start:a.start,end:a.end})+") is still open")}function Hw(t){const a=this;a.parser=l;function l(u){return Lw(u,{...a.data("settings"),...t,extensions:a.data("micromarkExtensions")||[],mdastExtensions:a.data("fromMarkdownExtensions")||[]})}}function Iw(t,a){const l={type:"element",tagName:"blockquote",properties:{},children:t.wrap(t.all(a),!0)};return t.patch(a,l),t.applyData(a,l)}function qw(t,a){const l={type:"element",tagName:"br",properties:{},children:[]};return t.patch(a,l),[t.applyData(a,l),{type:"text",value:`
`}]}function Vw(t,a){const l=a.value?a.value+`
`:"",u={},s=a.lang?a.lang.split(/\s+/):[];s.length>0&&(u.className=["language-"+s[0]]);let c={type:"element",tagName:"code",properties:u,children:[{type:"text",value:l}]};return a.meta&&(c.data={meta:a.meta}),t.patch(a,c),c=t.applyData(a,c),c={type:"element",tagName:"pre",properties:{},children:[c]},t.patch(a,c),c}function Fw(t,a){const l={type:"element",tagName:"del",properties:{},children:t.all(a)};return t.patch(a,l),t.applyData(a,l)}function Gw(t,a){const l={type:"element",tagName:"em",properties:{},children:t.all(a)};return t.patch(a,l),t.applyData(a,l)}function Yw(t,a){const l=typeof t.options.clobberPrefix=="string"?t.options.clobberPrefix:"user-content-",u=String(a.identifier).toUpperCase(),s=Ol(u.toLowerCase()),c=t.footnoteOrder.indexOf(u);let f,m=t.footnoteCounts.get(u);m===void 0?(m=0,t.footnoteOrder.push(u),f=t.footnoteOrder.length):f=c+1,m+=1,t.footnoteCounts.set(u,m);const p={type:"element",tagName:"a",properties:{href:"#"+l+"fn-"+s,id:l+"fnref-"+s+(m>1?"-"+m:""),dataFootnoteRef:!0,ariaDescribedBy:["footnote-label"]},children:[{type:"text",value:String(f)}]};t.patch(a,p);const h={type:"element",tagName:"sup",properties:{},children:[p]};return t.patch(a,h),t.applyData(a,h)}function Pw(t,a){const l={type:"element",tagName:"h"+a.depth,properties:{},children:t.all(a)};return t.patch(a,l),t.applyData(a,l)}function Xw(t,a){if(t.options.allowDangerousHtml){const l={type:"raw",value:a.value};return t.patch(a,l),t.applyData(a,l)}}function vx(t,a){const l=a.referenceType;let u="]";if(l==="collapsed"?u+="[]":l==="full"&&(u+="["+(a.label||a.identifier)+"]"),a.type==="imageReference")return[{type:"text",value:"!["+a.alt+u}];const s=t.all(a),c=s[0];c&&c.type==="text"?c.value="["+c.value:s.unshift({type:"text",value:"["});const f=s[s.length-1];return f&&f.type==="text"?f.value+=u:s.push({type:"text",value:u}),s}function Qw(t,a){const l=String(a.identifier).toUpperCase(),u=t.definitionById.get(l);if(!u)return vx(t,a);const s={src:Ol(u.url||""),alt:a.alt};u.title!==null&&u.title!==void 0&&(s.title=u.title);const c={type:"element",tagName:"img",properties:s,children:[]};return t.patch(a,c),t.applyData(a,c)}function Jw(t,a){const l={src:Ol(a.url)};a.alt!==null&&a.alt!==void 0&&(l.alt=a.alt),a.title!==null&&a.title!==void 0&&(l.title=a.title);const u={type:"element",tagName:"img",properties:l,children:[]};return t.patch(a,u),t.applyData(a,u)}function Zw(t,a){const l={type:"text",value:a.value.replace(/\r?\n|\r/g," ")};t.patch(a,l);const u={type:"element",tagName:"code",properties:{},children:[l]};return t.patch(a,u),t.applyData(a,u)}function Kw(t,a){const l=String(a.identifier).toUpperCase(),u=t.definitionById.get(l);if(!u)return vx(t,a);const s={href:Ol(u.url||"")};u.title!==null&&u.title!==void 0&&(s.title=u.title);const c={type:"element",tagName:"a",properties:s,children:t.all(a)};return t.patch(a,c),t.applyData(a,c)}function Ww(t,a){const l={href:Ol(a.url)};a.title!==null&&a.title!==void 0&&(l.title=a.title);const u={type:"element",tagName:"a",properties:l,children:t.all(a)};return t.patch(a,u),t.applyData(a,u)}function $w(t,a,l){const u=t.all(a),s=l?eC(l):Sx(a),c={},f=[];if(typeof a.checked=="boolean"){const b=u[0];let x;b&&b.type==="element"&&b.tagName==="p"?x=b:(x={type:"element",tagName:"p",properties:{},children:[]},u.unshift(x)),x.children.length>0&&x.children.unshift({type:"text",value:" "}),x.children.unshift({type:"element",tagName:"input",properties:{type:"checkbox",checked:a.checked,disabled:!0},children:[]}),c.className=["task-list-item"]}let m=-1;for(;++m<u.length;){const b=u[m];(s||m!==0||b.type!=="element"||b.tagName!=="p")&&f.push({type:"text",value:`
...
`});const h={type:"element",tagName:"li",properties:c,children:f};return t.patch(a,h),t.applyData(a,h)}function eC(t){let a=!1;if(t.type==="list"){a=t.spread||!1;const l=t.children;let u=-1;for(;!a&&++u<l.length;)a=Sx(l[u])}return a}function Sx(t){const a=t.spread;return a??t.children.length>1}function nC(t,a){const l={},u=t.all(a);let s=-1;for(typeof a.start=="number"&&a.start!==1&&(l.start=a.start);++s<u.length;){const f=u[s];if(f.type==="element"&&f.tagName==="li"&&f.properties&&Array.isArray(f.properties.className)&&f.properties.className.includes("task-list-item")){l.className=["contains-task-list"];break}}const c={type:"element",tagName:a.ordered?"ol":"ul",properties:l,children:t.wrap(u,!0)};return t.patch(a,c),t.applyData(a,c)}function tC(t,a){const l={type:"element",tagName:"p",properties:{},children:t.all(a)};return t.patch(a,l),t.applyData(a,l)}function rC(t,a){const l={type:"root",children:t.wrap(t.all(a))};return t.patch(a,l),t.applyData(a,l)}function lC(t,a){const l={type:"element",tagName:"strong",properties:{},children:t.all(a)};return t.patch(a,l),t.applyData(a,l)}function aC(t,a){const l=t.all(a),u=l.shift(),s=[];if(u){const f={type:"element",tagName:"thead",properties:{},children:t.wrap([u],!0)};t.patch(a.children[0],f),s.push(f)}if(l.length>0){const f={type:"element",tagName:"tbody",properties:{},children:t.wrap(l,!0)},m=ef(a.children[1]),p=ex(a.children[a.children.length-1]);m&&p&&(f.position={start:m,end:p}),s.push(f)}const c={type:"element",tagName:"table",properties:{},children:t.wrap(s,!0)};return t.patch(a,c),t.applyData(a,c)}function iC(t,a,l){const u=l?l.children:void 0,c=(u?u.indexOf(a):1)===0?"th":"td",f=l&&l.type==="table"?l.align:void 0,m=f?f.length:a.children.length;let p=-1;const h=[];for(;++p<m;){const x=a.children[p],S={},v=f?f[p]:void 0;v&&(S.align=v);let C={type:"element",tagName:c,properties:S,children:[]};x&&(C.children=t.all(x),t.patch(x,C),C=t.applyData(x,C)),h.push(C)}const b={type:"element",tagName:"tr",properties:{},children:t.wrap(h,!0)};return t.patch(a,b),t.applyData(a,b)}function uC(t,a){const l={type:"element",tagName:"td",properties:{},children:t.all(a)};return t.patch(a,l),t.applyData(a,l)}const tg=9,rg=32;function sC(t){const a=String(t),l=/\r?\n|\r/g;let u=l.exec(a),s=0;const c=[];for(;u;)c.push(lg(a.slice(s,u.index),s>0,!0),u[0]),s=u.index+u[0].length,u=l.exec(a);return c.push(lg(a.slice(s),s>0,!1)),c.join("")}function lg(t,a,l){let u=0,s=t.length;if(a){let c=t.codePointAt(u);for(;c===tg||c===rg;)u++,c=t.codePointAt(u)}if(l){let c=t.codePointAt(s-1);for(;c===tg||c===rg;)s--,c=t.codePointAt(s-1)}return s>u?t.slice(u,s):""}function oC(t,a){const l={type:"text",value:sC(String(a.value))};return t.patch(a,l),t.applyData(a,l)}function cC(t,a){const l={type:"element",tagName:"hr",properties:{},children:[]};return t.patch(a,l),t.applyData(a,l)}const fC={blockquote:Iw,break:qw,code:Vw,delete:Fw,emphasis:Gw,footnoteReference:Yw,heading:Pw,html:Xw,imageReference:Qw,image:Jw,inlineCode:Zw,linkReference:Kw,link:Ww,listItem:$w,list:nC,paragraph:tC,root:rC,strong:lC,table:aC,tableCell:uC,tableRow:iC,text:oC,thematicBreak:cC,toml:vu,yaml:vu,definition:vu,footnoteDefinition:vu};function vu(){}const kx=-1,Bu=0,qa=1,_u=2,sf=3,of=4,cf=5,ff=6,wx=7,Cx=8,ag=typeof self=="object"?self:globalThis,dC=(t,a)=>{const l=(s,c)=>(t.set(c,s),s),u=s=>{if(t.has(s))return t.get(s);const[c,f]=a[s];switch(c){case Bu:case kx:return l(f,s);case qa:{const m=l([],s);for(const p of f)m.push(u(p));return m}case _u:{const m=l({},s);for(const[p,h]of f)m[u(p)]=u(h);return m}case sf:return l(new Date(f),s);case of:{const{source:m,flags:p}=f;return l(new RegExp(m,p),s)}case cf:{const m=l(new Map,s);for(const[p,h]of f)m.set(u(p),u(h));return m}case ff:{const m=l(new Set,s);for(const p of f)m.add(u(p));return m}case wx:{const{name:m,message:p}=f;return l(new ag[m](p),s)}case Cx:return l(BigInt(f),s);case"BigInt":return l(Object(BigInt(f)),s);case"ArrayBuffer":return l(new Uint8Array(f).buffer,f);case"DataView":{const{buffer:m}=new Uint8Array(f);return l(new DataView(m),f)}}return l(new ag[c](f),s)};return u},ig=t=>dC(new Map,t)(0),El="",{toString:hC}={},{keys:mC}=Object,za=t=>{const a=typeof t;if(a!=="object"||!t)return[Bu,a];const l=hC.call(t).slice(8,-1);switch(l){case"Array":return[qa,El];case"Object":return[_u,El];case"Date":return[sf,El];case"RegExp":return[of,El];case"Map":return[cf,El];case"Set":return[ff,El];case"DataView":return[qa,l]}return l.includes("Array")?[qa,l]:l.includes("Error")?[wx,l]:[_u,l]},Su=([t,a])=>t===Bu&&(a==="function"||a==="symbol"),pC=(t,a,l,u)=>{const s=(f,m)=>{const p=u.push(f)-1;return l.set(m,p),p},c=f=>{if(l.has(f))return l.get(f);let[m,p]=za(f);switch(m){case Bu:{let b=f;switch(p){case"bigint":m=Cx,b=f.toString();break;case"function":case"symbol":if(t)throw new TypeError("unable to serialize "+p);b=null;break;case"undefined":return s([kx],f)}return s([m,b],f)}case qa:{if(p){let S=f;return p==="DataView"?S=new Uint8Array(f.buffer):p==="ArrayBuffer"&&(S=new Uint8Array(f)),s([p,[...S]],f)}const b=[],x=s([m,b],f);for(const S of f)b.push(c(S));return x}case _u:{if(p)switch(p){case"BigInt":return s([p,f.toString()],f);case"Boolean":case"Number":case"String":return s([p,f.valueOf()],f)}if(a&&"toJSON"in f)return c(f.toJSON());const b=[],x=s([m,b],f);for(const S of mC(f))(t||!Su(za(f[S])))&&b.push([c(S),c(f[S])]);return x}case sf:return s([m,f.toISOString()],f);case of:{const{source:b,flags:x}=f;return s([m,{source:b,flags:x}],f)}case cf:{const b=[],x=s([m,b],f);for(const[S,v]of f)(t||!(Su(za(S))||Su(za(v))))&&b.push([c(S),c(v)]);return x}case ff:{const b=[],x=s([m,b],f);for(const S of f)(t||!Su(za(S)))&&b.push(c(S));return x}}const{message:h}=f;return s([m,{name:p,message:h}],f)};return c},ug=(t,{json:a,lossy:l}={})=>{const u=[];return pC(!(a||l),!!a,new Map,u)(t),u},Du=typeof structuredClone=="function"?(t,a)=>a&&("json"in a||"lossy"in a)?ig(ug(t,a)):structuredClone(t):(t,a)=>ig(ug(t,a));function gC(t,a){const l=[{type:"text",value:"↩"}];return a>1&&l.push({type:"element",tagName:"sup",properties:{},children:[{type:"text",value:String(a)}]}),l}function xC(t,a){return"Back to reference "+(t+1)+(a>1?"-"+a:"")}function bC(t){const a=typeof t.options.clobberPrefix=="string"?t.options.clobberPrefix:"user-content-",l=t.options.footnoteBackContent||gC,u=t.options.footnoteBackLabel||xC,s=t.options.footnoteLabel||"Footnotes",c=t.options.footnoteLabelTagName||"h2",f=t.options.footnoteLabelProperties||{className:["sr-only"]},m=[];let p=-1;for(;++p<t.footnoteOrder.length;){const h=t.footnoteById.get(t.footnoteOrder[p]);if(!h)continue;const b=t.all(h),x=String(h.identifier).toUpperCase(),S=Ol(x.toLowerCase());let v=0;const C=[],R=t.footnoteCounts.get(x);for(;R!==void 0&&++v<=R;){C.length>0&&C.push({type:"text",value:" "});let H=typeof l=="string"?l:l(p,v);typeof H=="string"&&(H={type:"text",value:H}),C.push({type:"element",tagName:"a",properties:{href:"#"+a+"fnref-"+S+(v>1?"-"+v:""),dataFootnoteBackref:"",ariaLabel:typeof u=="string"?u:u(p,v),className:["data-footnote-backref"]},children:Array.isArray(H)?H:[H]})}const z=b[b.length-1];if(z&&z.type==="element"&&z.tagName==="p"){const H=z.children[z.children.length-1];H&&H.type==="text"?H.value+=" ":z.children.push({type:"text",value:" "}),z.children.push(...C)}else b.push(...C);const j={type:"element",tagName:"li",properties:{id:a+"fn-"+S},children:t.wrap(b,!0)};t.patch(h,j),m.push(j)}if(m.length!==0)return{type:"element",tagName:"section",properties:{dataFootnotes:!0,className:["footnotes"]},children:[{type:"element",tagName:c,properties:{...Du(f),id:"footnote-label"},children:[{type:"text",value:s}]},{type:"text",value:`
`},{type:"element",tagName:"ol",properties:{},children:t.wrap(m,!0)},{type:"text",value:`
`}]}}const Hu=(function(t){if(t==null)return kC;if(typeof t=="function")return Iu(t);if(typeof t=="object")return Array.isArray(t)?yC(t):vC(t);if(typeof t=="string")return SC(t);throw new Error("Expected function, string, or object as test")});function yC(t){const a=[];let l=-1;for(;++l<t.length;)a[l]=Hu(t[l]);return Iu(u);function u(...s){let c=-1;for(;++c<a.length;)if(a[c].apply(this,s))return!0;return!1}}function vC(t){const a=t;return Iu(l);function l(u){const s=u;let c;for(c in t)if(s[c]!==a[c])return!1;return!0}}function SC(t){return Iu(a);function a(l){return l&&l.type===t}}function Iu(t){return a;function a(l,u,s){return!!(wC(l)&&t.call(this,l,typeof u=="number"?u:void 0,s||void 0))}}function kC(){return!0}function wC(t){return t!==null&&typeof t=="object"&&"type"in t}const Tx=[],CC=!0,Hc=!1,TC="skip";function Ex(t,a,l,u){let s;typeof a=="function"&&typeof l!="function"?(u=l,l=a):s=a;const c=Hu(s),f=u?-1:1;m(t,void 0,[])();function m(p,h,b){const x=p&&typeof p=="object"?p:{};if(typeof x.type=="string"){const v=typeof x.tagName=="string"?x.tagName:typeof x.name=="string"?x.name:void 0;Object.defineProperty(S,"name",{value:"node ("+(p.type+(v?"<"+v+">":""))+")"})}return S;function S(){let v=Tx,C,R,z;if((!a||c(p,h,b[b.length-1]||void 0))&&(v=EC(l(p,b)),v[0]===Hc))return v;if("children"in p&&p.children){const j=p;if(j.children&&v[0]!==TC)for(R=(u?j.children.length:-1)+f,z=b.concat(j);R>-1&&R<j.children.length;){const H=j.children[R];if(C=m(H,R,z)(),C[0]===Hc)return C;R=typeof C[1]=="number"?C[1]:R+f}}return v}}}function EC(t){return Array.isArray(t)?t:typeof t=="number"?[CC,t]:t==null?Tx:[t]}function df(t,a,l,u){let s,c,f;typeof a=="function"&&typeof l!="function"?(c=void 0,f=a,s=l):(c=a,f=l,s=u),Ex(t,c,m,s);function m(p,h){const b=h[h.length-1],x=b?b.children.indexOf(p):void 0;return f(p,x,b)}}const Ic={}.hasOwnProperty,AC={};function jC(t,a){const l=a||AC,u=new Map,s=new Map,c=new Map,f={...fC,...l.handlers},m={all:h,applyData:MC,definitionById:u,footnoteById:s,footnoteCounts:c,footnoteOrder:[],handlers:f,one:p,options:l,patch:NC,wrap:DC};return df(t,function(b){if(b.type==="definition"||b.type==="footnoteDefinition"){const x=b.type==="definition"?u:s,S=String(b.identifier).toUpperCase();x.has(S)||x.set(S,b)}}),m;function p(b,x){const S=b.type,v=m.handlers[S];if(Ic.call(m.handlers,S)&&v)return v(m,b,x);if(m.options.passThrough&&m.options.passThrough.includes(S)){if("children"in b){const{children:R,...z}=b,j=Du(z);return j.children=m.all(b),j}return Du(b)}return(m.options.unknownHandler||_C)(m,b,x)}function h(b){const x=[];if("children"in b){const S=b.children;let v=-1;for(;++v<S.length;){const C=m.one(S[v],b);if(C){if(v&&S[v-1].type==="break"&&(!Array.isArray(C)&&C.type==="text"&&(C.value=sg(C.value)),!Array.isArray(C)&&C.type==="element")){const R=C.children[0];R&&R.type==="text"&&(R.value=sg(R.value))}Array.isArray(C)?x.push(...C):x.push(C)}}}return x}}function NC(t,a){t.position&&(a.position=x2(t))}function MC(t,a){let l=a;if(t&&t.data){const u=t.data.hName,s=t.data.hChildren,c=t.data.hProperties;if(typeof u=="string")if(l.type==="element")l.tagName=u;else{const f="children"in l?l.children:[l];l={type:"element",tagName:u,properties:{},children:f}}l.type==="element"&&c&&Object.assign(l.properties,Du(c)),"children"in l&&l.children&&s!==null&&s!==void 0&&(l.children=s)}return l}function _C(t,a){const l=a.data||{},u="value"in a&&!(Ic.call(l,"hProperties")||Ic.call(l,"hChildren"))?{type:"text",value:a.value}:{type:"element",tagName:"div",properties:{},children:t.all(a)};return t.patch(a,u),t.applyData(a,u)}function DC(t,a){const l=[];let u=-1;for(a&&l.push({type:"text",value:`
`});++u<t.length;)u&&l.push({type:"text",value:`
`}),l.push(t[u]);return a&&t.length>0&&l.push({type:"text",value:`
`}),l}function sg(t){let a=0,l=t.charCodeAt(a);for(;l===9||l===32;)a++,l=t.charCodeAt(a);return t.slice(a)}function og(t,a){const l=jC(t,a),u=l.one(t,void 0),s=bC(l),c=Array.isArray(u)?{type:"root",children:u}:u||{type:"root",children:[]};return s&&c.children.push({type:"text",value:`
`},s),c}function OC(t,a){return t&&"run"in t?async function(l,u){const s=og(l,{file:u,...a});await t.run(s,u)}:function(l,u){return og(l,{file:u,...t||a})}}function cg(t){if(t)throw t}var yc,fg;function RC(){if(fg)return yc;fg=1;var t=Object.prototype.hasOwnProperty,a=Object.prototype.toString,l=Object.defineProperty,u=Object.getOwnPropertyDescriptor,s=function(h){return typeof Array.isArray=="function"?Array.isArray(h):a.call(h)==="[object Array]"},c=function(h){if(!h||a.call(h)!=="[object Object]")return!1;var b=t.call(h,"constructor"),x=h.constructor&&h.constructor.prototype&&t.call(h.constructor.prototype,"isPrototypeOf");if(h.constructor&&!b&&!x)return!1;var S;for(S in h);return typeof S>"u"||t.call(h,S)},f=function(h,b){l&&b.name==="__proto__"?l(h,b.name,{enumerable:!0,configurable:!0,value:b.newValue,writable:!0}):h[b.name]=b.newValue},m=function(h,b){if(b==="__proto__")if(t.call(h,b)){if(u)return u(h,b).value}else return;return h[b]};return yc=function p(){var h,b,x,S,v,C,R=arguments[0],z=1,j=arguments.length,H=!1;for(typeof R=="boolean"&&(H=R,R=arguments[1]||{},z=2),(R==null||typeof R!="object"&&typeof R!="function")&&(R={});z<j;++z)if(h=arguments[z],h!=null)for(b in h)x=m(R,b),S=m(h,b),R!==S&&(H&&S&&(c(S)||(v=s(S)))?(v?(v=!1,C=x&&s(x)?x:[]):C=x&&c(x)?x:{},f(R,{name:b,newValue:p(H,C,S)})):typeof S<"u"&&f(R,{name:b,newValue:S}));return R},yc}var zC=RC();const vc=Yc(zC);function qc(t){if(typeof t!="object"||t===null)return!1;const a=Object.getPrototypeOf(t);return(a===null||a===Object.prototype||Object.getPrototypeOf(a)===null)&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)}function LC(){const t=[],a={run:l,use:u};return a;function l(...s){let c=-1;const f=s.pop();if(typeof f!="function")throw new TypeError("Expected function as last argument, not "+f);m(null,...s);function m(p,...h){const b=t[++c];let x=-1;if(p){f(p);return}for(;++x<s.length;)(h[x]===null||h[x]===void 0)&&(h[x]=s[x]);s=h,b?UC(b,m)(...h):f(null,...h)}}function u(s){if(typeof s!="function")throw new TypeError("Expected `middelware` to be a function, not "+s);return t.push(s),a}}function UC(t,a){let l;return u;function u(...f){const m=t.length>f.length;let p;m&&f.push(s);try{p=t.apply(this,f)}catch(h){const b=h;if(m&&l)throw b;return s(b)}m||(p&&p.then&&typeof p.then=="function"?p.then(c,s):p instanceof Error?s(p):c(p))}function s(f,...m){l||(l=!0,a(f,...m))}function c(f){s(null,f)}}const mt={basename:BC,dirname:HC,extname:IC,join:qC,sep:"/"};function BC(t,a){if(a!==void 0&&typeof a!="string")throw new TypeError('"ext" argument must be a string');Wa(t);let l=0,u=-1,s=t.length,c;if(a===void 0||a.length===0||a.length>t.length){for(;s--;)if(t.codePointAt(s)===47){if(c){l=s+1;break}}else u<0&&(c=!0,u=s+1);return u<0?"":t.slice(l,u)}if(a===t)return"";let f=-1,m=a.length-1;for(;s--;)if(t.codePointAt(s)===47){if(c){l=s+1;break}}else f<0&&(c=!0,f=s+1),m>-1&&(t.codePointAt(s)===a.codePointAt(m--)?m<0&&(u=s):(m=-1,u=f));return l===u?u=f:u<0&&(u=t.length),t.slice(l,u)}function HC(t){if(Wa(t),t.length===0)return".";let a=-1,l=t.length,u;for(;--l;)if(t.codePointAt(l)===47){if(u){a=l;break}}else u||(u=!0);return a<0?t.codePointAt(0)===47?"/":".":a===1&&t.codePointAt(0)===47?"//":t.slice(0,a)}function IC(t){Wa(t);let a=t.length,l=-1,u=0,s=-1,c=0,f;for(;a--;){const m=t.codePointAt(a);if(m===47){if(f){u=a+1;break}continue}l<0&&(f=!0,l=a+1),m===46?s<0?s=a:c!==1&&(c=1):s>-1&&(c=-1)}return s<0||l<0||c===0||c===1&&s===l-1&&s===u+1?"":t.slice(s,l)}function qC(...t){let a=-1,l;for(;++a<t.length;)Wa(t[a]),t[a]&&(l=l===void 0?t[a]:l+"/"+t[a]);return l===void 0?".":VC(l)}function VC(t){Wa(t);const a=t.codePointAt(0)===47;let l=FC(t,!a);return l.length===0&&!a&&(l="."),l.length>0&&t.codePointAt(t.length-1)===47&&(l+="/"),a?"/"+l:l}function FC(t,a){let l="",u=0,s=-1,c=0,f=-1,m,p;for(;++f<=t.length;){if(f<t.length)m=t.codePointAt(f);else{if(m===47)break;m=47}if(m===47){if(!(s===f-1||c===1))if(s!==f-1&&c===2){if(l.length<2||u!==2||l.codePointAt(l.length-1)!==46||l.codePointAt(l.length-2)!==46){if(l.length>2){if(p=l.lastIndexOf("/"),p!==l.length-1){p<0?(l="",u=0):(l=l.slice(0,p),u=l.length-1-l.lastIndexOf("/")),s=f,c=0;continue}}else if(l.length>0){l="",u=0,s=f,c=0;continue}}a&&(l=l.length>0?l+"/..":"..",u=2)}else l.length>0?l+="/"+t.slice(s+1,f):l=t.slice(s+1,f),u=f-s-1;s=f,c=0}else m===46&&c>-1?c++:c=-1}return l}function Wa(t){if(typeof t!="string")throw new TypeError("Path must be a string. Received "+JSON.stringify(t))}const GC={cwd:YC};function YC(){return"/"}function Vc(t){return!!(t!==null&&typeof t=="object"&&"href"in t&&t.href&&"protocol"in t&&t.protocol&&t.auth===void 0)}function PC(t){if(typeof t=="string")t=new URL(t);else if(!Vc(t)){const a=new TypeError('The "path" argument must be of type string or an instance of URL. Received `'+t+"`");throw a.code="ERR_INVALID_ARG_TYPE",a}if(t.protocol!=="file:"){const a=new TypeError("The URL must be of scheme file");throw a.code="ERR_INVALID_URL_SCHEME",a}return XC(t)}function XC(t){if(t.hostname!==""){const u=new TypeError('File URL host must be "localhost" or empty on darwin');throw u.code="ERR_INVALID_FILE_URL_HOST",u}const a=t.pathname;let l=-1;for(;++l<a.length;)if(a.codePointAt(l)===37&&a.codePointAt(l+1)===50){const u=a.codePointAt(l+2);if(u===70||u===102){const s=new TypeError("File URL path must not include encoded / characters");throw s.code="ERR_INVALID_FILE_URL_PATH",s}}return decodeURIComponent(a)}const Sc=["history","path","basename","stem","extname","dirname"];class Ax{constructor(a){let l;a?Vc(a)?l={path:a}:typeof a=="string"||QC(a)?l={value:a}:l=a:l={},this.cwd="cwd"in l?"":GC.cwd(),this.data={},this.history=[],this.messages=[],this.value,this.map,this.result,this.stored;let u=-1;for(;++u<Sc.length;){const c=Sc[u];c in l&&l[c]!==void 0&&l[c]!==null&&(this[c]=c==="history"?[...l[c]]:l[c])}let s;for(s in l)Sc.includes(s)||(this[s]=l[s])}get basename(){return typeof this.path=="string"?mt.basename(this.path):void 0}set basename(a){wc(a,"basename"),kc(a,"basename"),this.path=mt.join(this.dirname||"",a)}get dirname(){return typeof this.path=="string"?mt.dirname(this.path):void 0}set dirname(a){dg(this.basename,"dirname"),this.path=mt.join(a||"",this.basename)}get extname(){return typeof this.path=="string"?mt.extname(this.path):void 0}set extname(a){if(kc(a,"extname"),dg(this.dirname,"extname"),a){if(a.codePointAt(0)!==46)throw new Error("`extname` must start with `.`");if(a.includes(".",1))throw new Error("`extname` cannot contain multiple dots")}this.path=mt.join(this.dirname,this.stem+(a||""))}get path(){return this.history[this.history.length-1]}set path(a){Vc(a)&&(a=PC(a)),wc(a,"path"),this.path!==a&&this.history.push(a)}get stem(){return typeof this.path=="string"?mt.basename(this.path,this.extname):void 0}set stem(a){wc(a,"stem"),kc(a,"stem"),this.path=mt.join(this.dirname||"",a+(this.extname||""))}fail(a,l,u){const s=this.message(a,l,u);throw s.fatal=!0,s}info(a,l,u){const s=this.message(a,l,u);return s.fatal=void 0,s}message(a,l,u){const s=new xn(a,l,u);return this.path&&(s.name=this.path+":"+s.name,s.file=this.path),s.fatal=!1,this.messages.push(s),s}toString(a){return this.value===void 0?"":typeof this.value=="string"?this.value:new TextDecoder(a||void 0).decode(this.value)}}function kc(t,a){if(t&&t.includes(mt.sep))throw new Error("`"+a+"` cannot be a path: did not expect `"+mt.sep+"`")}function wc(t,a){if(!t)throw new Error("`"+a+"` cannot be empty")}function dg(t,a){if(!t)throw new Error("Setting `"+a+"` requires `path` to be set too")}function QC(t){return!!(t&&typeof t=="object"&&"byteLength"in t&&"byteOffset"in t)}const JC=(function(t){const u=this.constructor.prototype,s=u[t],c=function(){return s.apply(c,arguments)};return Object.setPrototypeOf(c,u),c}),ZC={}.hasOwnProperty;class hf extends JC{constructor(){super("copy"),this.Compiler=void 0,this.Parser=void 0,this.attachers=[],this.compiler=void 0,this.freezeIndex=-1,this.frozen=void 0,this.namespace={},this.parser=void 0,this.transformers=LC()}copy(){const a=new hf;let l=-1;for(;++l<this.attachers.length;){const u=this.attachers[l];a.use(...u)}return a.data(vc(!0,{},this.namespace)),a}data(a,l){return typeof a=="string"?arguments.length===2?(Ec("data",this.frozen),this.namespace[a]=l,this):ZC.call(this.namespace,a)&&this.namespace[a]||void 0:a?(Ec("data",this.frozen),this.namespace=a,this):this.namespace}freeze(){if(this.frozen)return this;const a=this;for(;++this.freezeIndex<this.attachers.length;){const[l,...u]=this.attachers[this.freezeIndex];if(u[0]===!1)continue;u[0]===!0&&(u[0]=void 0);const s=l.call(a,...u);typeof s=="function"&&this.transformers.use(s)}return this.frozen=!0,this.freezeIndex=Number.POSITIVE_INFINITY,this}parse(a){this.freeze();const l=ku(a),u=this.parser||this.Parser;return Cc("parse",u),u(String(l),l)}process(a,l){const u=this;return this.freeze(),Cc("process",this.parser||this.Parser),Tc("process",this.compiler||this.Compiler),l?s(void 0,l):new Promise(s);function s(c,f){const m=ku(a),p=u.parse(m);u.run(p,m,function(b,x,S){if(b||!x||!S)return h(b);const v=x,C=u.stringify(v,S);$C(C)?S.value=C:S.result=C,h(b,S)});function h(b,x){b||!x?f(b):c?c(x):l(void 0,x)}}}processSync(a){let l=!1,u;return this.freeze(),Cc("processSync",this.parser||this.Parser),Tc("processSync",this.compiler||this.Compiler),this.process(a,s),mg("processSync","process",l),u;function s(c,f){l=!0,cg(c),u=f}}run(a,l,u){hg(a),this.freeze();const s=this.transformers;return!u&&typeof l=="function"&&(u=l,l=void 0),u?c(void 0,u):new Promise(c);function c(f,m){const p=ku(l);s.run(a,p,h);function h(b,x,S){const v=x||a;b?m(b):f?f(v):u(void 0,v,S)}}}runSync(a,l){let u=!1,s;return this.run(a,l,c),mg("runSync","run",u),s;function c(f,m){cg(f),s=m,u=!0}}stringify(a,l){this.freeze();const u=ku(l),s=this.compiler||this.Compiler;return Tc("stringify",s),hg(a),s(a,u)}use(a,...l){const u=this.attachers,s=this.namespace;if(Ec("use",this.frozen),a!=null)if(typeof a=="function")p(a,l);else if(typeof a=="object")Array.isArray(a)?m(a):f(a);else throw new TypeError("Expected usable value, not `"+a+"`");return this;function c(h){if(typeof h=="function")p(h,[]);else if(typeof h=="object")if(Array.isArray(h)){const[b,...x]=h;p(b,x)}else f(h);else throw new TypeError("Expected usable value, not `"+h+"`")}function f(h){if(!("plugins"in h)&&!("settings"in h))throw new Error("Expected usable value but received an empty preset, which is probably a mistake: presets typically come with `plugins` and sometimes with `settings`, but this has neither");m(h.plugins),h.settings&&(s.settings=vc(!0,s.settings,h.settings))}function m(h){let b=-1;if(h!=null)if(Array.isArray(h))for(;++b<h.length;){const x=h[b];c(x)}else throw new TypeError("Expected a list of plugins, not `"+h+"`")}function p(h,b){let x=-1,S=-1;for(;++x<u.length;)if(u[x][0]===h){S=x;break}if(S===-1)u.push([h,...b]);else if(b.length>0){let[v,...C]=b;const R=u[S][1];qc(R)&&qc(v)&&(v=vc(!0,R,v)),u[S]=[h,v,...C]}}}}const KC=new hf().freeze();function Cc(t,a){if(typeof a!="function")throw new TypeError("Cannot `"+t+"` without `parser`")}function Tc(t,a){if(typeof a!="function")throw new TypeError("Cannot `"+t+"` without `compiler`")}function Ec(t,a){if(a)throw new Error("Cannot call `"+t+"` on a frozen processor.\nCreate a new processor first, by calling it: use `processor()` instead of `processor`.")}function hg(t){if(!qc(t)||typeof t.type!="string")throw new TypeError("Expected node, got `"+t+"`")}function mg(t,a,l){if(!l)throw new Error("`"+t+"` finished async. Use `"+a+"` instead")}function ku(t){return WC(t)?t:new Ax(t)}function WC(t){return!!(t&&typeof t=="object"&&"message"in t&&"messages"in t)}function $C(t){return typeof t=="string"||e3(t)}function e3(t){return!!(t&&typeof t=="object"&&"byteLength"in t&&"byteOffset"in t)}const n3="https://github.com/remarkjs/react-markdown/blob/main/changelog.md",pg=[],gg={allowDangerousHtml:!0},t3=/^(https?|ircs?|mailto|xmpp)$/i,r3=[{from:"astPlugins",id:"remove-buggy-html-in-markdown-parser"},{from:"allowDangerousHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"allowNode",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowElement"},{from:"allowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowedElements"},{from:"className",id:"remove-classname"},{from:"disallowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"disallowedElements"},{from:"escapeHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"includeElementIndex",id:"#remove-includeelementindex"},{from:"includeNodeIndex",id:"change-includenodeindex-to-includeelementindex"},{from:"linkTarget",id:"remove-linktarget"},{from:"plugins",id:"change-plugins-to-remarkplugins",to:"remarkPlugins"},{from:"rawSourcePos",id:"#remove-rawsourcepos"},{from:"renderers",id:"change-renderers-to-components",to:"components"},{from:"source",id:"change-source-to-children",to:"children"},{from:"sourcePos",id:"#remove-sourcepos"},{from:"transformImageUri",id:"#add-urltransform",to:"urlTransform"},{from:"transformLinkUri",id:"#add-urltransform",to:"urlTransform"}];function l3(t){const a=a3(t),l=i3(t);return u3(a.runSync(a.parse(l),l),t)}function a3(t){const a=t.rehypePlugins||pg,l=t.remarkPlugins||pg,u=t.remarkRehypeOptions?{...t.remarkRehypeOptions,...gg}:gg;return KC().use(Hw).use(l).use(OC,u).use(a)}function i3(t){const a=t.children||"",l=new Ax;return typeof a=="string"&&(l.value=a),l}function u3(t,a){const l=a.allowedElements,u=a.allowElement,s=a.components,c=a.disallowedElements,f=a.skipHtml,m=a.unwrapDisallowed,p=a.urlTransform||s3;for(const b of r3)Object.hasOwn(a,b.from)&&(""+b.from+(b.to?"use `"+b.to+"` instead":"remove it")+n3+b.id,void 0);return df(t,h),k2(t,{Fragment:g.Fragment,components:s,ignoreInvalidStyle:!0,jsx:g.jsx,jsxs:g.jsxs,passKeys:!0,passNode:!0});function h(b,x,S){if(b.type==="raw"&&S&&typeof x=="number")return f?S.children.splice(x,1):S.children[x]={type:"text",value:b.value},x;if(b.type==="element"){let v;for(v in gc)if(Object.hasOwn(gc,v)&&Object.hasOwn(b.properties,v)){const C=b.properties[v],R=gc[v];(R===null||R.includes(b.tagName))&&(b.properties[v]=p(String(C||""),v,b))}}if(b.type==="element"){let v=l?!l.includes(b.tagName):c?c.includes(b.tagName):!1;if(!v&&u&&typeof x=="number"&&(v=!u(b,x,S)),v&&S&&typeof x=="number")return m&&b.children?S.children.splice(x,1,...b.children):S.children.splice(x,1),x}}}function s3(t){const a=t.indexOf(":"),l=t.indexOf("?"),u=t.indexOf("#"),s=t.indexOf("/");return a===-1||s!==-1&&a>s||l!==-1&&a>l||u!==-1&&a>u||t3.test(t.slice(0,a))?t:""}function xg(t,a){const l=String(t);if(typeof a!="string")throw new TypeError("Expected character");let u=0,s=l.indexOf(a);for(;s!==-1;)u++,s=l.indexOf(a,s+a.length);return u}function o3(t){if(typeof t!="string")throw new TypeError("Expected a string");return t.replace(/[|\\{}()[\]^$+*?.]/g,"\\$&").replace(/-/g,"\\x2d")}function c3(t,a,l){const s=Hu((l||{}).ignore||[]),c=f3(a);let f=-1;for(;++f<c.length;)Ex(t,"text",m);function m(h,b){let x=-1,S;for(;++x<b.length;){const v=b[x],C=S?S.children:void 0;if(s(v,C?C.indexOf(v):void 0,S))return;S=v}if(S)return p(h,b)}function p(h,b){const x=b[b.length-1],S=c[f][0],v=c[f][1];let C=0;const z=x.children.indexOf(h);let j=!1,H=[];S.lastIndex=0;let _=S.exec(h.value);for(;_;){const K=_.index,re={index:_.index,input:_.input,stack:[...b,h]};let q=v(..._,re);if(typeof q=="string"&&(q=q.length>0?{type:"text",value:q}:void 0),q===!1?S.lastIndex=K+1:(C!==K&&H.push({type:"text",value:h.value.slice(C,K)}),Array.isArray(q)?H.push(...q):q&&H.push(q),C=K+_[0].length,j=!0),!S.global)break;_=S.exec(h.value)}return j?(C<h.value.length&&H.push({type:"text",value:h.value.slice(C)}),x.children.splice(z,1,...H)):H=[h],z+H.length}}function f3(t){const a=[];if(!Array.isArray(t))throw new TypeError("Expected find and replace tuple or list of tuples");const l=!t[0]||Array.isArray(t[0])?t:[t];let u=-1;for(;++u<l.length;){const s=l[u];a.push([d3(s[0]),h3(s[1])])}return a}function d3(t){return typeof t=="string"?new RegExp(o3(t),"g"):t}function h3(t){return typeof t=="function"?t:function(){return t}}const Ac="phrasing",jc=["autolink","link","image","label"];function m3(){return{transforms:[S3],enter:{literalAutolink:g3,literalAutolinkEmail:Nc,literalAutolinkHttp:Nc,literalAutolinkWww:Nc},exit:{literalAutolink:v3,literalAutolinkEmail:y3,literalAutolinkHttp:x3,literalAutolinkWww:b3}}}function p3(){return{unsafe:[{character:"@",before:"[+\\-.\\w]",after:"[\\-.\\w]",inConstruct:Ac,notInConstruct:jc},{character:".",before:"[Ww]",after:"[\\-.\\w]",inConstruct:Ac,notInConstruct:jc},{character:":",before:"[ps]",after:"\\/",inConstruct:Ac,notInConstruct:jc}]}}function g3(t){this.enter({type:"link",title:null,url:"",children:[]},t)}function Nc(t){this.config.enter.autolinkProtocol.call(this,t)}function x3(t){this.config.exit.autolinkProtocol.call(this,t)}function b3(t){this.config.exit.data.call(this,t);const a=this.stack[this.stack.length-1];a.type,a.url="http://"+this.sliceSerialize(t)}function y3(t){this.config.exit.autolinkEmail.call(this,t)}function v3(t){this.exit(t)}function S3(t){c3(t,[[/(https?:\/\/|www(?=\.))([-.\w]+)([^ \t\r\n]*)/gi,k3],[new RegExp("(?<=^|\\s|\\p{P}|\\p{S})([-.\\w+]+)@([-\\w]+(?:\\.[-\\w]+)+)","gu"),w3]],{ignore:["link","linkReference"]})}function k3(t,a,l,u,s){let c="";if(!jx(s)||(/^w/i.test(a)&&(l=a+l,a="",c="http://"),!C3(l)))return!1;const f=T3(l+u);if(!f[0])return!1;const m={type:"link",title:null,url:c+a+f[0],children:[{type:"text",value:a+f[0]}]};return f[1]?[m,{type:"text",value:f[1]}]:m}function w3(t,a,l,u){return!jx(u,!0)||/[-\d_]$/.test(l)?!1:{type:"link",title:null,url:"mailto:"+a+"@"+l,children:[{type:"text",value:a+"@"+l}]}}function C3(t){const a=t.split(".");return!(a.length<2||a[a.length-1]&&(/_/.test(a[a.length-1])||!/[a-zA-Z\d]/.test(a[a.length-1]))||a[a.length-2]&&(/_/.test(a[a.length-2])||!/[a-zA-Z\d]/.test(a[a.length-2])))}function T3(t){const a=/[!"&'),.:;<>?\]}]+$/.exec(t);if(!a)return[t,void 0];t=t.slice(0,a.index);let l=a[0],u=l.indexOf(")");const s=xg(t,"(");let c=xg(t,")");for(;u!==-1&&s>c;)t+=l.slice(0,u+1),l=l.slice(u+1),u=l.indexOf(")"),c++;return[t,l]}function jx(t,a){const l=t.input.charCodeAt(t.index-1);return(t.index===0||zr(l)||Lu(l))&&(!a||l!==47)}Nx.peek=R3;function E3(){this.buffer()}function A3(t){this.enter({type:"footnoteReference",identifier:"",label:""},t)}function j3(){this.buffer()}function N3(t){this.enter({type:"footnoteDefinition",identifier:"",label:"",children:[]},t)}function M3(t){const a=this.resume(),l=this.stack[this.stack.length-1];l.type,l.identifier=ut(this.sliceSerialize(t)).toLowerCase(),l.label=a}function _3(t){this.exit(t)}function D3(t){const a=this.resume(),l=this.stack[this.stack.length-1];l.type,l.identifier=ut(this.sliceSerialize(t)).toLowerCase(),l.label=a}function O3(t){this.exit(t)}function R3(){return"["}function Nx(t,a,l,u){const s=l.createTracker(u);let c=s.move("[^");const f=l.enter("footnoteReference"),m=l.enter("reference");return c+=s.move(l.safe(l.associationId(t),{after:"]",before:c})),m(),f(),c+=s.move("]"),c}function z3(){return{enter:{gfmFootnoteCallString:E3,gfmFootnoteCall:A3,gfmFootnoteDefinitionLabelString:j3,gfmFootnoteDefinition:N3},exit:{gfmFootnoteCallString:M3,gfmFootnoteCall:_3,gfmFootnoteDefinitionLabelString:D3,gfmFootnoteDefinition:O3}}}function L3(t){let a=!1;return t&&t.firstLineBlank&&(a=!0),{handlers:{footnoteDefinition:l,footnoteReference:Nx},unsafe:[{character:"[",inConstruct:["label","phrasing","reference"]}]};function l(u,s,c,f){const m=c.createTracker(f);let p=m.move("[^");const h=c.enter("footnoteDefinition"),b=c.enter("label");return p+=m.move(c.safe(c.associationId(u),{before:p,after:"]"})),b(),p+=m.move("]:"),u.children&&u.children.length>0&&(m.shift(4),p+=m.move((a?`
`:" ")+c.indentLines(c.containerFlow(u,m.current()),a?Mx:U3))),h(),p}}function U3(t,a,l){return a===0?t:Mx(t,a,l)}function Mx(t,a,l){return(l?"":"    ")+t}const B3=["autolink","destinationLiteral","destinationRaw","reference","titleQuote","titleApostrophe"];_x.peek=F3;function H3(){return{canContainEols:["delete"],enter:{strikethrough:q3},exit:{strikethrough:V3}}}function I3(){return{unsafe:[{character:"~",inConstruct:"phrasing",notInConstruct:B3}],handlers:{delete:_x}}}function q3(t){this.enter({type:"delete",children:[]},t)}function V3(t){this.exit(t)}function _x(t,a,l,u){const s=l.createTracker(u),c=l.enter("strikethrough");let f=s.move("~~");return f+=l.containerPhrasing(t,{...s.current(),before:f,after:"~"}),f+=s.move("~~"),c(),f}function F3(){return"~"}function G3(t){return t.length}function Y3(t,a){const l=a||{},u=(l.align||[]).concat(),s=l.stringLength||G3,c=[],f=[],m=[],p=[];let h=0,b=-1;for(;++b<t.length;){const R=[],z=[];let j=-1;for(t[b].length>h&&(h=t[b].length);++j<t[b].length;){const H=P3(t[b][j]);if(l.alignDelimiters!==!1){const _=s(H);z[j]=_,(p[j]===void 0||_>p[j])&&(p[j]=_)}R.push(H)}f[b]=R,m[b]=z}let x=-1;if(typeof u=="object"&&"length"in u)for(;++x<h;)c[x]=bg(u[x]);else{const R=bg(u);for(;++x<h;)c[x]=R}x=-1;const S=[],v=[];for(;++x<h;){const R=c[x];let z="",j="";R===99?(z=":",j=":"):R===108?z=":":R===114&&(j=":");let H=l.alignDelimiters===!1?1:Math.max(1,p[x]-z.length-j.length);const _=z+"-".repeat(H)+j;l.alignDelimiters!==!1&&(H=z.length+H+j.length,H>p[x]&&(p[x]=H),v[x]=H),S[x]=_}f.splice(1,0,S),m.splice(1,0,v),b=-1;const C=[];for(;++b<f.length;){const R=f[b],z=m[b];x=-1;const j=[];for(;++x<h;){const H=R[x]||"";let _="",K="";if(l.alignDelimiters!==!1){const re=p[x]-(z[x]||0),q=c[x];q===114?_=" ".repeat(re):q===99?re%2?(_=" ".repeat(re/2+.5),K=" ".repeat(re/2-.5)):(_=" ".repeat(re/2),K=_):K=" ".repeat(re)}l.delimiterStart!==!1&&!x&&j.push("|"),l.padding!==!1&&!(l.alignDelimiters===!1&&H==="")&&(l.delimiterStart!==!1||x)&&j.push(" "),l.alignDelimiters!==!1&&j.push(_),j.push(H),l.alignDelimiters!==!1&&j.push(K),l.padding!==!1&&j.push(" "),(l.delimiterEnd!==!1||x!==h-1)&&j.push("|")}C.push(l.delimiterEnd===!1?j.join("").replace(/ +$/,""):j.join(""))}return C.join(`
`)}function P3(t){return t==null?"":String(t)}function bg(t){const a=typeof t=="string"?t.codePointAt(0):0;return a===67||a===99?99:a===76||a===108?108:a===82||a===114?114:0}function X3(t,a,l,u){const s=l.enter("blockquote"),c=l.createTracker(u);c.move("> "),c.shift(2);const f=l.indentLines(l.containerFlow(t,c.current()),Q3);return s(),f}function Q3(t,a,l){return">"+(l?"":" ")+t}function J3(t,a){return yg(t,a.inConstruct,!0)&&!yg(t,a.notInConstruct,!1)}function yg(t,a,l){if(typeof a=="string"&&(a=[a]),!a||a.length===0)return l;let u=-1;for(;++u<a.length;)if(t.includes(a[u]))return!0;return!1}function vg(t,a,l,u){let s=-1;for(;++s<l.unsafe.length;)if(l.unsafe[s].character===`
`&&J3(l.stack,l.unsafe[s]))return/[ \t]/.test(u.before)?"":" ";return`\\
`}function Z3(t,a){const l=String(t);let u=l.indexOf(a),s=u,c=0,f=0;if(typeof a!="string")throw new TypeError("Expected substring");for(;u!==-1;)u===s?++c>f&&(f=c):c=1,s=u+a.length,u=l.indexOf(a,s);return f}function K3(t,a){return!!(a.options.fences===!1&&t.value&&!t.lang&&/[^ \r\n]/.test(t.value)&&!/^[\t ]*(?:[\r\n]|$)|(?:^|[\r\n])[\t ]*$/.test(t.value))}function W3(t){const a=t.options.fence||"`";if(a!=="`"&&a!=="~")throw new Error("Cannot serialize code with `"+a+"` for `options.fence`, expected `` ` `` or `~`");return a}function $3(t,a,l,u){const s=W3(l),c=t.value||"",f=s==="`"?"GraveAccent":"Tilde";if(K3(t,l)){const x=l.enter("codeIndented"),S=l.indentLines(c,eT);return x(),S}const m=l.createTracker(u),p=s.repeat(Math.max(Z3(c,s)+1,3)),h=l.enter("codeFenced");let b=m.move(p);if(t.lang){const x=l.enter(`codeFencedLang${f}`);b+=m.move(l.safe(t.lang,{before:b,after:" ",encode:["`"],...m.current()})),x()}if(t.lang&&t.meta){const x=l.enter(`codeFencedMeta${f}`);b+=m.move(" "),b+=m.move(l.safe(t.meta,{before:b,after:`
`,encode:["`"],...m.current()})),x()}return b+=m.move(`
`),c&&(b+=m.move(c+`
`)),b+=m.move(p),h(),b}function eT(t,a,l){return(l?"":"    ")+t}function mf(t){const a=t.options.quote||'"';if(a!=='"'&&a!=="'")throw new Error("Cannot serialize title with `"+a+"` for `options.quote`, expected `\"`, or `'`");return a}function nT(t,a,l,u){const s=mf(l),c=s==='"'?"Quote":"Apostrophe",f=l.enter("definition");let m=l.enter("label");const p=l.createTracker(u);let h=p.move("[");return h+=p.move(l.safe(l.associationId(t),{before:h,after:"]",...p.current()})),h+=p.move("]: "),m(),!t.url||/[\0- \u007F]/.test(t.url)?(m=l.enter("destinationLiteral"),h+=p.move("<"),h+=p.move(l.safe(t.url,{before:h,after:">",...p.current()})),h+=p.move(">")):(m=l.enter("destinationRaw"),h+=p.move(l.safe(t.url,{before:h,after:t.title?" ":`
`,...p.current()}))),m(),t.title&&(m=l.enter(`title${c}`),h+=p.move(" "+s),h+=p.move(l.safe(t.title,{before:h,after:s,...p.current()})),h+=p.move(s),m()),f(),h}function tT(t){const a=t.options.emphasis||"*";if(a!=="*"&&a!=="_")throw new Error("Cannot serialize emphasis with `"+a+"` for `options.emphasis`, expected `*`, or `_`");return a}function Ya(t){return"&#x"+t.toString(16).toUpperCase()+";"}function Ou(t,a,l){const u=Nl(t),s=Nl(a);return u===void 0?s===void 0?l==="_"?{inside:!0,outside:!0}:{inside:!1,outside:!1}:s===1?{inside:!0,outside:!0}:{inside:!1,outside:!0}:u===1?s===void 0?{inside:!1,outside:!1}:s===1?{inside:!0,outside:!0}:{inside:!1,outside:!1}:s===void 0?{inside:!1,outside:!1}:s===1?{inside:!0,outside:!1}:{inside:!1,outside:!1}}Dx.peek=rT;function Dx(t,a,l,u){const s=tT(l),c=l.enter("emphasis"),f=l.createTracker(u),m=f.move(s);let p=f.move(l.containerPhrasing(t,{after:s,before:m,...f.current()}));const h=p.charCodeAt(0),b=Ou(u.before.charCodeAt(u.before.length-1),h,s);b.inside&&(p=Ya(h)+p.slice(1));const x=p.charCodeAt(p.length-1),S=Ou(u.after.charCodeAt(0),x,s);S.inside&&(p=p.slice(0,-1)+Ya(x));const v=f.move(s);return c(),l.attentionEncodeSurroundingInfo={after:S.outside,before:b.outside},m+p+v}function rT(t,a,l){return l.options.emphasis||"*"}function lT(t,a){let l=!1;return df(t,function(u){if("value"in u&&/\r?\n|\r/.test(u.value)||u.type==="break")return l=!0,Hc}),!!((!t.depth||t.depth<3)&&lf(t)&&(a.options.setext||l))}function aT(t,a,l,u){const s=Math.max(Math.min(6,t.depth||1),1),c=l.createTracker(u);if(lT(t,l)){const b=l.enter("headingSetext"),x=l.enter("phrasing"),S=l.containerPhrasing(t,{...c.current(),before:`
`,after:`
`});return x(),b(),S+`
...
`,...c.current()});return/^[\t ]/.test(h)&&(h=Ya(h.charCodeAt(0))+h.slice(1)),h=h?f+" "+h:f,l.options.closeAtx&&(h+=" "+f),p(),m(),h}Ox.peek=iT;function Ox(t){return t.value||""}function iT(){return"<"}Rx.peek=uT;function Rx(t,a,l,u){const s=mf(l),c=s==='"'?"Quote":"Apostrophe",f=l.enter("image");let m=l.enter("label");const p=l.createTracker(u);let h=p.move("![");return h+=p.move(l.safe(t.alt,{before:h,after:"]",...p.current()})),h+=p.move("]("),m(),!t.url&&t.title||/[\0- \u007F]/.test(t.url)?(m=l.enter("destinationLiteral"),h+=p.move("<"),h+=p.move(l.safe(t.url,{before:h,after:">",...p.current()})),h+=p.move(">")):(m=l.enter("destinationRaw"),h+=p.move(l.safe(t.url,{before:h,after:t.title?" ":")",...p.current()}))),m(),t.title&&(m=l.enter(`title${c}`),h+=p.move(" "+s),h+=p.move(l.safe(t.title,{before:h,after:s,...p.current()})),h+=p.move(s),m()),h+=p.move(")"),f(),h}function uT(){return"!"}zx.peek=sT;function zx(t,a,l,u){const s=t.referenceType,c=l.enter("imageReference");let f=l.enter("label");const m=l.createTracker(u);let p=m.move("![");const h=l.safe(t.alt,{before:p,after:"]",...m.current()});p+=m.move(h+"]["),f();const b=l.stack;l.stack=[],f=l.enter("reference");const x=l.safe(l.associationId(t),{before:p,after:"]",...m.current()});return f(),l.stack=b,c(),s==="full"||!h||h!==x?p+=m.move(x+"]"):s==="shortcut"?p=p.slice(0,-1):p+=m.move("]"),p}function sT(){return"!"}Lx.peek=oT;function Lx(t,a,l){let u=t.value||"",s="`",c=-1;for(;new RegExp("(^|[^`])"+s+"([^`]|$)").test(u);)s+="`";for(/[^ \r\n]/.test(u)&&(/^[ \r\n]/.test(u)&&/[ \r\n]$/.test(u)||/^`|`$/.test(u))&&(u=" "+u+" ");++c<l.unsafe.length;){const f=l.unsafe[c],m=l.compilePattern(f);let p;if(f.atBreak)for(;p=m.exec(u);){let h=p.index;u.charCodeAt(h)===10&&u.charCodeAt(h-1)===13&&h--,u=u.slice(0,h)+" "+u.slice(p.index+1)}}return s+u+s}function oT(){return"`"}function Ux(t,a){const l=lf(t);return!!(!a.options.resourceLink&&t.url&&!t.title&&t.children&&t.children.length===1&&t.children[0].type==="text"&&(l===t.url||"mailto:"+l===t.url)&&/^[a-z][a-z+.-]+:/i.test(t.url)&&!/[\0- <>\u007F]/.test(t.url))}Bx.peek=cT;function Bx(t,a,l,u){const s=mf(l),c=s==='"'?"Quote":"Apostrophe",f=l.createTracker(u);let m,p;if(Ux(t,l)){const b=l.stack;l.stack=[],m=l.enter("autolink");let x=f.move("<");return x+=f.move(l.containerPhrasing(t,{before:x,after:">",...f.current()})),x+=f.move(">"),m(),l.stack=b,x}m=l.enter("link"),p=l.enter("label");let h=f.move("[");return h+=f.move(l.containerPhrasing(t,{before:h,after:"](",...f.current()})),h+=f.move("]("),p(),!t.url&&t.title||/[\0- \u007F]/.test(t.url)?(p=l.enter("destinationLiteral"),h+=f.move("<"),h+=f.move(l.safe(t.url,{before:h,after:">",...f.current()})),h+=f.move(">")):(p=l.enter("destinationRaw"),h+=f.move(l.safe(t.url,{before:h,after:t.title?" ":")",...f.current()}))),p(),t.title&&(p=l.enter(`title${c}`),h+=f.move(" "+s),h+=f.move(l.safe(t.title,{before:h,after:s,...f.current()})),h+=f.move(s),p()),h+=f.move(")"),m(),h}function cT(t,a,l){return Ux(t,l)?"<":"["}Hx.peek=fT;function Hx(t,a,l,u){const s=t.referenceType,c=l.enter("linkReference");let f=l.enter("label");const m=l.createTracker(u);let p=m.move("[");const h=l.containerPhrasing(t,{before:p,after:"]",...m.current()});p+=m.move(h+"]["),f();const b=l.stack;l.stack=[],f=l.enter("reference");const x=l.safe(l.associationId(t),{before:p,after:"]",...m.current()});return f(),l.stack=b,c(),s==="full"||!h||h!==x?p+=m.move(x+"]"):s==="shortcut"?p=p.slice(0,-1):p+=m.move("]"),p}function fT(){return"["}function pf(t){const a=t.options.bullet||"*";if(a!=="*"&&a!=="+"&&a!=="-")throw new Error("Cannot serialize items with `"+a+"` for `options.bullet`, expected `*`, `+`, or `-`");return a}function dT(t){const a=pf(t),l=t.options.bulletOther;if(!l)return a==="*"?"-":"*";if(l!=="*"&&l!=="+"&&l!=="-")throw new Error("Cannot serialize items with `"+l+"` for `options.bulletOther`, expected `*`, `+`, or `-`");if(l===a)throw new Error("Expected `bullet` (`"+a+"`) and `bulletOther` (`"+l+"`) to be different");return l}function hT(t){const a=t.options.bulletOrdered||".";if(a!=="."&&a!==")")throw new Error("Cannot serialize items with `"+a+"` for `options.bulletOrdered`, expected `.` or `)`");return a}function Ix(t){const a=t.options.rule||"*";if(a!=="*"&&a!=="-"&&a!=="_")throw new Error("Cannot serialize rules with `"+a+"` for `options.rule`, expected `*`, `-`, or `_`");return a}function mT(t,a,l,u){const s=l.enter("list"),c=l.bulletCurrent;let f=t.ordered?hT(l):pf(l);const m=t.ordered?f==="."?")":".":dT(l);let p=a&&l.bulletLastUsed?f===l.bulletLastUsed:!1;if(!t.ordered){const b=t.children?t.children[0]:void 0;if((f==="*"||f==="-")&&b&&(!b.children||!b.children[0])&&l.stack[l.stack.length-1]==="list"&&l.stack[l.stack.length-2]==="listItem"&&l.stack[l.stack.length-3]==="list"&&l.stack[l.stack.length-4]==="listItem"&&l.indexStack[l.indexStack.length-1]===0&&l.indexStack[l.indexStack.length-2]===0&&l.indexStack[l.indexStack.length-3]===0&&(p=!0),Ix(l)===f&&b){let x=-1;for(;++x<t.children.length;){const S=t.children[x];if(S&&S.type==="listItem"&&S.children&&S.children[0]&&S.children[0].type==="thematicBreak"){p=!0;break}}}}p&&(f=m),l.bulletCurrent=f;const h=l.containerFlow(t,u);return l.bulletLastUsed=f,l.bulletCurrent=c,s(),h}function pT(t){const a=t.options.listItemIndent||"one";if(a!=="tab"&&a!=="one"&&a!=="mixed")throw new Error("Cannot serialize items with `"+a+"` for `options.listItemIndent`, expected `tab`, `one`, or `mixed`");return a}function gT(t,a,l,u){const s=pT(l);let c=l.bulletCurrent||pf(l);a&&a.type==="list"&&a.ordered&&(c=(typeof a.start=="number"&&a.start>-1?a.start:1)+(l.options.incrementListMarker===!1?0:a.children.indexOf(t))+c);let f=c.length+1;(s==="tab"||s==="mixed"&&(a&&a.type==="list"&&a.spread||t.spread))&&(f=Math.ceil(f/4)*4);const m=l.createTracker(u);m.move(c+" ".repeat(f-c.length)),m.shift(f);const p=l.enter("listItem"),h=l.indentLines(l.containerFlow(t,m.current()),b);return p(),h;function b(x,S,v){return S?(v?"":" ".repeat(f))+x:(v?c:c+" ".repeat(f-c.length))+x}}function xT(t,a,l,u){const s=l.enter("paragraph"),c=l.enter("phrasing"),f=l.containerPhrasing(t,u);return c(),s(),f}const bT=Hu(["break","delete","emphasis","footnote","footnoteReference","image","imageReference","inlineCode","inlineMath","link","linkReference","mdxJsxTextElement","mdxTextExpression","strong","text","textDirective"]);function yT(t,a,l,u){return(t.children.some(function(f){return bT(f)})?l.containerPhrasing:l.containerFlow).call(l,t,u)}function vT(t){const a=t.options.strong||"*";if(a!=="*"&&a!=="_")throw new Error("Cannot serialize strong with `"+a+"` for `options.strong`, expected `*`, or `_`");return a}qx.peek=ST;function qx(t,a,l,u){const s=vT(l),c=l.enter("strong"),f=l.createTracker(u),m=f.move(s+s);let p=f.move(l.containerPhrasing(t,{after:s,before:m,...f.current()}));const h=p.charCodeAt(0),b=Ou(u.before.charCodeAt(u.before.length-1),h,s);b.inside&&(p=Ya(h)+p.slice(1));const x=p.charCodeAt(p.length-1),S=Ou(u.after.charCodeAt(0),x,s);S.inside&&(p=p.slice(0,-1)+Ya(x));const v=f.move(s+s);return c(),l.attentionEncodeSurroundingInfo={after:S.outside,before:b.outside},m+p+v}function ST(t,a,l){return l.options.strong||"*"}function kT(t,a,l,u){return l.safe(t.value,u)}function wT(t){const a=t.options.ruleRepetition||3;if(a<3)throw new Error("Cannot serialize rules with repetition `"+a+"` for `options.ruleRepetition`, expected `3` or more");return a}function CT(t,a,l){const u=(Ix(l)+(l.options.ruleSpaces?" ":"")).repeat(wT(l));return l.options.ruleSpaces?u.slice(0,-1):u}const Vx={blockquote:X3,break:vg,code:$3,definition:nT,emphasis:Dx,hardBreak:vg,heading:aT,html:Ox,image:Rx,imageReference:zx,inlineCode:Lx,link:Bx,linkReference:Hx,list:mT,listItem:gT,paragraph:xT,root:yT,strong:qx,text:kT,thematicBreak:CT};function TT(){return{enter:{table:ET,tableData:Sg,tableHeader:Sg,tableRow:jT},exit:{codeText:NT,table:AT,tableData:Mc,tableHeader:Mc,tableRow:Mc}}}function ET(t){const a=t._align;this.enter({type:"table",align:a.map(function(l){return l==="none"?null:l}),children:[]},t),this.data.inTable=!0}function AT(t){this.exit(t),this.data.inTable=void 0}function jT(t){this.enter({type:"tableRow",children:[]},t)}function Mc(t){this.exit(t)}function Sg(t){this.enter({type:"tableCell",children:[]},t)}function NT(t){let a=this.resume();this.data.inTable&&(a=a.replace(/\\([\\|])/g,MT));const l=this.stack[this.stack.length-1];l.type,l.value=a,this.exit(t)}function MT(t,a){return a==="|"?a:t}function _T(t){const a=t||{},l=a.tableCellPadding,u=a.tablePipeAlign,s=a.stringLength,c=l?" ":"|";return{unsafe:[{character:"\r",inConstruct:"tableCell"},{character:`
`,inConstruct:"tableCell"},{atBreak:!0,character:"|",after:"[	 :-]"},{character:"|",inConstruct:"tableCell"},{atBreak:!0,character:":",after:"-"},{atBreak:!0,character:"-",after:"[:|-]"}],handlers:{inlineCode:S,table:f,tableCell:p,tableRow:m}};function f(v,C,R,z){return h(b(v,R,z),v.align)}function m(v,C,R,z){const j=x(v,R,z),H=h([j]);return H.slice(0,H.indexOf(`
`))}function p(v,C,R,z){const j=R.enter("tableCell"),H=R.enter("phrasing"),_=R.containerPhrasing(v,{...z,before:c,after:c});return H(),j(),_}function h(v,C){return Y3(v,{align:C,alignDelimiters:u,padding:l,stringLength:s})}function b(v,C,R){const z=v.children;let j=-1;const H=[],_=C.enter("table");for(;++j<z.length;)H[j]=x(z[j],C,R);return _(),H}function x(v,C,R){const z=v.children;let j=-1;const H=[],_=C.enter("tableRow");for(;++j<z.length;)H[j]=p(z[j],v,C,R);return _(),H}function S(v,C,R){let z=Vx.inlineCode(v,C,R);return R.stack.includes("tableCell")&&(z=z.replace(/\|/g,"\\$&")),z}}function DT(){return{exit:{taskListCheckValueChecked:kg,taskListCheckValueUnchecked:kg,paragraph:RT}}}function OT(){return{unsafe:[{atBreak:!0,character:"-",after:"[:|-]"}],handlers:{listItem:zT}}}function kg(t){const a=this.stack[this.stack.length-2];a.type,a.checked=t.type==="taskListCheckValueChecked"}function RT(t){const a=this.stack[this.stack.length-2];if(a&&a.type==="listItem"&&typeof a.checked=="boolean"){const l=this.stack[this.stack.length-1];l.type;const u=l.children[0];if(u&&u.type==="text"){const s=a.children;let c=-1,f;for(;++c<s.length;){const m=s[c];if(m.type==="paragraph"){f=m;break}}f===l&&(u.value=u.value.slice(1),u.value.length===0?l.children.shift():l.position&&u.position&&typeof u.position.start.offset=="number"&&(u.position.start.column++,u.position.start.offset++,l.position.start=Object.assign({},u.position.start)))}}this.exit(t)}function zT(t,a,l,u){const s=t.children[0],c=typeof t.checked=="boolean"&&s&&s.type==="paragraph",f="["+(t.checked?"x":" ")+"] ",m=l.createTracker(u);c&&m.move(f);let p=Vx.listItem(t,a,l,{...u,...m.current()});return c&&(p=p.replace(/^(?:[*+-]|\d+\.)([\r\n]| {1,3})/,h)),p;function h(b){return b+f}}function LT(){return[m3(),z3(),H3(),TT(),DT()]}function UT(t){return{extensions:[p3(),L3(t),I3(),_T(t),OT()]}}const BT={tokenize:GT,partial:!0},Fx={tokenize:YT,partial:!0},Gx={tokenize:PT,partial:!0},Yx={tokenize:XT,partial:!0},HT={tokenize:QT,partial:!0},Px={name:"wwwAutolink",tokenize:VT,previous:Qx},Xx={name:"protocolAutolink",tokenize:FT,previous:Jx},Vt={name:"emailAutolink",tokenize:qT,previous:Zx},gt={};function IT(){return{text:gt}}let Rr=48;for(;Rr<123;)gt[Rr]=Vt,Rr++,Rr===58?Rr=65:Rr===91&&(Rr=97);gt[43]=Vt;gt[45]=Vt;gt[46]=Vt;gt[95]=Vt;gt[72]=[Vt,Xx];gt[104]=[Vt,Xx];gt[87]=[Vt,Px];gt[119]=[Vt,Px];function qT(t,a,l){const u=this;let s,c;return f;function f(x){return!Fc(x)||!Zx.call(u,u.previous)||gf(u.events)?l(x):(t.enter("literalAutolink"),t.enter("literalAutolinkEmail"),m(x))}function m(x){return Fc(x)?(t.consume(x),m):x===64?(t.consume(x),p):l(x)}function p(x){return x===46?t.check(HT,b,h)(x):x===45||x===95||gn(x)?(c=!0,t.consume(x),p):b(x)}function h(x){return t.consume(x),s=!0,p}function b(x){return c&&s&&Sn(u.previous)?(t.exit("literalAutolinkEmail"),t.exit("literalAutolink"),a(x)):l(x)}}function VT(t,a,l){const u=this;return s;function s(f){return f!==87&&f!==119||!Qx.call(u,u.previous)||gf(u.events)?l(f):(t.enter("literalAutolink"),t.enter("literalAutolinkWww"),t.check(BT,t.attempt(Fx,t.attempt(Gx,c),l),l)(f))}function c(f){return t.exit("literalAutolinkWww"),t.exit("literalAutolink"),a(f)}}function FT(t,a,l){const u=this;let s="",c=!1;return f;function f(x){return(x===72||x===104)&&Jx.call(u,u.previous)&&!gf(u.events)?(t.enter("literalAutolink"),t.enter("literalAutolinkHttp"),s+=String.fromCodePoint(x),t.consume(x),m):l(x)}function m(x){if(Sn(x)&&s.length<5)return s+=String.fromCodePoint(x),t.consume(x),m;if(x===58){const S=s.toLowerCase();if(S==="http"||S==="https")return t.consume(x),p}return l(x)}function p(x){return x===47?(t.consume(x),c?h:(c=!0,p)):l(x)}function h(x){return x===null||Mu(x)||Fe(x)||zr(x)||Lu(x)?l(x):t.attempt(Fx,t.attempt(Gx,b),l)(x)}function b(x){return t.exit("literalAutolinkHttp"),t.exit("literalAutolink"),a(x)}}function GT(t,a,l){let u=0;return s;function s(f){return(f===87||f===119)&&u<3?(u++,t.consume(f),s):f===46&&u===3?(t.consume(f),c):l(f)}function c(f){return f===null?l(f):a(f)}}function YT(t,a,l){let u,s,c;return f;function f(h){return h===46||h===95?t.check(Yx,p,m)(h):h===null||Fe(h)||zr(h)||h!==45&&Lu(h)?p(h):(c=!0,t.consume(h),f)}function m(h){return h===95?u=!0:(s=u,u=void 0),t.consume(h),f}function p(h){return s||u||!c?l(h):a(h)}}function PT(t,a){let l=0,u=0;return s;function s(f){return f===40?(l++,t.consume(f),s):f===41&&u<l?c(f):f===33||f===34||f===38||f===39||f===41||f===42||f===44||f===46||f===58||f===59||f===60||f===63||f===93||f===95||f===126?t.check(Yx,a,c)(f):f===null||Fe(f)||zr(f)?a(f):(t.consume(f),s)}function c(f){return f===41&&u++,t.consume(f),s}}function XT(t,a,l){return u;function u(m){return m===33||m===34||m===39||m===41||m===42||m===44||m===46||m===58||m===59||m===63||m===95||m===126?(t.consume(m),u):m===38?(t.consume(m),c):m===93?(t.consume(m),s):m===60||m===null||Fe(m)||zr(m)?a(m):l(m)}function s(m){return m===null||m===40||m===91||Fe(m)||zr(m)?a(m):u(m)}function c(m){return Sn(m)?f(m):l(m)}function f(m){return m===59?(t.consume(m),u):Sn(m)?(t.consume(m),f):l(m)}}function QT(t,a,l){return u;function u(c){return t.consume(c),s}function s(c){return gn(c)?l(c):a(c)}}function Qx(t){return t===null||t===40||t===42||t===95||t===91||t===93||t===126||Fe(t)}function Jx(t){return!Sn(t)}function Zx(t){return!(t===47||Fc(t))}function Fc(t){return t===43||t===45||t===46||t===95||gn(t)}function gf(t){let a=t.length,l=!1;for(;a--;){const u=t[a][1];if((u.type==="labelLink"||u.type==="labelImage")&&!u._balanced){l=!0;break}if(u._gfmAutolinkLiteralWalkedInto){l=!1;break}}return t.length>0&&!l&&(t[t.length-1][1]._gfmAutolinkLiteralWalkedInto=!0),l}const JT={tokenize:rE,partial:!0};function ZT(){return{document:{91:{name:"gfmFootnoteDefinition",tokenize:eE,continuation:{tokenize:nE},exit:tE}},text:{91:{name:"gfmFootnoteCall",tokenize:$T},93:{name:"gfmPotentialFootnoteCall",add:"after",tokenize:KT,resolveTo:WT}}}}function KT(t,a,l){const u=this;let s=u.events.length;const c=u.parser.gfmFootnotes||(u.parser.gfmFootnotes=[]);let f;for(;s--;){const p=u.events[s][1];if(p.type==="labelImage"){f=p;break}if(p.type==="gfmFootnoteCall"||p.type==="labelLink"||p.type==="label"||p.type==="image"||p.type==="link")break}return m;function m(p){if(!f||!f._balanced)return l(p);const h=ut(u.sliceSerialize({start:f.end,end:u.now()}));return h.codePointAt(0)!==94||!c.includes(h.slice(1))?l(p):(t.enter("gfmFootnoteCallLabelMarker"),t.consume(p),t.exit("gfmFootnoteCallLabelMarker"),a(p))}}function WT(t,a){let l=t.length;for(;l--;)if(t[l][1].type==="labelImage"&&t[l][0]==="enter"){t[l][1];break}t[l+1][1].type="data",t[l+3][1].type="gfmFootnoteCallLabelMarker";const u={type:"gfmFootnoteCall",start:Object.assign({},t[l+3][1].start),end:Object.assign({},t[t.length-1][1].end)},s={type:"gfmFootnoteCallMarker",start:Object.assign({},t[l+3][1].end),end:Object.assign({},t[l+3][1].end)};s.end.column++,s.end.offset++,s.end._bufferIndex++;const c={type:"gfmFootnoteCallString",start:Object.assign({},s.end),end:Object.assign({},t[t.length-1][1].start)},f={type:"chunkString",contentType:"string",start:Object.assign({},c.start),end:Object.assign({},c.end)},m=[t[l+1],t[l+2],["enter",u,a],t[l+3],t[l+4],["enter",s,a],["exit",s,a],["enter",c,a],["enter",f,a],["exit",f,a],["exit",c,a],t[t.length-2],t[t.length-1],["exit",u,a]];return t.splice(l,t.length-l+1,...m),t}function $T(t,a,l){const u=this,s=u.parser.gfmFootnotes||(u.parser.gfmFootnotes=[]);let c=0,f;return m;function m(x){return t.enter("gfmFootnoteCall"),t.enter("gfmFootnoteCallLabelMarker"),t.consume(x),t.exit("gfmFootnoteCallLabelMarker"),p}function p(x){return x!==94?l(x):(t.enter("gfmFootnoteCallMarker"),t.consume(x),t.exit("gfmFootnoteCallMarker"),t.enter("gfmFootnoteCallString"),t.enter("chunkString").contentType="string",h)}function h(x){if(c>999||x===93&&!f||x===null||x===91||Fe(x))return l(x);if(x===93){t.exit("chunkString");const S=t.exit("gfmFootnoteCallString");return s.includes(ut(u.sliceSerialize(S)))?(t.enter("gfmFootnoteCallLabelMarker"),t.consume(x),t.exit("gfmFootnoteCallLabelMarker"),t.exit("gfmFootnoteCall"),a):l(x)}return Fe(x)||(f=!0),c++,t.consume(x),x===92?b:h}function b(x){return x===91||x===92||x===93?(t.consume(x),c++,h):h(x)}}function eE(t,a,l){const u=this,s=u.parser.gfmFootnotes||(u.parser.gfmFootnotes=[]);let c,f=0,m;return p;function p(C){return t.enter("gfmFootnoteDefinition")._container=!0,t.enter("gfmFootnoteDefinitionLabel"),t.enter("gfmFootnoteDefinitionLabelMarker"),t.consume(C),t.exit("gfmFootnoteDefinitionLabelMarker"),h}function h(C){return C===94?(t.enter("gfmFootnoteDefinitionMarker"),t.consume(C),t.exit("gfmFootnoteDefinitionMarker"),t.enter("gfmFootnoteDefinitionLabelString"),t.enter("chunkString").contentType="string",b):l(C)}function b(C){if(f>999||C===93&&!m||C===null||C===91||Fe(C))return l(C);if(C===93){t.exit("chunkString");const R=t.exit("gfmFootnoteDefinitionLabelString");return c=ut(u.sliceSerialize(R)),t.enter("gfmFootnoteDefinitionLabelMarker"),t.consume(C),t.exit("gfmFootnoteDefinitionLabelMarker"),t.exit("gfmFootnoteDefinitionLabel"),S}return Fe(C)||(m=!0),f++,t.consume(C),C===92?x:b}function x(C){return C===91||C===92||C===93?(t.consume(C),f++,b):b(C)}function S(C){return C===58?(t.enter("definitionMarker"),t.consume(C),t.exit("definitionMarker"),s.includes(c)||s.push(c),Me(t,v,"gfmFootnoteDefinitionWhitespace")):l(C)}function v(C){return a(C)}}function nE(t,a,l){return t.check(Ka,a,t.attempt(JT,a,l))}function tE(t){t.exit("gfmFootnoteDefinition")}function rE(t,a,l){const u=this;return Me(t,s,"gfmFootnoteDefinitionIndent",5);function s(c){const f=u.events[u.events.length-1];return f&&f[1].type==="gfmFootnoteDefinitionIndent"&&f[2].sliceSerialize(f[1],!0).length===4?a(c):l(c)}}function lE(t){let l=(t||{}).singleTilde;const u={name:"strikethrough",tokenize:c,resolveAll:s};return l==null&&(l=!0),{text:{126:u},insideSpan:{null:[u]},attentionMarkers:{null:[126]}};function s(f,m){let p=-1;for(;++p<f.length;)if(f[p][0]==="enter"&&f[p][1].type==="strikethroughSequenceTemporary"&&f[p][1]._close){let h=p;for(;h--;)if(f[h][0]==="exit"&&f[h][1].type==="strikethroughSequenceTemporary"&&f[h][1]._open&&f[p][1].end.offset-f[p][1].start.offset===f[h][1].end.offset-f[h][1].start.offset){f[p][1].type="strikethroughSequence",f[h][1].type="strikethroughSequence";const b={type:"strikethrough",start:Object.assign({},f[h][1].start),end:Object.assign({},f[p][1].end)},x={type:"strikethroughText",start:Object.assign({},f[h][1].end),end:Object.assign({},f[p][1].start)},S=[["enter",b,m],["enter",f[h][1],m],["exit",f[h][1],m],["enter",x,m]],v=m.parser.constructs.insideSpan.null;v&&qn(S,S.length,0,Uu(v,f.slice(h+1,p),m)),qn(S,S.length,0,[["exit",x,m],["enter",f[p][1],m],["exit",f[p][1],m],["exit",b,m]]),qn(f,h-1,p-h+3,S),p=h+S.length-2;break}}for(p=-1;++p<f.length;)f[p][1].type==="strikethroughSequenceTemporary"&&(f[p][1].type="data");return f}function c(f,m,p){const h=this.previous,b=this.events;let x=0;return S;function S(C){return h===126&&b[b.length-1][1].type!=="characterEscape"?p(C):(f.enter("strikethroughSequenceTemporary"),v(C))}function v(C){const R=Nl(h);if(C===126)return x>1?p(C):(f.consume(C),x++,v);if(x<2&&!l)return p(C);const z=f.exit("strikethroughSequenceTemporary"),j=Nl(C);return z._open=!j||j===2&&!!R,z._close=!R||R===2&&!!j,m(C)}}}class aE{constructor(){this.map=[]}add(a,l,u){iE(this,a,l,u)}consume(a){if(this.map.sort(function(c,f){return c[0]-f[0]}),this.map.length===0)return;let l=this.map.length;const u=[];for(;l>0;)l-=1,u.push(a.slice(this.map[l][0]+this.map[l][1]),this.map[l][2]),a.length=this.map[l][0];u.push(a.slice()),a.length=0;let s=u.pop();for(;s;){for(const c of s)a.push(c);s=u.pop()}this.map.length=0}}function iE(t,a,l,u){let s=0;if(!(l===0&&u.length===0)){for(;s<t.map.length;){if(t.map[s][0]===a){t.map[s][1]+=l,t.map[s][2].push(...u);return}s+=1}t.map.push([a,l,u])}}function uE(t,a){let l=!1;const u=[];for(;a<t.length;){const s=t[a];if(l){if(s[0]==="enter")s[1].type==="tableContent"&&u.push(t[a+1][1].type==="tableDelimiterMarker"?"left":"none");else if(s[1].type==="tableContent"){if(t[a-1][1].type==="tableDelimiterMarker"){const c=u.length-1;u[c]=u[c]==="left"?"center":"right"}}else if(s[1].type==="tableDelimiterRow")break}else s[0]==="enter"&&s[1].type==="tableDelimiterRow"&&(l=!0);a+=1}return u}function sE(){return{flow:{null:{name:"table",tokenize:oE,resolveAll:cE}}}}function oE(t,a,l){const u=this;let s=0,c=0,f;return m;function m(A){let P=u.events.length-1;for(;P>-1;){const ae=u.events[P][1].type;if(ae==="lineEnding"||ae==="linePrefix")P--;else break}const J=P>-1?u.events[P][1].type:null,de=J==="tableHead"||J==="tableRow"?q:p;return de===q&&u.parser.lazy[u.now().line]?l(A):de(A)}function p(A){return t.enter("tableHead"),t.enter("tableRow"),h(A)}function h(A){return A===124||(f=!0,c+=1),b(A)}function b(A){return A===null?l(A):he(A)?c>1?(c=0,u.interrupt=!0,t.exit("tableRow"),t.enter("lineEnding"),t.consume(A),t.exit("lineEnding"),v):l(A):Te(A)?Me(t,b,"whitespace")(A):(c+=1,f&&(f=!1,s+=1),A===124?(t.enter("tableCellDivider"),t.consume(A),t.exit("tableCellDivider"),f=!0,b):(t.enter("data"),x(A)))}function x(A){return A===null||A===124||Fe(A)?(t.exit("data"),b(A)):(t.consume(A),A===92?S:x)}function S(A){return A===92||A===124?(t.consume(A),x):x(A)}function v(A){return u.interrupt=!1,u.parser.lazy[u.now().line]?l(A):(t.enter("tableDelimiterRow"),f=!1,Te(A)?Me(t,C,"linePrefix",u.parser.constructs.disable.null.includes("codeIndented")?void 0:4)(A):C(A))}function C(A){return A===45||A===58?z(A):A===124?(f=!0,t.enter("tableCellDivider"),t.consume(A),t.exit("tableCellDivider"),R):re(A)}function R(A){return Te(A)?Me(t,z,"whitespace")(A):z(A)}function z(A){return A===58?(c+=1,f=!0,t.enter("tableDelimiterMarker"),t.consume(A),t.exit("tableDelimiterMarker"),j):A===45?(c+=1,j(A)):A===null||he(A)?K(A):re(A)}function j(A){return A===45?(t.enter("tableDelimiterFiller"),H(A)):re(A)}function H(A){return A===45?(t.consume(A),H):A===58?(f=!0,t.exit("tableDelimiterFiller"),t.enter("tableDelimiterMarker"),t.consume(A),t.exit("tableDelimiterMarker"),_):(t.exit("tableDelimiterFiller"),_(A))}function _(A){return Te(A)?Me(t,K,"whitespace")(A):K(A)}function K(A){return A===124?C(A):A===null||he(A)?!f||s!==c?re(A):(t.exit("tableDelimiterRow"),t.exit("tableHead"),a(A)):re(A)}function re(A){return l(A)}function q(A){return t.enter("tableRow"),ee(A)}function ee(A){return A===124?(t.enter("tableCellDivider"),t.consume(A),t.exit("tableCellDivider"),ee):A===null||he(A)?(t.exit("tableRow"),a(A)):Te(A)?Me(t,ee,"whitespace")(A):(t.enter("data"),oe(A))}function oe(A){return A===null||A===124||Fe(A)?(t.exit("data"),ee(A)):(t.consume(A),A===92?W:oe)}function W(A){return A===92||A===124?(t.consume(A),oe):oe(A)}}function cE(t,a){let l=-1,u=!0,s=0,c=[0,0,0,0],f=[0,0,0,0],m=!1,p=0,h,b,x;const S=new aE;for(;++l<t.length;){const v=t[l],C=v[1];v[0]==="enter"?C.type==="tableHead"?(m=!1,p!==0&&(wg(S,a,p,h,b),b=void 0,p=0),h={type:"table",start:Object.assign({},C.start),end:Object.assign({},C.end)},S.add(l,0,[["enter",h,a]])):C.type==="tableRow"||C.type==="tableDelimiterRow"?(u=!0,x=void 0,c=[0,0,0,0],f=[0,l+1,0,0],m&&(m=!1,b={type:"tableBody",start:Object.assign({},C.start),end:Object.assign({},C.end)},S.add(l,0,[["enter",b,a]])),s=C.type==="tableDelimiterRow"?2:b?3:1):s&&(C.type==="data"||C.type==="tableDelimiterMarker"||C.type==="tableDelimiterFiller")?(u=!1,f[2]===0&&(c[1]!==0&&(f[0]=f[1],x=wu(S,a,c,s,void 0,x),c=[0,0,0,0]),f[2]=l)):C.type==="tableCellDivider"&&(u?u=!1:(c[1]!==0&&(f[0]=f[1],x=wu(S,a,c,s,void 0,x)),c=f,f=[c[1],l,0,0])):C.type==="tableHead"?(m=!0,p=l):C.type==="tableRow"||C.type==="tableDelimiterRow"?(p=l,c[1]!==0?(f[0]=f[1],x=wu(S,a,c,s,l,x)):f[1]!==0&&(x=wu(S,a,f,s,l,x)),s=0):s&&(C.type==="data"||C.type==="tableDelimiterMarker"||C.type==="tableDelimiterFiller")&&(f[3]=l)}for(p!==0&&wg(S,a,p,h,b),S.consume(a.events),l=-1;++l<a.events.length;){const v=a.events[l];v[0]==="enter"&&v[1].type==="table"&&(v[1]._align=uE(a.events,l))}return t}function wu(t,a,l,u,s,c){const f=u===1?"tableHeader":u===2?"tableDelimiter":"tableData",m="tableContent";l[0]!==0&&(c.end=Object.assign({},Al(a.events,l[0])),t.add(l[0],0,[["exit",c,a]]));const p=Al(a.events,l[1]);if(c={type:f,start:Object.assign({},p),end:Object.assign({},p)},t.add(l[1],0,[["enter",c,a]]),l[2]!==0){const h=Al(a.events,l[2]),b=Al(a.events,l[3]),x={type:m,start:Object.assign({},h),end:Object.assign({},b)};if(t.add(l[2],0,[["enter",x,a]]),u!==2){const S=a.events[l[2]],v=a.events[l[3]];if(S[1].end=Object.assign({},v[1].end),S[1].type="chunkText",S[1].contentType="text",l[3]>l[2]+1){const C=l[2]+1,R=l[3]-l[2]-1;t.add(C,R,[])}}t.add(l[3]+1,0,[["exit",x,a]])}return s!==void 0&&(c.end=Object.assign({},Al(a.events,s)),t.add(s,0,[["exit",c,a]]),c=void 0),c}function wg(t,a,l,u,s){const c=[],f=Al(a.events,l);s&&(s.end=Object.assign({},f),c.push(["exit",s,a])),u.end=Object.assign({},f),c.push(["exit",u,a]),t.add(l+1,0,c)}function Al(t,a){const l=t[a],u=l[0]==="enter"?"start":"end";return l[1][u]}const fE={name:"tasklistCheck",tokenize:hE};function dE(){return{text:{91:fE}}}function hE(t,a,l){const u=this;return s;function s(p){return u.previous!==null||!u._gfmTasklistFirstContentOfListItem?l(p):(t.enter("taskListCheck"),t.enter("taskListCheckMarker"),t.consume(p),t.exit("taskListCheckMarker"),c)}function c(p){return Fe(p)?(t.enter("taskListCheckValueUnchecked"),t.consume(p),t.exit("taskListCheckValueUnchecked"),f):p===88||p===120?(t.enter("taskListCheckValueChecked"),t.consume(p),t.exit("taskListCheckValueChecked"),f):l(p)}function f(p){return p===93?(t.enter("taskListCheckMarker"),t.consume(p),t.exit("taskListCheckMarker"),t.exit("taskListCheck"),m):l(p)}function m(p){return he(p)?a(p):Te(p)?t.check({tokenize:mE},a,l)(p):l(p)}}function mE(t,a,l){return Me(t,u,"whitespace");function u(s){return s===null?l(s):a(s)}}function pE(t){return ux([IT(),ZT(),lE(t),sE(),dE()])}const gE={};function xE(t){const a=this,l=t||gE,u=a.data(),s=u.micromarkExtensions||(u.micromarkExtensions=[]),c=u.fromMarkdownExtensions||(u.fromMarkdownExtensions=[]),f=u.toMarkdownExtensions||(u.toMarkdownExtensions=[]);s.push(pE(l)),c.push(LT()),f.push(UT(l))}function Va(t){return t==null?"":typeof t=="string"||typeof t=="number"?String(t):Array.isArray(t)?t.map(Va).join(""):typeof t=="object"&&t&&"props"in t?Va(t.props?.children):""}function Kx(){const t=new Map,a=l=>l.trim().toLowerCase().replace(/[^\p{L}\p{N}\s-]/gu,"").replace(/\s+/g,"-").replace(/-+/g,"-").replace(/^-|-$/g,"");return l=>{const u=a(l)||"section",s=t.get(u)??0;return t.set(u,s+1),s===0?u:`${u}-${s}`}}function bE(t,a=1,l=3){const u=Kx(),s=t.split(`
`);let c=!1;const f=[];for(const m of s){const p=m.trimEnd();if(p.trimStart().startsWith("```")){c=!c;continue}if(c)continue;const h=/^(#{1,6})\s+(.+?)\s*$/.exec(p);if(!h)continue;const b=h[1].length;if(b<a||b>l)continue;const x=h[2].replace(/\[([^\]]+)\]\([^)]+\)/g,"$1").replace(/[*_`]/g,"").trim(),S=u(x);f.push({id:S,text:x,level:b})}return f}const yE=({toc:t,activeId:a,onClickItem:l})=>t.length?g.jsx("aside",{className:"fixed left-[calc(50%+870px/2+48px)] top-[calc(var(--header-height)+48px)] hidden xl:block w-56 2xl:w-64 h-[calc(100vh-var(--header-height)-96px)] overflow-y-auto overflow-x-hidden",children:g.jsx("div",{className:"border-l border-(--border-subtle) pl-4 pr-2",children:g.jsx("nav",{"aria-label":"Table of contents",children:g.jsx("ul",{className:"space-y-2",children:t.map(u=>{const s=u.id===a,c=u.level===1?"pl-0":u.level===2?"pl-3":"pl-6";return g.jsx("li",{className:c,children:g.jsxs("button",{type:"button",onClick:()=>l(u.id),className:["group relative block w-full text-left cursor-pointer","text-[13px] leading-[1.65]","transition-all duration-200 origin-left","focus:outline-none focus-visible:ring-2 focus-visible:ring-(--accent)/60 focus-visible:ring-offset-2 focus-visible:ring-offset-(--bg-base)",s?"text-(--fg-base) scale-110":"text-gray-500 hover:text-gray-500/80 hover:scale-105"].join(" "),children:[g.jsx("span",{className:["absolute -left-[22px] top-[9px] h-1.5 w-1.5 rounded-full","bg-(--fg-base)","transition-opacity duration-200",s?"opacity-100":"opacity-0 group-hover:opacity-60"].join(" ")}),u.text]})},u.id)})})})})}):null,Cg=({dir:t})=>g.jsx("span",{className:["shrink-0 w-11 h-11 rounded-full flex items-center justify-center","border border-green-400 text-green-400","bg-transparent group-hover:bg-green-400/10","transition-colors duration-200"].join(" "),children:g.jsx("svg",{className:"w-5 h-5",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:t==="left"?g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"}):g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})}),Tg=({children:t,align:a,onClick:l})=>g.jsxs("button",{type:"button",onClick:l,className:["group relative w-full overflow-hidden rounded-2xl","border border-white/10","bg-white/5 hover:bg-white/8","transition-colors duration-200","focus:outline-none focus-visible:ring-2 focus-visible:ring-(--accent)/60 focus-visible:ring-offset-2 focus-visible:ring-offset-(--bg-base)",a==="left"?"text-left":"text-right"].join(" "),children:[g.jsx("span",{className:"pointer-events-none absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-200",children:g.jsx("span",{className:"absolute inset-0 bg-gradient-to-r from-(--accent)/0 via-(--accent)/10 to-(--accent)/0"})}),g.jsx("div",{className:"relative p-6 cursor-pointer",children:t})]}),vE=({prevPost:t,nextPost:a,onNavigate:l})=>!t&&!a?null:g.jsx("nav",{className:"mt-16 pt-8 border-t border-(--border-subtle)",children:g.jsxs("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6",children:[g.jsx("div",{className:"md:col-span-1 h-[88px]",children:t?g.jsx(Tg,{align:"left",onClick:()=>l(t.slug),children:g.jsxs("div",{className:"flex items-center justify-between gap-4 h-full",children:[g.jsx(Cg,{dir:"left"}),g.jsxs("div",{className:"min-w-0",children:[g.jsx("div",{className:"text-[12px] font-semibold text-fg-muted mb-1",children:"이전 포스트"}),g.jsx("h3",{className:`\r
                    ...
                    `,children:t.title})]})]})}):g.jsx("div",{className:"w-full h-full"})}),g.jsx("div",{className:"md:col-span-1  h-[88px]",children:a?g.jsx(Tg,{align:"right",onClick:()=>l(a.slug),children:g.jsxs("div",{className:"flex items-center justify-between gap-4 h-full",children:[g.jsxs("div",{className:"min-w-0 text-right",children:[g.jsx("div",{className:"text-[12px] font-semibold text-fg-muted mb-1",children:"다음 포스트"}),g.jsx("h3",{className:` \r
                      text-[18px] font-bold text-(--fg-base)\r
                      truncate overflow-hidden\r
                    `,children:a.title})]}),g.jsx(Cg,{dir:"right"})]})}):g.jsx("div",{className:"w-full h-full"})})]})}),SE=Au.memo(function({content:a}){const l=D.useMemo(()=>Kx(),[a]),u=D.useMemo(()=>[xE],[]),s=D.useMemo(()=>({h1:({children:c,...f})=>{const m=Va(c),p=l(m);return g.jsx("h1",{id:p,className:"scroll-mt-[calc(var(--header-height)+24px)]",...f,children:c})},h2:({children:c,...f})=>{const m=Va(c),p=l(m);return g.jsx("h2",{id:p,className:"scroll-mt-[calc(var(--header-height)+24px)]",...f,children:c})},h3:({children:c,...f})=>{const m=Va(c),p=l(m);return g.jsx("h3",{id:p,className:"scroll-mt-[calc(var(--header-height)+24px)]",...f,children:c})}}),[l]);return g.jsx(l3,{remarkPlugins:u,components:s,children:a})}),kE=()=>{const{slug:t}=$1(),a=Qa(),l=D.useMemo(()=>nt.find(x=>x.slug===t),[t]),u=D.useMemo(()=>l?.content??"",[l]),s=D.useMemo(()=>u?bE(u,1,3):[],[u]),{prevPost:c,nextPost:f}=D.useMemo(()=>{const x=nt.findIndex(S=>S.slug===t);return x===-1?{prevPost:null,nextPost:null}:{prevPost:x>0?nt[x-1]:null,nextPost:x<nt.length-1?nt[x+1]:null}},[t]),[m,p]=D.useState(),h=Au.useRef(!1),b=x=>{const S=document.getElementById(x);if(!S)return;h.current=!0,p(K=>K===x?K:x),history.replaceState(null,"",`#${x}`);const v=parseFloat(getComputedStyle(document.documentElement).getPropertyValue("--header-height").trim())||80,z=S.getBoundingClientRect().top+window.pageYOffset-v-24;window.scrollTo({top:z,behavior:"smooth"});const j=performance.now();let H=0;const _=()=>{const K=window.scrollY;Math.abs(K-z)<2?H+=1:H=0;const re=performance.now()-j>2200;if(H>=3||re){h.current=!1;return}requestAnimationFrame(_)};requestAnimationFrame(_)};return D.useEffect(()=>{if(!s.length)return;const x=()=>{const z=getComputedStyle(document.documentElement).getPropertyValue("--header-height").trim(),j=parseFloat(z);return Number.isFinite(j)?j:80},S=24;let v=0;const C=()=>{if(v=0,h.current)return;const z=x(),j=window.scrollY+z+S+1;let H=s[0]?.id;for(const _ of s){const K=document.getElementById(_.id);if(K)if(K.offsetTop<=j)H=_.id;else break}p(_=>_===H?_:H)},R=()=>{v||(v=requestAnimationFrame(C))};return C(),window.addEventListener("scroll",R,{passive:!0}),window.addEventListener("resize",R),()=>{window.removeEventListener("scroll",R),window.removeEventListener("resize",R),v&&cancelAnimationFrame(v)}},[s,t]),l?g.jsxs("div",{className:"min-h-screen bg-(--bg-base) text-(--fg-base) overflow-x-hidden",children:[g.jsx("div",{className:"mx-auto max-w-[870px] px-5 md:px-8 pt-[calc(var(--header-height)+48px)] pb-16",children:g.jsxs("article",{className:"w-full",children:[g.jsxs("button",{onClick:()=>a("/blog"),className:"relative z-10 mb-5 text-[13px] text-fg-muted hover:text-fg transition-colors flex items-center gap-2",children:[g.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})}),"목록으로"]}),g.jsxs("div",{className:"mb-10",children:[g.jsx("h1",{className:"text-[36px] md:text-[42px] font-bold leading-tight mb-4",children:l.title}),g.jsxs("div",{className:"w-full flex flex-col md:flex-row md:justify-between md:items-center gap-4",children:[g.jsx("div",{className:"flex flex-wrap gap-2",children:l.tags.map(x=>g.jsx("span",{className:"text-[13px] text-green-300 [html[data-theme='light']_&]:text-green-500 px-2.5 py-1.5",children:x},x))}),g.jsx("div",{className:"text-[13px] text-fg-muted whitespace-nowrap md:text-right",children:l.date})]})]}),l.cover&&g.jsx("div",{className:"relative h-[300px] md:h-[400px] rounded-2xl overflow-hidden mb-10 bg-(--bg-soft)",children:g.jsx("img",{src:l.cover,alt:l.title,className:"absolute inset-0 w-full h-full object-cover"})}),g.jsx("div",{className:"prose prose-invert max-w-none",children:u?g.jsx(SE,{content:u}):g.jsx("p",{className:"text-fg-muted",children:"콘텐츠가 없습니다."})}),g.jsx(vE,{prevPost:c,nextPost:f,onNavigate:x=>a(`/blog/${x}`)})]})}),g.jsx(yE,{toc:s,activeId:m,onClickItem:b})]}):g.jsx("div",{className:"min-h-screen bg-(--bg-base) text-(--fg-base) flex items-center justify-center",children:g.jsxs("div",{className:"text-center",children:[g.jsx("h1",{className:"text-[32px] font-bold mb-4",children:"포스트를 찾을 수 없습니다"}),g.jsx("button",{onClick:()=>a("/blog"),className:"px-4 py-2 rounded-full border border-(--border-subtle) bg-white/5 hover:bg-white/10 transition-colors",children:"블로그로 돌아가기"})]})})},wE="relative min-h-screen pt-[calc(var(--header-height)+56px)] pb-24 px-5 overflow-hidden",CE="pointer-events-none absolute inset-0 bg-[radial-gradient(900px_500px_at_20%_10%,rgba(125,211,252,0.16),transparent_60%),radial-gradient(800px_420px_at_80%_30%,rgba(167,139,250,0.14),transparent_60%),radial-gradient(700px_360px_at_50%_85%,rgba(34,197,94,0.10),transparent_60%)] [mask-image:radial-gradient(70%_60%_at_50%_40%,black,transparent)]",Eg="relative rounded-3xl border border-(--border-subtle) bg-(--bg-elevated)/70 p-6 backdrop-blur-xl shadow-[0_14px_34px_rgba(0,0,0,0.32)] transition-all duration-200 ease-out hover:-translate-y-0.5 hover:shadow-[0_20px_46px_rgba(0,0,0,0.55)] hover:border-white/20 [html[data-theme='light']_&]:bg-white/70 [html[data-theme='light']_&]:shadow-[0_10px_26px_rgba(0,0,0,0.08)] [html[data-theme='light']_&]:hover:shadow-[0_14px_34px_rgba(0,0,0,0.12)]",Ag="pointer-events-none absolute inset-0 rounded-3xl bg-[radial-gradient(900px_240px_at_10%_0%,rgba(255,255,255,0.14),transparent_55%)] [html[data-theme='light']_&]:bg-[radial-gradient(900px_240px_at_10%_0%,rgba(17,24,39,0.06),transparent_55%)]",TE="inline-flex items-center gap-2 text-[11px] uppercase tracking-[0.18em] text-fg-muted",Gc="inline-flex items-center rounded-full border border-(--border-subtle) bg-(--bg-soft) px-3 py-1 text-[11px] text-fg-muted [html[data-theme='light']_&]:bg-[#f5f5fb]",EE=()=>g.jsxs("main",{className:wE,children:[g.jsx("div",{className:CE}),g.jsxs("div",{className:"max-w-[760px] mx-auto relative",children:[g.jsxs("section",{className:"text-center mb-12",children:[g.jsx("div",{className:"flex justify-center mb-4",children:g.jsxs("span",{className:`${Gc} gap-2`,children:[g.jsx("span",{className:"w-1.5 h-1.5 rounded-full bg-green-400"}),g.jsx("span",{className:TE,children:"Contact"})]})}),g.jsx("h1",{className:"text-[34px] md:text-[44px] font-semibold tracking-[-0.02em] mb-4",children:"함께 이야기해요"}),g.jsxs("p",{className:"text-[15px] md:text-[16px] text-fg-muted leading-relaxed max-w-lg mx-auto",children:["프로젝트 제안, 협업, 채용 어떤 주제든 좋습니다.",g.jsx("br",{className:" md:block"}),"가능한 빠르게 확인하고 답변 드리겠습니다."]})]}),g.jsxs("div",{className:"grid gap-5",children:[g.jsxs("div",{className:Eg,children:[g.jsx("div",{className:Ag}),g.jsxs("div",{className:"flex items-center justify-between mb-4 relative",children:[g.jsx("h2",{className:"text-[16px] font-medium text-fg",children:"연락 채널"}),g.jsx("span",{className:Gc,children:"가장 빠른 답변: Email"})]}),g.jsxs("div",{className:"grid gap-3 relative",children:[g.jsx(La,{label:"Email",value:"lanos5019@ajou.ac.kr",href:"mailto:you@example.com",icon:g.jsx(DE,{})}),g.jsx(La,{label:"Phone",value:"010-3465-9425",href:"tel:010-3465-9425",icon:g.jsx(_E,{})}),g.jsx(La,{label:"GitHub",value:"@km-kwon",href:"https://github.com/km-kwon",external:!0,icon:g.jsx(OE,{})}),g.jsx(La,{label:"NPM",value:"@kwon-kyoungmin",href:"https://www.npmjs.com/~kwon-kyoungmin",external:!0,icon:g.jsx(zE,{})}),g.jsx(La,{label:"Apply",value:"Resume (PDF)",href:"/portfolio/resume.pdf",external:!0,icon:g.jsx(RE,{})})]})]}),g.jsxs("div",{className:Eg,children:[g.jsx("div",{className:Ag}),g.jsx("h2",{className:"text-[16px] font-medium text-fg mb-4 relative",children:"응답 안내"}),g.jsxs("div",{className:"grid md:grid-cols-2 gap-4 relative",children:[g.jsx(jg,{icon:g.jsx(AE,{}),title:"평균 응답 시간",value:"24시간 이내",sub:"최대한 빠르게 회신 드리겠습니다."}),g.jsx(jg,{icon:g.jsx(jE,{}),title:"위치",value:"대한민국, 성남",sub:"원격 협업도 가능합니다."})]})]})]})]})]}),La=({label:t,value:a,href:l,external:u,icon:s,download:c})=>g.jsxs("a",{href:l,target:u?"_blank":void 0,rel:u?"noreferrer":void 0,download:c,className:`group relative flex items-center gap-3 rounded-2xl px-4 py-3\r
               border border-(--border-subtle) bg-(--bg-soft)\r
               ...
               transition-all duration-150 ease-out`,children:[g.jsx("div",{className:`w-9 h-9 rounded-full bg-(--bg-elevated) border border-(--border-subtle)\r
                  ...
                  [html[data-theme='light']_&]:bg-[#f5f5fb]`,children:[g.jsx("div",{className:`w-10 h-10 rounded-full bg-(--bg-elevated) border border-(--border-subtle)\r
                    flex items-center justify-center shrink-0`,children:t}),g.jsxs("div",{className:"min-w-0",children:[g.jsx("p",{className:"text-[12px] font-medium text-fg",children:a}),g.jsx("p",{className:"text-[14px] font-semibold text-fg mt-1",children:l}),g.jsx("p",{className:"text-[12px] text-fg-muted mt-1 leading-relaxed",children:u})]})]}),AE=()=>g.jsx("svg",{className:"w-4 h-4 text-fg-muted",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"})}),jE=()=>g.jsxs("svg",{className:"w-4 h-4 text-fg-muted",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:[g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"}),g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M15 11a3 3 0 11-6 0 3 3 0 016 0z"})]}),NE=({className:t})=>g.jsxs("svg",{className:t??"",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:[g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M7 17L17 7"}),g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M10 7h7v7"})]}),ME=({className:t})=>g.jsxs("svg",{className:t??"",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:[g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M12 4v12m0 0l-4-4m4 4l4-4"}),g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M4 17v2a1 1 0 001 1h14a1 1 0 001-1v-2"})]}),_E=()=>g.jsx("svg",{className:"w-4 h-4 text-fg-muted",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"})}),DE=()=>g.jsxs("svg",{className:"w-4 h-4 text-fg-muted",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:[g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M3 8l9 6 9-6"}),g.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:1.5,d:"M5 6h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2z"})]}),OE=()=>g.jsx("svg",{className:"w-4 h-4 text-fg-muted",viewBox:"0 0 24 24",fill:"currentColor",children:g.jsx("path",{d:"M12 .5A12 12 0 0 0 0 12.7c0 5.4 3.4 10 8.2 11.6.6.1.8-.3.8-.6v-2.2c-3.3.7-4-1.5-4-1.5-.6-1.6-1.5-2-1.5-2-1.2-.9.1-.9.1-.9 1.3.1 2 .9 2 .9 1.2 2.1 3.1 1.5 3.9 1.1.1-.9.5-1.5.8-1.9-2.7-.3-5.5-1.4-5.5-6.1 0-1.3.4-2.3 1.1-3.2-.1-.3-.5-1.5.1-3.1 0 0 .9-.3 3.1 1.2.9-.3 1.9-.4 2.9-.4s2 .1 2.9.4c2.2-1.5 3.1-1.2 3.1-1.2.6 1.6.2 2.8.1 3.1.7.9 1.1 1.9 1.1 3.2 0 4.7-2.8 5.8-5.5 6.1.5.4.9 1.2.9 2.4v3.5c0 .3.2.7.8.6A12.2 12.2 0 0 0 24 12.7 12 12 0 0 0 12 .5Z"})}),RE=()=>g.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:"15",height:"15",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round",className:"lucide lucide-newspaper-icon lucide-newspaper",children:[g.jsx("path",{d:"M15 18h-5"}),g.jsx("path",{d:"M18 14h-8"}),g.jsx("path",{d:"M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 1-4 0v-9a2 2 0 0 1 2-2h2"}),g.jsx("rect",{width:"8",height:"4",x:"10",y:"6",rx:"1"})]}),zE=({className:t})=>g.jsxs("svg",{className:t??"w-4 h-4",viewBox:"0 0 24 24",fill:"none","aria-hidden":"true",children:[g.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"6",stroke:"currentColor",strokeWidth:"1.6"}),g.jsx("path",{d:"M8 16V8l8 8V8",stroke:"currentColor",strokeWidth:"2.2",strokeLinecap:"round",strokeLinejoin:"round"})]}),LE=()=>{const[t,a]=D.useState(()=>{if(typeof window>"u")return"dark";try{return localStorage.getItem("portfolio-theme")||"dark"}catch{return"dark"}});D.useEffect(()=>{if(!(typeof document>"u")){document.documentElement.setAttribute("data-theme",t);try{localStorage.setItem("portfolio-theme",t)}catch{}}},[t]);const l=D.useCallback(()=>{a(c=>c==="dark"?"light":"dark")},[]),u=D.useCallback(c=>{const f=document.getElementById(c);if(f){const b=f.getBoundingClientRect().top+window.pageYOffset-64-20;window.scrollTo({top:b,behavior:"smooth"})}},[]),s="/portfolio/".replace(/\/$/,"");return g.jsxs(Uy,{basename:s===""?void 0:s,children:[g.jsx($y,{}),g.jsx(Xy,{theme:t,onToggleTheme:l,onNavClick:u}),g.jsxs(my,{children:[g.jsx(Ua,{path:"/",element:g.jsx(YS,{})}),g.jsx(Ua,{path:"/blog",element:g.jsx(XS,{})}),g.jsx(Ua,{path:"/blog/:slug",element:g.jsx(kE,{})}),g.jsx(Ua,{path:"/contact",element:g.jsx(EE,{})})]}),g.jsx(Wy,{})]})};S1.createRoot(document.getElementById("root")).render(g.jsx(LE,{}));
