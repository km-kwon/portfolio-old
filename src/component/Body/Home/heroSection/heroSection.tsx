    ...
    >
      ...
      <div className="pt-2">
        ...
        <h1 className="text-[clamp(28px,4vw,36px)] font-bold leading-tight mb-4 tracking-tight">
          <span className="text-(--accent)">'최고'</span>를 위해
          <br />
          <span className="text-(--accent)">'최악'</span>을 대비하는,
          <br />
          '안전한 혁신가' 권경민입니다.
        </h1>
        <p className="text-[15px] text-fg-muted leading-[1.75] max-w-[520px] mb-8">
          ...
          <br />
          사이버보안을 전공하며 기른 <strong className="text-fg font-semibold">'비판적 사고'</strong>와{" "}
          <strong className="text-fg font-semibold">'리스크 관리'</strong> 역량을 프론트엔드 개발에 녹여내고
          있습니다.
        </p>
