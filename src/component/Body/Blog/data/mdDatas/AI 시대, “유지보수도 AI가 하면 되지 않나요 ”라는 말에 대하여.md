...
실제로 VTDM이라는 프로젝트의 개선/유지보수 작업을 혼자 맡았을 때도, 나는 AI를 꽤 공격적으로 활용했다.
...
> 프롬프트를 잘 쓴다는 건
>
> 단순히 AI에게 말을 예쁘게 하는것이 아니라,
>
> 문제를 제대로 정의하고, 제약을 설정하고, 설계 의도를 언어로 풀어낼 수 있다는 뜻이다.
...
- **코드는 점점 복잡해지고**
- **이해 비용은 기하급수적으로 늘고**
- 나중에는 AI에게 던져도 “뭐가 맞는지 내가 판단할 수 없는 상태”가 올 수 있다. (실제로 오기도 했다.)
...
반대로, 이런 것들은 여전히 **사람의 역할이** 가장 중요하다고 생각한다.
...
- 기능 개발을 할 때
  ...
  - “이 변경이 왜 이렇게 설계되었는지”에 대한 **두세 줄 메모(주석)** 남기기
